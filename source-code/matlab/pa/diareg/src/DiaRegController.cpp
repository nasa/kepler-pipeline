...
#include "DiaRegController.h"

//#include "libdiareg.h"

#include <iostream>

DiaRegController::DiaRegController(){
}

DiaRegController::~DiaRegController(){
}

int DiaRegController::doScience( DiaRegInputs& inputs, DiaRegOutputs& outputs ){
