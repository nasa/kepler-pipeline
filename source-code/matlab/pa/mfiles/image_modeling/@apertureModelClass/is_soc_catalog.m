function tf = is_soc_catalog(catalog)
%**************************************************************************
% tf = is_soc_catalog(catalog)
%**************************************************************************
% This function checks only the fields needed by apertureModelClass.
%
% INPUTS
%     catalog : A struct 
%
% OUTPUTS
%
%     tf      : A logical scalar equal to 'true' if 'catalog' is in the
%               accepted SOC format and 'false' otherwise.
%**************************************************************************
% 
...
%
    ...
    tfArray = false(numel(expectedStructFields), 1);
