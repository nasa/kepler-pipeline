...
remove_duplicate_cosmic_ray_events(cosmicRayEvents)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% function [cosmicRayEvents] = ...
% remove_duplicate_cosmic_ray_events(cosmicRayEvents)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% Remove duplicate cosmic ray events in target or background pixels.
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% 
...
if ~isempty(cosmicRayEvents)
    ...
    eventRows = [cosmicRayEvents.ccdRow]';
    eventColumns = [cosmicRayEvents.ccdColumn]';
    eventMjds = [cosmicRayEvents.mjd]';
    eventCoordinates = [eventMjds, eventRows, eventColumns];
