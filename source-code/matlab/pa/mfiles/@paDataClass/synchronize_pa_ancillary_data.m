...
synchronize_pa_ancillary_data(paDataObject, alerts)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% function [conditionedAncillaryDataStruct, alerts] = ...
% synchronize_ancillary_data(paDataObject, alerts)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% Method for PA ancillary data conditioning. Get needed structures and
% fields from PA data object and call common synchronization function.
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% 
...
longCadenceTimes = paDataObject.longCadenceTimes;

oapAncillaryEngineeringConfigurationStruct = ...
    paDataObject.oapAncillaryEngineeringConfigurationStruct;
ancillaryPipelineConfigurationStruct = ...
    paDataObject.ancillaryPipelineConfigurationStruct;
...
% Perform the ancillary data conditioning.
[conditionedAncillaryDataStruct, alerts] = ...
    synchronize_ancillary_data_mp(cadenceTimes, ...
    longCadenceTimes, oapAncillaryEngineeringConfigurationStruct, ...
