...
load ../../common/mfiles/paTestData_run1000  backgroundStruct;
...
bppParameterStruct.backgroundConfigurationStruct = backgroundConfigurationStruct;
bppParameterStruct.cosmicRayConfigurationStruct = cosmicRayConfigurationStruct;
bppParameterStruct.cleanCosmicRays = 1;
bppParameterStruct.debugFlag = 1;

bppResultStruct = bpp_matlab_controller(bppParameterStruct);
