...
%
% INPUTS
%     catalog : Can be any of the following:
%               1) An empty array.
%               2) A catalog struct array in the format returned by
%                  the sandbox tool retrieve_kics_matlabstyle().
%               3) A catalog struct array in the format expected by PA,
%                  which may contain additional fields.
%
%               In case 1 the input is simply passed to the output. In case
%               2, the conversion is made for fields expected by PA and any
%               unexpected fields are removed. In case  
%               3 any unneeded fields are removed.
%
% OUTPUTS
%     catalog : A catalog struct array in the following format:
%     |
%     |-.keplerId
%     |  |-.value
%     |   -.uncertainty
...
%
    ...
    elseif ~isempty(catalog) && isstruct(catalog)
