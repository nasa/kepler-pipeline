...
\begin{figure*}[h!]
  \centering
  \includegraphics[width=0.7\textwidth]{motion_figures/diff_MP_raDec2Pix_row.eps}
\end{figure*}
...
\begin{figure*}[h!]
  \centering
  \includegraphics[width=0.7\textwidth]{motion_figures/diff_MP_raDec2Pix_column.eps}
\end{figure*}
...
\begin{figure*}[h!]
  \centering
  \includegraphics[width=0.6\textwidth]{motion_figures/motion_dashboard.eps}
\end{figure*}
