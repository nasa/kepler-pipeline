...
\begin{figure*}[h!]
  \centering
  \includegraphics[width=0.45\textwidth]{centroid_figures/lc/prf_centroid_sd_dist.eps}
  \includegraphics[width=0.45\textwidth]{centroid_figures/lc/flux_weighted_centroid_sd_dist.eps}
...
\begin{figure*}[h!]
  \centering
  \includegraphics[width=0.7\textwidth]{centroid_figures/lc/out_of_family_count.eps}
\end{figure*}
...
\begin{figure*}[h!]
  \centering
  \includegraphics[width=0.65\textwidth]{centroid_figures/lc/large_chatter_count.eps}
\end{figure*}
