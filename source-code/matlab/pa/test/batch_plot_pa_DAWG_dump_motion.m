function batch_plot_pa_DAWG_dump_motion( varargin )
%**************************************************************************
% batch_plot_pa_DAWG_dump_motion( varargin )
%**************************************************************************
% INPUTS
...
for iChannel = 1:numel(channelDir)
    if( ~isempty(channelDir{iChannel}) )
        ...
        disp(['Channel ',num2str(channelList(iChannel)),'    --   Processing ', channelDir{iChannel}, '...']);
        plot_pa_DAWG_dump_motion(s.motionOutputStruct);
