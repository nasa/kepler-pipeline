...
% function self = test_for_missing_inputs(self)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% This method tests the all received file extractor for missing inputs.
%
%  Example
%  =======
%  Use a test runner to run the test method:
%      run(text_test_runner, testAllReceivedFileClass('test_for_missing_inputs'));
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%
% 
...
display('Test all received file extractor for missing inputs');
...
for iTest=1:2
    ...
    try
        ...
        switch (iTest)
            case 1
                retrievedAllReceivedFiles = retrieve_all_received_files();
            case 2
                startMjd = 54590.0;
                retrievedAllReceivedFiles = retrieve_all_received_files(startMjd);
        end
    catch
...
% Test allReceivedFileClass constructor for missing inputs

startMjd = 54000.0;
endMjd  = 64000.0;
allReceivedFiles = retrieve_all_received_files(startMjd, endMjd);
allReceivedFile  = allReceivedFiles(1);
...
remove_field_and_test_for_failure(allReceivedFile, 'allReceivedFile', allReceivedFile, 'allReceivedFile', 'allReceivedFileClass', fieldsAndBounds);
...
for iField = 1:nFields
    fieldsAndBounds( 3,:) = { 'dispatcherType';         [];         [];         { dispatcherType{iField} } };
    remove_field_and_test_for_failure(allReceivedFile.(fieldString{iField}), ['allReceivedFile.' fieldString{iField}], ...
        ['allReceivedFile.' fieldString{iField}], ['allReceivedFile.' fieldString{iField}], 'allReceivedFileClass', fieldsAndBounds);
end
