...
%
    display('flatfield pdq usecase');

    % This test case uses two module outputs, not the mod/out loop
    modules = [4 13];
    outputs = [4  1];
    start_mjd = 55000;
    end_mjd   = 56000;
    ...
    flatDataFull = retrieve_flat_field_model(modules(1), outputs(1), start_mjd, end_mjd);
