...
/*     Local Variables */
	...
	s_copy(messge, "The value of # was not the value expected./crThe val"
		"ue was:/cr(3:) '#' /cr(-3:) the expected value was:/cr(3:) '"
	...
	s_copy(messge, "The value of # was not less than '#' as was expected"
		". /cr The value was: '#'. ", (ftnlen)320, (ftnlen)78);
	repmc_(messge, "#", name__, messge, (ftnlen)320, (ftnlen)1, rtrim_(
		name__, name_len), (ftnlen)320);
	repmc_(messge, "#", myexp, messge, (ftnlen)320, (ftnlen)1, lexp, (
		ftnlen)320);
	...
	s_copy(messge, "The value of # was not greater than '#' as was expec"
		"ted. /cr The value was: '#'. ", (ftnlen)320, (ftnlen)81);
	repmc_(messge, "#", name__, messge, (ftnlen)320, (ftnlen)1, rtrim_(
		name__, name_len), (ftnlen)320);
	repmc_(messge, "#", myexp, messge, (ftnlen)320, (ftnlen)1, lexp, (
		ftnlen)320);
    ...
    if (! fail) {
	s_copy(messge, "The comparison/cr/cr(3:) # # '#' /cr/cr(-3:)was sati"
		"sfied./crThe value of # was '#'. ", (ftnlen)320, (ftnlen)85);
	repmc_(messge, "#", name__, messge, (ftnlen)320, (ftnlen)1, rtrim_(
		name__, name_len), (ftnlen)320);
	repmc_(messge, "#", comp, messge, (ftnlen)320, (ftnlen)1, rtrim_(comp,
		 comp_len), (ftnlen)320);
