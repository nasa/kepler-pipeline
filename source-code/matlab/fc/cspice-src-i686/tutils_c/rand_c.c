...
-Procedure rand_c ( Random d.p. number )

-Abstract
 
   Return a pseudo-random d.p. number lying in a specified interval. 
...
-Brief_I/O
   ...
   --------  ---  -------------------------------------------------- 
   lb,
   ub         I   Bounds of interval from which to pick d.p. number.
...
-Detailed_Input
   ...
   lb,
   ub             are, respectively, d.p. numbers defining an interval
                  from which to pick a pseudo-random d.p. number.
                     
-Detailed_Output
 
   The function returns a random d.p. number in the interval [lb, ub].
...
-Examples
   ...
   1) Obtain 25 random d.p. numbers in the interval [-100, 100].
      Use a non-default seed.
         ...
         SpiceInt                seed = 99999;
         SpiceInt                i;
         SpiceDouble             random [ NRAND ];
   
         srand ( (unsigned int) seed );
         
         for ( i = 0;  i < NRAND;  i++ )
         {
            random[i] = rand_c ( LB, UB  );
         }
...
-Index_Entries
   ...
   return random d.p. number from interval 
...
{ /* Begin rand_c */
   ...
   */
   ...
   /*
   Get a random number in the range 0 to RAND_MAX.  
   */
