...
/* Subroutine */ int curtim_(char *time, ftnlen time_len)
{
    ...
    extern /* Subroutine */ int rjust_(char *, char *, ftnlen, ftnlen), 
	    ...
	    ftnlen), cputim_(doublereal *), intstr_(integer *, char *, ftnlen)
	    ;
...
/*     components, see the routine CPUTIM. */
...
/* -    SPICELIB Version 1.0.0, 20-APR-1994 (WLT) */
...
/* -& */
	...
	ivec[(i__1 = i__ - 1) < 6 && 0 <= i__1 ? i__1 : s_rnge("ivec", i__1, 
		"curtim_", (ftnlen)143)] = (integer) tvec[(i__2 = i__ - 1) < 
...
/* Writing concatenation */
    ...
    i__3[2] = 3, a__1[2] = month + ((i__1 = ivec[1] - 1) < 12 && 0 <= i__1 ? 
	    i__1 : s_rnge("month", i__1, "curtim_", (ftnlen)162)) * 3;
    i__3[3] = 1, a__1[3] = "-";
    i__3[4] = 2, a__1[4] = day;
    i__3[5] = 1, a__1[5] = " ";
