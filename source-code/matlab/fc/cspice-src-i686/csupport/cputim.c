...
-Examples
   ...
   The following routine illustrates how you might use cputim_
...
-Version
   ...
   -CSPICE Version 1.1.0, 05-FEB-1999 (NJB)

      Unneeded #includes were removed.
      
   -CSPICE Version 1.0.0, 26-JAN-1998 (NJB)
