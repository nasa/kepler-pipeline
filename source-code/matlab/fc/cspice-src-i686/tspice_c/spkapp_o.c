/* spkapp_o.f -- translated by f2c (version 19980913).
...
/* Subroutine */ int spkapp_o__(integer *targ, doublereal *et, char *ref, 
...
/*        SPKAPP_O begins by computing the geometric position T(ET) of */
...
/*        selected, SPKAPP_O computes the position of the target body at */
...
/*        selected, SPKAPP_O computes the position of the target body T */
...
/*     In the following code fragment, SPKSSB and SPKAPP_O are used */
...
/*           CALL SPKAPP_O (  IO,     EPOCH,  'J2000',  STVGR2, */
/*       .                 'LT+S',  STIO,    LT               ) */
...
/*     1) The kernel files to be used by SPKAPP_O must be loaded */
...
/*        In the example program, the calling sequence of SPKAPP_O */
/*        was corrected. */

/* -    SPICELIB Version 1.1.0, 25-MAY-1990 (HAN) */

/*        The local variable CORR was added to eliminate a */
/*        run-time error that occurred when SPKAPP_O was determining */
...
/*        error that occurred when SPKAPP_O was determining what */
/*        corrections to apply to the state. If the literal string */
/*        'LT' was assigned to ABCORR, SPKAPP_O attempted to look at */
...
/*        Also, without the local variable CORR, SPKAPP_O would have to */
