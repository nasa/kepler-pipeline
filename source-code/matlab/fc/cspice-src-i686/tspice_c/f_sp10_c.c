...
-Procedure f_sp10_c ( Test wrappers for selected SPK type 10 routines )
...
-Version
   ...
   -tspice_c Version 1.1.0 15-AUG-1999 (NJB)  

      Computed state vector test criteria changed from exact equality
      to relative error within bounds.

   -tspice_c Version 1.0.0 10-AUG-1999 (NJB)  
