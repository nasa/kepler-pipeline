...
extern int chckad_(char *name__, doublereal *array, char *comp, doublereal *exp__, integer *size, doublereal *tol, logical *ok, ftnlen name_len, ftnlen comp_len);
...
/*:ref: halfpi_ 7 0 */
/*:ref: verbos_ 12 0 */
extern int chckai_(char *name__, integer *array, char *comp, integer *exp__, integer *size, logical *ok, ftnlen name_len, ftnlen comp_len);
/*:ref: tststy_ 14 4 13 13 124 124 */
/*:ref: tstlgs_ 14 4 13 13 124 124 */
/*:ref: repmi_ 14 7 13 13 4 13 124 124 124 */
/*:ref: repmc_ 14 8 13 13 13 13 124 124 124 124 */
...
/*:ref: tstlog_ 14 3 13 12 124 */
/*:ref: verbos_ 12 0 */
extern int chckoc_(char *name__, char *array, char *order, integer *size, logical *ok, ftnlen name_len, ftnlen array_len, ftnlen order_len);
/*:ref: rtrim_ 4 2 13 124 */
/*:ref: tststy_ 14 4 13 13 124 124 */
/*:ref: tstlgs_ 14 4 13 13 124 124 */
/*:ref: repmc_ 14 8 13 13 13 13 124 124 124 124 */
...
/*:ref: tstlog_ 14 3 13 12 124 */
/*:ref: verbos_ 12 0 */
extern int chckod_(char *name__, doublereal *array, char *order, integer *size, logical *ok, ftnlen name_len, ftnlen order_len);
/*:ref: rtrim_ 4 2 13 124 */
/*:ref: tststy_ 14 4 13 13 124 124 */
/*:ref: tstlgs_ 14 4 13 13 124 124 */
/*:ref: repmc_ 14 8 13 13 13 13 124 124 124 124 */
...
/*:ref: tstlog_ 14 3 13 12 124 */
/*:ref: verbos_ 12 0 */
extern int chckoi_(char *name__, integer *array, char *order, integer *size, logical *ok, ftnlen name_len, ftnlen order_len);
/*:ref: tststy_ 14 4 13 13 124 124 */
/*:ref: tstlgs_ 14 4 13 13 124 124 */
/*:ref: rtrim_ 4 2 13 124 */
/*:ref: repmc_ 14 8 13 13 13 13 124 124 124 124 */
...
/*:ref: tstlog_ 14 3 13 12 124 */
/*:ref: verbos_ 12 0 */
extern int chcksc_(char *name__, char *val, char *comp, char *exp__, logical *ok, ftnlen name_len, ftnlen val_len, ftnlen comp_len, ftnlen exp_len);
/*:ref: tststy_ 14 4 13 13 124 124 */
/*:ref: tstlgs_ 14 4 13 13 124 124 */
...
/*:ref: verbos_ 12 0 */
/*:ref: tstlog_ 14 3 13 12 124 */
extern int chcksd_(char *name__, doublereal *val, char *comp, doublereal *exp__, doublereal *tol, logical *ok, ftnlen name_len, ftnlen comp_len);
/*:ref: tststy_ 14 4 13 13 124 124 */
/*:ref: tstlgs_ 14 4 13 13 124 124 */
/*:ref: repmc_ 14 8 13 13 13 13 124 124 124 124 */
/*:ref: rtrim_ 4 2 13 124 */
...
/*:ref: verbos_ 12 0 */
/*:ref: tstlog_ 14 3 13 12 124 */
extern int chcksi_(char *name__, integer *val, char *comp, integer *exp__, integer *tol, logical *ok, ftnlen name_len, ftnlen comp_len);
/*:ref: tststy_ 14 4 13 13 124 124 */
/*:ref: tstlgs_ 14 4 13 13 124 124 */
/*:ref: repmc_ 14 8 13 13 13 13 124 124 124 124 */
/*:ref: rtrim_ 4 2 13 124 */
...
/*:ref: verbos_ 12 0 */
/*:ref: tstlog_ 14 3 13 12 124 */
extern int chcksl_(char *name__, logical *val, logical *exp__, logical *ok, ftnlen name_len);
/*:ref: tststy_ 14 4 13 13 124 124 */
/*:ref: tstlgs_ 14 4 13 13 124 124 */
/*:ref: repmc_ 14 8 13 13 13 13 124 124 124 124 */
/*:ref: rtrim_ 4 2 13 124 */
/*:ref: verbos_ 12 0 */
/*:ref: tstlog_ 14 3 13 12 124 */
extern int chckxc_(logical *except, char *short__, logical *ok, ftnlen short_len);
/*:ref: tststy_ 14 4 13 13 124 124 */
/*:ref: tstlgs_ 14 4 13 13 124 124 */
/*:ref: failed_ 12 0 */
...
/*:ref: tstlog_ 14 3 13 12 124 */
/*:ref: verbos_ 12 0 */
extern int mprint_(doublereal *mat, integer *rows, integer *cols, char *fmt, ftnlen fmt_len);
/*:ref: nblen_ 4 2 13 124 */
/*:ref: dpfmt_ 14 5 7 13 13 124 124 */
/*:ref: rtrim_ 4 2 13 124 */
/*:ref: dpstrf_ 14 6 7 4 13 13 124 124 */
/*:ref: tostdo_ 14 2 13 124 */
extern int t_stat__(char *act, char *name__, logical *ok, integer *number, ftnlen act_len, ftnlen name_len);
...
/*:ref: rtrim_ 4 2 13 124 */
extern int tsetup_(char *lognam, char *versn, ftnlen lognam_len, ftnlen versn_len);
/*:ref: tstlgs_ 14 4 13 13 124 124 */
...
extern int tstck3_(char *cknm, char *sclknm, logical *loadck, logical *loadsc, logical *keepsc, integer *handle, ftnlen cknm_len, ftnlen sclknm_len);
...
extern int tstfil_(char *pattrn, char *port, char *file, ftnlen pattrn_len, ftnlen port_len, ftnlen file_len);
...
/*:ref: reset_ 14 0 */
/*:ref: tstslf_ 14 2 13 124 */
extern int tstio_(char *line, char *name__, char *port, logical *ok, logical *status, ftnlen line_len, ftnlen name_len, ftnlen port_len);
...
extern int tstlgr_(char *messge, logical *errlog, char *gstyle, char *fstyle, char *marker, integer *int__, doublereal *dp, ftnlen messge_len, ftnlen gstyle_len, ftnlen fstyle_len, ftnlen marker_len);
extern int tstlog_(char *messge, logical *errlog, ftnlen messge_len);
extern int tstlgs_(char *gstyle, char *fstyle, ftnlen gstyle_len, ftnlen fstyle_len);
extern int tststy_(char *gstyle, char *fstyle, ftnlen gstyle_len, ftnlen fstyle_len);
extern int vrblog_(char *messge, logical *errlog, ftnlen messge_len);
extern int tstmsg_(char *marker, char *messge, ftnlen marker_len, ftnlen messge_len);
...
extern int tstopl_(char *lognam, char *versn, ftnlen lognam_len, ftnlen versn_len);
/*:ref: tstfil_ 14 6 13 13 13 124 124 124 */
/*:ref: failed_ 12 0 */
...
extern int tstpck_(char *namepc, logical *loadpc, logical *keeppc, ftnlen namepc_len);
/*:ref: kilfil_ 14 2 13 124 */
/*:ref: begdat_ 13 2 13 124 */
/*:ref: txtopn_ 14 3 13 4 124 */
/*:ref: rtrim_ 4 2 13 124 */
...
/*:ref: verbos_ 12 0 */
/*:ref: tstlog_ 14 3 13 12 124 */
extern int tstsav_(char *env, char *versn, char *time, ftnlen env_len, ftnlen versn_len, ftnlen time_len);
extern int tstget_(char *env, char *versn, char *time, ftnlen env_len, ftnlen versn_len, ftnlen time_len);
...
/*:ref: rtrim_ 4 2 13 124 */
extern int tstst_(integer *body, doublereal *et, char *segid, integer *frame, doublereal *state, integer *center, doublereal *gm, ftnlen segid_len);
...
extern int tsttxt_(char *namtxt, char *txt, integer *nlines, logical *load, logical *keep, ftnlen namtxt_len, ftnlen txt_len);
/*:ref: kilfil_ 14 2 13 124 */
/*:ref: txtopn_ 14 3 13 4 124 */
/*:ref: rtrim_ 4 2 13 124 */
/*:ref: ldpool_ 14 2 13 124 */
...
extern int tstent_(integer *fileno, char *table, integer *segno, char *column, integer *rowno, integer *nmax, integer *nelts, char *cvals, doublereal *dvals, integer *ivals, doublereal *tvals, logical *isnull, ftnlen table_len, ftnlen column_len, ftnlen cvals_len);
/*:ref: return_ 12 0 */
/*:ref: chkin_ 14 2 13 124 */
/*:ref: chkout_ 14 2 13 124 */
/*:ref: repmi_ 14 7 13 13 4 13 124 124 124 */
...
/*:ref: odd_ 12 1 4 */
/*:ref: rtrim_ 4 2 13 124 */
extern int tstsch_(char *table, integer *mxrows, integer *segtyp, integer *nrows, integer *ncols, char *cnames, integer *cclass, integer *dtypes, integer *stlens, integer *dims__, logical *indexd, logical *nullok, char *decls, ftnlen table_len, ftnlen cnames_len, ftnlen decls_len);
/*:ref: return_ 12 0 */
/*:ref: chkin_ 14 2 13 124 */
/*:ref: setmsg_ 14 2 13 124 */
