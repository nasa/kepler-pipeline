...
/*                       +-                                           -+ */
/*                       | .364240763232  .606202078226 -.706999085399 | */
/*                       |                                             | */
/*            TICAM  =   | .342866017955  .618542793166  .706999085399 | */
/*                       |                                             | */
/*                       | .865893503921 -.499923847578  .174524064373 | */
/*                       +-                                           -+ */
...
/*            CALL M2EUL ( TICAM, 3, 1, 3, KAPPA, ANG2, ANG3 ) */
...
/*            PRINT *, 'Alpha = ', DPR() * ALPHA */
/*            PRINT *, 'Delta = ', DPR() * DELTA */
/*            PRINT *, 'Kappa = ', DPR() * KAPPA */

/*         We should see something like */

/*            Alpha = 3.15000000000000000D+02 */
/*            Delta = 1.00000000000000000D+00 */
/*            Kappa = 4.50000000000000000D+01 */
...
/*     of R that has unitized columns. */
	...
	vhat_(&r__[(i__1 = i__ * 3 - 3) < 9 && 0 <= i__1 ? i__1 : s_rnge(
		"r", i__1, "m2eul_", (ftnlen)641)], &tmprot[(i__2 = i__ * 3 - 
...
/*        1. */
	...
	if (*axis2 == next[(i__1 = *axis3 - 1) < 3 && 0 <= i__1 ? i__1 : 
		s_rnge("next", i__1, "m2eul_", (ftnlen)720)]) {
	    sign = 1.;
	} else {
	    sign = -1.;
	}

/*        Since the the axis indices sum to 6, */
...
/*        little mapping that takes 1 to 2, 2 to 3, and 3 to 1. */
	...
	if (*axis2 == next[(i__1 = *axis3 - 1) < 3 && 0 <= i__1 ? i__1 : 
		s_rnge("next", i__1, "m2eul_", (ftnlen)857)]) {
	    sign = 1.;
	} else {
	    sign = -1.;
	}
