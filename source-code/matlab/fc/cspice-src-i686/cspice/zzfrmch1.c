...
/*        CALL ZZFRMCH1 ( FRAME1, FRAME2, ET,   XFORM ) */
...
/*        CALL ZZFRMCH1 ( FRAME1, FRAME2, ET, STXFRM ) */
...
/*     same then we simply return the identity matrix. */
	...
	for (i__ = 1; i__ <= 6; ++i__) {
	    xform[(i__1 = i__ + i__ * 6 - 7) < 36 && 0 <= i__1 ? i__1 : 
		    s_rnge("xform", i__1, "zzfrmch1_", (ftnlen)369)] = 1.;
	    i__1 = i__ - 1;
	    for (j = 1; j <= i__1; ++j) {
		xform[(i__2 = i__ + j * 6 - 7) < 36 && 0 <= i__2 ? i__2 : 
			s_rnge("xform", i__2, "zzfrmch1_", (ftnlen)372)] = 0.;
		xform[(i__2 = j + i__ * 6 - 7) < 36 && 0 <= i__2 ? i__2 : 
			s_rnge("xform", i__2, "zzfrmch1_", (ftnlen)373)] = 0.;
	    }
	}
...
/*           for the next NODE. */
	    ...
	    i__1, "zzfrmch1_", (ftnlen)446)] == 1 || frame[(i__2 = node - 1) <
...
/*        root classes or we run into FRAME2. */
	...
	zzfrmgt1_(&frame[(i__1 = node - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge(
		"frame", i__1, "zzfrmch1_", (ftnlen)460)], et, &trans[(i__2 = 
		(node * 6 + 1) * 6 - 42) < 504 && 0 <= i__2 ? i__2 : s_rnge(
		"trans", i__2, "zzfrmch1_", (ftnlen)460)], &relto, &found);
	if (found) {
...
/*           transformation from FRAME(NODE) to RELTO. */
	    ...
	    frame[(i__1 = node - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge("frame",
		     i__1, "zzfrmch1_", (ftnlen)471)] = relto;
		...
		for (j = 1; j <= 6; ++j) {
		    trans[(i__1 = i__ + (j + (node - 1) * 6) * 6 - 43) < 504 
			    ...
			    "rmch1_", (ftnlen)476)] = tempxf[(i__2 = i__ + j * 
			    6 - 7) < 36 && 0 <= i__2 ? i__2 : s_rnge("tempxf",
			     i__2, "zzfrmch1_", (ftnlen)476)];
		}
	    }
	}
...
/*        another transformation. */
		...
		"frame", i__1, "zzfrmch1_", (ftnlen)486)] == 1 || frame[(i__2 
		= node - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge("frame", i__2, 
		"zzfrmch1_", (ftnlen)486)] == *frame2 || ! found;
    }
...
/*     We now have to do essentially the same thing for FRAME2. */
    ...
    if (frame[(i__1 = node - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge("frame", 
	    i__1, "zzfrmch1_", (ftnlen)524)] == *frame2) {
...
/*              works see ZZMSXF. */
		...
		for (i__ = 4; i__ <= 6; ++i__) {
			...
			trans2[(i__1 = i__ + (j + put * 6) * 6 - 43) < 72 && 
				0 <= i__1 ? i__1 : s_rnge("trans2", i__1, 
				"zzfrmch1_", (ftnlen)628)] = tempxf[(i__2 = 
				i__ - 1) < 36 && 0 <= i__2 ? i__2 : s_rnge(
				"tempxf", i__2, "zzfrmch1_", (ftnlen)628)] * 
				trans2[(i__3 = (j + get * 6) * 6 - 42) < 72 &&
				 0 <= i__3 ? i__3 : s_rnge("trans2", i__3, 
				"zzfrmch1_", (ftnlen)628)] + tempxf[(i__4 = 
				i__ + 5) < 36 && 0 <= i__4 ? i__4 : s_rnge(
				"tempxf", i__4, "zzfrmch1_", (ftnlen)628)] * 
				trans2[(i__5 = (j + get * 6) * 6 - 41) < 72 &&
				 0 <= i__5 ? i__5 : s_rnge("trans2", i__5, 
				"zzfrmch1_", (ftnlen)628)] + tempxf[(i__6 = 
				i__ + 11) < 36 && 0 <= i__6 ? i__6 : s_rnge(
				"tempxf", i__6, "zzfrmch1_", (ftnlen)628)] * 
				trans2[(i__7 = (j + get * 6) * 6 - 40) < 72 &&
				 0 <= i__7 ? i__7 : s_rnge("trans2", i__7, 
				"zzfrmch1_", (ftnlen)628)] + tempxf[(i__8 = 
				i__ + 17) < 36 && 0 <= i__8 ? i__8 : s_rnge(
				"tempxf", i__8, "zzfrmch1_", (ftnlen)628)] * 
				trans2[(i__9 = (j + get * 6) * 6 - 39) < 72 &&
				 0 <= i__9 ? i__9 : s_rnge("trans2", i__9, 
				"zzfrmch1_", (ftnlen)628)] + tempxf[(i__10 = 
				i__ + 23) < 36 && 0 <= i__10 ? i__10 : s_rnge(
				"tempxf", i__10, "zzfrmch1_", (ftnlen)628)] * 
				trans2[(i__11 = (j + get * 6) * 6 - 38) < 72 
				&& 0 <= i__11 ? i__11 : s_rnge("trans2", 
				i__11, "zzfrmch1_", (ftnlen)628)] + tempxf[(
				...
				"ns2", i__13, "zzfrmch1_", (ftnlen)628)];
		    }
		}
...
/*              from the upper left hand block of the matrix. */
		...
		for (i__ = 4; i__ <= 6; ++i__) {
			...
			trans2[(i__1 = i__ + (j + put * 6) * 6 - 43) < 72 && 
				0 <= i__1 ? i__1 : s_rnge("trans2", i__1, 
				"zzfrmch1_", (ftnlen)647)] = trans2[(i__2 = k 
...
/*     get from FRAME1 to FRAME2. */
	...
	frmnam_(&frame[(i__1 = node - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge(
		"frame", i__1, "zzfrmch1_", (ftnlen)693)], name3, (ftnlen)32);
	...
	errint_("#", &frame[(i__1 = node - 1) < 10 && 0 <= i__1 ? i__1 : 
		s_rnge("frame", i__1, "zzfrmch1_", (ftnlen)726)], (ftnlen)1);
	errint_("#", frame2, (ftnlen)1);
...
/*     result from FRAME1 to FRAME2. */
    ...
    invstm_(&trans2[(i__1 = (get * 6 + 1) * 6 - 42) < 72 && 0 <= i__1 ? i__1 :
	     s_rnge("trans2", i__1, "zzfrmch1_", (ftnlen)761)], &trans[(i__2 =
	     (cmnode * 6 + 1) * 6 - 42) < 504 && 0 <= i__2 ? i__2 : s_rnge(
	    "trans", i__2, "zzfrmch1_", (ftnlen)761)]);
