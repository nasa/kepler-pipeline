...
/*     left (L2R is YES) or from the right (L2R is NO). */
	...
	ends[(i__1 = from - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("ends", i__1,
		 "zztime_", (ftnlen)546)] = ends[(i__2 = to - 1) < 32 && 0 <= 
		i__2 ? i__2 : s_rnge("ends", i__2, "zztime_", (ftnlen)546)];
	pends[(i__1 = from - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("pends", 
		i__1, "zztime_", (ftnlen)547)] = pends[(i__2 = to - 1) < 32 &&
...
/* -& */
	...
	if (did) {
	    *b = begs[(i__1 = from - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge(
		    "begs", i__1, "zztime_", (ftnlen)854)];
	    *e = ends[(i__1 = to - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("ends"
		    , i__1, "zztime_", (ftnlen)855)];
	    ret_val = TRUE_;
	    return ret_val;
	}
...
/* -& */
	...
	*b = begs[(i__1 = put - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("begs", 
		i__1, "zztime_", (ftnlen)1135)];
	*e = ends[(i__1 = put - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("ends", 
		i__1, "zztime_", (ftnlen)1136)];
	next = put + 1;
	i__1 = size;
	for (get = next; get <= i__1; ++get) {
	    begs[(i__2 = put - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("begs", 
		    i__2, "zztime_", (ftnlen)1142)] = begs[(i__3 = get - 1) < 
		    32 && 0 <= i__3 ? i__3 : s_rnge("begs", i__3, "zztime_", (
		    ftnlen)1142)];
	    ends[(i__2 = put - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("ends", 
		    i__2, "zztime_", (ftnlen)1143)] = ends[(i__3 = get - 1) < 
		    32 && 0 <= i__3 ? i__3 : s_rnge("ends", i__3, "zztime_", (
		    ftnlen)1143)];
	    pbegs[(i__2 = put - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("pbegs", 
		    i__2, "zztime_", (ftnlen)1144)] = pbegs[(i__3 = get - 1) <
		     32 && 0 <= i__3 ? i__3 : s_rnge("pbegs", i__3, "zztime_",
		     (ftnlen)1144)];
	    pends[(i__2 = put - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("pends", 
		    i__2, "zztime_", (ftnlen)1145)] = pends[(i__3 = get - 1) <
		     32 && 0 <= i__3 ? i__3 : s_rnge("pends", i__3, "zztime_",
		     (ftnlen)1145)];
...
/* -& */
	...
	if (*(unsigned char *)&rep[i__ - 1] != *(unsigned char *)letter) {
	    ...
	    *(unsigned char *)&rep[put - 1] = *(unsigned char *)&rep[i__ - 1];
	    begs[(i__2 = put - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("begs", 
		    i__2, "zztime_", (ftnlen)1296)] = begs[(i__3 = i__ - 1) < 
		    32 && 0 <= i__3 ? i__3 : s_rnge("begs", i__3, "zztime_", (
		    ftnlen)1296)];
	    ends[(i__2 = put - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("ends", 
		    i__2, "zztime_", (ftnlen)1297)] = ends[(i__3 = i__ - 1) < 
		    32 && 0 <= i__3 ? i__3 : s_rnge("ends", i__3, "zztime_", (
		    ftnlen)1297)];
	    pbegs[(i__2 = put - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("pbegs", 
		    i__2, "zztime_", (ftnlen)1298)] = pbegs[(i__3 = i__ - 1) <
		     32 && 0 <= i__3 ? i__3 : s_rnge("pbegs", i__3, "zztime_",
		     (ftnlen)1298)];
	    pends[(i__2 = put - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("pends", 
		    i__2, "zztime_", (ftnlen)1299)] = pends[(i__3 = i__ - 1) <
		     32 && 0 <= i__3 ? i__3 : s_rnge("pends", i__3, "zztime_",
		     (ftnlen)1299)];
	} else {
	    did = TRUE_;
...
/*        group to the last. */
	...
	for (i__ = 32; i__ <= 126; ++i__) {
	    f[(i__1 = i__ - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("f", i__1, 
		    "zztime_", (ftnlen)1725)] = 0;
	    l[(i__1 = i__ - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		    "zztime_", (ftnlen)1726)] = -1;
	    s_copy(names + (((i__1 = i__ - 32) < 97 && 0 <= i__1 ? i__1 : 
		    s_rnge("names", i__1, "zztime_", (ftnlen)1727)) << 5), 
		    "substring", (ftnlen)32, (ftnlen)9);
	}
	s_copy(names + (((i__1 = '\'' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1731)) << 5), "\"Year Abbr"
		"eviation Mark\"", (ftnlen)32, (ftnlen)24);
	s_copy(names + (((i__1 = ',' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1732)) << 5), "comma", (
		ftnlen)32, (ftnlen)5);
	s_copy(names + (((i__1 = '-' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1733)) << 5), "dash", (
		ftnlen)32, (ftnlen)4);
	s_copy(names + (((i__1 = '.' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1734)) << 5), "period", (
		ftnlen)32, (ftnlen)6);
	s_copy(names + (((i__1 = '/' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1735)) << 5), "slash", (
		ftnlen)32, (ftnlen)5);
	s_copy(names + (((i__1 = ':' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1736)) << 5), "colon", (
		ftnlen)32, (ftnlen)5);
	s_copy(names + (((i__1 = 'D' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1737)) << 5), "Day of Month"
		, (ftnlen)32, (ftnlen)12);
	s_copy(names + (((i__1 = 'H' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1738)) << 5), "Hour", (
		ftnlen)32, (ftnlen)4);
	s_copy(names + (((i__1 = 'M' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1739)) << 5), "Minute", (
		ftnlen)32, (ftnlen)6);
	s_copy(names + (((i__1 = 'N' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1740)) << 5), "AM/PM indic"
		"ator", (ftnlen)32, (ftnlen)15);
	s_copy(names + (((i__1 = 'O' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1741)) << 5), "UTC-Offset "
		"indicator", (ftnlen)32, (ftnlen)20);
	s_copy(names + (((i__1 = 'S' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1742)) << 5), "Second", (
		ftnlen)32, (ftnlen)6);
	s_copy(names + (((i__1 = 'Y' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1743)) << 5), "Year", (
		ftnlen)32, (ftnlen)4);
	s_copy(names + (((i__1 = 'Z' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1744)) << 5), "Time-Zone i"
		"ndicator", (ftnlen)32, (ftnlen)19);
	s_copy(names + (((i__1 = '[' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1745)) << 5), "Left Parent"
		"hesis", (ftnlen)32, (ftnlen)16);
	s_copy(names + (((i__1 = ']' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1746)) << 5), "Right Paren"
		"thesis", (ftnlen)32, (ftnlen)17);
	s_copy(names + (((i__1 = 'b' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1747)) << 5), "White Space",
		 (ftnlen)32, (ftnlen)11);
	s_copy(names + (((i__1 = 'd' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1748)) << 5), "Day-of-Year"
		" indicator", (ftnlen)32, (ftnlen)21);
	s_copy(names + (((i__1 = 'e' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1749)) << 5), "Era", (
		ftnlen)32, (ftnlen)3);
	s_copy(names + (((i__1 = 'i' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1750)) << 5), "Integer", (
		ftnlen)32, (ftnlen)7);
	s_copy(names + (((i__1 = 'j' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1751)) << 5), "Julian Date"
		" indicator", (ftnlen)32, (ftnlen)21);
	s_copy(names + (((i__1 = 'm' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1752)) << 5), "Month", (
		ftnlen)32, (ftnlen)5);
	s_copy(names + (((i__1 = 'n' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1753)) << 5), "Decimal Num"
		"ber", (ftnlen)32, (ftnlen)14);
	s_copy(names + (((i__1 = 'o' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1754)) << 5), "UTC-Offset "
		"indicator", (ftnlen)32, (ftnlen)20);
	s_copy(names + (((i__1 = 's' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1755)) << 5), "Time System"
		" specification", (ftnlen)32, (ftnlen)25);
	s_copy(names + (((i__1 = 't' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1756)) << 5), "ISO Time Se"
		"parator", (ftnlen)32, (ftnlen)18);
	s_copy(names + (((i__1 = 'w' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1757)) << 5), "Weekday", (
		ftnlen)32, (ftnlen)7);
	s_copy(names + (((i__1 = 'y' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge(
		"names", i__1, "zztime_", (ftnlen)1758)) << 5), "Day of Year",
		 (ftnlen)32, (ftnlen)11);
...
/*        Tokens beginning with ' ' */
	...
	f[(i__1 = ' ' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("f", i__1, 
		"zztime_", (ftnlen)1786)] = i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1787)) * 12, " ", (ftnlen)
		12, (ftnlen)1);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1788)] = 1;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1789)] = 'b';
	l[(i__1 = ' ' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1790)] = i__;

/*        Tokens beginning with '(' */

	++i__;
	f[(i__1 = '(' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("f", i__1, 
		"zztime_", (ftnlen)1796)] = i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1797)) * 12, "(", (ftnlen)
		12, (ftnlen)1);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1798)] = 1;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1799)] = '[';
	l[(i__1 = '(' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1800)] = i__;

/*        Tokens beginning with ')' */

	++i__;
	f[(i__1 = ')' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("f", i__1, 
		"zztime_", (ftnlen)1805)] = i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1806)) * 12, ")", (ftnlen)
		12, (ftnlen)1);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1807)] = 1;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1808)] = ']';
	l[(i__1 = ')' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1809)] = i__;

/*        Tokens beginning with ',' */

	++i__;
	f[(i__1 = ',' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("f", i__1, 
		"zztime_", (ftnlen)1814)] = i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1815)) * 12, ",", (ftnlen)
		12, (ftnlen)1);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1816)] = 1;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1817)] = ',';
	l[(i__1 = ',' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1818)] = i__;

/*        Tokens beginning with '-' */

	++i__;
	f[(i__1 = '-' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("f", i__1, 
		"zztime_", (ftnlen)1824)] = i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1825)) * 12, "-", (ftnlen)
		12, (ftnlen)1);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1826)] = 1;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1827)] = '-';
	l[(i__1 = '-' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1828)] = i__;
...
/*        Tokens beginning with '.' */
	...
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1835)) * 12, ".", (ftnlen)
		12, (ftnlen)1);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1836)] = 1;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1837)] = '.';
	l[(i__1 = '.' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1838)] = i__;
...
/*        Tokens beginning with '/' */
	...
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1845)) * 12, "//", (ftnlen)
		12, (ftnlen)2);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1846)] = 2;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1847)] = 'd';
	l[(i__1 = '/' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1848)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
...
/*        Tokens beginning with ':' */
	...
	++i__;
	f[(i__1 = ':' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("f", i__1, 
		"zztime_", (ftnlen)1859)] = i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1860)) * 12, "::", (ftnlen)
		12, (ftnlen)2);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1861)] = 2;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1862)] = 'd';
	l[(i__1 = ':' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1863)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1866)) * 12, ":", (ftnlen)
		12, (ftnlen)1);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1867)] = 1;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1868)] = ':';
	l[(i__1 = ':' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1869)] = i__;
...
/*        Tokens beginning with 'A' */
	...
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1876)) * 12, "A.D.", (
		ftnlen)12, (ftnlen)4);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1877)] = 4;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1878)] = 'e';
	l[(i__1 = 'A' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1879)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1882)) * 12, "AD", (ftnlen)
		12, (ftnlen)2);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1883)] = 2;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1884)] = 'e';
	l[(i__1 = 'A' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1885)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1888)) * 12, "A.M.", (
		ftnlen)12, (ftnlen)4);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1889)] = 4;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1890)] = 'N';
	l[(i__1 = 'A' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1891)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1894)) * 12, "AM", (ftnlen)
		12, (ftnlen)2);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1895)] = 2;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1896)] = 'N';
	l[(i__1 = 'A' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1897)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1900)) * 12, "APRIL", (
		ftnlen)12, (ftnlen)5);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1901)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1902)] = 'm';
	l[(i__1 = 'A' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1903)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1906)) * 12, "AUGUST", (
		ftnlen)12, (ftnlen)6);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1907)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1908)] = 'm';
	l[(i__1 = 'A' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
...
/*        Tokens beginning with 'B' */
	...
	f[(i__1 = 'B' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("f", i__1, 
		"zztime_", (ftnlen)1915)] = i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1916)) * 12, "B.C.", (
		ftnlen)12, (ftnlen)4);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1917)] = 4;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1918)] = 'e';
	l[(i__1 = 'B' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1919)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1922)) * 12, "BC", (ftnlen)
		12, (ftnlen)2);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1923)] = 2;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1924)] = 'e';
	l[(i__1 = 'B' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
...
/*        Tokens beginning with 'C' */
	...
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1932)) * 12, "CDT", (ftnlen)
		12, (ftnlen)3);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1933)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1934)] = 'Z';
	l[(i__1 = 'C' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1935)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1938)) * 12, "CST", (ftnlen)
		12, (ftnlen)3);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1939)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1940)] = 'Z';
	l[(i__1 = 'C' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
...
/*        Tokens beginning with 'D' */
	...
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1948)) * 12, "DECEMBER", (
		ftnlen)12, (ftnlen)8);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1949)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1950)] = 'm';
	l[(i__1 = 'D' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1951)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1954)) * 12, "D+", (ftnlen)
		12, (ftnlen)2);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1955)] = 2;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1956)] = 'E';
	l[(i__1 = 'D' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1957)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1960)) * 12, "D-", (ftnlen)
		12, (ftnlen)2);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1961)] = 2;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1962)] = 'E';
	l[(i__1 = 'D' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1963)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1966)) * 12, "D", (ftnlen)
		12, (ftnlen)1);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1967)] = 1;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1968)] = 'E';
	l[(i__1 = 'D' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
...
/*        Tokens beginning with 'E' */
	...
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1979)) * 12, "EDT", (ftnlen)
		12, (ftnlen)3);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1980)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1981)] = 'Z';
	l[(i__1 = 'E' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1982)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1985)) * 12, "EST", (ftnlen)
		12, (ftnlen)3);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)1986)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)1987)] = 'Z';
	l[(i__1 = 'E' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)1988)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1991)) * 12, "E+", (ftnlen)
		12, (ftnlen)2);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
	...
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
	...
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)1997)) * 12, "E-", (ftnlen)
		12, (ftnlen)2);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
	...
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
	...
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2003)) * 12, "E", (ftnlen)
		12, (ftnlen)1);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2004)] = 1;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2005)] = 'E';
	l[(i__1 = 'E' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
...
/*        Tokens beginning with 'F' */
	...
	f[(i__1 = 'F' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("f", i__1, 
		"zztime_", (ftnlen)2013)] = i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2014)) * 12, "FEBRUARY", (
		ftnlen)12, (ftnlen)8);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2015)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2016)] = 'm';
	l[(i__1 = 'F' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2017)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2020)) * 12, "FRIDAY", (
		ftnlen)12, (ftnlen)6);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2021)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2022)] = 'w';
	l[(i__1 = 'F' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2023)] = i__;
...
/*        Tokens beginning with 'J' */
	...
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2030)) * 12, "JANUARY", (
		ftnlen)12, (ftnlen)7);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
	...
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
	...
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2036)) * 12, "JD", (ftnlen)
		12, (ftnlen)2);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2037)] = 2;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2038)] = 'j';
	l[(i__1 = 'J' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2039)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2042)) * 12, "JULY", (
		ftnlen)12, (ftnlen)4);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2043)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2044)] = 'm';
	l[(i__1 = 'J' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2045)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2048)) * 12, "JUNE", (
		ftnlen)12, (ftnlen)4);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2049)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2050)] = 'm';
	l[(i__1 = 'J' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2051)] = i__;
...
/*        Tokens beginning with 'M' */
	...
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2058)) * 12, "MARCH", (
		ftnlen)12, (ftnlen)5);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
	...
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
	...
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2064)) * 12, "MAY", (ftnlen)
		12, (ftnlen)3);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
	...
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
	...
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2070)) * 12, "MDT", (ftnlen)
		12, (ftnlen)3);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2071)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2072)] = 'Z';
	l[(i__1 = 'M' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2073)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2076)) * 12, "MONDAY", (
		ftnlen)12, (ftnlen)6);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2077)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2078)] = 'w';
	l[(i__1 = 'M' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2079)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2082)) * 12, "MST", (ftnlen)
		12, (ftnlen)3);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2083)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2084)] = 'Z';
	l[(i__1 = 'M' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2085)] = i__;

/*        Tokens beginning with 'N' */

	++i__;
	f[(i__1 = 'N' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("f", i__1, 
		"zztime_", (ftnlen)2091)] = i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2092)) * 12, "NOVEMBER", (
		ftnlen)12, (ftnlen)8);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2093)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2094)] = 'm';
...
/*        Tokens beginning with 'O' */
	...
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2102)) * 12, "OCTOBER", (
		ftnlen)12, (ftnlen)7);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2103)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2104)] = 'm';
	l[(i__1 = 'O' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2105)] = i__;
...
/*        Tokens beginning with 'P' */
	...
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2112)) * 12, "P.M.", (
		ftnlen)12, (ftnlen)4);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2113)] = 4;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2114)] = 'N';
	l[(i__1 = 'P' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2115)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2118)) * 12, "PDT", (ftnlen)
		12, (ftnlen)3);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2119)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2120)] = 'Z';
	l[(i__1 = 'P' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2121)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2124)) * 12, "PM", (ftnlen)
		12, (ftnlen)2);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2125)] = 2;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2126)] = 'N';
	l[(i__1 = 'P' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2127)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2130)) * 12, "PST", (ftnlen)
		12, (ftnlen)3);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2131)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2132)] = 'Z';
	l[(i__1 = 'P' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2133)] = i__;

/*        Tokens beginning with 'S' */

	++i__;
	f[(i__1 = 'S' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("f", i__1, 
		"zztime_", (ftnlen)2139)] = i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2140)) * 12, "SATURDAY", (
		ftnlen)12, (ftnlen)8);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2141)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2142)] = 'w';
	l[(i__1 = 'S' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2143)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2146)) * 12, "SEPTEMBER", (
		ftnlen)12, (ftnlen)9);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2147)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2148)] = 'm';
	l[(i__1 = 'S' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2149)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2152)) * 12, "SUNDAY", (
		ftnlen)12, (ftnlen)6);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2153)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2154)] = 'w';
	l[(i__1 = 'S' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
...
/*        Tokens beginning with 'T' */
	...
	f[(i__1 = 'T' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("f", i__1, 
		"zztime_", (ftnlen)2161)] = i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2162)) * 12, "TDB", (ftnlen)
		12, (ftnlen)3);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2163)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2164)] = 's';
	l[(i__1 = 'T' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2165)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2168)) * 12, "TDT", (ftnlen)
		12, (ftnlen)3);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2169)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2170)] = 's';
	l[(i__1 = 'T' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2171)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2174)) * 12, "THURSDAY", (
		ftnlen)12, (ftnlen)8);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2175)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2176)] = 'w';
	l[(i__1 = 'T' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2177)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2180)) * 12, "TUESDAY", (
		ftnlen)12, (ftnlen)7);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2181)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2182)] = 'w';
	l[(i__1 = 'T' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2183)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2186)) * 12, "T", (ftnlen)
		12, (ftnlen)1);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2187)] = 1;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2188)] = 't';
	l[(i__1 = 'T' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2189)] = i__;

/*        Tokens beginning with 'U' */

	++i__;
	f[(i__1 = 'U' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("f", i__1, 
		"zztime_", (ftnlen)2195)] = i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2196)) * 12, "UTC+", (
		ftnlen)12, (ftnlen)4);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2197)] = 4;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2198)] = 'O';
	l[(i__1 = 'U' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2199)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2202)) * 12, "UTC-", (
		ftnlen)12, (ftnlen)4);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2203)] = 4;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2204)] = 'o';
	l[(i__1 = 'U' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2205)] = i__;
	++i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2208)) * 12, "UTC", (ftnlen)
		12, (ftnlen)3);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2209)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2210)] = 's';
	l[(i__1 = 'U' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
...
/*        Tokens beginning with '''' */
	...
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2217)) * 12, "'", (ftnlen)
		12, (ftnlen)1);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2218)] = 1;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2219)] = '\'';
	l[(i__1 = '\'' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
...
/*        Tokens beginning with 'W' */
	...
	f[(i__1 = 'W' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("f", i__1, 
		"zztime_", (ftnlen)2225)] = i__;
	s_copy(recog + ((i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge(
		"recog", i__1, "zztime_", (ftnlen)2226)) * 12, "WEDNESDAY", (
		ftnlen)12, (ftnlen)9);
	width[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 : s_rnge("width", 
		i__1, "zztime_", (ftnlen)2227)] = 3;
	*(unsigned char *)&class__[(i__1 = i__ - 1) < 70 && 0 <= i__1 ? i__1 :
		 s_rnge("class", i__1, "zztime_", (ftnlen)2228)] = 'w';
	l[(i__1 = 'W' - 32) < 97 && 0 <= i__1 ? i__1 : s_rnge("l", i__1, 
		"zztime_", (ftnlen)2229)] = i__;
    }
...
/*           beyond this token. */
	    ...
	    *(unsigned char *)&rep[put - 1] = 'i';
	    begs[(i__1 = put - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("begs", 
		    i__1, "zztime_", (ftnlen)2270)] = from;
	    ends[(i__1 = put - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("ends", 
		    i__1, "zztime_", (ftnlen)2271)] = to;
	    next = to + 1;
	    pto = pfrom + nchar - 1;
	    pnext = pto + 1;
	    ...
	    pbegs[(i__1 = put - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("pbegs", 
		    i__1, "zztime_", (ftnlen)2276)] = pfrom;
	    pends[(i__1 = put - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("pends", 
		    i__1, "zztime_", (ftnlen)2277)] = pto;
	} else if (item == blank) {
...
/*           blanks together as one big fat blank. */
	    ...
	    *(unsigned char *)&rep[put - 1] = 'b';
	    ...
	    --to;
	    ends[(i__1 = put - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("ends", 
		    i__1, "zztime_", (ftnlen)2298)] = to;
	    pto = pfrom + to - from;
	    pnext = pto + 1;
	    s_copy(pictur + (pfrom - 1), string + (from - 1), pto - (pfrom - 
		    1), to - (from - 1));
	    pbegs[(i__1 = put - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("pbegs", 
		    i__1, "zztime_", (ftnlen)2303)] = pfrom;
	    pends[(i__1 = put - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("pends", 
		    i__1, "zztime_", (ftnlen)2304)] = pto;
	} else if (item == 9) {
...
/*           blanks. */
	    ...
	    *(unsigned char *)&rep[put - 1] = 'b';
	    begs[(i__1 = put - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("begs", 
		    i__1, "zztime_", (ftnlen)2313)] = from;
	    ends[(i__1 = put - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("ends", 
		    i__1, "zztime_", (ftnlen)2314)] = from;
	    ++next;
	    pto = pfrom;
	    pnext = pto + 1;
	    s_copy(pictur + (pfrom - 1), " ", pto - (pfrom - 1), (ftnlen)1);
	    pbegs[(i__1 = put - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("pbegs", 
		    i__1, "zztime_", (ftnlen)2320)] = pfrom;
	    pends[(i__1 = put - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("pends", 
		    i__1, "zztime_", (ftnlen)2321)] = pfrom;
...
/*                 end of the match. */
		    ...
		    *(unsigned char *)&rep[put - 1] = *(unsigned char *)&
			    ...
			    : s_rnge("class", i__1, "zztime_", (ftnlen)2449)];
		    begs[(i__1 = put - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge(
			    "begs", i__1, "zztime_", (ftnlen)2450)] = from;
		    ends[(i__1 = put - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge(
			    "ends", i__1, "zztime_", (ftnlen)2451)] = to;
		    pbegs[(i__1 = put - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge(
			    "pbegs", i__1, "zztime_", (ftnlen)2452)] = pfrom;
		    pends[(i__1 = put - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge(
			    "pends", i__1, "zztime_", (ftnlen)2453)] = pto;
		    check = FALSE_;
		    next = to + 1;
		}
		++i__;
...
/* -& */
    ...
    *e = 0;
	...
	j = begs[(i__1 = i__ - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("begs", 
		i__1, "zztime_", (ftnlen)2685)];
	k = ends[(i__1 = i__ - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("ends", 
		i__1, "zztime_", (ftnlen)2686)];
	if (item == 'Y') {
	    ++nyear;
	    ++(*e);
		...
		zzrepsub_(pictur, &pbegs[(i__1 = i__ - 1) < 32 && 0 <= i__1 ? 
			i__1 : s_rnge("pbegs", i__1, "zztime_", (ftnlen)2695)]
			, &pends[(i__2 = i__ - 1) < 32 && 0 <= i__2 ? i__2 : 
			s_rnge("pends", i__2, "zztime_", (ftnlen)2695)], 
			"YR", pictur, (ftnlen)160, (ftnlen)2, (ftnlen)160);
	    } else {
		zzrepsub_(pictur, &pbegs[(i__1 = i__ - 1) < 32 && 0 <= i__1 ? 
			i__1 : s_rnge("pbegs", i__1, "zztime_", (ftnlen)2698)]
			, &pends[(i__2 = i__ - 1) < 32 && 0 <= i__2 ? i__2 : 
			s_rnge("pends", i__2, "zztime_", (ftnlen)2698)], 
		...
		nparsd_(string + (j - 1), &tvec[1], error, &ptr, k - (j - 1), 
			error_len);
		zzrepsub_(pictur, &pbegs[(i__1 = i__ - 1) < 32 && 0 <= i__1 ? 
			i__1 : s_rnge("pbegs", i__1, "zztime_", (ftnlen)2712)]
			, &pends[(i__2 = i__ - 1) < 32 && 0 <= i__2 ? i__2 : 
			s_rnge("pends", i__2, "zztime_", (ftnlen)2712)], 
	    ...
	    zzmkpc_(pictur, &pbegs[(i__1 = i__ - 1) < 32 && 0 <= i__1 ? i__1 :
		     s_rnge("pbegs", i__1, "zztime_", (ftnlen)2725)], &pends[(
		    i__2 = i__ - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("pends",
		     i__2, "zztime_", (ftnlen)2725)], "DD", string + (j - 1), 
	    ...
	    nparsd_(string + (j - 1), &tvec[1], error, &ptr, k - (j - 1), 
		    error_len);
	    zzmkpc_(pictur, &pbegs[(i__1 = i__ - 1) < 32 && 0 <= i__1 ? i__1 :
		     s_rnge("pbegs", i__1, "zztime_", (ftnlen)2735)], &pends[(
		    i__2 = i__ - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("pends",
		     i__2, "zztime_", (ftnlen)2735)], "DOY", string + (j - 1),
...
/*           set up the logical AMPM to indicate its presence. */
		...
		zzmkpc_(pictur, &pbegs[(i__1 = i__ - 1) < 32 && 0 <= i__1 ? 
			i__1 : s_rnge("pbegs", i__1, "zztime_", (ftnlen)2751)]
			, &pends[(i__2 = i__ - 1) < 32 && 0 <= i__2 ? i__2 : 
			s_rnge("pends", i__2, "zztime_", (ftnlen)2751)], 
			"AP", string + (j - 1), (ftnlen)160, (ftnlen)2, k - (
			j - 1));
	    } else {
		zzmkpc_(pictur, &pbegs[(i__1 = i__ - 1) < 32 && 0 <= i__1 ? 
			i__1 : s_rnge("pbegs", i__1, "zztime_", (ftnlen)2756)]
			, &pends[(i__2 = i__ - 1) < 32 && 0 <= i__2 ? i__2 : 
			s_rnge("pends", i__2, "zztime_", (ftnlen)2756)], 
	    ...
	    nparsd_(string + (j - 1), &hms[1], error, &ptr, k - (j - 1), 
		    error_len);
	    zzmkpc_(pictur, &pbegs[(i__1 = i__ - 1) < 32 && 0 <= i__1 ? i__1 :
		     s_rnge("pbegs", i__1, "zztime_", (ftnlen)2768)], &pends[(
		    i__2 = i__ - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("pends",
		     i__2, "zztime_", (ftnlen)2768)], "MN", string + (j - 1), 
		    (ftnlen)160, (ftnlen)2, k - (j - 1));
	} else if (item == 'S') {
	    ++nsec;
	    ++(*e);
	    nparsd_(string + (j - 1), &hms[2], error, &ptr, k - (j - 1), 
		    error_len);
	    zzmkpc_(pictur, &pbegs[(i__1 = i__ - 1) < 32 && 0 <= i__1 ? i__1 :
		     s_rnge("pbegs", i__1, "zztime_", (ftnlen)2778)], &pends[(
		    i__2 = i__ - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("pends",
		     i__2, "zztime_", (ftnlen)2778)], "SC", string + (j - 1), 
		    (ftnlen)160, (ftnlen)2, k - (j - 1));
	} else if (item == 'J') {
	    ++njd;
	    ++(*e);
	    nparsd_(string + (j - 1), tvec, error, &ptr, k - (j - 1), 
		    error_len);
	    zzmkpc_(pictur, &pbegs[(i__1 = i__ - 1) < 32 && 0 <= i__1 ? i__1 :
		     s_rnge("pbegs", i__1, "zztime_", (ftnlen)2788)], &pends[(
		    i__2 = i__ - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("pends",
		     i__2, "zztime_", (ftnlen)2788)], "JULIAND", string + (j 
	    ...
	    *e = 0;
	    ...
	    repmc_(error, "#", names + (((i__1 = item - 32) < 97 && 0 <= i__1 
		    ? i__1 : s_rnge("names", i__1, "zztime_", (ftnlen)2836)) 
...
/*     problems. */
    ...
    *e = 0;
	...
	j = begs[(i__1 = p1 - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("begs", 
		i__1, "zztime_", (ftnlen)2962)];
	k = ends[(i__1 = p1 - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("ends", 
		i__1, "zztime_", (ftnlen)2963)];
	i__1 = k + 1;
	zzinssub_(error, ">", &i__1, error, error_len, (ftnlen)1, error_len);
	zzinssub_(error, "<", &j, error, error_len, (ftnlen)1, error_len);
	repmc_(messge, "#", string + (j - 1), messge, (ftnlen)160, (ftnlen)1, 
...
/* Computing MIN */
	...
	p1 = min(i__1,i__2);
	j = begs[(i__1 = p2 - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("begs", 
		i__1, "zztime_", (ftnlen)2985)];
	k = ends[(i__1 = p2 - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("ends", 
		i__1, "zztime_", (ftnlen)2986)];
	i__1 = k + 1;
	zzinssub_(error, ">", &i__1, error, error_len, (ftnlen)1, error_len);
	zzinssub_(error, "<", &j, error, error_len, (ftnlen)1, error_len);
	j = begs[(i__1 = p1 - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("begs", 
		i__1, "zztime_", (ftnlen)2991)];
	k = ends[(i__1 = p1 - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("ends", 
		i__1, "zztime_", (ftnlen)2992)];
	i__1 = k + 1;
	zzinssub_(error, ">", &i__1, error, error_len, (ftnlen)1, error_len);
	zzinssub_(error, "<", &j, error, error_len, (ftnlen)1, error_len);
	prefix_(messge, &c__1, error, (ftnlen)160, error_len);
...
/*           is in the specified range. */
	    ...
	    j = begs[(i__2 = i__ - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("begs"
		    , i__2, "zztime_", (ftnlen)3367)];
	    k = ends[(i__2 = i__ - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("ends"
		    , i__2, "zztime_", (ftnlen)3368)];
