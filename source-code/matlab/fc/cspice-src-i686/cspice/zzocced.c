	...
	doublereal *centr2, doublereal *semax2)
{
    ...
    doublereal angcmp;
    integer bigidx;
    doublereal minang[2], bigctr[3], maxang[2], maxrad[2], minrad[2], xr[9]	
	    /* was [3][3] */, minvec[3];
    extern /* Subroutine */ int saelgv_(doublereal *, doublereal *, 
	    doublereal *, doublereal *);
    doublereal sclmat[9]	/* was [3][3] */, smlmaj[3], tmpmaj[3], 
	    raydir[3], minsep, smldir[3], maxsep, smlmat[9]	/* was [3][3] 
	    */, smlmin[3], uasize;
    integer frtidx, smlidx;
    extern /* Subroutine */ int setmsg_(char *, ftnlen);
    doublereal smlctr[3], tmpmin[3], sclrot[9]	/* was [3][3] */, trgsep, 
	    invray[3], tmpctr[3];
    ...
    extern /* Subroutine */ int errint_(char *, integer *, ftnlen), vminus_(
	    doublereal *, doublereal *);
...
/*     from the principal axis frames of the targets to the base frame. */
	...
	unorm_(&semax1[(i__1 = i__ * 3 - 3) < 9 && 0 <= i__1 ? i__1 : s_rnge(
		"semax1", i__1, "zzocced_", (ftnlen)542)], &rmat[(i__2 = (i__ 
		+ 3) * 3 - 12) < 18 && 0 <= i__2 ? i__2 : s_rnge("rmat", i__2,
		 "zzocced_", (ftnlen)542)], &r__[(i__3 = i__ - 1) < 6 && 0 <= 
		i__3 ? i__3 : s_rnge("r", i__3, "zzocced_", (ftnlen)542)]);
	unorm_(&semax2[(i__1 = i__ * 3 - 3) < 9 && 0 <= i__1 ? i__1 : s_rnge(
		"semax2", i__1, "zzocced_", (ftnlen)543)], &rmat[(i__2 = (i__ 
		+ 6) * 3 - 12) < 18 && 0 <= i__2 ? i__2 : s_rnge("rmat", i__2,
		 "zzocced_", (ftnlen)543)], &r__[(i__3 = i__ + 2) < 6 && 0 <= 
		i__3 ? i__3 : s_rnge("r", i__3, "zzocced_", (ftnlen)543)]);
    }
...
/* Computing MIN */
	d__1 = r__[(i__2 = i__ * 3 - 3) < 6 && 0 <= i__2 ? i__2 : s_rnge(
		"r", i__2, "zzocced_", (ftnlen)551)], d__2 = r__[(i__3 = i__ *
		 3 - 2) < 6 && 0 <= i__3 ? i__3 : s_rnge("r", i__3, "zzocced_"
		, (ftnlen)551)], d__1 = min(d__1,d__2), d__2 = r__[(i__4 = 
		i__ * 3 - 1) < 6 && 0 <= i__4 ? i__4 : s_rnge("r", i__4, 
		"zzocced_", (ftnlen)551)];
	minrad[(i__1 = i__ - 1) < 2 && 0 <= i__1 ? i__1 : s_rnge("minrad", 
		i__1, "zzocced_", (ftnlen)551)] = min(d__1,d__2);
/* Computing MAX */
	d__1 = r__[(i__2 = i__ * 3 - 3) < 6 && 0 <= i__2 ? i__2 : s_rnge(
		"r", i__2, "zzocced_", (ftnlen)552)], d__2 = r__[(i__3 = i__ *
		 3 - 2) < 6 && 0 <= i__3 ? i__3 : s_rnge("r", i__3, "zzocced_"
		, (ftnlen)552)], d__1 = max(d__1,d__2), d__2 = r__[(i__4 = 
		i__ * 3 - 1) < 6 && 0 <= i__4 ? i__4 : s_rnge("r", i__4, 
		"zzocced_", (ftnlen)552)];
	maxrad[(i__1 = i__ - 1) < 2 && 0 <= i__1 ? i__1 : s_rnge("maxrad", 
		i__1, "zzocced_", (ftnlen)552)] = max(d__1,d__2);
    }
...
/*     the resulting matrices are supposed to be rotations. */
	...
	if (! isrot_(&rmat[(i__1 = (i__ * 3 + 1) * 3 - 12) < 18 && 0 <= i__1 ?
		 i__1 : s_rnge("rmat", i__1, "zzocced_", (ftnlen)606)], &
		c_b50, &c_b51)) {
	    setmsg_("Semi-axis matrix SEMAX# is not a rotation matrix.  The "
		    "determinant of this matrix is #.", (ftnlen)87);
	    errint_("#", &i__, (ftnlen)1);
...
/*     ellipsoids. */
    ...
    for (i__ = 1; i__ <= 2; ++i__) {
/* Computing 2nd power */
	d__1 = tpos[(i__1 = i__ * 3 - 3) < 6 && 0 <= i__1 ? i__1 : s_rnge(
		"tpos", i__1, "zzocced_", (ftnlen)647)] / r__[(i__2 = i__ * 3 
		- 3) < 6 && 0 <= i__2 ? i__2 : s_rnge("r", i__2, "zzocced_", (
		ftnlen)647)];
/* Computing 2nd power */
	d__2 = tpos[(i__3 = i__ * 3 - 2) < 6 && 0 <= i__3 ? i__3 : s_rnge(
		"tpos", i__3, "zzocced_", (ftnlen)647)] / r__[(i__4 = i__ * 3 
		- 2) < 6 && 0 <= i__4 ? i__4 : s_rnge("r", i__4, "zzocced_", (
		ftnlen)647)];
/* Computing 2nd power */
	d__3 = tpos[(i__5 = i__ * 3 - 1) < 6 && 0 <= i__5 ? i__5 : s_rnge(
		"tpos", i__5, "zzocced_", (ftnlen)647)] / r__[(i__6 = i__ * 3 
		- 1) < 6 && 0 <= i__6 ? i__6 : s_rnge("r", i__6, "zzocced_", (
		ftnlen)647)];
...
/*     positive at this point. */
	...
	minang[(i__1 = i__ - 1) < 2 && 0 <= i__1 ? i__1 : s_rnge("minang", 
		i__1, "zzocced_", (ftnlen)672)] = asin(minrad[(i__2 = i__ - 1)
		 < 2 && 0 <= i__2 ? i__2 : s_rnge("minrad", i__2, "zzocced_", 
		(ftnlen)672)] / dist[(i__3 = i__ - 1) < 2 && 0 <= i__3 ? i__3 
		: s_rnge("dist", i__3, "zzocced_", (ftnlen)672)]);
	maxang[(i__1 = i__ - 1) < 2 && 0 <= i__1 ? i__1 : s_rnge("maxang", 
		i__1, "zzocced_", (ftnlen)673)] = asin(maxrad[(i__2 = i__ - 1)
		 < 2 && 0 <= i__2 ? i__2 : s_rnge("maxrad", i__2, "zzocced_", 
		(ftnlen)673)] / dist[(i__3 = i__ - 1) < 2 && 0 <= i__3 ? i__3 
		: s_rnge("dist", i__3, "zzocced_", (ftnlen)673)]);
    }
...
/*           versa.) */
	    ...
	    if (minang[(i__1 = i__ - 1) < 2 && 0 <= i__1 ? i__1 : s_rnge(
		    "minang", i__1, "zzocced_", (ftnlen)790)] >= maxang[(i__2 
		    = 3 - i__ - 1) < 2 && 0 <= i__2 ? i__2 : s_rnge("maxang", 
		    i__2, "zzocced_", (ftnlen)790)] + trgsep) {
...
/*     Let SMLMAT be the rotation matrix that effects this mapping. */
    ...
    xpose_(&rmat[(i__1 = (smlidx * 3 + 1) * 3 - 12) < 18 && 0 <= i__1 ? i__1 :
	     s_rnge("rmat", i__1, "zzocced_", (ftnlen)861)], smlmat);
...
/*     ellipsoid to the viewing point. */
    ...
    vsub_(viewpt, &ctrs[(i__1 = smlidx * 3 - 3) < 6 && 0 <= i__1 ? i__1 : 
	    s_rnge("ctrs", i__1, "zzocced_", (ftnlen)867)], smlvu);
...
/*     Find the limb of the smaller ellipsoid as seen from VIEW. */
    ...
    edlimb_(&r__[(i__1 = smlidx * 3 - 3) < 6 && 0 <= i__1 ? i__1 : s_rnge(
	    "r", i__1, "zzocced_", (ftnlen)874)], &r__[(i__2 = smlidx * 3 - 2)
	     < 6 && 0 <= i__2 ? i__2 : s_rnge("r", i__2, "zzocced_", (ftnlen)
	    874)], &r__[(i__3 = smlidx * 3 - 1) < 6 && 0 <= i__3 ? i__3 : 
	    s_rnge("r", i__3, "zzocced_", (ftnlen)874)], view, limb);
...
/*     this. */
    ...
    vadd_(&ctrs[(i__1 = smlidx * 3 - 3) < 6 && 0 <= i__1 ? i__1 : s_rnge(
	    "ctrs", i__1, "zzocced_", (ftnlen)892)], smlctr, tmpctr);
    vequ_(tmpctr, smlctr);
...
/*     lengths of the large ellipsoid. */
    ...
    sclmat[0] = 1. / r__[(i__1 = bigidx * 3 - 3) < 6 && 0 <= i__1 ? i__1 : 
	    s_rnge("r", i__1, "zzocced_", (ftnlen)905)];
    sclmat[4] = 1. / r__[(i__1 = bigidx * 3 - 2) < 6 && 0 <= i__1 ? i__1 : 
	    s_rnge("r", i__1, "zzocced_", (ftnlen)906)];
    sclmat[8] = 1. / r__[(i__1 = bigidx * 3 - 1) < 6 && 0 <= i__1 ? i__1 : 
	    s_rnge("r", i__1, "zzocced_", (ftnlen)907)];
...
/*     We use one matrix SCLROT to perform these composed operations. */
    ...
    xpose_(&rmat[(i__1 = (bigidx * 3 + 1) * 3 - 12) < 18 && 0 <= i__1 ? i__1 :
	     s_rnge("rmat", i__1, "zzocced_", (ftnlen)917)], xr);
...
/*     Map the center of the large ellipsoid to BIGCTR. */
    ...
    mxv_(sclrot, &ctrs[(i__1 = bigidx * 3 - 3) < 6 && 0 <= i__1 ? i__1 : 
	    s_rnge("ctrs", i__1, "zzocced_", (ftnlen)932)], bigctr);
...
/*     non-zero, for safety, we'll test it anyway. */

    if (bigr == 0.) {
	setmsg_("Distance of transformed viewing point from transformed cent"
		"er of small ellipsoid is zero.", (ftnlen)89);
...
/*        from the viewing point to the center of the small ellipsoid. */
	...
	dist[(i__1 = smlidx - 1) < 2 && 0 <= i__1 ? i__1 : s_rnge("dist", 
		i__1, "zzocced_", (ftnlen)1116)] = vdist_(xview, smlctr);

/*        The checks we've already done should ensure that DIST(SMLIDX) */
/*        is non-zero, but we'll check anyway for safety. */

	if (dist[(i__1 = smlidx - 1) < 2 && 0 <= i__1 ? i__1 : s_rnge("dist", 
		i__1, "zzocced_", (ftnlen)1122)] == 0.) {
	    sigerr_("Distance of transformed center of ellipsoid having inde"
		    "x # from transformed viewing point is zero.", (ftnlen)98);
	    errint_("#", &smlidx, (ftnlen)1);
	    sigerr_("SPICE(DIVIDEBYZERO)", (ftnlen)19);
	    chkout_("ZZOCCED", (ftnlen)7);
	    return ret_val;
	}
...
/*        limb of the small ellipsoid. */

	minang[(i__1 = smlidx - 1) < 2 && 0 <= i__1 ? i__1 : s_rnge("minang", 
		i__1, "zzocced_", (ftnlen)1138)] = asin(vnorm_(smlmin) / dist[
		(i__2 = smlidx - 1) < 2 && 0 <= i__2 ? i__2 : s_rnge("dist", 
		i__2, "zzocced_", (ftnlen)1138)]);
	maxang[(i__1 = smlidx - 1) < 2 && 0 <= i__1 ? i__1 : s_rnge("maxang", 
		i__1, "zzocced_", (ftnlen)1139)] = asin(vnorm_(smlmaj) / dist[
		(i__2 = smlidx - 1) < 2 && 0 <= i__2 ? i__2 : s_rnge("dist", 
		i__2, "zzocced_", (ftnlen)1139)]);
...
/*        ellipsoid in the circumscribing cone of the sphere. */
	...
	if (xasep + maxang[(i__1 = smlidx - 1) < 2 && 0 <= i__1 ? i__1 : 
		s_rnge("maxang", i__1, "zzocced_", (ftnlen)1152)] <= uasize) {
...
/*        small ellipsoid by the circumscribing cone of the sphere. */
	...
	if (xasep + minang[(i__1 = smlidx - 1) < 2 && 0 <= i__1 ? i__1 : 
		s_rnge("minang", i__1, "zzocced_", (ftnlen)1182)] > uasize) {
