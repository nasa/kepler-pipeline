	...
	extrem_len)
{
    ...
    extern /* Subroutine */ int cmprss_(char *, integer *, char *, char *, 
	    ftnlen, ftnlen, ftnlen), inrypl_(doublereal *, doublereal *, 
	    doublereal *, integer *, doublereal *);
    extern logical return_(void);
    doublereal btwprx, extprx;
    char exttyp[3];
    doublereal lpt[3], xpt[3];
...
/*     the point of extreme angular separation. */
...
/*           The ray-plane intersection is on ellipse or inside the */
...
/*                          UPPER  - LOWER                        2 */
    ...
    gr = (3. - sqrt(5.)) / 2.;
    lower = p2 / 20 * (extidx - 1);
    upper = p2 / 20 * (extidx + 1);
