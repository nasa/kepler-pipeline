...
-Detailed_Input
   ...
   lenout     The allowed length of the output string.  This length
              ...
              characters, lenout needs to be x + 1.  32 is a
              reasonable value for lenout (31 characters plus the null
              terminator).
...
-Exceptions
   ...
   5) If the output string has length less than two characters, it
      ...
      routine.  In this event, the the error SPICE(STRINGTOOSHORT) is
      signaled.
