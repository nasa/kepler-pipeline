...
/* Subroutine */ int hyptof_(doublereal *ma, doublereal *ecc, doublereal *f)
{
    ...
    integer count;
    doublereal lower, upper, middle, midval, lastdf, maxlog;
...
/*     defined for nonpositive x). If the mean anomaly is zero, the */
...
/*     Finally pick a reasonalbe upper bound on the number of loop */
