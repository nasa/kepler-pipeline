...
/*     leapseconds (at least we avoid this problem for the moment). */
	...
	if (tvec[(i__1 = sc - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", 
		i__1, "str2et_", (ftnlen)913)] >= 60. && tvec[(i__2 = sc - 1) 
		< 8 && 0 <= i__2 ? i__2 : s_rnge("tvec", i__2, "str2et_", (
		ftnlen)913)] < 61.) {
	    adjust = TRUE_;
	    tvec[(i__1 = sc - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", 
		    i__1, "str2et_", (ftnlen)917)] = tvec[(i__2 = sc - 1) < 8 
...
/*     Reset TVEC(SC) if it was adjusted earlier. */
	...
	tvec[(i__1 = sc - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", i__1, 
		"str2et_", (ftnlen)1001)] = tvec[(i__2 = sc - 1) < 8 && 0 <= 
		i__2 ? i__2 : s_rnge("tvec", i__2, "str2et_", (ftnlen)1001)] 
		+ 1.;
    }
...
/*     If the era is B.C. we need to reset the year. */
	...
	tvec[(i__1 = yr - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", i__1, 
		"str2et_", (ftnlen)1042)] = 1. - tvec[(i__2 = yr - 1) < 8 && 
...
/*     the hours component of the time. */
	...
	if (tvec[(i__1 = hr - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", 
		i__1, "str2et_", (ftnlen)1051)] < 12.) {
	    tvec[(i__1 = hr - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", 
		    i__1, "str2et_", (ftnlen)1052)] = tvec[(i__2 = hr - 1) < 
		    8 && 0 <= i__2 ? i__2 : s_rnge("tvec", i__2, "str2et_", (
		    ftnlen)1052)] + 12.;
	}
    } else if (s_cmp(modify + 48, "A.M.", (ftnlen)16, (ftnlen)4) == 0) {
	if (tvec[(i__1 = hr - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", 
		i__1, "str2et_", (ftnlen)1057)] >= 12.) {
	    tvec[(i__1 = hr - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", 
		    i__1, "str2et_", (ftnlen)1058)] = tvec[(i__2 = hr - 1) < 
		    8 && 0 <= i__2 ? i__2 : s_rnge("tvec", i__2, "str2et_", (
		    ftnlen)1058)] - 12.;
	}
    }
...
/*     string is in fact an abbreviated year. */
    ...
    year = i_dnnt(&tvec[(i__1 = yr - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge(
	    "tvec", i__1, "str2et_", (ftnlen)1069)]);
    if (yabbrv) {
	texpyr_(&year);
	tvec[(i__1 = yr - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", i__1, 
		"str2et_", (ftnlen)1074)] = (doublereal) year;
    } else if (year < 100 && s_cmp(modify, " ", (ftnlen)16, (ftnlen)1) == 0) {
	texpyr_(&year);
	tvec[(i__1 = yr - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", i__1, 
		"str2et_", (ftnlen)1080)] = (doublereal) year;
    }
...
/*        We need to check the components. */
	...
	if (s_cmp(type__, "YD", (ftnlen)16, (ftnlen)2) == 0) {
	    dojul = tvec[(i__1 = yr - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge(
		    "tvec", i__1, "str2et_", (ftnlen)1095)] < 1582. || tvec[(
		    i__2 = yr - 1) < 8 && 0 <= i__2 ? i__2 : s_rnge("tvec", 
		    i__2, "str2et_", (ftnlen)1095)] == 1582. && tvec[(i__3 = 
		    dy - 1) < 8 && 0 <= i__3 ? i__3 : s_rnge("tvec", i__3, 
		    "str2et_", (ftnlen)1095)] < 279.;
	} else {
	    dojul = tvec[(i__1 = yr - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge(
		    "tvec", i__1, "str2et_", (ftnlen)1101)] < 1582. || tvec[(
		    i__2 = yr - 1) < 8 && 0 <= i__2 ? i__2 : s_rnge("tvec", 
		    i__2, "str2et_", (ftnlen)1101)] <= 1582. && tvec[(i__3 = 
		    mm - 1) < 8 && 0 <= i__3 ? i__3 : s_rnge("tvec", i__3, 
		    "str2et_", (ftnlen)1101)] < 10. || tvec[(i__4 = yr - 1) < 
		    8 && 0 <= i__4 ? i__4 : s_rnge("tvec", i__4, "str2et_", (
		    ftnlen)1101)] <= 1582. && tvec[(i__5 = mm - 1) < 8 && 0 <=
		     i__5 ? i__5 : s_rnge("tvec", i__5, "str2et_", (ftnlen)
		    1101)] <= 10. && tvec[(i__6 = dy - 1) < 8 && 0 <= i__6 ? 
		    i__6 : s_rnge("tvec", i__6, "str2et_", (ftnlen)1101)] < 
		    6.;
	}
    } else if (s_cmp(calndr, juln, (ftnlen)16, (ftnlen)16) == 0) {
	dojul = TRUE_;
...
/*     diagnostic message. */
	...
	if (s_cmp(type__, "YD", (ftnlen)16, (ftnlen)2) == 0) {
	    year = (integer) d_int(&tvec[(i__1 = yr - 1) < 8 && 0 <= i__1 ? 
		    i__1 : s_rnge("tvec", i__1, "str2et_", (ftnlen)1129)]);
	    month = 1;
	    day = (integer) d_int(&tvec[(i__1 = dy - 1) < 8 && 0 <= i__1 ? 
		    i__1 : s_rnge("tvec", i__1, "str2et_", (ftnlen)1131)]);
	    frac = tvec[(i__1 = dy - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge(
		    "tvec", i__1, "str2et_", (ftnlen)1132)] - (doublereal) 
		    day;
	    orgnyr = year;
	    jul2gr_(&year, &month, &day, &doy);
	    tvec[(i__1 = yr - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", 
		    i__1, "str2et_", (ftnlen)1137)] = (doublereal) year;
	    tvec[(i__1 = dy - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", 
		    i__1, "str2et_", (ftnlen)1138)] = (doublereal) doy + frac;
	} else {
	    year = (integer) d_int(&tvec[(i__1 = yr - 1) < 8 && 0 <= i__1 ? 
		    i__1 : s_rnge("tvec", i__1, "str2et_", (ftnlen)1142)]);
	    month = (integer) d_int(&tvec[(i__1 = mm - 1) < 8 && 0 <= i__1 ? 
		    i__1 : s_rnge("tvec", i__1, "str2et_", (ftnlen)1143)]);
	    day = (integer) d_int(&tvec[(i__1 = dy - 1) < 8 && 0 <= i__1 ? 
		    i__1 : s_rnge("tvec", i__1, "str2et_", (ftnlen)1144)]);
	    frac = tvec[(i__1 = dy - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge(
		    "tvec", i__1, "str2et_", (ftnlen)1145)] - (doublereal) 
		    day;
	    orgnyr = year;
	    jul2gr_(&year, &month, &day, &doy);
	    tvec[(i__1 = yr - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", 
		    i__1, "str2et_", (ftnlen)1150)] = (doublereal) year;
	    tvec[(i__1 = mm - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", 
		    i__1, "str2et_", (ftnlen)1151)] = (doublereal) month;
	    tvec[(i__1 = dy - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", 
		    i__1, "str2et_", (ftnlen)1152)] = (doublereal) day + frac;
	}
    } else {
	orgnyr = (integer) d_int(&tvec[(i__1 = yr - 1) < 8 && 0 <= i__1 ? 
		i__1 : s_rnge("tvec", i__1, "str2et_", (ftnlen)1158)]);
    }
...
/*        associated with the time zone. */
	...
	tvec[(i__1 = hr - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", i__1, 
		"str2et_", (ftnlen)1194)] = tvec[(i__2 = hr - 1) < 8 && 0 <= 
		i__2 ? i__2 : s_rnge("tvec", i__2, "str2et_", (ftnlen)1194)] 
		- hoff;
	tvec[(i__1 = mn - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", i__1, 
		"str2et_", (ftnlen)1195)] = tvec[(i__2 = mn - 1) < 8 && 0 <= 
		i__2 ? i__2 : s_rnge("tvec", i__2, "str2et_", (ftnlen)1195)] 
		- moff;
	secs = tvec[(i__1 = sc - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", 
		i__1, "str2et_", (ftnlen)1196)];
	tvec[(i__1 = sc - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", i__1, 
		"str2et_", (ftnlen)1197)] = 0.;
	ttrans_(forml, forml, tvec, (ftnlen)16, (ftnlen)16);
	tvec[(i__1 = sc - 1) < 8 && 0 <= i__1 ? i__1 : s_rnge("tvec", i__1, 
		"str2et_", (ftnlen)1201)] = secs;
    }
...
/*           Normalize the time vector. */
		...
		repmc_(error, "#", mname + (((i__2 = month - 1) < 12 && 0 <= 
			...
			ftnlen)1379)) << 4), error, (ftnlen)400, (ftnlen)1, (
			ftnlen)16, (ftnlen)400);
