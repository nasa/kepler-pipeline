	...
	ticks, doublereal *sclkdp, doublereal *et, ftnlen clkstr_len)
{
    ...
    extern /* Subroutine */ int nparsd_(char *, doublereal *, char *, integer 
	    ...
	    *, ftnlen, ftnlen), prefix_(char *, integer *, char *, ftnlen, 
	    ftnlen);
    static doublereal prstrt[50];
    static integer pad, end;
    static char cmp[25*10];
...
/*        rest of the names, we'll have to add the suffix. */
	...
	for (i__ = 2; i__ <= 9; ++i__) {
	    suffix_("_#", &c__0, kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ?
		     i__1 : s_rnge("kvname", i__1, "sc01_", (ftnlen)835)) * 
		    60, (ftnlen)2, (ftnlen)60);
	    i__3 = -(*sc);
	    repmi_(kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ? i__1 : 
		    s_rnge("kvname", i__1, "sc01_", (ftnlen)836)) * 60, "#", &
		    i__3, kvname + ((i__2 = i__ - 1) < 9 && 0 <= i__2 ? i__2 :
		     s_rnge("kvname", i__2, "sc01_", (ftnlen)836)) * 60, (
...
/*           -  The partition end times */
	...
	scli01_(namlst + 240, sc, &c__10, &n, &nfield, (ftnlen)60);
	scli01_(namlst + 420, sc, &c__5, &n, &delcde, (ftnlen)60);
	scli01_(namlst + 480, sc, &c__1, &ntsys, &timsys, (ftnlen)60);
	scld01_(namlst + 60, sc, &c__30000, &ncoeff, coeffs, (ftnlen)60);
	scld01_(namlst + 120, sc, &c__50, &n, prstrt, (ftnlen)60);
	scld01_(namlst + 180, sc, &c__50, &npart, prend, (ftnlen)60);
...
/*     Determine how many ticks is each field is worth. */
    ...
    cmptks[(i__1 = nfield - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge("cmptks", 
	    i__1, "sc01_", (ftnlen)923)] = 1.;
    for (i__ = nfield - 1; i__ >= 1; --i__) {
	cmptks[(i__1 = i__ - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge("cmptks", 
		i__1, "sc01_", (ftnlen)926)] = cmptks[(i__2 = i__) < 10 && 0 
		<= i__2 ? i__2 : s_rnge("cmptks", i__2, "sc01_", (ftnlen)926)]
		 * moduli[(i__3 = i__) < 10 && 0 <= i__3 ? i__3 : s_rnge(
		"moduli", i__3, "sc01_", (ftnlen)926)];
    }
...
/*     to be equal to the offset value. */
	...
	if (s_cmp(cmp + ((i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge(
		"cmp", i__2, "sc01_", (ftnlen)959)) * 25, " ", (ftnlen)25, (
		ftnlen)1) == 0) {
	    cmpval[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge("cmpval"
		    , i__2, "sc01_", (ftnlen)960)] = offset[(i__3 = i__ - 1) <
		     10 && 0 <= i__3 ? i__3 : s_rnge("offset", i__3, "sc01_", 
		    (ftnlen)960)];
	} else {
	    nparsd_(cmp + ((i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge(
		    "cmp", i__2, "sc01_", (ftnlen)962)) * 25, &cmpval[(i__3 = 
		    i__ - 1) < 10 && 0 <= i__3 ? i__3 : s_rnge("cmpval", i__3,
		     "sc01_", (ftnlen)962)], error, &pntr, (ftnlen)25, (
		    ftnlen)240);
	}
	if (s_cmp(error, " ", (ftnlen)240, (ftnlen)1) != 0) {
	    ...
	    errch_("#", cmp + ((i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : 
		    s_rnge("cmp", i__2, "sc01_", (ftnlen)970)) * 25, (ftnlen)
		    1, (ftnlen)25);
...
/*         have been invalid. */
	...
	cmpval[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge("cmpval", 
		i__2, "sc01_", (ftnlen)984)] = cmpval[(i__3 = i__ - 1) < 10 &&
		 0 <= i__3 ? i__3 : s_rnge("cmpval", i__3, "sc01_", (ftnlen)
		984)] - offset[(i__4 = i__ - 1) < 10 && 0 <= i__4 ? i__4 : 
		s_rnge("offset", i__4, "sc01_", (ftnlen)984)];
	if (d_nint(&cmpval[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge(
		"cmpval", i__2, "sc01_", (ftnlen)987)]) < 0.) {
...
/*     add up the results. */
	...
	*ticks += cmpval[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge(
		"cmpval", i__2, "sc01_", (ftnlen)1008)] * cmptks[(i__3 = i__ 
...
/*        rest of the names, we'll have to add the suffix. */
	...
	for (i__ = 2; i__ <= 9; ++i__) {
	    suffix_("_#", &c__0, kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ?
		     i__1 : s_rnge("kvname", i__1, "sc01_", (ftnlen)1331)) * 
		    60, (ftnlen)2, (ftnlen)60);
	    i__3 = -(*sc);
	    repmi_(kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ? i__1 : 
		    s_rnge("kvname", i__1, "sc01_", (ftnlen)1332)) * 60, 
		    "#", &i__3, kvname + ((i__2 = i__ - 1) < 9 && 0 <= i__2 ? 
		    i__2 : s_rnge("kvname", i__2, "sc01_", (ftnlen)1332)) * 
...
/*     Determine how many ticks each field is worth. */
    ...
    cmptks[(i__1 = nfield - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge("cmptks", 
	    i__1, "sc01_", (ftnlen)1406)] = 1.;
    for (i__ = nfield - 1; i__ >= 1; --i__) {
	cmptks[(i__1 = i__ - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge("cmptks", 
		i__1, "sc01_", (ftnlen)1409)] = cmptks[(i__2 = i__) < 10 && 0 
		<= i__2 ? i__2 : s_rnge("cmptks", i__2, "sc01_", (ftnlen)1409)
		] * moduli[(i__3 = i__) < 10 && 0 <= i__3 ? i__3 : s_rnge(
		"moduli", i__3, "sc01_", (ftnlen)1409)];
    }
...
/*     Determine the width of each field. */
	...
	maxwid = moduli[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge(
		"moduli", i__2, "sc01_", (ftnlen)1417)] + offset[(i__3 = i__ 
		- 1) < 10 && 0 <= i__3 ? i__3 : s_rnge("offset", i__3, "sc01_"
		, (ftnlen)1417)] - 1.;
	d__1 = maxwid + .5;
	cmpwid[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge("cmpwid", 
		i__2, "sc01_", (ftnlen)1419)] = (integer) d_lg10(&d__1) + 1;
    }
...
/*     is worth. */
	...
	d__1 = rem / cmptks[(i__3 = i__ - 1) < 10 && 0 <= i__3 ? i__3 : 
		s_rnge("cmptks", i__3, "sc01_", (ftnlen)1466)];
	cmpval[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge("cmpval", 
		i__2, "sc01_", (ftnlen)1466)] = d_int(&d__1) + offset[(i__4 = 
		i__ - 1) < 10 && 0 <= i__4 ? i__4 : s_rnge("offset", i__4, 
		"sc01_", (ftnlen)1466)];
	rem = d_mod(&rem, &cmptks[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : 
		s_rnge("cmptks", i__2, "sc01_", (ftnlen)1467)]);
    }
    cmpval[(i__1 = nfield - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge("cmpval", 
	    i__1, "sc01_", (ftnlen)1471)] = rem + offset[(i__2 = nfield - 1) <
...
/*     numbers to character strings. */
	...
	dpstrf_(&cmpval[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge(
		"cmpval", i__2, "sc01_", (ftnlen)1479)], &c__25, "F", dpchar, 
		(ftnlen)1, (ftnlen)25);
	end = i_indx(dpchar, ".", (ftnlen)25, (ftnlen)1) - 1;
	length[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge("length", 
		i__2, "sc01_", (ftnlen)1482)] = end - 1;
	s_copy(cmp + ((i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge(
		"cmp", i__2, "sc01_", (ftnlen)1483)) * 25, dpchar + 1, (
		ftnlen)25, end - 1);
    }
...
/*     Pad on the left with zeros if necessary. */
	...
	pad = cmpwid[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge("cmp"
		"wid", i__2, "sc01_", (ftnlen)1492)] - length[(i__3 = i__ - 1) 
	...
	if (pad > 0) {
		...
		prefix_("0", &c__0, cmp + ((i__3 = i__ - 1) < 10 && 0 <= i__3 
			? i__3 : s_rnge("cmp", i__3, "sc01_", (ftnlen)1497)) *
...
/*     each field. */
    ...
    s_copy(clkstr, cmp, clkstr_len, (ftnlen)25);
    i__1 = nfield;
    for (i__ = 2; i__ <= i__1; ++i__) {
	prefix_(del + ((i__2 = delcde - 1) < 5 && 0 <= i__2 ? i__2 : s_rnge(
		"del", i__2, "sc01_", (ftnlen)1512)), &c__0, cmp + ((i__3 = 
		i__ - 1) < 10 && 0 <= i__3 ? i__3 : s_rnge("cmp", i__3, "sc0"
		"1_", (ftnlen)1512)) * 25, (ftnlen)1, (ftnlen)25);
	suffix_(cmp + ((i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge(
		"cmp", i__2, "sc01_", (ftnlen)1513)) * 25, &c__0, clkstr, (
		ftnlen)25, clkstr_len);
    }
    chkout_("SCFM01", (ftnlen)6);
    return 0;
...
/*        rest of the names, we'll have to add the suffix. */
	...
	for (i__ = 2; i__ <= 9; ++i__) {
	    suffix_("_#", &c__0, kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ?
		     i__1 : s_rnge("kvname", i__1, "sc01_", (ftnlen)1828)) * 
		    60, (ftnlen)2, (ftnlen)60);
	    i__3 = -(*sc);
	    repmi_(kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ? i__1 : 
		    s_rnge("kvname", i__1, "sc01_", (ftnlen)1829)) * 60, 
		    "#", &i__3, kvname + ((i__2 = i__ - 1) < 9 && 0 <= i__2 ? 
		    i__2 : s_rnge("kvname", i__2, "sc01_", (ftnlen)1829)) * 
		    60, (ftnlen)60, (ftnlen)1, (ftnlen)60);
	}
...
/*     start. */
    ...
    i__1 = npart;
    for (i__ = 1; i__ <= i__1; ++i__) {
	d__1 = prend[(i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : s_rnge("pre"
		"nd", i__2, "sc01_", (ftnlen)1908)] - prstrt[(i__3 = i__ - 1) <
		 50 && 0 <= i__3 ? i__3 : s_rnge("prstrt", i__3, "sc01_", (
		ftnlen)1908)] + mxtick;
	mxtick = d_nint(&d__1);
    }
...
/*           last SCLK value in the array is the one we want. */
    ...
    if (*sclkdp < coeffs[(i__1 = ncoeff / 3 * 3 - 3) < 30000 && 0 <= i__1 ? 
	    i__1 : s_rnge("coeffs", i__1, "sc01_", (ftnlen)1952)]) {
	lower = 1;
	upper = ncoeff / 3;
...
/*        already made sure that the invariant expression above is true. */
	...
	while(lower < upper - 1) {
	    ...
	    if (*sclkdp < coeffs[(i__1 = middle * 3 - 3) < 30000 && 0 <= i__1 
		    ? i__1 : s_rnge("coeffs", i__1, "sc01_", (ftnlen)1974)]) {
		upper = middle;
	    } else {
		lower = middle;
	    }
...
/*        rest of the names, we'll have to add the suffix. */
	...
	for (i__ = 2; i__ <= 9; ++i__) {
	    suffix_("_#", &c__0, kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ?
		     i__1 : s_rnge("kvname", i__1, "sc01_", (ftnlen)2362)) * 
		    60, (ftnlen)2, (ftnlen)60);
	    i__3 = -(*sc);
	    repmi_(kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ? i__1 : 
		    s_rnge("kvname", i__1, "sc01_", (ftnlen)2363)) * 60, 
		    "#", &i__3, kvname + ((i__2 = i__ - 1) < 9 && 0 <= i__2 ? 
		    i__2 : s_rnge("kvname", i__2, "sc01_", (ftnlen)2363)) * 
		    60, (ftnlen)60, (ftnlen)1, (ftnlen)60);
	}
...
/*        The coefficient set to use for extrapolation is the first. */
	...
	lower = 1;
	    ...
	    i__1 ? i__1 : s_rnge("coeffs", i__1, "sc01_", (ftnlen)2496)]) {
...
/*        already made sure that the invariant expression above is true. */
	...
	while(lower < upper - 1) {
	    ...
	    if (partim < coeffs[(i__1 = middle * 3 - 2) < 30000 && 0 <= i__1 ?
		     i__1 : s_rnge("coeffs", i__1, "sc01_", (ftnlen)2518)]) {
		upper = middle;
	    } else {
		lower = middle;
	    }
...
/*     correspond to the the time value */
...
/*     ensure this. */
    ...
    timdif = partim - coeffs[(i__1 = lower * 3 - 2) < 30000 && 0 <= i__1 ? 
	    i__1 : s_rnge("coeffs", i__1, "sc01_", (ftnlen)2567)];
    const__ = coeffs[(i__1 = lower * 3 - 3) < 30000 && 0 <= i__1 ? i__1 : 
	    s_rnge("coeffs", i__1, "sc01_", (ftnlen)2568)];
    if (coeffs[(i__1 = lower * 3 - 1) < 30000 && 0 <= i__1 ? i__1 : s_rnge(
	    "coeffs", i__1, "sc01_", (ftnlen)2570)] <= 0.) {
    ...
    for (i__ = nfield; i__ >= 2; --i__) {
	tikmsc *= moduli[(i__1 = i__ - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge(
		"moduli", i__1, "sc01_", (ftnlen)2583)];
    }
    rate = 1. / (coeffs[(i__1 = lower * 3 - 1) < 30000 && 0 <= i__1 ? i__1 : 
	    s_rnge("coeffs", i__1, "sc01_", (ftnlen)2586)] / tikmsc);
...
/*     ticks since spacecraft clock start. */
    ...
    for (i__ = 2; i__ <= i__1; ++i__) {
	d__1 = prend[(i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : s_rnge("pre"
		"nd", i__2, "sc01_", (ftnlen)2600)] - prstrt[(i__3 = i__ - 1) <
		 50 && 0 <= i__3 ? i__3 : s_rnge("prstrt", i__3, "sc01_", (
		ftnlen)2600)] + mxtick;
	mxtick = d_nint(&d__1);
    }
...
/*        rest of the names, we'll have to add the suffix. */
	...
	for (i__ = 2; i__ <= 9; ++i__) {
	    suffix_("_#", &c__0, kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ?
		     i__1 : s_rnge("kvname", i__1, "sc01_", (ftnlen)2883)) * 
		    60, (ftnlen)2, (ftnlen)60);
	    i__3 = -(*sc);
	    repmi_(kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ? i__1 : 
		    s_rnge("kvname", i__1, "sc01_", (ftnlen)2884)) * 60, 
		    "#", &i__3, kvname + ((i__2 = i__ - 1) < 9 && 0 <= i__2 ? 
		    i__2 : s_rnge("kvname", i__2, "sc01_", (ftnlen)2884)) * 
		    60, (ftnlen)60, (ftnlen)1, (ftnlen)60);
	}
...
/*        PARTIM precedes the coverage of the kernel. */
	...
	return 0;
	    ...
	    i__1 ? i__1 : s_rnge("coeffs", i__1, "sc01_", (ftnlen)3016)]) {
...
/*        already made sure that the invariant expression above is true. */
	...
	while(lower < upper - 1) {
	    middle = (lower + upper) / 2;
	    if (partim < coeffs[(i__1 = middle * 3 - 2) < 30000 && 0 <= i__1 ?
		     i__1 : s_rnge("coeffs", i__1, "sc01_", (ftnlen)3038)]) {
		upper = middle;
	    } else {
		lower = middle;
	    }
...
/*     most significant count') to change the rate to seconds per tick. */
    ...
    timdif = partim - coeffs[(i__1 = lower * 3 - 2) < 30000 && 0 <= i__1 ? 
	    i__1 : s_rnge("coeffs", i__1, "sc01_", (ftnlen)3083)];
    const__ = coeffs[(i__1 = lower * 3 - 3) < 30000 && 0 <= i__1 ? i__1 : 
	    s_rnge("coeffs", i__1, "sc01_", (ftnlen)3084)];
    if (coeffs[(i__1 = lower * 3 - 1) < 30000 && 0 <= i__1 ? i__1 : s_rnge(
	    "coeffs", i__1, "sc01_", (ftnlen)3086)] <= 0.) {
	setmsg_("Invalid SCLK rate.", (ftnlen)18);
	sigerr_("SPICE(VALUEOUTOFRANGE)", (ftnlen)22);
	chkout_("SCEC01", (ftnlen)6);
	return 0;
    ...
    for (i__ = nfield; i__ >= 2; --i__) {
	tikmsc *= moduli[(i__1 = i__ - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge(
		"moduli", i__1, "sc01_", (ftnlen)3099)];
    }
    rate = 1. / (coeffs[(i__1 = lower * 3 - 1) < 30000 && 0 <= i__1 ? i__1 : 
	    s_rnge("coeffs", i__1, "sc01_", (ftnlen)3102)] / tikmsc);
...
/*     ticks since spacecraft clock start. */
    ...
    for (i__ = 2; i__ <= i__1; ++i__) {
	d__1 = prend[(i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : s_rnge("pre"
		"nd", i__2, "sc01_", (ftnlen)3116)] - prstrt[(i__3 = i__ - 1) <
		 50 && 0 <= i__3 ? i__3 : s_rnge("prstrt", i__3, "sc01_", (
		ftnlen)3116)] + mxtick;
	mxtick = d_nint(&d__1);
    }
