...
-Detailed_Output
   ...
   output     is the input string converted to the described format
...
-Exceptions
   ...
   loading a leapseconds kernel via the routine ldpool_c before calling
   this routine.  If a leapsecond kernel has not been loaded, an error
   will be signaled by routines called by timout_c.

-Files

   A leapseconds kernel must be "loaded" via the routine ldpool_c
...
-Particulars
   ...
   Rounding vs. Truncation
      ...
      Rounding 1992 Dec 31, 13:12:00 to the the nearest day
