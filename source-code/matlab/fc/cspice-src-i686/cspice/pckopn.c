...
/*     ***************************************************************** */
/*     The code currently commented out below is to support the the DAF */
/*     comment area software. This software has not been incorporated */
/*     into spicelib, but it should be there soon. When the DAF comment */
/*     area software becomes a part of spicelib, the comment markers in */
/*     the first column of the IF statement should be removed. */
/*     ***************************************************************** */
