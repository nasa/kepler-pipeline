...
/*        unit is present. */
	...
	while(! found && findex > 0) {
	    if (ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge(
		    "ftlun", i__1, "dasfm_", (ftnlen)1344)] == number) {
		found = TRUE_;
	    } else {
	...
	if (found) {
	    if (ftacc[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge(
		    "ftacc", i__1, "dasfm_", (ftnlen)1354)] == 2) {
...
/*              of links to this file. */
		...
		ftlnk[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge(
			"ftlnk", i__1, "dasfm_", (ftnlen)1367)] = ftlnk[(i__2 
			= findex - 1) < 21 && 0 <= i__2 ? i__2 : s_rnge("ftl"
			"nk", i__2, "dasfm_", (ftnlen)1367)] + 1;
		*handle = fthan[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 :
			 s_rnge("fthan", i__1, "dasfm_", (ftnlen)1368)];
	    }
	} else {
...
/*           Compare binary format to local format.  These must match. */
		...
		errch_("#", bfflst + (((i__1 = bff - 1) < 4 && 0 <= i__1 ? 
			i__1 : s_rnge("bfflst", i__1, "dasfm_", (ftnlen)1488))
			 << 3), (ftnlen)1, (ftnlen)8);
...
/*           restoring a DAS file whose creation was interrupted. */
	    ...
	    ftsum[(i__1 = fthead * 14 - 14) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)1571)] = locrrc;
	    ftsum[(i__1 = fthead * 14 - 13) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)1572)] = locrch;
	    ftsum[(i__1 = fthead * 14 - 12) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)1573)] = loccrc;
	    ftsum[(i__1 = fthead * 14 - 11) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)1574)] = loccch;
...
/*              record of the current type. */
		...
		ldrec[(i__1 = type__ - 1) < 3 && 0 <= i__1 ? i__1 : s_rnge(
			"ldrec", i__1, "dasfm_", (ftnlen)1590)] = 0;
...
/*                 cluster. */
		    ...
		    prvtyp = prev[(i__1 = dsctyp - 1) < 3 && 0 <= i__1 ? i__1 
			    : s_rnge("prev", i__1, "dasfm_", (ftnlen)1656)];
		    endrec = nrec;
		    pos = 9;
		    while(last < maxadr) {
			++pos;
...
/*                 of the last data record of TYPE. */
		    ...
		    ldrec[(i__1 = type__ - 1) < 3 && 0 <= i__1 ? i__1 : 
			    s_rnge("ldrec", i__1, "dasfm_", (ftnlen)1684)] = 
			    endrec;
		} else {
...
/*                 There's no data of TYPE in the file. */
		    ...
		    ftsum[(i__1 = type__ + 11 + fthead * 14 - 15) < 294 && 0 
			    ...
			    ftnlen)1691)] = 0;
		    ldrec[(i__1 = type__ - 1) < 3 && 0 <= i__1 ? i__1 : 
			    s_rnge("ldrec", i__1, "dasfm_", (ftnlen)1692)] = 
			    0;
		}
	    }
...
/*           Compare binary format to local format.  These must match. */
		...
		errch_("#", fname, (ftnlen)1, fname_len);
		errch_("#", bfflst + (((i__1 = bff - 1) < 4 && 0 <= i__1 ? 
			i__1 : s_rnge("bfflst", i__1, "dasfm_", (ftnlen)2131))
			 << 3), (ftnlen)1, (ftnlen)8);
		sigerr_("SPICE(NONNATIVEFILE)", (ftnlen)20);
		chkout_("DASOPW", (ftnlen)6);
		return 0;
...
/*           Set the output argument HANDLE as well. */
	    ...
	    ++nxthan;
	    fthan[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		    "an", i__1, "dasfm_", (ftnlen)2202)] = nxthan;
	    ftlun[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("ftl"
		    "un", i__1, "dasfm_", (ftnlen)2203)] = number;
	    ftacc[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fta"
		    "cc", i__1, "dasfm_", (ftnlen)2204)] = 2;
	    ftlnk[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("ftl"
		    "nk", i__1, "dasfm_", (ftnlen)2205)] = 1;
...
/*           restoring a DAS file whose creation was interrupted. */
	    ...
	    cleari_(&c__14, &ftsum[(i__1 = fthead * 14 - 14) < 294 && 0 <= 
		    ...
		    2217)]);
	    ftsum[(i__1 = fthead * 14 - 14) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)2219)] = locrrc;
	    ftsum[(i__1 = fthead * 14 - 13) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)2220)] = locrch;
	    ftsum[(i__1 = fthead * 14 - 12) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)2221)] = loccrc;
	    ftsum[(i__1 = fthead * 14 - 11) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)2222)] = loccch;
...
/*              record of the current type. */
		...
		ldrec[(i__1 = type__ - 1) < 3 && 0 <= i__1 ? i__1 : s_rnge(
			"ldrec", i__1, "dasfm_", (ftnlen)2238)] = 0;
...
/*                 cluster. */
		    ...
		    dsctyp = dirrec[8];
		    prvtyp = prev[(i__1 = dsctyp - 1) < 3 && 0 <= i__1 ? i__1 
			    : s_rnge("prev", i__1, "dasfm_", (ftnlen)2305)];
		    endrec = nrec;
		    pos = 9;
		    while(last < maxadr) {
			++pos;
...
/*                 of the last data record of TYPE. */
		    ...
		    ftsum[(i__1 = type__ + 11 + fthead * 14 - 15) < 294 && 0 
			    ...
			    ftnlen)2332)] = pos;
		    ldrec[(i__1 = type__ - 1) < 3 && 0 <= i__1 ? i__1 : 
			    s_rnge("ldrec", i__1, "dasfm_", (ftnlen)2333)] = 
			    endrec;
		} else {
...
/*                 There's no data of TYPE in the file. */
		    ...
		    ftsum[(i__1 = type__ + 11 + fthead * 14 - 15) < 294 && 0 
			    ...
			    ftnlen)2339)] = 0;
		    ldrec[(i__1 = type__ - 1) < 3 && 0 <= i__1 ? i__1 : 
			    s_rnge("ldrec", i__1, "dasfm_", (ftnlen)2340)] = 
			    0;
		}
	    }
...
/*           Now NREC is the last directory record. */
	    ...
	    ftsum[(i__1 = fthead * 14 - 10) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)2375)] = max(
		    ldrmax,nrec) + 1;

/*           Insert the new handle into our handle set. */

	    *handle = fthan[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : 
		    s_rnge("fthan", i__1, "dasfm_", (ftnlen)2380)];
	    insrti_(handle, fhlist);
	}
    }
    chkout_("DASOPW", (ftnlen)6);
...
/*           Set the output argument HANDLE as well. */
	    ...
	    cleari_(&c__14, &ftsum[(i__1 = fthead * 14 - 14) < 294 && 0 <= 
		    ...
		    2858)]);
	    fthan[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		    "an", i__1, "dasfm_", (ftnlen)2860)] = nxthan;
	    ftlun[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("ftl"
		    "un", i__1, "dasfm_", (ftnlen)2861)] = number;
	    ftacc[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fta"
		    "cc", i__1, "dasfm_", (ftnlen)2862)] = 2;
	    ftlnk[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("ftl"
		    "nk", i__1, "dasfm_", (ftnlen)2863)] = 1;
	    ftsum[(i__1 = fthead * 14 - 10) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)2864)] = *ncomr + 
		    3;
	    ftsum[(i__1 = fthead * 14 - 12) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)2865)] = *ncomr;
	    *handle = fthan[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : 
		    s_rnge("fthan", i__1, "dasfm_", (ftnlen)2867)];
...
/*           Set the output argument HANDLE as well. */
	    ...
	    cleari_(&c__14, &ftsum[(i__1 = fthead * 14 - 14) < 294 && 0 <= 
		    ...
		    3256)]);
	    fthan[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		    "an", i__1, "dasfm_", (ftnlen)3258)] = nxthan;
	    ftlun[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("ftl"
		    "un", i__1, "dasfm_", (ftnlen)3259)] = number;
	    ftacc[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fta"
		    "cc", i__1, "dasfm_", (ftnlen)3260)] = 2;
	    ftlnk[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("ftl"
		    "nk", i__1, "dasfm_", (ftnlen)3261)] = 1;
	    ftsum[(i__1 = fthead * 14 - 10) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)3262)] = 3;
	    *handle = fthan[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : 
		    s_rnge("fthan", i__1, "dasfm_", (ftnlen)3264)];
...
/*              Set the output argument HANDLE as well. */
		...
		fthan[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge(
			"fthan", i__1, "dasfm_", (ftnlen)3624)] = nxthan;
		ftlun[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge(
			"ftlun", i__1, "dasfm_", (ftnlen)3625)] = number;
		ftacc[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge(
			"ftacc", i__1, "dasfm_", (ftnlen)3626)] = 2;
		ftlnk[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge(
			"ftlnk", i__1, "dasfm_", (ftnlen)3627)] = 1;
		ftsum[(i__1 = fthead * 14 - 10) < 294 && 0 <= i__1 ? i__1 : 
			s_rnge("ftsum", i__1, "dasfm_", (ftnlen)3628)] = 3;
		*handle = fthan[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 :
			 s_rnge("fthan", i__1, "dasfm_", (ftnlen)3630)];
...
/*     table; see whether this handle is present. */
	...
	if (fthan[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		"an", i__1, "dasfm_", (ftnlen)3888)] == *handle) {
	    found = TRUE_;
	} else {
	    findex = lnknxt_(&findex, pool);
	}
...
/*           Delete the handle from our handle set. */
	    ...
	    cl__1.cunit = ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 :
		     s_rnge("ftlun", i__1, "dasfm_", (ftnlen)3913)];
	    cl__1.csta = 0;
	    f_clos(&cl__1);
	    if (findex == fthead) {
...
/*     Initialize the file table pool and handle list, if necessary. */
    ...
    while(! found && findex > 0) {
	if (fthan[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		"an", i__1, "dasfm_", (ftnlen)4231)] == *handle) {
	    found = TRUE_;
	} else {
	    findex = lnknxt_(&findex, pool);
	}
...
/*        Give the caller the current summary from the file table. */
	...
	*nresvr = ftsum[(i__1 = findex * 14 - 14) < 294 && 0 <= i__1 ? i__1 : 
		s_rnge("ftsum", i__1, "dasfm_", (ftnlen)4244)];
	*nresvc = ftsum[(i__1 = findex * 14 - 13) < 294 && 0 <= i__1 ? i__1 : 
		s_rnge("ftsum", i__1, "dasfm_", (ftnlen)4245)];
	*ncomr = ftsum[(i__1 = findex * 14 - 12) < 294 && 0 <= i__1 ? i__1 : 
		s_rnge("ftsum", i__1, "dasfm_", (ftnlen)4246)];
	*ncomc = ftsum[(i__1 = findex * 14 - 11) < 294 && 0 <= i__1 ? i__1 : 
		s_rnge("ftsum", i__1, "dasfm_", (ftnlen)4247)];
	*free = ftsum[(i__1 = findex * 14 - 10) < 294 && 0 <= i__1 ? i__1 : 
		s_rnge("ftsum", i__1, "dasfm_", (ftnlen)4248)];
	for (i__ = 1; i__ <= 3; ++i__) {
	    lastla[(i__1 = i__ - 1) < 3 && 0 <= i__1 ? i__1 : s_rnge("lastla",
		     i__1, "dasfm_", (ftnlen)4251)] = ftsum[(i__2 = i__ + 5 + 
		    findex * 14 - 15) < 294 && 0 <= i__2 ? i__2 : s_rnge(
		    "ftsum", i__2, "dasfm_", (ftnlen)4251)];
	    lastrc[(i__1 = i__ - 1) < 3 && 0 <= i__1 ? i__1 : s_rnge("lastrc",
		     i__1, "dasfm_", (ftnlen)4252)] = ftsum[(i__2 = i__ + 8 + 
		    findex * 14 - 15) < 294 && 0 <= i__2 ? i__2 : s_rnge(
		    "ftsum", i__2, "dasfm_", (ftnlen)4252)];
	    lastwd[(i__1 = i__ - 1) < 3 && 0 <= i__1 ? i__1 : s_rnge("lastwd",
		     i__1, "dasfm_", (ftnlen)4253)] = ftsum[(i__2 = i__ + 11 
		    + findex * 14 - 15) < 294 && 0 <= i__2 ? i__2 : s_rnge(
		    "ftsum", i__2, "dasfm_", (ftnlen)4253)];
	}
    } else {
...
/*     Find the file table entries for this file. */
    ...
    while(! found && findex > 0) {
	if (fthan[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		"an", i__1, "dasfm_", (ftnlen)4592)] == *handle) {
	    found = TRUE_;
	} else {
	    findex = lnknxt_(&findex, pool);
	}
...
/*        counts in the file record.  Otherwise, leave the file alone. */
	...
	if (*nresvr != ftsum[(i__1 = findex * 14 - 14) < 294 && 0 <= i__1 ? 
		i__1 : s_rnge("ftsum", i__1, "dasfm_", (ftnlen)4625)] || *
		nresvc != ftsum[(i__2 = findex * 14 - 13) < 294 && 0 <= i__2 ?
		 i__2 : s_rnge("ftsum", i__2, "dasfm_", (ftnlen)4625)] || *
		ncomr != ftsum[(i__3 = findex * 14 - 12) < 294 && 0 <= i__3 ? 
		i__3 : s_rnge("ftsum", i__3, "dasfm_", (ftnlen)4625)] || *
		ncomc != ftsum[(i__5 = findex * 14 - 11) < 294 && 0 <= i__5 ? 
		i__5 : s_rnge("ftsum", i__5, "dasfm_", (ftnlen)4625)]) {

/*           Read the file record. */

	    io___53.ciunit = ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? 
		    i__1 : s_rnge("ftlun", i__1, "dasfm_", (ftnlen)4633)];
...
L100004:
		...
		errfnm_("#", &ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? 
			i__1 : s_rnge("ftlun", i__1, "dasfm_", (ftnlen)4650)],
			 (ftnlen)1);
		errint_("#", &iostat, (ftnlen)1);
	    ...
	    io___55.ciunit = ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? 
		    i__1 : s_rnge("ftlun", i__1, "dasfm_", (ftnlen)4658)];
...
L100005:
		...
		cl__1.cunit = ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? 
			i__1 : s_rnge("ftlun", i__1, "dasfm_", (ftnlen)4673)];
		cl__1.csta = 0;
		f_clos(&cl__1);
...
/*     Find the file table entries for this file. */
    ...
    while(! found && findex > 0) {
	if (fthan[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		"an", i__1, "dasfm_", (ftnlen)4912)] == *handle) {
	    found = TRUE_;
	} else {
	    findex = lnknxt_(&findex, pool);
	}
...
/*     Find the file table entries for this file. */
	...
	if (ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("ftl"
		"un", i__1, "dasfm_", (ftnlen)5137)] == *unit) {
	    found = TRUE_;
	} else {
	    findex = lnknxt_(&findex, pool);
	}
...
/*     Find the file table entries for this file. */
    ...
    while(! found && findex > 0) {
	if (fthan[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		"an", i__1, "dasfm_", (ftnlen)5375)] == *handle) {
	    found = TRUE_;
	} else {
	    findex = lnknxt_(&findex, pool);
	}
	...
	ioin__1.inunit = ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : 
		s_rnge("ftlun", i__1, "dasfm_", (ftnlen)5385)];
	ioin__1.infile = 0;
	ioin__1.inex = 0;
	ioin__1.inopen = 0;
	ioin__1.innum = 0;
...
/*     Find the file table entries for this file. */
    ...
    while(! found && findex > 0) {
	if (ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("ftl"
		"un", i__1, "dasfm_", (ftnlen)5603)] == number) {
	    found = TRUE_;
	} else {
	    findex = lnknxt_(&findex, pool);
	}
...
/*     DAS designated by the the input argument HANDLE is not open */
...
/*        must exist. */
	...
	while(! found && findex > 0) {
	    if (fthan[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge(
		    "fthan", i__1, "dasfm_", (ftnlen)6116)] == *handle) {
		found = TRUE_;
	    } else {
		findex = lnknxt_(&findex, pool);
	    }
...
/*           for writing. */
	    ...
	    ioin__1.inunit = ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? 
		    i__1 : s_rnge("ftlun", i__1, "dasfm_", (ftnlen)6134)];
	    ioin__1.infile = 0;
	    ioin__1.inex = 0;
	    ioin__1.inopen = 0;
	    ioin__1.innum = 0;
...
/*     unlawful for the handle to be absent. */
    ...
    while(! found && findex > 0) {
	if (fthan[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		"an", i__1, "dasfm_", (ftnlen)6367)] == *handle) {
	    found = TRUE_;
	} else {
	    findex = lnknxt_(&findex, pool);
	}
