...
/*        from the kernel pool (if there is a value there). */
	...
	swpool_(agent + (((i__1 = this__ - 1) < 30 && 0 <= i__1 ? i__1 : 
		s_rnge("agent", i__1, "ckmeta_", (ftnlen)290)) << 5), &c__1, 
		lookup + (((i__2 = (this__ << 1) - 2) < 60 && 0 <= i__2 ? 
		i__2 : s_rnge("lookup", i__2, "ckmeta_", (ftnlen)290)) << 5), 
		(ftnlen)32, (ftnlen)32);
	cvpool_(agent + (((i__1 = this__ - 1) < 30 && 0 <= i__1 ? i__1 : 
		s_rnge("agent", i__1, "ckmeta_", (ftnlen)291)) << 5), &update,
		 (ftnlen)32);
	gipool_(lookup + (((i__1 = (this__ << 1) - 2) < 60 && 0 <= i__1 ? 
		i__1 : s_rnge("lookup", i__1, "ckmeta_", (ftnlen)293)) << 5), 
		&c__1, &c__1, &n, &sclks[(i__2 = this__ - 1) < 30 && 0 <= 
		i__2 ? i__2 : s_rnge("sclks", i__2, "ckmeta_", (ftnlen)293)], 
		found, (ftnlen)32);
	gipool_(lookup + (((i__1 = (this__ << 1) - 1) < 60 && 0 <= i__1 ? 
		i__1 : s_rnge("lookup", i__1, "ckmeta_", (ftnlen)296)) << 5), 
		&c__1, &c__1, &n, &spks[(i__2 = this__ - 1) < 30 && 0 <= i__2 
		? i__2 : s_rnge("spks", i__2, "ckmeta_", (ftnlen)296)], &
		found[1], (ftnlen)32);
...
/*        zero in that case. */
	...
	if (cks[(i__1 = this__ - 1) < 30 && 0 <= i__1 ? i__1 : s_rnge("cks", 
		i__1, "ckmeta_", (ftnlen)305)] <= -1000) {
	    if (! found[0]) {
		sclks[(i__1 = this__ - 1) < 30 && 0 <= i__1 ? i__1 : s_rnge(
			"sclks", i__1, "ckmeta_", (ftnlen)308)] = cks[(i__2 = 
			this__ - 1) < 30 && 0 <= i__2 ? i__2 : s_rnge("cks", 
			i__2, "ckmeta_", (ftnlen)308)] / 1000;
	    }
	    if (! found[1]) {
		spks[(i__1 = this__ - 1) < 30 && 0 <= i__1 ? i__1 : s_rnge(
			"spks", i__1, "ckmeta_", (ftnlen)312)] = cks[(i__2 = 
			this__ - 1) < 30 && 0 <= i__2 ? i__2 : s_rnge("cks", 
			i__2, "ckmeta_", (ftnlen)312)] / 1000;
	    }
	} else {
	    if (! found[0]) {
		sclks[(i__1 = this__ - 1) < 30 && 0 <= i__1 ? i__1 : s_rnge(
			"sclks", i__1, "ckmeta_", (ftnlen)318)] = 0;
	    }
	    if (! found[1]) {
		spks[(i__1 = this__ - 1) < 30 && 0 <= i__1 ? i__1 : s_rnge(
			"spks", i__1, "ckmeta_", (ftnlen)322)] = 0;
	    }
	}
    }
