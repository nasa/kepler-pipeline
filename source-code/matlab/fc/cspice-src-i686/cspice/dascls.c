...
/*     This routine provides the only official method of closing an */
/*     open DAS file.  Closing a DAS file by any other means may */
/*     cause the DAS mechanism for keeping track of which files are open */
/*     to fail.  Closing a DAS file that has been opened for writing by */
/*     any other means may result in the production of something other */
/*     than a DAS file. */
...
/*                  CALL DASADD ( HANDLE, 100, DATAD, FIRST, LAST ) */
