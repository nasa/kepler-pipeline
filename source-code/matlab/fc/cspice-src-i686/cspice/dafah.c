...
/*     return. */
	...
	ftlnk[(i__1 = findex - 1) < 1000 && 0 <= i__1 ? i__1 : s_rnge("ftlnk",
		 i__1, "dafah_", (ftnlen)1204)] = ftlnk[(i__2 = findex - 1) < 
...
/*     newly opened DAF. */
    ...
    ++nft;
    fthan[(i__1 = nft - 1) < 1000 && 0 <= i__1 ? i__1 : s_rnge("fthan", i__1, 
	    "dafah_", (ftnlen)1646)] = *handle;
    ftnd[(i__1 = nft - 1) < 1000 && 0 <= i__1 ? i__1 : s_rnge("ftnd", i__1, 
	    "dafah_", (ftnlen)1647)] = fnd;
    ftni[(i__1 = nft - 1) < 1000 && 0 <= i__1 ? i__1 : s_rnge("ftni", i__1, 
	    "dafah_", (ftnlen)1648)] = fni;
    ftlnk[(i__1 = nft - 1) < 1000 && 0 <= i__1 ? i__1 : s_rnge("ftlnk", i__1, 
	    "dafah_", (ftnlen)1649)] = 1;
...
/*     opened DAF. */
    ...
    ++nft;
    fthan[(i__1 = nft - 1) < 1000 && 0 <= i__1 ? i__1 : s_rnge("fthan", i__1, 
	    "dafah_", (ftnlen)2202)] = *handle;
    ftnd[(i__1 = nft - 1) < 1000 && 0 <= i__1 ? i__1 : s_rnge("ftnd", i__1, 
	    "dafah_", (ftnlen)2203)] = fnd;
    ftni[(i__1 = nft - 1) < 1000 && 0 <= i__1 ? i__1 : s_rnge("ftni", i__1, 
	    "dafah_", (ftnlen)2204)] = fni;
    ftlnk[(i__1 = nft - 1) < 1000 && 0 <= i__1 ? i__1 : s_rnge("ftlnk", i__1, 
	    "dafah_", (ftnlen)2205)] = 1;
...
/*     our newly opened DAF. */
    ...
    ++nft;
    fthan[(i__1 = nft - 1) < 1000 && 0 <= i__1 ? i__1 : s_rnge("fthan", i__1, 
	    "dafah_", (ftnlen)2735)] = *handle;
    ftnd[(i__1 = nft - 1) < 1000 && 0 <= i__1 ? i__1 : s_rnge("ftnd", i__1, 
	    "dafah_", (ftnlen)2736)] = fnd;
    ftni[(i__1 = nft - 1) < 1000 && 0 <= i__1 ? i__1 : s_rnge("ftni", i__1, 
	    "dafah_", (ftnlen)2737)] = fni;
    ftlnk[(i__1 = nft - 1) < 1000 && 0 <= i__1 ? i__1 : s_rnge("ftlnk", i__1, 
	    "dafah_", (ftnlen)2738)] = 1;
...
/*     Standard SPICE error handling. */
	...
	*nd = ftnd[(i__1 = findex - 1) < 1000 && 0 <= i__1 ? i__1 : s_rnge(
		"ftnd", i__1, "dafah_", (ftnlen)3290)];
	*ni = ftni[(i__1 = findex - 1) < 1000 && 0 <= i__1 ? i__1 : s_rnge(
		"ftni", i__1, "dafah_", (ftnlen)3291)];
    } else {
...
/*     DAF designated by the the input argument HANDLE is not open */
...
/*         DAFSIH, so that the the routine will return if DAFSIH */
