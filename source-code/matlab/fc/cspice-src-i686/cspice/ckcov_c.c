...
-Examples
   ...
   2)  Find the coverage for the object designated by `idcode' provided
       by the set of CK files loaded via a metakernel. (The metakernel
       must also specify leapseconds and SCLK kernels.)
