...
/*                    the frame REF.  Each packet contains a quaternion */
/*                    and optionally, depending on the segment subtype, */
/*                    attitude derivative data, from which a C-matrix and */
/*                    an angular velocity vector may be derived. */
...
/*                    For all subtypes, quaternions are "SPICE-style": */
/*                    the scalar part comes first, followed by the vector */
/*                    part.  The quaternion (q0, q1, q2, q3) is related */
/*                    to the corresponding C-matrix by the formula: */
