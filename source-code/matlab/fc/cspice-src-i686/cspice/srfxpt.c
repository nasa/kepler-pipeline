	...
	abcorr_len, ftnlen obsrvr_len, ftnlen dref_len)
{
    ...
    extern /* Subroutine */ int setmsg_(char *, ftnlen), sigerr_(char *, 
	    ftnlen);
    doublereal prevet;
    extern /* Subroutine */ int chkout_(char *, ftnlen), spkssb_(integer *, 
	    doublereal *, char *, doublereal *, ftnlen), stlabx_(doublereal *,
	     doublereal *, doublereal *), npedln_(doublereal *, doublereal *, 
    ...
    extern /* Subroutine */ int spkezp_(integer *, doublereal *, char *, char 
	    *, integer *, doublereal *, doublereal *, ftnlen, ftnlen), 
	    ...
	    doublereal *, doublereal *, ftnlen, ftnlen), surfpt_(doublereal *,
	     doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, logical *);
    logical fnd;
...
/*                    CALL VMINUS ( SPOINT, OBSPOS, XVEC ) */
...
/*     correction for stellar aberration, is parallel to the the ray. So */
...
/*           distinct, so this should be a very unusual occurrence. */
	...
	reject = asin(maxrad * 1.001 / range);
	vminus_(obspos, negpos);
	if (vsep_(negpos, trgdir) > reject) {

/*           The angular separation of ray and target is too */
/*           great for a solution to exist, even with a better */
/*           light time estimate. */
...
/*        If we're not using light time corrections, we're done now. */
/*        FOUND has been set. */
