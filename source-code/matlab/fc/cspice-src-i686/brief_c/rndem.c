...
/* Subroutine */ int rndem_(logical *obnam, integer *objlis, integer *objsiz, 
	doublereal *intval, doublereal *filwin, char *winsym, integer *winptr,
	 doublereal *winval, ftnlen winsym_len)
{
...
/*        specified. */
	...
	maknam_(object, objsiz, obnam, objnam, (ftnlen)32);
