...
/* Subroutine */ int filtem_(logical *obnam, integer *objlis, doublereal *
	from, doublereal *to, doublereal *filwin, doublereal *tmpwin, char *
	winsym, integer *winptr, doublereal *winval, ftnlen winsym_len)
{
    logical keep;
...
/*        list of objects to disply. */
	...
	maknam_(object, &sobj, obnam, objnam, (ftnlen)32);
