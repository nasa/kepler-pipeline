...
/*        Substitute string and print out the line. */
	...
	repmcw_(outlin, "#", idline, &c__8, outlin, (ftnlen)256, (ftnlen)1, (
...
/*              first object. */
	    ...
	    repmcw_(outlin, "#", idline, &c__8, outlin, (ftnlen)256, (ftnlen)
...
/*              the first interval. */
		...
		repmcw_(outlin, "#", idline, &c__8, outlin, (ftnlen)256, (
			ftnlen)1, (ftnlen)256, (ftnlen)256);
		tostdo_(outlin, rtrim_(outlin, (ftnlen)256));
		if (*fdsp) {
...
/* Subroutine */ int prinst_(integer *id, doublereal *tbegin, doublereal *
	...
	logical *tdsp, logical *gdsp, ftnlen tout_len)
{
