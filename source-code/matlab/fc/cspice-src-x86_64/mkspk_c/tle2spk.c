	...
	frnmvl_len, ftnlen sgidvl_len)
{
    ...
    extern /* Subroutine */ int errint_(char *, integer *, ftnlen), sigerr_(
	    char *, ftnlen), namfrm_(char *, integer *, ftnlen), intstr_(
	    integer *, char *, ftnlen), rdtext_(char *, char *, logical *, 
	    ...
	    ftnlen), orderd_(doublereal *, integer *, integer *), reordd_(
	    integer *, integer *, doublereal *), reorbd_(integer *, integer *,
	     integer *, doublereal *), tostdo_(char *, ftnlen);
    extern doublereal spd_(void);
    extern /* Subroutine */ int cltext_(char *, ftnlen), chkout_(char *, 
	    ftnlen);
    integer put;
