	...
	logical *found)
{
    ...
    /* Local variables */
    static char name__[32], spec[32], item[32*14];
    static integer idnt[1], axes[3], pool[52]	/* was [2][26] */;
    ...
    static integer buffi[20]	/* was [1][20] */;
    ...
    extern /* Subroutine */ int gcpool_(char *, integer *, integer *, integer 
	    *, char *, logical *, ftnlen, ftnlen), gdpool_(char *, integer *, 
	    integer *, integer *, doublereal *, logical *, ftnlen), gipool_(
	    char *, integer *, integer *, integer *, integer *, logical *, 
	    ftnlen), sigerr_(char *, ftnlen), chkout_(char *, ftnlen), 
	    sharpr_(doublereal *), dtpool_(char *, logical *, integer *, char 
	    *, ftnlen, ftnlen), setmsg_(char *, ftnlen);
    static doublereal matrix[9]	/* was [3][3] */;
    extern /* Subroutine */ int errint_(char *, integer *, ftnlen), cvpool_(
	    char *, logical *, ftnlen), vsclip_(doublereal *, doublereal *);
...
/*     frame to it's relative frame.  One instance in which you */
...
/*     Lookup the address of the instance data. */
...
/* Writing concatenation */
    i__1[0] = 8, a__1[0] = "TKFRAME_";
    i__1[1] = 32, a__1[1] = idstr;
    s_cat(agent, a__1, i__1, &c__2, (ftnlen)32);
    r__ = rtrim_(agent, (ftnlen)32);
/* Writing concatenation */
    i__1[0] = 8, a__1[0] = "TKFRAME_";
    i__1[1] = 32, a__1[1] = frname;
    s_cat(altnat, a__1, i__1, &c__2, (ftnlen)32);
...
/*        information from the local buffer. */
	...
	rot[0] = buffd[(i__2 = at * 9 - 9) < 180 && 0 <= i__2 ? i__2 : s_rnge(
		"buffd", i__2, "tkfram_", (ftnlen)433)];
	rot[1] = buffd[(i__2 = at * 9 - 8) < 180 && 0 <= i__2 ? i__2 : s_rnge(
		"buffd", i__2, "tkfram_", (ftnlen)434)];
	rot[2] = buffd[(i__2 = at * 9 - 7) < 180 && 0 <= i__2 ? i__2 : s_rnge(
		"buffd", i__2, "tkfram_", (ftnlen)435)];
	rot[3] = buffd[(i__2 = at * 9 - 6) < 180 && 0 <= i__2 ? i__2 : s_rnge(
		"buffd", i__2, "tkfram_", (ftnlen)436)];
	rot[4] = buffd[(i__2 = at * 9 - 5) < 180 && 0 <= i__2 ? i__2 : s_rnge(
		"buffd", i__2, "tkfram_", (ftnlen)437)];
	rot[5] = buffd[(i__2 = at * 9 - 4) < 180 && 0 <= i__2 ? i__2 : s_rnge(
		"buffd", i__2, "tkfram_", (ftnlen)438)];
	rot[6] = buffd[(i__2 = at * 9 - 3) < 180 && 0 <= i__2 ? i__2 : s_rnge(
		"buffd", i__2, "tkfram_", (ftnlen)439)];
	rot[7] = buffd[(i__2 = at * 9 - 2) < 180 && 0 <= i__2 ? i__2 : s_rnge(
		"buffd", i__2, "tkfram_", (ftnlen)440)];
	rot[8] = buffd[(i__2 = at * 9 - 1) < 180 && 0 <= i__2 ? i__2 : s_rnge(
		"buffd", i__2, "tkfram_", (ftnlen)441)];
	*frame = buffi[(i__2 = at - 1) < 20 && 0 <= i__2 ? i__2 : s_rnge(
		"buffi", i__2, "tkfram_", (ftnlen)443)];
    } else {
...
/* Writing concatenation */
	i__1[0] = r__, a__1[0] = agent;
	i__1[1] = 5, a__1[1] = "_SPEC";
	s_cat(item, a__1, i__1, &c__2, (ftnlen)32);
/* Writing concatenation */
	i__1[0] = r__, a__1[0] = agent;
	i__1[1] = 9, a__1[1] = "_RELATIVE";
	s_cat(item + 32, a__1, i__1, &c__2, (ftnlen)32);
/* Writing concatenation */
	i__1[0] = ar, a__1[0] = altnat;
	i__1[1] = 5, a__1[1] = "_SPEC";
	s_cat(alt, a__1, i__1, &c__2, (ftnlen)32);
/* Writing concatenation */
	i__1[0] = ar, a__1[0] = altnat;
	i__1[1] = 9, a__1[1] = "_RELATIVE";
	s_cat(alt + 32, a__1, i__1, &c__2, (ftnlen)32);

/*        See if the friendlier version of the kernel pool variables */
/*        are available. */

	for (i__ = 1; i__ <= 2; ++i__) {
	    dtpool_(alt, found, &n, type__, (ftnlen)32, (ftnlen)1);
	    if (*found) {
		s_copy(item + (((i__2 = i__ - 1) < 14 && 0 <= i__2 ? i__2 : 
			s_rnge("item", i__2, "tkfram_", (ftnlen)466)) << 5), 
			alt + (((i__3 = i__ - 1) < 14 && 0 <= i__3 ? i__3 : 
			s_rnge("alt", i__3, "tkfram_", (ftnlen)466)) << 5), (
			ftnlen)32, (ftnlen)32);
	    }
	}
...
/*           We give preference to the the kernel pool variable */
/*           TKFRAME_<name>_MATRIX if it is available. */

/* Writing concatenation */
	    i__1[0] = r__, a__1[0] = agent;
	    i__1[1] = 7, a__1[1] = "_MATRIX";
	    s_cat(item + 64, a__1, i__1, &c__2, (ftnlen)32);
/* Writing concatenation */
	    i__1[0] = ar, a__1[0] = altnat;
	    i__1[1] = 7, a__1[1] = "_MATRIX";
	    s_cat(alt + 64, a__1, i__1, &c__2, (ftnlen)32);
...
/* Writing concatenation */
	    i__1[0] = r__, a__1[0] = agent;
	    i__1[1] = 7, a__1[1] = "_ANGLES";
	    s_cat(item + 64, a__1, i__1, &c__2, (ftnlen)32);
/* Writing concatenation */
	    i__1[0] = r__, a__1[0] = agent;
	    i__1[1] = 5, a__1[1] = "_AXES";
	    s_cat(item + 96, a__1, i__1, &c__2, (ftnlen)32);
/* Writing concatenation */
	    i__1[0] = r__, a__1[0] = agent;
	    i__1[1] = 6, a__1[1] = "_UNITS";
	    s_cat(item + 128, a__1, i__1, &c__2, (ftnlen)32);
/* Writing concatenation */
	    i__1[0] = ar, a__1[0] = altnat;
	    i__1[1] = 7, a__1[1] = "_ANGLES";
	    s_cat(alt + 64, a__1, i__1, &c__2, (ftnlen)32);
/* Writing concatenation */
	    i__1[0] = ar, a__1[0] = altnat;
	    i__1[1] = 5, a__1[1] = "_AXES";
	    s_cat(alt + 96, a__1, i__1, &c__2, (ftnlen)32);
/* Writing concatenation */
	    i__1[0] = ar, a__1[0] = altnat;
	    i__1[1] = 6, a__1[1] = "_UNITS";
	    s_cat(alt + 128, a__1, i__1, &c__2, (ftnlen)32);

/*           Again, we give preference to the more friendly form */
/*           of TKFRAME specification. */

	    for (i__ = 3; i__ <= 5; ++i__) {
		dtpool_(alt + (((i__2 = i__ - 1) < 14 && 0 <= i__2 ? i__2 : 
			s_rnge("alt", i__2, "tkfram_", (ftnlen)594)) << 5), 
			found, &n, type__, (ftnlen)32, (ftnlen)1);
		if (*found) {
		    s_copy(item + (((i__2 = i__ - 1) < 14 && 0 <= i__2 ? i__2 
			    : s_rnge("item", i__2, "tkfram_", (ftnlen)597)) <<
			     5), alt + (((i__3 = i__ - 1) < 14 && 0 <= i__3 ? 
			    i__3 : s_rnge("alt", i__3, "tkfram_", (ftnlen)597)
...
/*           Convert angles to radians. */
	    ...
	    for (i__ = 1; i__ <= 3; ++i__) {
		convrt_(&angles[(i__2 = i__ - 1) < 3 && 0 <= i__2 ? i__2 : 
			s_rnge("angles", i__2, "tkfram_", (ftnlen)626)], 
			units, "RADIANS", &tempd, (ftnlen)32, (ftnlen)7);
		angles[(i__2 = i__ - 1) < 3 && 0 <= i__2 ? i__2 : s_rnge(
			"angles", i__2, "tkfram_", (ftnlen)627)] = tempd;
	    }
	    if (failed_()) {
		lnkini_(&c__20, pool);
		*frame = 0;
...
/*        Buffer the identifier, relative frame and rotation matrix. */
	...
	buffd[(i__2 = at * 9 - 9) < 180 && 0 <= i__2 ? i__2 : s_rnge("buffd", 
		i__2, "tkfram_", (ftnlen)711)] = rot[0];
	buffd[(i__2 = at * 9 - 8) < 180 && 0 <= i__2 ? i__2 : s_rnge("buffd", 
		i__2, "tkfram_", (ftnlen)712)] = rot[1];
	buffd[(i__2 = at * 9 - 7) < 180 && 0 <= i__2 ? i__2 : s_rnge("buffd", 
		i__2, "tkfram_", (ftnlen)713)] = rot[2];
	buffd[(i__2 = at * 9 - 6) < 180 && 0 <= i__2 ? i__2 : s_rnge("buffd", 
		i__2, "tkfram_", (ftnlen)714)] = rot[3];
	buffd[(i__2 = at * 9 - 5) < 180 && 0 <= i__2 ? i__2 : s_rnge("buffd", 
		i__2, "tkfram_", (ftnlen)715)] = rot[4];
	buffd[(i__2 = at * 9 - 4) < 180 && 0 <= i__2 ? i__2 : s_rnge("buffd", 
		i__2, "tkfram_", (ftnlen)716)] = rot[5];
	buffd[(i__2 = at * 9 - 3) < 180 && 0 <= i__2 ? i__2 : s_rnge("buffd", 
		i__2, "tkfram_", (ftnlen)717)] = rot[6];
	buffd[(i__2 = at * 9 - 2) < 180 && 0 <= i__2 ? i__2 : s_rnge("buffd", 
		i__2, "tkfram_", (ftnlen)718)] = rot[7];
	buffd[(i__2 = at * 9 - 1) < 180 && 0 <= i__2 ? i__2 : s_rnge("buffd", 
		i__2, "tkfram_", (ftnlen)719)] = rot[8];
	buffi[(i__2 = at - 1) < 20 && 0 <= i__2 ? i__2 : s_rnge("buffi", i__2,
		 "tkfram_", (ftnlen)721)] = *frame;
...
/* Writing concatenation */
	    i__1[0] = r__, a__1[0] = agent;
	    i__1[1] = 7, a__1[1] = "_ANGLES";
	    s_cat(item + 160, a__1, i__1, &c__2, (ftnlen)32);
/* Writing concatenation */
	    i__1[0] = r__, a__1[0] = agent;
	    i__1[1] = 6, a__1[1] = "_UNITS";
	    s_cat(item + 192, a__1, i__1, &c__2, (ftnlen)32);
/* Writing concatenation */
	    i__1[0] = ar, a__1[0] = altnat;
	    i__1[1] = 9, a__1[1] = "_RELATIVE";
	    s_cat(item + 224, a__1, i__1, &c__2, (ftnlen)32);
/* Writing concatenation */
	    i__1[0] = ar, a__1[0] = altnat;
	    i__1[1] = 5, a__1[1] = "_SPEC";
	    s_cat(item + 256, a__1, i__1, &c__2, (ftnlen)32);
/* Writing concatenation */
	    i__1[0] = ar, a__1[0] = altnat;
	    i__1[1] = 5, a__1[1] = "_AXES";
	    s_cat(item + 288, a__1, i__1, &c__2, (ftnlen)32);
/* Writing concatenation */
	    i__1[0] = ar, a__1[0] = altnat;
	    i__1[1] = 7, a__1[1] = "_MATRIX";
	    s_cat(item + 320, a__1, i__1, &c__2, (ftnlen)32);
/* Writing concatenation */
	    i__1[0] = ar, a__1[0] = altnat;
	    i__1[1] = 2, a__1[1] = "_Q";
	    s_cat(item + 352, a__1, i__1, &c__2, (ftnlen)32);
/* Writing concatenation */
	    i__1[0] = ar, a__1[0] = altnat;
	    i__1[1] = 7, a__1[1] = "_ANGLES";
	    s_cat(item + 384, a__1, i__1, &c__2, (ftnlen)32);
/* Writing concatenation */
	    i__1[0] = ar, a__1[0] = altnat;
	    i__1[1] = 6, a__1[1] = "_UNITS";
	    s_cat(item + 416, a__1, i__1, &c__2, (ftnlen)32);
