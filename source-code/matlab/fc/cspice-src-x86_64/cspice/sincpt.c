...
/*     4)  If the input target body-fixed frame FIXFRM is not */
...
/*     5)  If the input frame FIXFRM is not centered at the target body, */
...
/*    C */
/*          CHARACTER*(*)         META */
/*          PARAMETER           ( META   = 'mgs_example2.mk' ) */
...
/*     above, to convert J2GEOM to FIXFRM, evaluated at TRGEPC. */
