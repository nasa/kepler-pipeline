...
/*        unit is present. */
	...
	while(! found && findex > 0) {
	    if (ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge(
		    "ftlun", i__1, "dasfm_", (ftnlen)1364)] == number) {
		found = TRUE_;
	    } else {
	...
	if (found) {
	    if (ftacc[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge(
		    "ftacc", i__1, "dasfm_", (ftnlen)1374)] == 2) {
...
/*              of links to this file. */
		...
		ftlnk[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge(
			"ftlnk", i__1, "dasfm_", (ftnlen)1387)] = ftlnk[(i__2 
			= findex - 1) < 21 && 0 <= i__2 ? i__2 : s_rnge("ftl"
			"nk", i__2, "dasfm_", (ftnlen)1387)] + 1;
		*handle = fthan[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 :
			 s_rnge("fthan", i__1, "dasfm_", (ftnlen)1388)];
	    }
	} else {
...
/*           Compare binary format to local format.  These must match. */
		...
		errch_("#", bfflst + (((i__1 = bff - 1) < 4 && 0 <= i__1 ? 
			i__1 : s_rnge("bfflst", i__1, "dasfm_", (ftnlen)1508))
			 << 3), (ftnlen)1, (ftnlen)8);
...
/*           restoring a DAS file whose creation was interrupted. */
	    ...
	    ftsum[(i__1 = fthead * 14 - 14) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)1591)] = locrrc;
	    ftsum[(i__1 = fthead * 14 - 13) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)1592)] = locrch;
	    ftsum[(i__1 = fthead * 14 - 12) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)1593)] = loccrc;
	    ftsum[(i__1 = fthead * 14 - 11) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)1594)] = loccch;
...
/*              record of the current type. */
		...
		ldrec[(i__1 = type__ - 1) < 3 && 0 <= i__1 ? i__1 : s_rnge(
			"ldrec", i__1, "dasfm_", (ftnlen)1610)] = 0;
...
/*                 cluster. */
		    ...
		    prvtyp = prev[(i__1 = dsctyp - 1) < 3 && 0 <= i__1 ? i__1 
			    : s_rnge("prev", i__1, "dasfm_", (ftnlen)1676)];
		    endrec = nrec;
		    pos = 9;
		    while(last < maxadr) {
			++pos;
...
/*                 of the last data record of TYPE. */
		    ...
		    ldrec[(i__1 = type__ - 1) < 3 && 0 <= i__1 ? i__1 : 
			    s_rnge("ldrec", i__1, "dasfm_", (ftnlen)1704)] = 
			    endrec;
		} else {
...
/*           Compare binary format to local format.  These must match. */
		...
		errch_("#", fname, (ftnlen)1, fname_len);
		errch_("#", bfflst + (((i__1 = bff - 1) < 4 && 0 <= i__1 ? 
			i__1 : s_rnge("bfflst", i__1, "dasfm_", (ftnlen)2151))
			 << 3), (ftnlen)1, (ftnlen)8);
		sigerr_("SPICE(NONNATIVEFILE)", (ftnlen)20);
		chkout_("DASOPW", (ftnlen)6);
		return 0;
...
/*           Set the output argument HANDLE as well. */
	    ...
	    ++nxthan;
	    fthan[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		    "an", i__1, "dasfm_", (ftnlen)2222)] = nxthan;
	    ftlun[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("ftl"
		    "un", i__1, "dasfm_", (ftnlen)2223)] = number;
	    ftacc[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fta"
		    "cc", i__1, "dasfm_", (ftnlen)2224)] = 2;
	    ftlnk[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("ftl"
		    "nk", i__1, "dasfm_", (ftnlen)2225)] = 1;
...
/*           restoring a DAS file whose creation was interrupted. */
	    ...
	    cleari_(&c__14, &ftsum[(i__1 = fthead * 14 - 14) < 294 && 0 <= 
		    ...
		    2237)]);
	    ftsum[(i__1 = fthead * 14 - 14) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)2239)] = locrrc;
	    ftsum[(i__1 = fthead * 14 - 13) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)2240)] = locrch;
	    ftsum[(i__1 = fthead * 14 - 12) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)2241)] = loccrc;
	    ftsum[(i__1 = fthead * 14 - 11) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)2242)] = loccch;
...
/*              record of the current type. */
		...
		ldrec[(i__1 = type__ - 1) < 3 && 0 <= i__1 ? i__1 : s_rnge(
			"ldrec", i__1, "dasfm_", (ftnlen)2258)] = 0;
...
/*                 cluster. */
		    ...
		    dsctyp = dirrec[8];
		    prvtyp = prev[(i__1 = dsctyp - 1) < 3 && 0 <= i__1 ? i__1 
			    : s_rnge("prev", i__1, "dasfm_", (ftnlen)2325)];
		    endrec = nrec;
		    pos = 9;
		    while(last < maxadr) {
			++pos;
...
/*                 of the last data record of TYPE. */
		    ...
		    ftsum[(i__1 = type__ + 11 + fthead * 14 - 15) < 294 && 0 
			    ...
			    ftnlen)2352)] = pos;
		    ldrec[(i__1 = type__ - 1) < 3 && 0 <= i__1 ? i__1 : 
			    s_rnge("ldrec", i__1, "dasfm_", (ftnlen)2353)] = 
			    endrec;
		} else {
...
/*                 There's no data of TYPE in the file. */
		    ...
		    ftsum[(i__1 = type__ + 11 + fthead * 14 - 15) < 294 && 0 
			    ...
			    ftnlen)2359)] = 0;
		    ldrec[(i__1 = type__ - 1) < 3 && 0 <= i__1 ? i__1 : 
			    s_rnge("ldrec", i__1, "dasfm_", (ftnlen)2360)] = 
			    0;
		}
	    }
...
/*           Now NREC is the last directory record. */
	    ...
	    ftsum[(i__1 = fthead * 14 - 10) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)2395)] = max(
		    ldrmax,nrec) + 1;

/*           Insert the new handle into our handle set. */

	    *handle = fthan[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : 
		    s_rnge("fthan", i__1, "dasfm_", (ftnlen)2400)];
	    insrti_(handle, fhlist);
	}
    }
    chkout_("DASOPW", (ftnlen)6);
...
/*           Set the output argument HANDLE as well. */
	    ...
	    cleari_(&c__14, &ftsum[(i__1 = fthead * 14 - 14) < 294 && 0 <= 
		    ...
		    2878)]);
	    fthan[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		    "an", i__1, "dasfm_", (ftnlen)2880)] = nxthan;
	    ftlun[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("ftl"
		    "un", i__1, "dasfm_", (ftnlen)2881)] = number;
	    ftacc[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fta"
		    "cc", i__1, "dasfm_", (ftnlen)2882)] = 2;
	    ftlnk[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("ftl"
		    "nk", i__1, "dasfm_", (ftnlen)2883)] = 1;
	    ftsum[(i__1 = fthead * 14 - 10) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)2884)] = *ncomr + 
		    3;
	    ftsum[(i__1 = fthead * 14 - 12) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)2885)] = *ncomr;
	    *handle = fthan[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : 
		    s_rnge("fthan", i__1, "dasfm_", (ftnlen)2887)];
...
/*           Set the output argument HANDLE as well. */
	    ...
	    cleari_(&c__14, &ftsum[(i__1 = fthead * 14 - 14) < 294 && 0 <= 
		    ...
		    3276)]);
	    fthan[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		    "an", i__1, "dasfm_", (ftnlen)3278)] = nxthan;
	    ftlun[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("ftl"
		    "un", i__1, "dasfm_", (ftnlen)3279)] = number;
	    ftacc[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fta"
		    "cc", i__1, "dasfm_", (ftnlen)3280)] = 2;
	    ftlnk[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("ftl"
		    "nk", i__1, "dasfm_", (ftnlen)3281)] = 1;
	    ftsum[(i__1 = fthead * 14 - 10) < 294 && 0 <= i__1 ? i__1 : 
		    s_rnge("ftsum", i__1, "dasfm_", (ftnlen)3282)] = 3;
	    *handle = fthan[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : 
		    s_rnge("fthan", i__1, "dasfm_", (ftnlen)3284)];
...
/*              Set the output argument HANDLE as well. */
		...
		fthan[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge(
			"fthan", i__1, "dasfm_", (ftnlen)3644)] = nxthan;
		ftlun[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge(
			"ftlun", i__1, "dasfm_", (ftnlen)3645)] = number;
		ftacc[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge(
			"ftacc", i__1, "dasfm_", (ftnlen)3646)] = 2;
		ftlnk[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge(
			"ftlnk", i__1, "dasfm_", (ftnlen)3647)] = 1;
		ftsum[(i__1 = fthead * 14 - 10) < 294 && 0 <= i__1 ? i__1 : 
			s_rnge("ftsum", i__1, "dasfm_", (ftnlen)3648)] = 3;
		*handle = fthan[(i__1 = fthead - 1) < 21 && 0 <= i__1 ? i__1 :
			 s_rnge("fthan", i__1, "dasfm_", (ftnlen)3650)];
...
/*     table; see whether this handle is present. */
	...
	if (fthan[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		"an", i__1, "dasfm_", (ftnlen)3908)] == *handle) {
	    found = TRUE_;
	} else {
	    findex = lnknxt_(&findex, pool);
	}
...
/*           Delete the handle from our handle set. */
	    ...
	    cl__1.cunit = ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 :
		     s_rnge("ftlun", i__1, "dasfm_", (ftnlen)3933)];
	    cl__1.csta = 0;
	    f_clos(&cl__1);
	    if (findex == fthead) {
...
/*     Initialize the file table pool and handle list, if necessary. */
    ...
    while(! found && findex > 0) {
	if (fthan[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		"an", i__1, "dasfm_", (ftnlen)4251)] == *handle) {
	    found = TRUE_;
	} else {
	    findex = lnknxt_(&findex, pool);
	}
...
/*        Give the caller the current summary from the file table. */
	...
	*nresvr = ftsum[(i__1 = findex * 14 - 14) < 294 && 0 <= i__1 ? i__1 : 
		s_rnge("ftsum", i__1, "dasfm_", (ftnlen)4264)];
	*nresvc = ftsum[(i__1 = findex * 14 - 13) < 294 && 0 <= i__1 ? i__1 : 
		s_rnge("ftsum", i__1, "dasfm_", (ftnlen)4265)];
	*ncomr = ftsum[(i__1 = findex * 14 - 12) < 294 && 0 <= i__1 ? i__1 : 
		s_rnge("ftsum", i__1, "dasfm_", (ftnlen)4266)];
	*ncomc = ftsum[(i__1 = findex * 14 - 11) < 294 && 0 <= i__1 ? i__1 : 
		s_rnge("ftsum", i__1, "dasfm_", (ftnlen)4267)];
	*free = ftsum[(i__1 = findex * 14 - 10) < 294 && 0 <= i__1 ? i__1 : 
		s_rnge("ftsum", i__1, "dasfm_", (ftnlen)4268)];
	for (i__ = 1; i__ <= 3; ++i__) {
	    lastla[(i__1 = i__ - 1) < 3 && 0 <= i__1 ? i__1 : s_rnge("lastla",
		     i__1, "dasfm_", (ftnlen)4271)] = ftsum[(i__2 = i__ + 5 + 
		    findex * 14 - 15) < 294 && 0 <= i__2 ? i__2 : s_rnge(
		    "ftsum", i__2, "dasfm_", (ftnlen)4271)];
	    lastrc[(i__1 = i__ - 1) < 3 && 0 <= i__1 ? i__1 : s_rnge("lastrc",
		     i__1, "dasfm_", (ftnlen)4272)] = ftsum[(i__2 = i__ + 8 + 
		    findex * 14 - 15) < 294 && 0 <= i__2 ? i__2 : s_rnge(
		    "ftsum", i__2, "dasfm_", (ftnlen)4272)];
	    lastwd[(i__1 = i__ - 1) < 3 && 0 <= i__1 ? i__1 : s_rnge("lastwd",
		     i__1, "dasfm_", (ftnlen)4273)] = ftsum[(i__2 = i__ + 11 
		    + findex * 14 - 15) < 294 && 0 <= i__2 ? i__2 : s_rnge(
		    "ftsum", i__2, "dasfm_", (ftnlen)4273)];
	}
    } else {
...
/*     Find the file table entries for this file. */
    ...
    while(! found && findex > 0) {
	if (fthan[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		"an", i__1, "dasfm_", (ftnlen)4612)] == *handle) {
	    found = TRUE_;
	} else {
	    findex = lnknxt_(&findex, pool);
	}
...
/*        counts in the file record.  Otherwise, leave the file alone. */
	...
	if (*nresvr != ftsum[(i__1 = findex * 14 - 14) < 294 && 0 <= i__1 ? 
		i__1 : s_rnge("ftsum", i__1, "dasfm_", (ftnlen)4645)] || *
		nresvc != ftsum[(i__2 = findex * 14 - 13) < 294 && 0 <= i__2 ?
		 i__2 : s_rnge("ftsum", i__2, "dasfm_", (ftnlen)4645)] || *
		ncomr != ftsum[(i__3 = findex * 14 - 12) < 294 && 0 <= i__3 ? 
		i__3 : s_rnge("ftsum", i__3, "dasfm_", (ftnlen)4645)] || *
		ncomc != ftsum[(i__5 = findex * 14 - 11) < 294 && 0 <= i__5 ? 
		i__5 : s_rnge("ftsum", i__5, "dasfm_", (ftnlen)4645)]) {

/*           Read the file record. */

	    io___53.ciunit = ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? 
		    i__1 : s_rnge("ftlun", i__1, "dasfm_", (ftnlen)4653)];
...
L100004:
		...
		errfnm_("#", &ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? 
			i__1 : s_rnge("ftlun", i__1, "dasfm_", (ftnlen)4670)],
			 (ftnlen)1);
		errint_("#", &iostat, (ftnlen)1);
...
L100005:
		...
		cl__1.cunit = ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? 
			i__1 : s_rnge("ftlun", i__1, "dasfm_", (ftnlen)4693)];
		cl__1.csta = 0;
		f_clos(&cl__1);
		setmsg_("Attempt to update file record failed. File was '#'."
			"  Value of IOSTAT was '#'.", (ftnlen)77);
		errfnm_("#", &ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? 
			i__1 : s_rnge("ftlun", i__1, "dasfm_", (ftnlen)4698)],
			 (ftnlen)1);
		errint_("#", &iostat, (ftnlen)1);
		sigerr_("SPICE(DASWRITEFAIL)", (ftnlen)19);
		chkout_("DASUFS", (ftnlen)6);
...
/*     Find the file table entries for this file. */
    ...
    while(! found && findex > 0) {
	if (fthan[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		"an", i__1, "dasfm_", (ftnlen)4932)] == *handle) {
	    found = TRUE_;
	} else {
	    findex = lnknxt_(&findex, pool);
	}
...
/*     Find the file table entries for this file. */
	...
	if (ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("ftl"
		"un", i__1, "dasfm_", (ftnlen)5157)] == *unit) {
	    found = TRUE_;
	} else {
	    findex = lnknxt_(&findex, pool);
	}
...
/*     Find the file table entries for this file. */
    ...
    while(! found && findex > 0) {
	if (fthan[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		"an", i__1, "dasfm_", (ftnlen)5395)] == *handle) {
	    found = TRUE_;
	} else {
	    findex = lnknxt_(&findex, pool);
	}
	...
	ioin__1.inunit = ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : 
		s_rnge("ftlun", i__1, "dasfm_", (ftnlen)5405)];
	ioin__1.infile = 0;
	ioin__1.inex = 0;
	ioin__1.inopen = 0;
	ioin__1.innum = 0;
...
/*     Find the file table entries for this file. */
    ...
    while(! found && findex > 0) {
	if (ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("ftl"
		"un", i__1, "dasfm_", (ftnlen)5623)] == number) {
	    found = TRUE_;
	} else {
	    findex = lnknxt_(&findex, pool);
	}
...
/*        must exist. */
	...
	while(! found && findex > 0) {
	    if (fthan[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge(
		    "fthan", i__1, "dasfm_", (ftnlen)6136)] == *handle) {
		found = TRUE_;
	    } else {
		findex = lnknxt_(&findex, pool);
	    }
...
/*           for writing. */
	    ...
	    ioin__1.inunit = ftlun[(i__1 = findex - 1) < 21 && 0 <= i__1 ? 
		    i__1 : s_rnge("ftlun", i__1, "dasfm_", (ftnlen)6154)];
	    ioin__1.infile = 0;
	    ioin__1.inex = 0;
	    ioin__1.inopen = 0;
	    ioin__1.innum = 0;
...
/*     unlawful for the handle to be absent. */
    ...
    while(! found && findex > 0) {
	if (fthan[(i__1 = findex - 1) < 21 && 0 <= i__1 ? i__1 : s_rnge("fth"
		"an", i__1, "dasfm_", (ftnlen)6387)] == *handle) {
	    found = TRUE_;
	} else {
	    findex = lnknxt_(&findex, pool);
	}
