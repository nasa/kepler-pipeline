...
/*        rest of the names, we'll have to add the suffix. */
	...
	for (i__ = 2; i__ <= 9; ++i__) {
	    suffix_("_#", &c__0, kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ?
		     i__1 : s_rnge("kvname", i__1, "sc01_", (ftnlen)855)) * 
		    60, (ftnlen)2, (ftnlen)60);
	    i__3 = -(*sc);
	    repmi_(kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ? i__1 : 
		    s_rnge("kvname", i__1, "sc01_", (ftnlen)856)) * 60, "#", &
		    i__3, kvname + ((i__2 = i__ - 1) < 9 && 0 <= i__2 ? i__2 :
		     s_rnge("kvname", i__2, "sc01_", (ftnlen)856)) * 60, (
...
/*     Determine how many ticks is each field is worth. */
    ...
    cmptks[(i__1 = nfield - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge("cmptks", 
	    i__1, "sc01_", (ftnlen)943)] = 1.;
    for (i__ = nfield - 1; i__ >= 1; --i__) {
	cmptks[(i__1 = i__ - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge("cmptks", 
		i__1, "sc01_", (ftnlen)946)] = cmptks[(i__2 = i__) < 10 && 0 
		<= i__2 ? i__2 : s_rnge("cmptks", i__2, "sc01_", (ftnlen)946)]
		 * moduli[(i__3 = i__) < 10 && 0 <= i__3 ? i__3 : s_rnge(
		"moduli", i__3, "sc01_", (ftnlen)946)];
    }
...
/*     to be equal to the offset value. */
	...
	if (s_cmp(error, " ", (ftnlen)240, (ftnlen)1) != 0) {
	    ...
	    errch_("#", cmp + ((i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : 
		    s_rnge("cmp", i__2, "sc01_", (ftnlen)990)) * 30, (ftnlen)
		    1, (ftnlen)30);
...
/*         have been invalid. */
	...
	cmpval[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge("cmpval", 
		i__2, "sc01_", (ftnlen)1004)] = cmpval[(i__3 = i__ - 1) < 10 
		&& 0 <= i__3 ? i__3 : s_rnge("cmpval", i__3, "sc01_", (ftnlen)
		1004)] - offset[(i__4 = i__ - 1) < 10 && 0 <= i__4 ? i__4 : 
		s_rnge("offset", i__4, "sc01_", (ftnlen)1004)];
	if (d_nint(&cmpval[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge(
		"cmpval", i__2, "sc01_", (ftnlen)1007)]) < 0.) {
...
/*     add up the results. */
	...
	*ticks += cmpval[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge(
		"cmpval", i__2, "sc01_", (ftnlen)1028)] * cmptks[(i__3 = i__ 
...
/*        rest of the names, we'll have to add the suffix. */
	...
	for (i__ = 2; i__ <= 9; ++i__) {
	    suffix_("_#", &c__0, kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ?
		     i__1 : s_rnge("kvname", i__1, "sc01_", (ftnlen)1367)) * 
		    60, (ftnlen)2, (ftnlen)60);
	    i__3 = -(*sc);
	    repmi_(kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ? i__1 : 
		    s_rnge("kvname", i__1, "sc01_", (ftnlen)1368)) * 60, 
		    "#", &i__3, kvname + ((i__2 = i__ - 1) < 9 && 0 <= i__2 ? 
		    i__2 : s_rnge("kvname", i__2, "sc01_", (ftnlen)1368)) * 
...
/*     Determine how many ticks each field is worth. */
    ...
    cmptks[(i__1 = nfield - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge("cmptks", 
	    i__1, "sc01_", (ftnlen)1442)] = 1.;
    for (i__ = nfield - 1; i__ >= 1; --i__) {
	cmptks[(i__1 = i__ - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge("cmptks", 
		i__1, "sc01_", (ftnlen)1445)] = cmptks[(i__2 = i__) < 10 && 0 
		<= i__2 ? i__2 : s_rnge("cmptks", i__2, "sc01_", (ftnlen)1445)
		] * moduli[(i__3 = i__) < 10 && 0 <= i__3 ? i__3 : s_rnge(
		"moduli", i__3, "sc01_", (ftnlen)1445)];
    }
...
/*     Determine the width of each field. */
	...
	maxwid = moduli[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge(
		"moduli", i__2, "sc01_", (ftnlen)1453)] + offset[(i__3 = i__ 
		- 1) < 10 && 0 <= i__3 ? i__3 : s_rnge("offset", i__3, "sc01_"
		, (ftnlen)1453)] - 1.;
	d__1 = maxwid + .5;
	cmpwid[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge("cmpwid", 
		i__2, "sc01_", (ftnlen)1455)] = (integer) d_lg10(&d__1) + 1;
    }
...
/*     is worth. */
	...
	d__1 = rem / cmptks[(i__3 = i__ - 1) < 10 && 0 <= i__3 ? i__3 : 
		s_rnge("cmptks", i__3, "sc01_", (ftnlen)1502)];
	cmpval[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge("cmpval", 
		i__2, "sc01_", (ftnlen)1502)] = d_int(&d__1) + offset[(i__4 = 
		i__ - 1) < 10 && 0 <= i__4 ? i__4 : s_rnge("offset", i__4, 
		"sc01_", (ftnlen)1502)];
	rem = d_mod(&rem, &cmptks[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : 
		s_rnge("cmptks", i__2, "sc01_", (ftnlen)1503)]);
    }
    cmpval[(i__1 = nfield - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge("cmpval", 
	    i__1, "sc01_", (ftnlen)1507)] = rem + offset[(i__2 = nfield - 1) <
...
/*     Pad on the left with zeros if necessary. */
	...
	pad = cmpwid[(i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge("cmp"
		"wid", i__2, "sc01_", (ftnlen)1528)] - length[(i__3 = i__ - 1) 
	...
	if (pad > 0) {
		...
		prefix_("0", &c__0, cmp + ((i__3 = i__ - 1) < 10 && 0 <= i__3 
			? i__3 : s_rnge("cmp", i__3, "sc01_", (ftnlen)1533)) *
...
/*     each field. */
	...
	if (*(unsigned char *)&del[(i__2 = delcde - 1) < 5 && 0 <= i__2 ? 
		i__2 : s_rnge("del", i__2, "sc01_", (ftnlen)1548)] != ' ') {
	    prefix_(del + ((i__2 = delcde - 1) < 5 && 0 <= i__2 ? i__2 : 
		    s_rnge("del", i__2, "sc01_", (ftnlen)1550)), &c__0, cmp + 
		    ((i__3 = i__ - 1) < 10 && 0 <= i__3 ? i__3 : s_rnge("cmp",
		     i__3, "sc01_", (ftnlen)1550)) * 30, (ftnlen)1, (ftnlen)
		    30);
	    suffix_(cmp + ((i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge(
		    "cmp", i__2, "sc01_", (ftnlen)1551)) * 30, &c__0, clkstr, 
		    (ftnlen)30, clkstr_len);
	} else {
	    suffix_(cmp + ((i__2 = i__ - 1) < 10 && 0 <= i__2 ? i__2 : s_rnge(
		    "cmp", i__2, "sc01_", (ftnlen)1553)) * 30, &c__1, clkstr, 
		    (ftnlen)30, clkstr_len);
	}
    }
    chkout_("SCFM01", (ftnlen)6);
...
/*        rest of the names, we'll have to add the suffix. */
	...
	for (i__ = 2; i__ <= 9; ++i__) {
	    suffix_("_#", &c__0, kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ?
		     i__1 : s_rnge("kvname", i__1, "sc01_", (ftnlen)1879)) * 
		    60, (ftnlen)2, (ftnlen)60);
	    i__3 = -(*sc);
	    repmi_(kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ? i__1 : 
		    s_rnge("kvname", i__1, "sc01_", (ftnlen)1880)) * 60, 
		    "#", &i__3, kvname + ((i__2 = i__ - 1) < 9 && 0 <= i__2 ? 
		    i__2 : s_rnge("kvname", i__2, "sc01_", (ftnlen)1880)) * 
		    60, (ftnlen)60, (ftnlen)1, (ftnlen)60);
	}
...
/*     start. */
	...
	d__1 = prend[(i__2 = i__ - 1) < 9999 && 0 <= i__2 ? i__2 : s_rnge(
		"prend", i__2, "sc01_", (ftnlen)1959)] - prstrt[(i__3 = i__ - 
...
/*           last SCLK value in the array is the one we want. */
    ...
    if (*sclkdp < coeffs[(i__1 = ncoeff / 3 * 3 - 3) < 30000 && 0 <= i__1 ? 
	    i__1 : s_rnge("coeffs", i__1, "sc01_", (ftnlen)2003)]) {
	lower = 1;
	upper = ncoeff / 3;
...
/*        rest of the names, we'll have to add the suffix. */
	...
	for (i__ = 2; i__ <= 9; ++i__) {
	    suffix_("_#", &c__0, kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ?
		     i__1 : s_rnge("kvname", i__1, "sc01_", (ftnlen)2428)) * 
		    60, (ftnlen)2, (ftnlen)60);
	    i__3 = -(*sc);
	    repmi_(kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ? i__1 : 
		    s_rnge("kvname", i__1, "sc01_", (ftnlen)2429)) * 60, 
		    "#", &i__3, kvname + ((i__2 = i__ - 1) < 9 && 0 <= i__2 ? 
		    i__2 : s_rnge("kvname", i__2, "sc01_", (ftnlen)2429)) * 
		    60, (ftnlen)60, (ftnlen)1, (ftnlen)60);
	}
...
/*        The coefficient set to use for extrapolation is the first. */
	...
	lower = 1;
	    ...
	    i__1 ? i__1 : s_rnge("coeffs", i__1, "sc01_", (ftnlen)2562)]) {
...
/*        already made sure that the invariant expression above is true. */
	...
	while(lower < upper - 1) {
	    ...
	    if (partim < coeffs[(i__1 = middle * 3 - 2) < 30000 && 0 <= i__1 ?
		     i__1 : s_rnge("coeffs", i__1, "sc01_", (ftnlen)2584)]) {
		upper = middle;
	    } else {
		lower = middle;
	    }
...
/*     ensure this. */
    ...
    timdif = partim - coeffs[(i__1 = lower * 3 - 2) < 30000 && 0 <= i__1 ? 
	    i__1 : s_rnge("coeffs", i__1, "sc01_", (ftnlen)2633)];
    const__ = coeffs[(i__1 = lower * 3 - 3) < 30000 && 0 <= i__1 ? i__1 : 
	    s_rnge("coeffs", i__1, "sc01_", (ftnlen)2634)];
    if (coeffs[(i__1 = lower * 3 - 1) < 30000 && 0 <= i__1 ? i__1 : s_rnge(
	    "coeffs", i__1, "sc01_", (ftnlen)2636)] <= 0.) {
    ...
    for (i__ = nfield; i__ >= 2; --i__) {
	tikmsc *= moduli[(i__1 = i__ - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge(
		"moduli", i__1, "sc01_", (ftnlen)2649)];
    }
    rate = 1. / (coeffs[(i__1 = lower * 3 - 1) < 30000 && 0 <= i__1 ? i__1 : 
	    s_rnge("coeffs", i__1, "sc01_", (ftnlen)2652)] / tikmsc);
...
/*     ticks since spacecraft clock start. */
    ...
    for (i__ = 2; i__ <= i__1; ++i__) {
	d__1 = prend[(i__2 = i__ - 1) < 9999 && 0 <= i__2 ? i__2 : s_rnge(
		"prend", i__2, "sc01_", (ftnlen)2666)] - prstrt[(i__3 = i__ - 
		1) < 9999 && 0 <= i__3 ? i__3 : s_rnge("prstrt", i__3, "sc01_"
		, (ftnlen)2666)] + mxtick;
	mxtick = d_nint(&d__1);
    }
...
/*        rest of the names, we'll have to add the suffix. */
	...
	for (i__ = 2; i__ <= 9; ++i__) {
	    suffix_("_#", &c__0, kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ?
		     i__1 : s_rnge("kvname", i__1, "sc01_", (ftnlen)2962)) * 
		    60, (ftnlen)2, (ftnlen)60);
	    i__3 = -(*sc);
	    repmi_(kvname + ((i__1 = i__ - 1) < 9 && 0 <= i__1 ? i__1 : 
		    s_rnge("kvname", i__1, "sc01_", (ftnlen)2963)) * 60, 
		    "#", &i__3, kvname + ((i__2 = i__ - 1) < 9 && 0 <= i__2 ? 
		    i__2 : s_rnge("kvname", i__2, "sc01_", (ftnlen)2963)) * 
		    60, (ftnlen)60, (ftnlen)1, (ftnlen)60);
	}
...
/*        PARTIM precedes the coverage of the kernel. */
	...
	return 0;
	    ...
	    i__1 ? i__1 : s_rnge("coeffs", i__1, "sc01_", (ftnlen)3095)]) {
...
/*        already made sure that the invariant expression above is true. */
	...
	while(lower < upper - 1) {
	    middle = (lower + upper) / 2;
	    if (partim < coeffs[(i__1 = middle * 3 - 2) < 30000 && 0 <= i__1 ?
		     i__1 : s_rnge("coeffs", i__1, "sc01_", (ftnlen)3117)]) {
		upper = middle;
	    } else {
		lower = middle;
	    }
...
/*     most significant count') to change the rate to seconds per tick. */
    ...
    timdif = partim - coeffs[(i__1 = lower * 3 - 2) < 30000 && 0 <= i__1 ? 
	    i__1 : s_rnge("coeffs", i__1, "sc01_", (ftnlen)3162)];
    const__ = coeffs[(i__1 = lower * 3 - 3) < 30000 && 0 <= i__1 ? i__1 : 
	    s_rnge("coeffs", i__1, "sc01_", (ftnlen)3163)];
    if (coeffs[(i__1 = lower * 3 - 1) < 30000 && 0 <= i__1 ? i__1 : s_rnge(
	    "coeffs", i__1, "sc01_", (ftnlen)3165)] <= 0.) {
	setmsg_("Invalid SCLK rate.", (ftnlen)18);
	sigerr_("SPICE(VALUEOUTOFRANGE)", (ftnlen)22);
	chkout_("SCEC01", (ftnlen)6);
	return 0;
    ...
    for (i__ = nfield; i__ >= 2; --i__) {
	tikmsc *= moduli[(i__1 = i__ - 1) < 10 && 0 <= i__1 ? i__1 : s_rnge(
		"moduli", i__1, "sc01_", (ftnlen)3178)];
    }
    rate = 1. / (coeffs[(i__1 = lower * 3 - 1) < 30000 && 0 <= i__1 ? i__1 : 
	    s_rnge("coeffs", i__1, "sc01_", (ftnlen)3181)] / tikmsc);
...
/*     ticks since spacecraft clock start. */
    ...
    for (i__ = 2; i__ <= i__1; ++i__) {
	d__1 = prend[(i__2 = i__ - 1) < 9999 && 0 <= i__2 ? i__2 : s_rnge(
		"prend", i__2, "sc01_", (ftnlen)3195)] - prstrt[(i__3 = i__ - 
		1) < 9999 && 0 <= i__3 ? i__3 : s_rnge("prstrt", i__3, "sc01_"
		, (ftnlen)3195)] + mxtick;
	mxtick = d_nint(&d__1);
    }
