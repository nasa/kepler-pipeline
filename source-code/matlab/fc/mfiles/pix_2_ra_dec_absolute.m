function [ra dec] = pix_2_ra_dec_absolute(module, output, row, column, mjds, raPointing, decPointing, rollPointing, aberrateFlag)
% [ra dec] = pix_2_ra_dec_absolute(module, output, row, column, mjds, raPointing, decPointing, rollPointing, aberrateFlag)
%
