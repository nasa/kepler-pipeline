function [module output row column] = ra_dec_2_pix(raDec2PixObject, ra, dec, mjds, aberrateFlag)
% [module output row column] = ra_dec_2_pix(raDec2PixObject, ra, dec, mjds, aberrateFlag)
%
...
% The FC pointing model is used to simulate spacecraft pointing.  See ra_dec_2_pix_absolute or ra_dec_2_pix_relative to specify a pointing.
%
% INPUTS:
...
%
    ...
    if nargin < 4 || nargin > 5
        error('MATLAB:FC:raDec2PixClass:ra_dec_2_pix', 'ra_dec_2_pix takes 4 or 5 arguments');
    end

    [module output row column] = ra_dec_2_pix_absolute(raDec2PixObject, ra, dec, mjds, aberrateFlag);
return
