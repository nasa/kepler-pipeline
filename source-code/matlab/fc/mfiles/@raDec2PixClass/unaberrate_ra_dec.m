...
function [aberRa, aberDec] = unaberrate_ra_dec(raDec2PixObject, ra, dec, julianTime)
...
%
    ...
    velocity = get_velocity_vector_mps( raDec2PixObject, julianTime ) ;
    [aberRa, aberDec] = remove_aberration_from_ra_dec( ra, dec, velocity ) ;
