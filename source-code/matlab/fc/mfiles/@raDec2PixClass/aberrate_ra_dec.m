...
function [aberRa, aberDec] = aberrate_ra_dec(raDec2PixObject, ra, dec, julianTime) 
...
%
    ...
    vel = get_velocity_vector_mps(raDec2PixObject, julianTime);    
    
    [aberRa, aberDec] = apply_aberration_to_ra_dec( ra, dec, vel ) ;    
