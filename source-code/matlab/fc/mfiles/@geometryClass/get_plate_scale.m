function plate_scale = get_plate_scale(geometryObject, mjd)
%
%function plate_scale = get_plate_scale(geometryObject, mjd)
%
% Return the plate scale (in arcsec/pixel) for all outputs for the given MJD.
%
%
% 
...
%
    ...
    if any(mjd < min(geometryObject.mjds))
        error('Matlab:FC:geometryClass:get_plate_scale', ...
    ...
    plate_scale = outConstants.array(Geometry.ELEMENT_COUNT_NO_PLATESCALE+1:Geometry.ELEMENT_COUNT_NO_PLATESCALE+1+84-1);
return
