function pincushion = get_pincushion(geometryObject, mjd)
%
%function pincushion = get_pincushion(geometryObject, mjd)
%
% Return the pincushion parameter (in 1/arcsec^2) for all outputs for the given MJD.
%
%
% 
...
%
    ...
    if any(mjd < min(geometryObject.mjds))
        error('Matlab:FC:geometryClass:get_pincushion', ...
    ...
    pincushionIndex = Geometry.ELEMENT_COUNT_NO_PLATESCALE + 84 + [1:84] ;
    pincushion = outConstants.array(pincushionIndex);
return
