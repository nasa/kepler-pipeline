function [transitModel] = convert_trapezoidal_fit_parameters_to_transit_model(dvDataObject, trapezoidalFit, iTarget)
%
...
%
%    2014-August-27, JT:
%        Refactored with call to trapezoidal_fit_parameters_to_transit_model
%    2014-August-04, JL:
%        Initial release
%
%=========================================================================================
...
% Get required information from the DV data object
...
% Convert trapezoidal fit parameters to transit model
[transitModel] = ...
    trapezoidal_fit_parameters_to_transit_model(trapezoidalFit, ...
    targetStruct, cadenceTimes, planetFitConfigurationStruct, ...
