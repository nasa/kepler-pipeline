function [whitenedFluxTimeSeries] = generate_whitened_flux_time_series_struct(whiteningFilterObject, targetFluxTimeSeries)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% This method whitens the flux time series and generates the whitenedFluxTimeSeries struct
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% 
...
waveletObject = set_custom_filter_banks( waveletObject, H, G );
waveletObject = set_custom_whitening_coefficients( waveletObject, whiteningCoefficients);
   
fluxTimeSeriesValues            = targetFluxTimeSeries.values;
whitenedFluxTimeSeriesValues    = apply_whitening_to_time_series( waveletObject, fluxTimeSeriesValues );

whitenedFluxTimeSeries.values        = whitenedFluxTimeSeriesValues;
whitenedFluxTimeSeries.gapIndicators = targetFluxTimeSeries.gapIndicators;
whitenedFluxTimeSeries.filledIndices = targetFluxTimeSeries.filledIndices;
