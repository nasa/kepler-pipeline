...
exposureStartImpactParam(exposureStartTransitSign >= 0) ...
    = magvec(exposureStartImpactParam(exposureStartTransitSign > 0,:))/primaryRadiusMeters;

exposureStartImpactParam(exposureStartTransitSign < 0) ...
    = magvec(exposureStartImpactParam(exposureStartTransitSign < 0,:))/secondaryRadiusMeters;
...
exposureEndImpactParam(exposureEndTransitSign >= 0) ...
    = magvec(exposureEndImpactParam(exposureEndTransitSign >= 0,:))/primaryRadiusMeters;

exposureEndImpactParam(exposureEndTransitSign < 0) ...
    = magvec(exposureEndImpactParam(exposureEndTransitSign < 0,:))/secondaryRadiusMeters;



intermediateStruct.exposureStartPosition          = exposureStartPosition;
intermediateStruct.exposureEndPosition            = exposureEndPosition;
intermediateStruct.rotatedExposureStartPosition   = rotatedExposureStartPosition;
intermediateStruct.rotatedExposureEndPosition     = rotatedExposureEndPosition;
