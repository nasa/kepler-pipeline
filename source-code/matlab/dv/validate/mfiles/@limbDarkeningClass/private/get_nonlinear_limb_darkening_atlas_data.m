function get_nonlinear_limb_darkening_atlas_data()
%
% function to construct and save nonlinear limb darkening coefficients from
% atlas data.
%
...
%
%
% OUTPUT is a matfile atlasNonlinearLimbDarkeningData.mat
%--------------------------------------------------------------------------
% 
