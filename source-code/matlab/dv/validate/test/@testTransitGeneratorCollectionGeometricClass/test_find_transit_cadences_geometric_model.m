function self = test_find_transit_cadences_geometric_model( self )
%
% test_find_transit_cadences_geometric_model -- unit test of find_transit_cadences method of transitGeneratorCollectionClass with geometric transit model
%
% test_find_transit_cadences tests the following functionality of the find_transit_cadences method:
%
% ==> basic functionality -- method executes correctly
% ==> When the epoch of one embedded object is changed, the cadence numbers for that object change but the cadence numbers for other objects do not.
%
% This is a unit test in the mlunit context.  To execute just this unit test, use the following syntax:
%
%   run(text_test_runner, testTransitGeneratorCollectionClass('test_find_transit_cadences_geometric_model'));
%
...
%=========================================================================================
  ...
  disp(' ');
  disp(' ... testing transitGeneratorCollectionClass find transit cadecnes method with geometric transit model ... ') ;
  disp(' ');
...
% get the cadence numbers for the first transit from objects 1 and 2; they should agree
  ...
  assert_equals( cadences1, cadences2, 'Cadences for transit 1, objects 1 and 2, do not agree' );
...
% get the cadences again
  ...
  assert_equals( cadences3-1, cadences4, 'Cadences for transit 1, objects 1 and 2, do not have correct offset' );
  assert_equals( cadences4,   cadences2, 'Cadences for transit 1, object 2, before and after set do not agree' );
