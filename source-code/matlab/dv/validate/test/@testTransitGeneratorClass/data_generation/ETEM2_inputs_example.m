...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% Inputs for Data Validation test data.   The astrophysics ranges are the
% same for all runs, the only difference are the mod/outs:
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%
% MODIFIED FOR SM 8/26/09
%
% mod/outs:
%
% 7/3
%
% 2000 targets
% 4000 cadences (6 weeks)
%
% start time: '24-April-2009 00:00:00.000'
%
%
% target list set name: ort4b_redo_trimmed_lc
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
runParamsData.simulationData.runStartDate               = '24-April-2009 00:00:00.000'; % start date of current run
runParamsData.simulationData.runDuration                = 4000; % length of run in the units defined in the next field
...
runParamsData.simulationData.moduleNumber       = 7; % which CCD module, ouput and season, legal values: 2-4, 6-20, 22-24
...
runParamsData.keplerData.maskedSmearCoAddRows   = 7:19;          % will be overwritten
runParamsData.keplerData.virtualSmearCoAddRows  = 1046:1059;     % will be overwritten
runParamsData.keplerData.blackCoAddCols         = 1116:1132;     % will be overwritten
...
runParamsData.keplerData.readNoise              = 100; % e-/pixel/second,   % will be overwritten

runParamsData.keplerData.numMemoryBits          = 23; % number of bits in accumulation memory
runParamsData.keplerData.electronsPerADU        = 116; % match current value,   % will be overwritten
...
runParamsData.keplerData.requantizationTableId     = 200;    % ID of requantization table,   % will be overwritten
runParamsData.keplerData.requantTableLcFixedOffset = 419400; % needs to match requantization table,   % will be overwritten
runParamsData.keplerData.requantTableScFixedOffset = 219400; % needs to match requantization table,   % will be overwritten
...
tadInputData.targetListSetName          = 'ort4b_redo_trimmed_lc';
tadInputData.refPixTargetListSetName    = 'ort4b_redo_trimmed_rp';
...
%**************************************************************************
% Earth transits - short periods
%**************************************************************************

counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Short Period Transiting Earths';
...
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.radiusUnits = 'earthRadius';
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.orbitalPeriodRange = [4 7]; % days
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.eccentricityRange  = [0 0];



%**************************************************************************
% Earth transits - medium periods
%**************************************************************************

counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Medium Period Transiting Earths';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionType      = 'random';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionNumber    = 20;
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionOn        = 'properties';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionMagnitudeRange = [9 15];
...
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.radiusUnits = 'earthRadius';
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.orbitalPeriodRange = [7 30]; % days
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.eccentricityRange = [0 0];


%**************************************************************************
% Jupiter transits - short periods
%**************************************************************************


counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Short Period Transiting Jupiters';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionType      = 'random';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionNumber    = 20;
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionOn        = 'properties';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionMagnitudeRange = [9 15];
...
%**************************************************************************
% Jupiter transits - medium periods
%**************************************************************************

counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Medium Period Transiting Jupiters';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionType = 'random';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionNumber = 20;
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionOn = 'properties';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionMagnitudeRange = [9 15];
...
%**************************************************************************
% Eclipsing Binaries - short periods
%**************************************************************************

counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Short Period Eclipsing Binary Stars';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionType      = 'random';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionNumber    = 20;
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionOn        = 'properties';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionMagnitudeRange = [9 15];
...
%**************************************************************************
% Eclipsing Binaries - medium periods
%**************************************************************************

counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Medium Period Eclipsing Binary Stars';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionType          = 'random';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionNumber        = 20;
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionOn = 'properties';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionMagnitudeRange = [9 15];
...
%**************************************************************************
% Background Binaries - medium periods
%**************************************************************************
...
ccdData.targetScienceManagerData.backgroundBinarySpecification.magnitudeOffsetRange    = [2 7];

% Note: default plugin values:
...
%**************************************************************************
% Attempt to create multiple body systems!
%**************************************************************************
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Medium Period Transiting Earths on 12th mag stars only (multiple planets?)';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionType      = 'random';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionNumber    = 100;
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionOn        = 'properties';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionMagnitudeRange = [12.01 12.5];
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionEffTempRange   = [5240 6530];
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionlogGRange      = [4 5];
...
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Short Period Transiting Jupiters on 12th mag stars only (multiple planets?)';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionType           = 'random';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionNumber         = 100;
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionOn             = 'properties';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionMagnitudeRange = [12.01 12.5];
...
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Medium Period Eclipsing Binaries on 12th mag stars only (multiple planets?)';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionType          = 'random';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionNumber        = 100;
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionOn = 'properties';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionMagnitudeRange = [12.01 12.5];
