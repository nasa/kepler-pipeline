function test_new_tgmodel_and_old_ldmodel(inputsStruct)
%
...
% Run in profiler
%transitModelObject = transitGeneratorClass(transitModelStruct);transitModelLightCurve = generate_planet_model_light_curve(transitModelObject);

%--------------------------------------------------------------------------
% test new transit model, new limb darkening model
%--------------------------------------------------------------------------
for iTarget = 1: length([inputsStruct.targetStruct])
