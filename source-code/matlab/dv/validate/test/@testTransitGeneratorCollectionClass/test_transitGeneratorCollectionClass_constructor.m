function self = test_transitGeneratorCollectionClass_constructor( self )
%
% test_transitGeneratorCollectionClass_constructor -- unit test for the constructor of the
% transitGeneratorCollectionClass
%
% test_transitGeneratorCollectionClass_constructor tests the following features of the
% constructor for the transitGeneratorCollectionClass:
%
...
% following syntax:
%
%   run(text_test_runner, testTransitGeneratorCollectionClass('test_transitGeneratorCollectionClass_constructor'));
%
...
%=========================================================================================
  ...
  disp(' ... testing transitGeneratorCollectionClass constructor ... ') ;
...
% Test 1:  oddEvenFlag == 0
  ...
  assert_equals( transitStructFields, { 'transitGeneratorObjectVector' ; ...
      'oddEvenFlag' }, ...
      'transitGeneratorCollectionClass has wrong field names for oddEvenFlag == 0' ) ;
  assert_equals( transitStruct.oddEvenFlag, 0, ...
      'transitGeneratorCollectionClass has wrong oddEvenFlag value for oddEvenFlag == 0' ) ;
  assert_equals( struct(transitObject0), ...
      struct(transitStruct.transitGeneratorObjectVector), ...
...
% test 2:  oddEvenFlag == 1
  ...
  assert_equals( transitStructFields, { 'transitGeneratorObjectVector' ; ...
      'oddEvenFlag' }, ...
      'transitGeneratorCollectionClass has wrong field names for oddEvenFlag == 1' ) ;
  assert_equals( transitStruct.oddEvenFlag, 1, ...
      'transitGeneratorCollectionClass has wrong oddEvenFlag value for oddEvenFlag == 1' ) ;
  assert_equals( size( transitStruct.transitGeneratorObjectVector ), [2 1], ...
      'transitGeneratorCollectionClass has wrong size transitGeneratorObjectVector for oddEvenFlag == 1' ) ;
  for iObject = 1:2
    assert_equals( struct(transitObject0), ...
      struct(transitStruct.transitGeneratorObjectVector(iObject)), ...
...
% test 3:  oddEvenFlag == 2
  ...
  assert_equals( transitStructFields, { 'transitGeneratorObjectVector' ; ...
      'oddEvenFlag' }, ...
      'transitGeneratorCollectionClass has wrong field names for oddEvenFlag == 2' ) ;
  assert_equals( transitStruct.oddEvenFlag, 2, ...
      'transitGeneratorCollectionClass has wrong oddEvenFlag value for oddEvenFlag == 2' ) ;
  cadenceTimes = get( transitObject0, 'cadenceTimes' ) ;
  [nTransits, nValidTransits] = get_number_of_transits_in_time_series( ...
      transitObject0, cadenceTimes, false(size(cadenceTimes)), [] ) ;
  assert_equals( nTransits, nValidTransits, ...
      'nTransits and nValidTransits not equal when they should be' ) ;
...
% test 3:  oddEvenFlag == 2, but 1 transit is fully gapped
  ...
  [nTransits, nValidTransits] = get_number_of_transits_in_time_series( ...
      transitObject0, cadenceTimes, gapIndicators, [] ) ;
  assert_not_equals( nTransits, nValidTransits, ...
      'nTransits and nValidTransits equal when they should not be' ) ;
...
% test 4:  oddEvenFlag == 2, but transit is fully filled
  ...
  [nTransits, nValidTransits] = get_number_of_transits_in_time_series( ...
      transitObject0, cadenceTimes, gapIndicators, transit5 ) ;
  assert_not_equals( nTransits, nValidTransits, ...
      'nTransits and nValidTransits equal when they should not be' ) ;
...
% test 5:  error cases
  ...
  try_to_catch_error_condition( ...
      'transitObject = transitGeneratorCollectionClass( transitModel, 3 ) ;', ...
      'oddEvenFlagInvalid', 'caller' ) ;
  try_to_catch_error_condition( ...
      'transitObject = transitGeneratorCollectionClass( transitModel, [0 1] ) ;', ...
      'oddEvenFlagInvalid', 'caller' ) ;
...
% test 6:  warning cases
  ...
  transitObject = transitGeneratorCollectionClass( transitModel, 2, gapIndicators ) ;
  [w1,w2] = lastwarn ;
  mlunit_assert( ~isempty( strfind( w2, 'filledIndicesNotPresent' ) ), ...
      'filledIndicesNotPresent warning not issued' ) ;
  
  transitObject = transitGeneratorCollectionClass( transitModel, 2, [], [] ) ;
  [w1,w2] = lastwarn ;
  mlunit_assert( ~isempty( strfind( w2, 'gapIndicatorsNotPresent' ) ), ...
      'gapIndicatorsNotPresent warning not issued' ) ;
