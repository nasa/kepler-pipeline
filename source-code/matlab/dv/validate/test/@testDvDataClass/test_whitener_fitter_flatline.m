function self = test_whitener_fitter_flatline( self )
%
% test_whitener_fitter_fit_flatline -- test
...
%
%      run(text_test_runner, testDvDataClass('test_whitener_fitter_flatline'));
%
...
%=========================================================================================
  ...
  disp('... testing iterative whitener-fitter method, flatline initial transit model ... ')
...
% tune the TCE to have no transits in the time range

  endTime = max( dvDataStruct.dvCadenceTimes.midTimestamps ) ;
  timeRange = range( dvDataStruct.dvCadenceTimes.midTimestamps ) ;
  tceForWhitenerTest.epochMjd = endTime + timeRange / 2 ;
...
% attempt a fit, and see that it does fail as desired
  ...
  try_to_catch_error_condition( ...
      ...
      'dvResultsStruct, tceForWhitenerTest, 1, 1, 0, inf )'], ...
