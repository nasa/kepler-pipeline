function self = test_whitener_fitter_time_limit_geometric_model( self )
%
% test_whitener_fitter_fit_time_limit_geometric_model -- test perform_iterative_whitening_and_model_fitting method of dvDataClass for cases in which
...
%
%      run(text_test_runner, testDvDataGeometricClass('test_whitener_fitter_time_limit_geometric_model'));
%
...
%=========================================================================================
  ...
  disp(' ');
  disp('... testing iterative whitener-fitter method with geometric transit model, time limit reached ... ');
  disp(' ');
...
% do one in which the timeout time is yesterday, and see that it does fail as desired
  ...
  try_to_catch_error_condition( ...
      '[dvResultsStruct, converged, secondaryConverged, alertMessageStruct] = perform_iterative_whitening_and_model_fitting( dvDataObject, dvResultsStructBeforeFit, dvDataStruct.targetStruct.thresholdCrossingEvent, 1, 1, 0, datenum(now)-1 );', ...
