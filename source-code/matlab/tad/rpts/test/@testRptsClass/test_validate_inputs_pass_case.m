...
% test_validate_inputs_pass_case
%
...
%         Example: run(text_test_runner, testRptsClass('test_validate_inputs_pass_case'));
...
% create the class and ensure that no errors are generated
