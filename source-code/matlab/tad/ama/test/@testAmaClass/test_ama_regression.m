function self = test_ama_regression(self)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% function self = ama_regression_test(self)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%
...
testAmaResultStruct = ama_matlab_controller(amaParameterStruct);

% remove the duration list structure
testAmaResultStruct = rmfield(testAmaResultStruct, 'durationList');
...
% interested in
assert_equals(testAmaResultStruct, ...
    standardAmaResultStruct, ...
    'aperture mask assignment: regression result contents not equal');
