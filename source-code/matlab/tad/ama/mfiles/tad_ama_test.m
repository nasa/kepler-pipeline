...
%
load tadTestInputs.mat
amaParameterStruct.amaConfigurationStruct = [];
amaParameterStruct.amaConfigurationStruct.defaultStellarLabels = amaParameterStruct.defaultStellarLabels;
amaParameterStruct.amaConfigurationStruct.defaultCustomLabels = amaParameterStruct.defaultCustomLabels;
