function amaResultStruct = ama_matlab_controller(amaParameterStruct)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% function amaResultStruct = ama_matlab_controller(amaParameterStruct)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% 
% master control function for the assignment of apretures to masks.
% Assumes 0-base indexing on inputs
% Input:
...
amaParameterStruct = convert_ama_inputs_to_1_base(amaParameterStruct);

% call the 1-base indexing version
amaResultStruct = ama_matlab_controller_1_base(amaParameterStruct);

% convert the required outputs to 0-base
amaResultStruct = convert_ama_outputs_to_0_base(amaResultStruct);
