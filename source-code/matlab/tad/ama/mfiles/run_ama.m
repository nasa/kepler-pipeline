function amaResultStruct = run_ama(optimalApertureStruct, maskDefinitions)
% function amaResultStruct = run_ama(optimalApertureStruct, maskDefinitions)
% build_ama_inputs_from_coa_outputs;
% 
% inputs and  are 0-based!
%
% 
...
amaParameterStruct.apertureStructs = optimalApertureStruct;
amaParameterStruct.apertureStructs = rmfield(amaParameterStruct.apertureStructs, ...
    {'signalToNoiseRatio', 'crowdingMetric', 'fluxFractionInAperture', 'isUserDefined', 'rejected', 'labels', 'snr'});
if isfield(amaParameterStruct.apertureStructs, 'distanceFromEdge') 
	amaParameterStruct.apertureStructs = rmfield(amaParameterStruct.apertureStructs, ...
    	'distanceFromEdge');
end
