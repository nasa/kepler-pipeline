...
% coaConfigurationStruct.saturationSpillBufferSize = 1;
% 
...
clear classes
load tadTestInputs2
clear amtParameterStruct maskTableParametersStruct amaParameterStruct amtResultStruct coaResultStruct
%%
...
largeMaskNum = 1;
amtResultStruct.maskDefinitions(largeMaskStart + largeMaskNum) ...
    = image_to_target_definition(ones(100, 5), [50, 2]);
...
largeMaskNum = largeMaskNum + 1;
amtResultStruct.maskDefinitions(largeMaskStart + largeMaskNum) ...
    = image_to_target_definition(ones(20, 5), [10, 2]);
largeMaskNum = largeMaskNum + 1;
amtResultStruct.maskDefinitions(largeMaskStart + largeMaskNum) ...
