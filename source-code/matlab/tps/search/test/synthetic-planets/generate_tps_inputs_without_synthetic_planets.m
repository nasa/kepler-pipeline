function generate_tps_inputs_without_synthetic_planets( tpsDawgStruct, keplerIdList, ...
    nBatchJobs, archString, tpsInputStructTemplate, restartTask, restartSubTask )
% 
