function plot_tps_flux_for_new_tce_on_kois( koiStruct, tceStruct, iTarget )
%
% plot_tps_flux_for_new_tce_on_kois( koiStruct, tceStruct, iTarget ) -- plot 
...
%    first 3 plots, superimpose the expected transit locations and depths from the TCE
%    data; on the fourth, fold at the TCE period and center on the TCE epoch.
%
% 
...
%=========================================================================================
  ...
  periodDays = koiStruct.tcePeriodDays( iTarget ) ;
  epochKjd   = koiStruct.tceEpochKjd( iTarget ) ;
  mes        = koiStruct.mes( iTarget ) ;
...
% plot the single event statistics
  ...
  xlabel('Cadence Time [JD - 2454900]') ;
  title([' MES=',num2str(mes), ', Period=',num2str(periodDays),' days']) ;
