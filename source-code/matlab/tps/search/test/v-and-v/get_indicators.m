...
%
% get_indicators -- construct vectors of normal, gap, and fill indicators
%
% [gapIndicators, fillIndicators, normalIndicators] = get_indicators( taskfile )
%    constructs three nCadences x 1 logical vectors which show, for each cadence, whether
%    it is gapped, filled or "normal" (essentially, neither gapped nor filled).
%
% 
