function [periodBinCenters, analyticWindowFunction] = get_analytic_window_function(minPeriodDays,maxPeriodDays,deltaPeriodDays,groupLabel,targetId,dutyCycle)
% compute analytic window function according to Chris Burke's prescription
% 
...
% Data directory, for stellar parameters file
...
% Period bins
% nBins = 70;
periodBinWidth = deltaPeriodDays; %(maxPeriodDays - minPeriodDays)/nBins(1); % 10 days
periodBinEdges = (minPeriodDays:periodBinWidth:maxPeriodDays)';

% Bin centers from periodBinEdges
periodBinCenters = (periodBinEdges(2:end) + periodBinEdges(1:end-1))./2;

% Get duty cycle
% dutyCycle = input('Duty cycle -- nominal is 0.78: ');

% Get data span from stellar parameters file
...
% 1/26/2016: I don't understand this comment:
...
% Return analytic window function
analyticWindowFunction = WF';
