...
%
    ...
    inputsStruct.raDec2PixModel.spiceFileDir='/path/to/matlab/tps/cdpp-short-cadence';

    nTargets = length(inputsStruct.targetDataStruct);

    for jTarget = 1:nTargets,
        inputsStruct.targetDataStruct(jTarget).gapIndicators(4063:4077) = true; % momemtum desat cadences 1 minute long, 1 cadence padding on either side
        inputsStruct.targetDataStruct(jTarget).gapIndicators(8413:8427) = true; % momemtum desat cadences 1 minute long
        inputsStruct.targetDataStruct(jTarget).gapIndicators(11470:11484) = true; % momemtum desat cadences 1 minute long
        inputsStruct.targetDataStruct(jTarget).gapIndicators(12102:112158) = true; % momemtum desat cadences 1 minute long
    end

    inputsStruct.ancillaryTargetConfigurationStruct.gridSize = 3;
    inputsStruct.ancillaryTargetConfigurationStruct.modelOrder = 3;
    inputsStruct.ancillaryTargetConfigurationStruct.interactionEnabled = true;
