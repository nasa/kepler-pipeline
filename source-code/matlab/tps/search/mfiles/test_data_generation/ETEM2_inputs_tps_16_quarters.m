function gloabalConfigurationStruct = ETEM2_inputs_tps_16_quarters()
...
runParamsData.simulationData.runStartDate = '2-Mar-2009'; % start date of current run
runParamsData.simulationData.runDuration = 365*4; % length of run in the units defined in the next field
...
runParamsData.keplerData.makeClean = 1; % if true use average bias, for producing clean image
...
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionMagnitudeRange = [10 13];
...
ccdData.targetScienceManagerData.backgroundBinarySpecification.selectionMagnitudeRange = [10 13];
