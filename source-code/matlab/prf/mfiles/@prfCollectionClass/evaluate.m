function [pixelArray, rowArray, columnArray] = evaluate( prfCollectionObject, row, ...
    column, rowsEvaluate, columnsEvaluate, polyBasis )
%
...
if nargin < 6
  ...
  if ( ~prfCollectionObject.interpolateFlag )
          [pixelArray, rowArray, columnArray] = evaluate( ...
              prfCollectionObject.prfCenterObject, row, column, rowsEvaluate, ...
              columnsEvaluate, polyBasis ) ;
  else
...
%     evaluate the PRFs which correspond to the triangle in question
      ...
      [prfCorner1,r1,c1] = evaluate( prfCollectionObject.prfCornerObject(triangleNumber), ...
          row, column, rowsEvaluate, columnsEvaluate, polyBasis ) ;
      [prfCorner2,r2,c2] = evaluate( prfCollectionObject.prfCornerObject(triangleNumber+1), ...
          row, column, rowsEvaluate, columnsEvaluate, polyBasis ) ;
      [prfCenter,rc,cc] = evaluate( prfCollectionObject.prfCenterObject, row, column, ...
           rowsEvaluate, columnsEvaluate, polyBasis ) ;
