function [prfValue, prfRow, prfColumn] = make_array( prfCollectionObject, row, column, ...
...
% if there is only 1 prfClass object, use its make_array method
  ...
  if ( ~prfCollectionObject.interpolateFlag )
      ...
      switch nargin
          ...
          case {1,2,3}
              [prfValue,prfRow,prfColumn] = make_array( ...
                  prfCollectionObject.prfCenterObject ) ;
          case 4 % optional resolution argument
              [prfValue,prfRow,prfColumn] = make_array( ...
                  prfCollectionObject.prfCenterObject, resolution ) ;
          case 5 % optional reverse argument
              [prfValue,prfRow,prfColumn] = make_array( ...
                  prfCollectionObject.prfCenterObject, resolution, reverse ) ;
          case 6 % optional offset argument
              [prfValue,prfRow,prfColumn] = make_array( ...
                  prfCollectionObject.prfCenterObject, resolution, reverse, offset ) ;
          otherwise
              error('prf:prfCollectionClass:make_array:invalidArgs', ...
                'prfCollectionClass:make_array:  invalid arguments') ;
...
%     get the arrays of the individual PRFs and interpolate them
      ...
      [prfArray1,prfRow,prfColumn] = make_array( ...
          prfCollectionObject.prfCornerObject(triangleNumber), resolution, reverse, offset ) ;
      [prfArray2,prfRow,prfColumn] = make_array( ...
          prfCollectionObject.prfCornerObject(triangleNumber+1), resolution, reverse, offset ) ;
      [prfArrayC,prfRow,prfColumn] = make_array( ...
          prfCollectionObject.prfCenterObject, resolution, reverse, offset ) ;
