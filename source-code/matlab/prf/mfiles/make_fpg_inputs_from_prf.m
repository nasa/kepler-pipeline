function fpgInputStruct = make_fpg_inputs_from_prf(prfOutputs, fpgOutput, exampleFpgInputs, iteration)
...
fpgInputStruct.geometryBlobFileName = fpgOutput.geometryBlobFileName;
