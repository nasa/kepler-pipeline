function [prfArray, prfRow, prfColumn] = draw(prfObject, type, resolution, reverse, offset)
%
...
[prfArray, prfRow, prfColumn] = make_array(prfObject, resolution, reverse, offset);
figure;
