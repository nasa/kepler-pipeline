function create_cutoff_value_file(iteration, taskMap, location)
% function create_cutoff_value_file(iteration, taskMap, location)
% 
...
for c=1:84
    ...
    for i=1:5
        eval(['cutoffValues(c, i) = inputStruct(i).prfConfigurationStruct.contourCutoffPrf' ...
            num2str(i) '(' num2str(c) ');']);
    end
end

save cutoffValues.mat cutoffValues
