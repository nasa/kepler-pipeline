...
%      run(text_test_runner, testPdcClass('test_validate_inputs_pass_case'));
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% 
...
% --->> NOT provided   <<----
% (1) Create the input structure pdcDataStruct
% [pdcDataStruct] = generate_pdc_test_data;

% (2) Load a previously generated test data structure pdcDataStruct
load(fullfile(pdcTestDataDir, 'pdc-inputs-0.mat'));

% (3) Read a test data structure pdcDataStruct from a previously
%     generated bin file
...
pdcDataObject = pdcDataClass(pdcInputDataStruct); %#ok<NASGU>
