function verify_sc_126pdc7(flightDataDirString)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% function verify_sc_126pdc7
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%
% SOC126 (SC)
...
%
% 126.PDC.7
%    PDC shall be capable of using module parameters for a list of ancillary 
...
fields = fieldnames(inputsStruct.ancillaryEngineeringConfigurationStruct);

display('Fieldnames in inputsStruct.ancillaryEngineeringConfigurationStruct are: ')
display(' ')
fields
...
load pdc_cads.mat
display('Fieldnames in conditionedAncillaryDataStruct are: ')
display(' ')
conditionedAncillaryDataStruct
display(' ')
display(' ')
display('Fields in conditionedAncillaryDataStruct(1) are: ')
display(' ')
conditionedAncillaryDataStruct(1)
display(' ')
display('Fields in conditionedAncillaryDataStruct(2) are: ')
display(' ')
conditionedAncillaryDataStruct(2)
display(' ')
