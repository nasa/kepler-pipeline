function [pdcPerformanceAnalysisStruct] = analyze_pdc_performance_by_mod_out()
%
...
pdcPerformanceAnalysisStruct.ccdModule = ccdModule;
pdcPerformanceAnalysisStruct.ccdOutput = ccdOutput;
pdcPerformanceAnalysisStruct.modOutIndex = modOutIndex;
pdcPerformanceAnalysisStruct.keplerMags = keplerMags;
pdcPerformanceAnalysisStruct.isValidTarget = isValidTarget;
pdcPerformanceAnalysisStruct.rawFluxRmsUncertainties = rawFluxRmsUncertainties;
pdcPerformanceAnalysisStruct.correctedFluxSigma = correctedFluxSigma;
pdcPerformanceAnalysisStruct.fluxRatio = fluxRatio;
