%% pdc_convert_62_data_to_70
%
% function [pdcInputStruct] = pdc_convert_62_data_to_70(pdcInputStruct)
%
% Update 6.2-era PDC input structures to 7.0. This is useful when testing
...
if ~isfield(pdcInputStruct.harmonicsIdentificationConfigurationStruct, 'medianWindowLengthForTimeSeriesSmoothing')
...
if ~isfield(pdcInputStruct.gapFillConfigurationStruct, 'giantTransitPolyFitChunkLengthInHours')
    pdcInputStruct.gapFillConfigurationStruct.giantTransitPolyFitChunkLengthInHours = 72;
end % if

if ~isfield(pdcInputStruct.gapFillConfigurationStruct, 'removeShortPeriodEclipsingBinaries')
    pdcInputStruct.gapFillConfigurationStruct.removeShortPeriodEclipsingBinaries = false;
end % if
