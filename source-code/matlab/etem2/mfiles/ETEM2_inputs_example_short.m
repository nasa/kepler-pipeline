...
runParamsData.simulationData.moduleNumber = 16; % which CCD module, ouput and season, legal values: 2-4, 6-20, 22-24
...
tadInputData.targetSelectorData.magnitudeRange = [12 13];
...
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionOn = 'magnitude';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionRange = [12 13];
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData ...
...
ccdData.targetScienceManagerData.backgroundBinarySpecification.selectionNumber = 2;
ccdData.targetScienceManagerData.backgroundBinarySpecification.selectionOn = 'magnitude';
ccdData.targetScienceManagerData.backgroundBinarySpecification.selectionRange = [12 13];
