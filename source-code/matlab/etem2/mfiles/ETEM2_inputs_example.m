...
% ETEM requires this optional argument '1' to
...
runParamsData.keplerData.requantizationTableId = 200; % ID of requantization table
...
% use the following line instead of the previous line to create PSFs from 
% PRFs in the database
