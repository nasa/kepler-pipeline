function gloabalConfigurationStruct = ETEM2_dark_inputs_example()
...
runParamsData.simulationData.runStartDate = '30-Mar-2012 17:29:36.8448'; % start date of current run
...
runParamsData.simulationData.moduleNumber = 4; % which CCD module, ouput and season, legal values: 2-4, 6-20, 22-24
...
runParamsData.keplerData.exposuresPerShortCadence = 1; % # of exposures in a short cadence, 9 for a ~1-minute cadence
runParamsData.keplerData.shortsPerLongCadence = 1; % # of short cadences in a long cadence

runParamsData.simulationData.cleanOutput = 1; % 1 to remove restart files
