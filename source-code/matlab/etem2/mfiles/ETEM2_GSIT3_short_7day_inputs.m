...
runParamsData.simulationData.runStartDate = '16-June-2010 3:14:31.4880'; % start date of current run
runParamsData.simulationData.runDuration = 30*361; % length of run in the units defined in the next field
...
runParamsData.keplerData.refPixCadenceInterval = 1e8; % how often to save reference pixels (in cadences)
...
tadInputData.targetSelectorData.magnitudeRange = [11 14];
