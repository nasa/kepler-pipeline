function dynamicNoiseObject = dynamicBartNoiseClass(dynamicNoiseData, runParamsObject, electronsToAduObject)
%
...
dynamicNoiseData.simTime = 0; 

dynamicNoiseData.centerTime = 0;

temperatureFunctionData = dynamicNoiseData.temperatureFunctionData;
dynamicNoiseData.centerTemperature = temperatureFunctionData.referenceTemperature ;
temperatureFunctionData = rmfield(temperatureFunctionData,'referenceTemperature') ;
...
dynamicNoiseObject = class(dynamicNoiseData, 'dynamicBartNoiseClass', runParamsObject);
