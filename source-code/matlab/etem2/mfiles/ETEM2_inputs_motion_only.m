...
runParamsData.etemInformation.etem2OutputLocation = [runParamsData.etemInformation.etem2Location filesep 'output_motion_only']; 
...
tadInputData.targetSelectorData.magnitudeRange = [13 17];
