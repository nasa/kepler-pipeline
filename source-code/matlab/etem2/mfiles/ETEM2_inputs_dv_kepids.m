...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% (9) Eclipsing Binaries: Short periods (4-7 days), Range of impact
% parameters (b = 0-0.7), eccentricity randomly drawn from Duquennoy & Mayor
% (1991) distribution of binary eccentricities
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
...
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.eccentricityRange           = [];   % default = [-1 -1] %%% ADDED 7/20/2010
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.orbitalPeriodRange          = [4 7];   % default = [10 20]
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.orbitalPeriodUnits          = 'day';   % default = 'day'
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.minimumImpactParameterRange = [0 0.7]; % default = [0 0.7]
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% (10) Eclipsing Binaries: Medium periods (7-30 days), Range of impact
% parameters (b = 0-0.7), eccentricity randomly drawn from Duquennoy & Mayor
% (1991) distribution of binary eccentricities
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
counter = counter + 1;
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% (11) Eclipsing Binaries: Short periods (4-7 days), Range of impact         %%% ADDED 7/20/2010
% parameters (b = 0-0.7), eccentricity = 0
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% (12) Eclipsing Binaries: Medium periods (7-30 days), Range of impact       %%% ADDED 7/20/2010
% parameters (b = 0-0.7), eccentricity = 0
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% (13) Background Binaries: Medium periods (10-20 days)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% set host star parameters
...
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Multiple Planet System #4, Mod/Out = 2/1, KepId = 2572932, Jupiter (Rp=1, P=20 days, b=0, e=0)';
...
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Multiple Planet System #4, Mod/Out = 2/1, KepId = 2572932, Earth (Rp=1.5, P=5 days, b=0, e=0)';
...
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Multiple Planet System #5, Mod/Out = 2/1, KepId = 3228825, Jupiter (Rp=1, P=5 days, b=0, e=0)';
...
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Multiple Planet System #5, Mod/Out = 2/1, KepId = 3228825, Earth (Rp=2.5, P=10 days, b=0, e=0)';
...
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Multiple Planet System #6, Mod/Out = 2/1, KepId = 3335816, Jupiter (Rp=1.3, P=15 days, b=0, e=0)';
...
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Multiple Planet System #6, Mod/Out = 2/1, KepId = 3335816, Earth (Rp=1.4, P=5 days, b=0, e=0)';
...
% set planetary companion parameters (some overwrite defaults in defined_plugins)
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.radiusRange                 = [1.4 1.4];         % default = [0.5 3]
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.radiusUnits                 = 'earthRadius'; % default = 'earthRadius'
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.eccentricityRange           = [0 0];   % default = [0 0.8]
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.orbitalPeriodRange          = [5 5];   % default = [10 20]
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.orbitalPeriodUnits          = 'day';   % default = 'day'
...
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Multiple Planet System #6, Mod/Out = 2/1, KepId = 3335816, Earth (Rp=2, P=10 days, b=0, e=0)';
...
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Multiple Planet System #7, Mod/Out = 12/2, KepId = 7023269, Jupiter (Rp=1.5, P=18 days, b=0, e=0)';
...
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Multiple Planet System #7, Mod/Out = 12/2, KepId = 7023269, Earth (Rp=1.8, P=10 days, b=0, e=0)';
...
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Multiple Planet System #7, Mod/Out = 12/2, KepId = 7023269, Earth (Rp=2.3, P=5 days, b=0, e=0)';
...
% set planetary companion parameters (some overwrite defaults in defined_plugins)
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.radiusRange                 = [2.3 2.3];         % default = [0.5 3]
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.radiusUnits                 = 'earthRadius'; % default = 'earthRadius'
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.eccentricityRange           = [0 0];   % default = [0 0.8]
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.orbitalPeriodRange          = [5 5];   % default = [10 20]
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.orbitalPeriodUnits          = 'day';   % default = 'day'
...
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Multiple Planet System #8, Mod/Out = 12/2, KepId = 7107547, Jupiter (Rp=1.2, P=5 days, b=0, e=0)';
...
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Multiple Planet System #8, Mod/Out = 12/2, KepId = 7107547, Earth (Rp=1.8, P=12 days, b=0, e=0)';
...
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Multiple Planet System #9, Mod/Out = 12/2, KepId = 7435515, Jupiter (Rp=1, P=20 days, b=0, e=0)';
...
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Multiple Planet System #9, Mod/Out = 12/2, KepId = 7435515, Earth (Rp=1.8, P=10 days, b=0, e=0)';
