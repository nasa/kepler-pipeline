...
stellarPropertiesStruct = struct('effectiveTemperature', 5850, ...
    'logSurfaceGravity', 4.4, 'effectiveTemperatureUncertainty', 250);

stellarPropertiesStruct = get_stellar_properties(...
    simpleStellarPropertiesObject, stellarPropertiesStruct);
disp(stellarPropertiesStruct);
