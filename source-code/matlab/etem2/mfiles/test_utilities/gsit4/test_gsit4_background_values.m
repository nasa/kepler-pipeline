function result = test_gsit4_background_values(ffiLocation, targetDefsLocator, fitsLocation)
...
%         display(['checking module = ' num2str(module), ' output = ' num2str(output)]);
        mDefs = targetStruct.backgroundMaskDefinitions;
        tDefs = targetStruct.backgroundTargetDefinitions;
