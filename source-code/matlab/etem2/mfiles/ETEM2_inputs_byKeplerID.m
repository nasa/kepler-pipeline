...
runParamsData.keplerData.requantizationTableId = 170; % ID of requantization table
...
tadInputData.targetListSetName = 'quarter1_spring2009_lc_v2';
tadInputData.refPixTargetListSetName = 'quarter1_spring2009_rp_v2';
...
ccdPlaneData(ccdPlaneCount).psfObjectData.psfFileLocation = '/path/to/psf_data_5_6_09/oriented_psf';
ccdPlaneData(ccdPlaneCount).psfObjectData.psfFilename = 'kplr2009042300-114_psf.mat';
...
ccdData.targetScienceManagerData.targetSpecifiction(counter).keplerId = 6694396;
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData ...
	= pluginList.transitingPlanetData;
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.radiusUnits = 'jupiterRadius';
counter = counter + 1;
...
counter = 1;
ccdData.targetScienceManagerData.backgroundBinarySpecification(counter).selectionType = 'random';
ccdData.targetScienceManagerData.backgroundBinarySpecification(counter).selectionNumber = 2;
ccdData.targetScienceManagerData.backgroundBinarySpecification(counter).selectionOn = 'properties';
ccdData.targetScienceManagerData.backgroundBinarySpecification(counter).selectionMagnitudeRange = [12 13];
ccdData.targetScienceManagerData.backgroundBinarySpecification(counter).selectionEffTempRange = [5240 6530];
ccdData.targetScienceManagerData.backgroundBinarySpecification(counter).selectionlogGRange = [4 5];
