%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function h0 = daubh0(n)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Function Name:  daubh0.m
% Software level: Heritage Code
%
% Description: This function returns the Daubechies scaling filter (low
% pass) coefficients for filter length = n. N can only be 4, 12, 20
% The coefficients are not calculated but looked up and returned.
%
% Input:
%        n - scaling filter length
%
% Output:
%       h0 - scaling filter coefficients, a vector of length n
%
% Author: J.Jenkins
%
% H.Chandrasekaran -  added comments as part of CVS Matlab
