function gloabalConfigurationStruct = ETEM2_inputs_example(nonLinear)
...
runParamsData.simulationData.runStartDate = '1-April-2009 12:00:00.000'; % start date of current run
runParamsData.simulationData.runDuration = 5; % length of run in the units defined in the next field
...
if nonLinear
	runParamsData.etemInformation.etem2OutputLocation = [runParamsData.etemInformation.etem2Location filesep ...
			'output/nonlinearstudy/nonlinear']; 
else
	runParamsData.etemInformation.etem2OutputLocation = [runParamsData.etemInformation.etem2Location filesep ...
			'output/nonlinearstudy/linear']; 
end
...
runParamsData.keplerData.supressQuantizationNoise = 1; % if true don't add quantization noise, for producing clean image
runParamsData.keplerData.useMeanBias = 1; % if true use average bias, for producing clean image
...
runParamsData.keplerData.requantizationTableId = 175; % ID of requantization table
runParamsData.keplerData.requantTableLcFixedOffset = 419405; % needs to match requantization table
runParamsData.keplerData.requantTableScFixedOffset = 419405; % needs to match requantization table
...
tadInputData.targetListSetName = 'q1-lc';
tadInputData.refPixTargetListSetName = 'q1-rp';
