function nTargets = get_num_targets(location, type)
% function nTargets = get_num_targets(location, runstr)
%
% the optional type argument may have the values 'targets' or 'target' or 'background' or 'reference'
%
% returns the # of targets for the specified etem2 run
%
