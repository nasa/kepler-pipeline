function gloabalConfigurationStruct = ETEM2_cbd_inputs_example( )
...
runParamsData.simulationData.moduleNumber = 2; %16; % which CCD module, ouput and season, legal values: 2-4, 6-20, 22-24
...
runParamsData.keplerData.requantizationTableId = 2; % ID of requantization table
...
ccdDarkData.numDarkCadences = 24;
...
ccdDarkData.blackLevelData = pluginList.twoDBlackTestData;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
