...
runParamsData.simulationData.runStartDate = '18-March-2009 12:00:00.000'; % start date of current run
runParamsData.simulationData.runDuration = 90; % length of run in the units defined in the next field
...
runParamsData.simulationData.moduleNumber = 23; % which CCD module, ouput and season, legal values: 2-4, 6-20, 22-24
...
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionNumber = 4;
...
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.orbitalPeriodRange = [5 7]; % days
cccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.eccentricityRange = [0 0.02]; 
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Transiting Jupiters';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionType = 'random';
...
ccdData.targetScienceManagerData.targetSpecifiction(counter).lightCurveData.eccentricityRange = [0 0.02]; 
counter = counter + 1;
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Eclipsing Binary Stars';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionType = 'random';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionNumber = 30;
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionOn = 'properties';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionMagnitudeRange = [9 15];
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionEffTempRange = [5240 6530];
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionlogGRange = [4 5];
...
ccdData.targetScienceManagerData.targetSpecifiction(counter).description = ...
    'Eclipsing Binary Stars';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionType = 'random';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionNumber = 2;
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionOn = 'properties';
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionMagnitudeRange = [9 15];
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionEffTempRange = [5240 6530];
ccdData.targetScienceManagerData.targetSpecifiction(counter).selectionlogGRange = [4 5];
