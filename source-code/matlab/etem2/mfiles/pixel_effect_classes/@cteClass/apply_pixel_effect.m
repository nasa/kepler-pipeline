function outImage = apply_pixel_effect(cteObject, inImage)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function outImage = add_cte(cteObject, inImage)
%
...
parallelCTE = cteObject.parallelCTE;
serialCTE = cteObject.serialCTE;
