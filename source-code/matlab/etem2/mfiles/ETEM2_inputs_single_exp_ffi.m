function gloabalConfigurationStruct = ETEM2_inputs_single_exp_ffi()
...
runParamsData.simulationData.runStartDate = '2-May-2012 16:26:39.42680'; % start date of current run
...
runParamsData.simulationData.firstRollDate = '24-June-2010 17:29:36.8448'; % Date of a roll near launch.

runParamsData.simulationData.moduleNumber = 13; % which CCD module, ouput and season, legal values: 2-4, 6-20, 22-24
...
runParamsData.etemInformation.etem2OutputLocation = '/disk2/gsit4/output_ffi'; 
...
runParamsData.keplerData.zodiacalLightFlux = 0; % Zodiacal light background.  If 0.0 is computed.
runParamsData.keplerData.darkCurrent = 0; % dark current in e-/pixel/sec
