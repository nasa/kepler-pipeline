...
runParamsData.simulationData.runDuration = 48; % length of run in the units defined in the next field
...
runParamsData.simulationData.moduleNumber = 3; % which CCD module, ouput and season, legal values: 2-4, 6-20, 22-24
...
% have a list for time-varying PSFs
psfCount = 1;
ccdPlaneData(ccdPlaneCount).psfObjectData(psfCount) = pluginList.specificPsfData;
ccdPlaneData(ccdPlaneCount).psfObjectData(psfCount).psfFilename = 'psf_focus_4_z1f1.mat';
psfCount = psfCount + 1;
ccdPlaneData(ccdPlaneCount).psfObjectData(psfCount) = pluginList.specificPsfData;
ccdPlaneData(ccdPlaneCount).psfObjectData(psfCount).psfFilename = 'psf_focus_1_z5f5.mat';
