function pixelArray = apply_effect(etemUndershootObject, pixelArray)
...
% imbed the pixelArray in a larger array with leading columns.  The number
...
nCols = etemUndershootObject.nFilterCoeff;
leadingCols = repmat(pixelArray(:,1), 1, nCols);
filterArray = [leadingCols, pixelArray];
...
filterArray = filter(etemUndershootObject.filterCoeff, 1, filterArray, [], 2);

% extract pixelArray
pixelArray = filterArray(:,nCols+1:end);
