...
runParamsData.simulationData.runDuration = 96; % length of run in the units defined in the next field
...
runParamsData.simulationData.outputNumber = 2; % legal values: 1-4
