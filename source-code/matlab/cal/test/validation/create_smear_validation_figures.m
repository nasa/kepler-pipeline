function create_smear_validation_figures(dataTypeString, quarterString, ...
    cadenceTypeString, monthString, figurePath, createPlotFlag, ...
    createImageFlag, printEpsFlag, printPngFlag)
%
...
% .fig, .eps, and .png figures are saved to files in the figurePath
%
%
...
if createImageFlag
    ...
    colorbar
    title([dataTypeString ' ' quarterString '-' monthString ': MEDIAN ' cadenceTypeString ' masked smear pixels'], 'fontsize', 14)
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_med_msmear_per_col_per_channel'];
    ...
    ylabel(' CCD Col Index ', 'fontsize', 14)
    colorbar
    title([dataTypeString ' ' quarterString '-' monthString ': STD ' cadenceTypeString ' masked smear pixels'], 'fontsize', 14)
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_std_msmear_per_col_per_channel'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    ylabel(' CCD Col Index ', 'fontsize', 14)
    colorbar
    title([dataTypeString ' ' quarterString '-' monthString ': MEDIAN ' cadenceTypeString ' virtual smear pixels'], 'fontsize', 14)
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_med_vsmear_per_col_per_channel'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    ylabel(' CCD Col Index ', 'fontsize', 14)
    colorbar
    title([dataTypeString ' ' quarterString '-' monthString ': STD ' cadenceTypeString ' virtual smear pixels'], 'fontsize', 14)
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_std_vsmear_per_col_per_channel'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    ylabel(' CCD Col Index ', 'fontsize', 14)
    colorbar
    title([dataTypeString ' ' quarterString '-' monthString ': MEDIAN ' cadenceTypeString ' masked-virtual smear diff'], 'fontsize', 14)
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_med_smeardiff_per_col_per_channel'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    ylabel(' CCD Col Index ', 'fontsize', 14)
    colorbar
    title([dataTypeString ' ' quarterString '-' monthString ': STD ' cadenceTypeString ' masked-virtual smear diff'], 'fontsize', 14)
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_std_smeardiff_per_col_per_channel'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_med_msmear_per_cad_per_channel'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_std_msmear_per_cad_per_channel'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_med_vsmear_per_cad_per_channel'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_std_vsmear_per_cad_per_channel'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_med_smeardiff_per_cad_per_channel'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_std_smeardiff_per_cad_per_channel'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
end
...
if createPlotFlag
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_med_msmear_per_col_per_channel_plot'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_std_msmear_per_col_per_channel_plot'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_med_vsmear_per_col_per_channel_plot'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_std_vsmear_per_col_per_channel_plot'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_med_smeardiff_per_col_per_channel_plot'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_std_smeardiff_per_col_per_channel_plot'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_med_msmear_per_cad_per_channel_plot'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_std_msmear_per_cad_per_channel_plot'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_' lower(cadenceTypeString) '_med_vsmear_per_cad_per_channel_plot'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_std_vsmear_per_cad_per_channel_plot'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_med_smeardiff_per_cad_per_channel_plot'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_std_smeardiff_per_cad_per_channel_plot'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
end
