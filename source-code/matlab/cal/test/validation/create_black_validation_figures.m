function create_black_validation_figures(dataTypeString, quarterString, ...
...
% .fig, .eps, and .jpg figures are saved to files in the figurePath
%
%
...
if createImageFlag
    ...
    colorbar
    title([dataTypeString ' ' quarterString '-' monthString ': MEDIAN ' cadenceTypeString ' black residuals'], 'fontsize', 14)
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_'  lower(cadenceTypeString) '_med_black_per_row_per_channel'];
    ...
    ylabel(' CCD Row Index ', 'fontsize', 14)
    colorbar
    title([dataTypeString ' ' quarterString '-' monthString ': STD ' cadenceTypeString ' black residuals'], 'fontsize', 14)
    set(gca, 'XTick', 1:length(allChannelsArray))
    set(gca, 'XTicklabel', allChannelsArray)
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_' lower(cadenceTypeString) '_std_black_per_row_per_channel'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    colorbar
    title([dataTypeString ' ' quarterString '-' monthString ': MED ' cadenceTypeString ' black residuals'], 'fontsize', 14)
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_' lower(cadenceTypeString) '_med_black_per_cad_per_channel'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_' lower(cadenceTypeString) '_std_black_per_cad_per_channel'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
end
...
if createPlotFlag
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_' lower(cadenceTypeString) '_med_black_per_row_per_channel_plot'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath,  lower(quarterString) '_' lower(monthString) '_' lower(cadenceTypeString) '_std_black_per_row_per_channel_plot'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_' lower(cadenceTypeString) '_med_black_per_cad_per_channel_plot'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
    ...
    fileNameStr = [figurePath, lower(quarterString) '_' lower(monthString) '_' lower(cadenceTypeString) '_std_black_per_cad_per_channel_plot'];
    plot_cal_figs_to_file(fileNameStr,  printEpsFlag, printPngFlag);
end
