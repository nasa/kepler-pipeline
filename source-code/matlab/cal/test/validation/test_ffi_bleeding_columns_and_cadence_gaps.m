function test_ffi_bleeding_columns_and_cadence_gaps()
...
for i = 1:length(allChannels)
    ...
    %------------------------------------------------------------------
    % update cadence gap flags
    %------------------------------------------------------------------
%     inputsStruct.cadenceTimes.isMmntmDmp = true;
%     inputsStruct.cadenceTimes.isFinePnt= false;
%     
%     inputsStruct.cadenceTimes.isSefiAcc = true;
%     inputsStruct.cadenceTimes.isSefiCad = true;
%     inputsStruct.cadenceTimes.isLdeOos = true;
%     inputsStruct.cadenceTimes.isLdeParEr = true;
%     inputsStruct.cadenceTimes.isScrcErr = true;
