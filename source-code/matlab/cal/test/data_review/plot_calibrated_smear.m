function plot_calibrated_smear(quarterString, cadenceTypeString, monthString, ...
    figurePath, createPlotFlag, createImageFlag)
%
...
if createImageFlag
    ...
    set(gca, 'XTick', 1:length(channelList))
    set(gca, 'XTicklabel', channelList)
