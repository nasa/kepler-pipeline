function investigate_kdawg18_Q2(channelString)
%
...
if strcmpi(channelString, '46')

    %dataDir =  '/path/to/cal_Q2_data_review/DAWG_Q2_Figures/lc_photometric/lc_ch46_cad2965/';
    
    dataDir = '/path/to/pipeline_results/science_q2/q2_archive_ksop516/lc/cal-matlab-2376-88313/';
    backgroundPixCoordinatesFilename = '/path/to/cal_Q2_data_review/DAWG_Q2_Figures/lc_photometric/background_pix_14_2.mat';
...
for i = 1:numInvocations-1
    ...
    eval(['save /path/to/cal_Q2_data_review/DAWG_Q2_Figures/lc_photometric/lc_ch46_cad2965/bg_output_pixels_ch' channelString '_invoc' num2str(i) '.mat  bgOutputPixels bgOutputGaps bgPixelIdx'])
end
