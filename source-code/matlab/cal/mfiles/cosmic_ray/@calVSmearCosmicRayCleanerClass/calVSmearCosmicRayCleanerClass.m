classdef calVSmearCosmicRayCleanerClass < calCosmicRayCleanerClass
%************************************************************************** 
% classdef calVSmearCosmicRayCleanerClass < cosmicRayCleanerClass
%************************************************************************** 
% A class to clean cosmic ray signal from virtual smear pixels in CAL.
%
% METHODS
%
...
%
%             calVSmearCosmicRayCleanerClass()
%             calVSmearCosmicRayCleanerClass( calObject )
%             calVSmearCosmicRayCleanerClass( calInputStruct )
%
...
%
    ...
    methods 
        ...
        function obj = calVSmearCosmicRayCleanerClass( varargin )
            obj = obj@calCosmicRayCleanerClass( varargin{:}, ...
                @calVSmearCosmicRayCleanerClass.assemble_cosmic_ray_input_struct);
        end
