classdef calBlackCosmicRayCleanerClass < calCosmicRayCleanerClass
%************************************************************************** 
% classdef calBlackCosmicRayCleanerClass < calCosmicRayCleanerClass
%************************************************************************** 
% A class to clean cosmic ray signal from black pixels in CAL.
%
% METHODS
%
...
%
%             calBlackCosmicRayCleanerClass()
%             calBlackCosmicRayCleanerClass( calObject )
%             calBlackCosmicRayCleanerClass( calInputStruct )
%             calBlackCosmicRayCleanerClass( calObject, calIntermediateStruct )
%             calBlackCosmicRayCleanerClass( calInputStruct, calIntermediateStruct)
%
...
%
    %% ----------------------------- Data ---------------------------------
    properties (Constant)
        TRAILING_COLUMN = 1132;
        NEIGHBORHOOD    = [1 0; -1 0]; % (row, col) offsets of neighbors.
    end
    ...
    methods 
        ...
        %   3) A calClass object or calDataStruct and a
        %      calIntermediateStruct.
        function obj = calBlackCosmicRayCleanerClass( varargin )
            obj = obj@calCosmicRayCleanerClass( varargin{:}, ...
                @calBlackCosmicRayCleanerClass.assemble_cosmic_ray_input_struct);
        end
