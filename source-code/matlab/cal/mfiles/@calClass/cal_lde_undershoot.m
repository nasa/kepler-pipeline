function [ldeUndershootMetrics] = cal_lde_undershoot(calObject)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% function [ldeUndershootMetrics] = cal_lde_undershoot(calObject)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% Interface between cal_matlab_controller and
% compute_lde_undershoot_metrics function.
%
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% 
...
if calObject.lastCall
    ...
    % Get the required fields from input object. Note that row index from
    % Fc Constants must be converted from 0-based to 1-based indexing.
    ...
    virtualSmearStartRow = fcConstants.VIRTUAL_SMEAR_START + 1;    
...
%     end
    ...
    % Compute the lde undershoot metrics for each undershoot target.
    stateFilename = [ calObject.localFilenames.stateFilePath, calObject.localFilenames.calMetricsFilename];
    
    [ldeUndershootMetrics] = ...
        compute_lde_undershoot_metrics(moduleParametersStruct, ...
        ldeUndershootIds, virtualSmearStartRow, cadenceGapIndicators, ...
        stateFilename, debugLevel);
