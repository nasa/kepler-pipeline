function result = empty_tStruct()

% function result = empty_tStruct()
%
% Return 1x1 structure of the form transformStruct. With all fields empty.
%   
...
%
% The default disableLevel = 0, perform transformation for both x and Cx.
%                     
%
% 
...
result = struct('transformType',[],...
                'disableLevel',int8(0),...
                'yDataInputName',[],...
                'yIndices',[],...
                'size',struct('transformType',[],...
                              'disableLevel',[],...
                              'yDataInputName',[],...
                              'yIndices',[]),...
                'originalShape',struct('transformType',[],...
                              'disableLevel',[],...
                              'yDataInputName',[],...
                              'yIndices',[],...
                              'size',struct('transformType',[],...
                                            ...
                                            'yDataInputName',[],...
                                            'yIndices',[])),...
                'transformParamStruct',empty_tParamStruct);
