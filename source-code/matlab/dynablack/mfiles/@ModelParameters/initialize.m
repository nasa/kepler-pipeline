...
% function obj = initialize(obj, param_count,  param_type_list, coefficient_cells)
% 
% Initialization routine for ModelParameters class. Simply loads required values into object property structure.
%
% INPUTS:
% 
...
if nargin > 0
    ...
    error('ModelParameters object cannot be initialized with zero arguments');
end
