%% FGSFrame_components (multiple pixel & LC case)
...
%
function valDN = FGSFrame_components(obj, clockOffset_list, lc_list)
%% ARGUMENTS
% 
% * Function returns:
       ...
       if clockOffset_count==0
           ...
           for clockOffset_ID = 1:clockOffset_count
               ...
               if clockOffset > 0 && clockOffset < 21 
                    valDN(clockOffset_ID,1:lc_count) = obj.FGSFrame_parameters.estimates(obj.Predictors,clockOffset,lc_list)';
               end
           end
       end
   end
end % FGSFrame_components
