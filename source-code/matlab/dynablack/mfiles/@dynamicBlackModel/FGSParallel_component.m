%% FGSParallel_component (single pixel case)
...
% FGSParallel_components does multiple pixels & LCs
% 
%
%   Revision History:
%
...
%
function valDN = FGSParallel_component(obj, clockOffset, row, column, lc)
%% ARGUMENTS
% 
% * Function returns:
...
%%
   if nargin > 0
       if clockOffset  >0 & clockOffset < 567
            valDN = obj.FGSParallel_parameters.estimate(obj.Predictors,clockOffset,lc)';
       else
            valDN = 0;
       end
   end
end % FGSParallel_component
