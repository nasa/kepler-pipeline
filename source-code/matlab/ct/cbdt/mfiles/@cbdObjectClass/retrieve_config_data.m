function [ancillaryData] = retrieve_config_data(cbdObj)
% function [ancillaryData] = retrieve_config_data(cbdObj)
...
try
    ...
    ancillaryData = retrieve_ancillary_data(...
            [modoutTempKeywords;ldeDrvTempKeywords;ldeAcqTempKeywords], ...
            cbdObj.startMjd, cbdObj.endMjd);
