function [leadBlackA,maskSmearB,virtualSmearD,trailBlackE,sA,sB,sD,sE] = extractCollateralVectors(ffi);
% function [leadBlackA,maskSmearB,virtualSmearD,trailBlackE,sA,sB,sD,sE] = extractCollateralVectors(ffi);
%
% extractCollateraVectors: returns vectors of mean and standard deviation [row/column] 
% from each collateral data area:
%   A - leading black
%   B - masked smear
%   D - virtual smear
%   E - trailing black
...
% load CCD formatting parameters
CCDFormatParams;
