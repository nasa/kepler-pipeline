function obj = cbdtState(varargin)

% Constructor for a cbdtState class object.
...
if nargin == 0 % Used when objects are loaded from disk
  obj = init_fields;
  obj = class(obj, 'cbdtState');
  return;
end

firstArg = varargin{1};
if isa(firstArg, 'cbdtState') %  used when objects are passed as arguments
  obj = firstArg;
  return;
end
