function self = test_output_size_check(self)
%
...
%
    % Test that the output image is 1070x1132

    import gov.nasa.kepler.common.FcConstants;
    display('test image output size')
    ...
    for channel = 1:84
        ...
        assert(size(image, 1) == FcConstants.CCD_ROWS);
        assert(size(image, 2) == FcConstants.CCD_COLUMNS);
    end
