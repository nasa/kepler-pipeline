function self = test_output_data_pixel_count(self)
%
...
%
    ...
    % Test that the right number of pixels are set in the output image.

    display('test output data pixel count')
    ...
    assert(length(find(image ~= -1)) == length(rows));
return
