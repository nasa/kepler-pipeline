function fpgResultsPlotStruct = prepare_fpg_displays( fpgResultsObject )
%
% prepare_fpg_displays -- generate the plots associated with Focal Plane Geometry.
%
% fpgResultsPlotStruct = prepare_fpg_displays( fpgResultsObject ) returns a structure of
%    plot handles for the results plots of FPG.
%
% Version date:  2008-August-01.
%
% 
...
%
%     2008-August-01, PT:
%          add forgotten plot of data status map (d'oh!).
%     2008-July-25, PT:
%          eliminate FOV plot (no longer supported in fpgResultsClass).
%
%=========================================================================================

% plot the misalignments, both in terms of pointing angles and in terms of offset in
% pixels
