function interactive_histogram(ffiName)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% interactive_histogram(ffiName)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% 
% interactive_histogram(ffiName) is the interactive tool for Data Goodness.
% This function launches a gui figure with 5 axes.  When input file has
% multiple channels and a focal plane display window exists running 
% mouse_over_to_get_modout.m , then interaction data can be switched by 
% clicking on the desired modout on the focal plane display figure
%
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% INPUT:
%            
...
fh2 = figure( 'position', [ 200   35   1045   830], 'tag', 'int_hist',...
    'numbertitle', 'off', 'name', 'Data Goodness Tool GUI', 'visible', 'off');
...
menustring_colormap = {'Hot', 'Gray','Jet', 'Spring', 'Summer', 'Autumn', 'Winter'};
...
auto_checkbox_h =  uicontrol('style', 'checkbox', 'units', 'pixels', ...
...
uicontrol(fh2, 'style', 'text', 'position', [ 940 415 75 200],...
