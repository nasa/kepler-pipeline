function [gainForOneCadenceAllModOuts, readNoiseForOneCadenceAllModOuts, configMapStruct, requantTableStruct]...
    = extract_simple_focal_plane_models_per_cadence(pdqScienceObject, timeStampInMjd)
%----------------------------------------------------------------------
...
gainForOneCadenceAllModOuts        = get_gain(gainObject, timeStampInMjd);

readNoiseObject                     = readNoiseClass(pdqScienceObject.readNoiseModel);

readNoiseForOneCadenceAllModOuts   = get_read_noise(readNoiseObject, timeStampInMjd);
...
configMapStruct.ccdReadTime = get_readout_time(configMapObject, timeStampInMjd);

configMapStruct.ccdExposureTime = get_exposure_time(configMapObject, timeStampInMjd);

configMapStruct.numberOfExposuresPerLongCadence = ...
    get_number_of_exposures_per_long_cadence_period(configMapObject, timeStampInMjd);


% get fixed offset from configmap
requantTableStruct.requantizationTableFixedOffset = get_fixed_offset(configMapObject, timeStampInMjd);
...
[requantizationTable, meanBlackTable] = get_requant_table(requantTableObject, timeStampInMjd);

requantTableStruct.meanBlackEntries = meanBlackTable;
