function introduce_gaps_in_pdq_pixel_data(s, gapPercentage)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% function introduce_gaps_in_pdq_pixel_data(s, gapPercentage)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%-------------------------------------------
...
nGappedCadences = ceil((gapPercentage/100)*nCadences);
...
for iTarget = 1:nStellarTargets
    ...
    for jPixel = 1:nPixelsForThisTarget
        ...
        s.stellarPdqTargets(iTarget).referencePixels(jPixel).gapIndicators(gappedCadences) = true;
...
for iBkgd = 1:nBkgdTargets
    ...
    for jPixel = 1:nBgdPixelsForThisBkgd
        ...
        s.backgroundPdqTargets(iBkgd).referencePixels(jPixel).gapIndicators(gappedCadences) = true; % no gaps at all for now
    end
end
for iCollateral = 1:nCollateralTargets
    ...
    for jPixel = 1:nCollPixels
        ...
        s.collateralPdqTargets(iCollateral).referencePixels(jPixel).gapIndicators(gappedCadences) = true; % no gaps at all for now
    end
end
