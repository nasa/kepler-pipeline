function test_pdq_track_trend_triangle
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
% Set up random time series with triangle trend. There are 100 cadences at
% one day intervals.
nCadences = 100;
...
metricTs.values(1:50) = metricTs.values(1:50) + 0.1*(1:50)';
metricTs.values(51:100) = metricTs.values(51:100) + (5 - 0.1*(1:50)');

% Set up other create_report inputs.
fixedLowerBound = -15;
fixedUpperBound = 15;

metricName = 'Triangle Trend';
metricUnits = 'Sigma';
