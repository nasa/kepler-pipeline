function test_pdq_track_trend_linear_gaps
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
pdqInputStruct.pdqConfiguration.horizonTime = 20.0;
pdqInputStruct.pdqConfiguration.debugLevel = 1;

% Instantiate class object.
pdqScienceObject = pdqScienceClass(pdqInputStruct);

% Set up random time series with linear trend and gaps. There are 100
% cadences at one day intervals.
nCadences = 100;
...
metricTs.values = metricTs.values + 0.1*(1:nCadences)';

metricTs.gapIndicators(31:35) = true;
metricTs.gapIndicators(61:70) = true;

% Set up other create_report inputs.
fixedLowerBound = -15;
fixedUpperBound = 11;

metricName = 'Linear Trend with Gaps';
metricUnits = 'Sigma';
