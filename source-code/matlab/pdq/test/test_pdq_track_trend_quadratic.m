function test_pdq_track_trend_quadratic
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
% Set up random time series with quadratic trend. There are 100 cadences at
% one day intervals.
nCadences = 100;
...
metricTs.values = metricTs.values + 0.0008*((1:nCadences)'.^2);

% Set up other create_report inputs.
fixedLowerBound = -15;
fixedUpperBound = 15;

metricName = 'Quadratic Trend';
metricUnits = 'Sigma';
