function [pdqInputStruct, rowIndices] = pdqval_insert_gaps_in_time_series(pdqInputStruct, gaps)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% function [pdqInputStruct, rowIndices] = pdqval_insert_gaps_in_time_series(pdqInputStruct, gaps)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
%
%     gaps      
%         An nGaps x 6 matrix in which each row indicates the location of a 
%         gap in the reference pixel data. Columns consist of integers 
%         having the following meanings: 
%
%         [module, output, targetType, targeIndex, pixelIndex, cadenceIndex]   
%            
%         and target types are 1=stellar, 2 = background, 3=collateral
%
% Ouput:
%     pdqInputStruct 
...
%
%     rowIndices
%         The row indices of gaps that were actually inserted. gaps(rowIndices)
%         reteives the gaps that were inserted into pdqInputStruct.
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% 
