function validate_time_series_structure(inStruct, fieldsAndBounds, mnemonic, warningInsteadOfErrorFlag)
...
if nargin < 3
    ...
    error('validate_time_series_structure:WrongNumberOfInputs',...
        'validate_time_series_structure must be called with 3 inputs.');
end
...
inStruct.values = inStruct.values(~inStruct.gapIndicators);
inStruct.uncertainties = inStruct.uncertainties(~inStruct.gapIndicators);
