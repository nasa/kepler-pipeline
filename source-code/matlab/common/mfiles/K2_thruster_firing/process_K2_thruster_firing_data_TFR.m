function [thrusterFiringDataStruct, thrusterFiringEvents, cadenceTimes] = process_K2_thruster_firing_data_TFR(varargin)
%==========================================================================
...
campaignIndex = campaignId(1:end-3);
...
switch campaignId
    ...
    case     'c0_partition1_sc'
        taskfilesDir = '/path/to/c0/pipeline-results/c0-full-ksop2001/sc-redo/uow/cal-505-q00-04.01-2611480-2612730/st-0/';
        load(strcat(taskfilesDir,'cal-inputs-0.mat'))
        

    case     'c0_partition2_sc'
        taskfilesDir = '/path/to/c0/pipeline-results/c0-full-ksop2001/sc-redo/uow/cal-505-q00-04.01-2612731-2613981/st-0/';
        load(strcat(taskfilesDir,'cal-inputs-0.mat'))
        

    case     'c0_partition3_sc'
        taskfilesDir = '/path/to/c0/pipeline-results/c0-full-ksop2001/sc-redo/uow/cal-505-q00-04.01-2613982-2615232/st-0/';
        load(strcat(taskfilesDir,'cal-inputs-0.mat'))
    ...
    case 'c0_part2_lc'
        ...
        % KSOP-2020
        taskfilesDir = '/path/to/ksop-2020-c0-part2/pa/';
    ...
    case 'c1_part1_lc'
        ...
        % KSOP-2128
        taskfilesDir = '/path/to/ksop-2128/lc/pa1/';
    ...
    case 'c1_part1_sc' 
        ...
        % KSOP 2129 taskfiles
        taskfilesDir = '/path/to/ksop-2129-release-9.3VnV-K2-C1/pdc/';
    ...
    case 'c2_lc'
        ...
        % KSOP-2257 taskfiles
        taskfilesDir = '/path/to/ksop-2257-k2-PA-VnV-Must-have/pa-matlab-1035/';
    ...
    case 'c2_sc'
        ...
        % KSOP-2341 taskfiles
        taskfilesDir = '/path/to/ksop-2341-k2-c2-sc-pa/';
...
switch campaignIndex
    ...
    case {'c0','c1','c2'} % Campaigns 0, 1, and 2
        ...
        if(isempty(cadenceDataIsWithinThrusterTelemetrySamplingWindowIndicators))
            ...
            % sampling window
            cadenceTimes.startTimestamps = cadenceTimes.startTimestamps(cadenceDataIsWithinThrusterTelemetrySamplingWindowIndicators);
            cadenceTimes.midTimestamps = cadenceTimes.midTimestamps(cadenceDataIsWithinThrusterTelemetrySamplingWindowIndicators);
            cadenceTimes.endTimestamps = cadenceTimes.endTimestamps(cadenceDataIsWithinThrusterTelemetrySamplingWindowIndicators);
            cadenceTimes.gapIndicators = cadenceTimes.gapIndicators(cadenceDataIsWithinThrusterTelemetrySamplingWindowIndicators);
            cadenceTimes.requantEnabled = cadenceTimes.requantEnabled(cadenceDataIsWithinThrusterTelemetrySamplingWindowIndicators);
            cadenceTimes.cadenceNumbers = cadenceTimes.cadenceNumbers(cadenceDataIsWithinThrusterTelemetrySamplingWindowIndicators);
            cadenceTimes.isSefiAcc = cadenceTimes.isSefiAcc(cadenceDataIsWithinThrusterTelemetrySamplingWindowIndicators);
            cadenceTimes.isSefiCad = cadenceTimes.isSefiCad(cadenceDataIsWithinThrusterTelemetrySamplingWindowIndicators);
            cadenceTimes.isLdeOos = cadenceTimes.isLdeOos(cadenceDataIsWithinThrusterTelemetrySamplingWindowIndicators);
            cadenceTimes.isFinePnt = cadenceTimes.isFinePnt(cadenceDataIsWithinThrusterTelemetrySamplingWindowIndicators);
            cadenceTimes.isMmntmDmp = cadenceTimes.isMmntmDmp(cadenceDataIsWithinThrusterTelemetrySamplingWindowIndicators);
            cadenceTimes.isLdeParEr = cadenceTimes.isLdeParEr(cadenceDataIsWithinThrusterTelemetrySamplingWindowIndicators);
            cadenceTimes.isScrcErr = cadenceTimes.isScrcErr(cadenceDataIsWithinThrusterTelemetrySamplingWindowIndicators);
    ...
    otherwise % Campaign 9 and above
        ...
        switch campaignId
            case 'C9a-LC'
                headerCheckFile = strcat(campaignId,'-header-check-20160601.txt');
            case 'C9a-SC'
                headerCheckFile = strcat(campaignId,'-header-check-20160601.txt');
            case 'C9b-LC'
                headerCheckFile = strcat(campaignId,'-header-check-ksop2673-20160707.txt');
            case 'C9b-SC'
                headerCheckFile = strcat(campaignId,'-header-check-ksop2673-20160707.txt');
            case 'C10-LC'
                headerCheckFile = 'C10-LC-header-check-160926.txt';
            case 'C10-SC'
                headerCheckFile = 'C10-SC-header-check-160926.txt';
        end
        
        if(strcmp(campaignId(end-1:end),'LC'))
        ...
        elseif(strcmp(campaignId(end-1:end),'SC'))
