...
% revision record
% 2/6/17 -  Change campaignIdRange list per KSOC-5127
%           Change function call from 'process_K2_thruster_firing_data_TFR()' to 'process_K2_thruster_firing_data_TFR_KSOC_5127()'
%           Save updated version of this script as 'make_K2_thruster_firing_flags_KSOC_5127'
%           Remove 'skip' switch - I gues that can be turned back on if the .mat archive arleady exists which could then just be loaded and
%           not recreated.

% campaignIdRange = {'c0_part2_lc','c1_part1_lc','c1_part2_lc','c1_part1_sc','c1_part2_sc','c2_lc','c2_sc'};

% ****** substitute in new campaign tags taken from header check files - see KSOC-5127
campaignIdRange = {'c0-part2-sc'};      %, 'c0-part2-lc', 'c0-part1-sc', 'c0-part2-sc'}
...
%     if(~skip)
        ...
        [thrusterFiringDataStruct, thrusterFiringEvents, cadenceTimes] = process_K2_thruster_firing_data_TFR_KSOC_5127(iCampaign);
...
%     end
    ...
    clear thrusterFiringDataStruct thrusterFiringEvents cadenceTimes;
