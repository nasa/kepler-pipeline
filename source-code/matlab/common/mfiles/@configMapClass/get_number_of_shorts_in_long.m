function [numberOfShortsInLong, closestConfigMapTimeStamps] = get_number_of_shorts_in_long(configMapObject, timeStamps)
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% function [numberOfShortsInLong, closestConfigMapTimeStamps] = get_number_of_shorts_in_long(configMapObject, timeStamps)
%
%
...
numberOfShortsInLong = -1*ones(nTimeStamps,1);
...
for jTimeStamp = 1:nTimeStamps
    ...
    numberOfShortsInLong(jTimeStamp) = longCadencePeriodInShortCadences;
