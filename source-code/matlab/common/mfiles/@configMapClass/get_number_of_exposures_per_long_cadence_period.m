function [numberOfExposures, closestConfigMapTimeStamps] = get_number_of_exposures_per_long_cadence_period(configMapObject, timeStamps)
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% function [numberOfExposures, closestConfigMapTimeStamps] = get_number_of_exposures_per_long_cadence_period(configMapObject, timeStamps)
%
%
...
numberOfExposures = -1*ones(nTimeStamps,1);
...
for jTimeStamp = 1:nTimeStamps
    ...
    %
    %     numberOfExposures(jTimeStamp) = longCadencePeriodInShortCadences*shortCadencePeriodInSeconds/integrationTime;


    numberOfExposures(jTimeStamp) = longCadencePeriodInShortCadences*shortCadencePeriodInIntegrations;
