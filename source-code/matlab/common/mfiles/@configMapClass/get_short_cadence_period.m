function [shortCadencePeriods, closestConfigMapTimeStamps] = get_short_cadence_period(configMapObject, timeStamps)
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% function [shortCadencePeriods, closestConfigMapTimeStamps] = get_short_cadence_period(configMapObject, timeStamps)
%
%
...
shortCadencePeriods = -1*ones(nTimeStamps,1);
...
for jTimeStamp = 1:nTimeStamps
    ...
    shortCadencePeriods(jTimeStamp) = shortCadencePeriodInSeconds;
