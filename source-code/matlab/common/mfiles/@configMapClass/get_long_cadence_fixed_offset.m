function requantTableFixedOffsets = get_long_cadence_fixed_offset(configMapObject, timeStamps)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
for jTimeStamp = 1:nTimeStamps
    ...
    indexMatched = strmatch('requantTableLcFixedOffset', allNames, 'exact');
    ...
    if(~isempty(indexMatched))
        ...
        error('configMapClass:get:invalidFieldName',...
            ['no match found for the given field requantTableLcFixedOffset - for the time stamp ' num2str(timeStamps(jTimeStamp))]);
    end
