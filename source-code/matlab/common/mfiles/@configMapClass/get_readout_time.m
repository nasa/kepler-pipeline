function [readOutTimes, closestConfigMapTimeStamps] = get_readout_time(configMapObject, timeStamps)
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% function [readOutTimes, closestConfigMapTimeStamps] = get_readout_time(configMapObject, timeStamps)
%
%
...
readOutTimes = -1*ones(nTimeStamps,1);
...
for jTimeStamp = 1:nTimeStamps
    ...
    readOutTimes(jTimeStamp) = readoutPeriodInMsec;
    readOutTimes(jTimeStamp) = readOutTimes(jTimeStamp)*1e-3; % converts to seconds
