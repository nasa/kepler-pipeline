function timeSeriesStruct = retrieve_pixel_time_series_calibrated(modules, outputs, startMjd, endMjd, getLongCadence)
%
% The long/short cadence pixel time series extractor retrieves the original or
% calibrated pixel time series of the long or short cadence target data for a
% specified mod/out for a given time interval.
%
% timeSeriesStruct = retrieve_pixel_time_series_calibrated(modules, outputs, startMjd, endMjd)
% or
% timeSeriesStruct = retrieve_pixel_time_series_calibrated(modules, outputs, startMjd, endMjd, getLongCadence)
%
...
%
    ...
    try
        timeSeriesStruct = retrieve_pixel_time_series_work(modules, outputs, startMjd, endMjd, getLongCadence, 1);
        SandboxTools.close;
    catch
        SandboxTools.close;
        rethrow(lasterror);
