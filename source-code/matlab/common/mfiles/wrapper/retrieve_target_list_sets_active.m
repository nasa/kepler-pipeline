function targetListSets = retrieve_target_list_sets_active()
%function targetListSets = retrieve_target_list_sets_active()
%
% Retrieves the active target list sets. A target list set is active if it has an associated supplemental run.
% 
...
javaTargetListSets = targetSelectionCrud.retrieveAllTargetListSetsActive.toArray;
