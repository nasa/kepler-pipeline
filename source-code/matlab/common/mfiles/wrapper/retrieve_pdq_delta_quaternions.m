...
%
    ...
    import gov.nasa.kepler.systest.sbt.SbtRetrievePdqDeltaQuaternions;
    sbt = SbtRetrievePdqDeltaQuaternions();
    
    pathJava = sbt.retrievePdqDeltaQuaternions();
    path = pathJava.toCharArray()';
    
    pdqDeltaQuaternionsStruct = sbt_sdf_to_struct(path);
    pdqDeltaQuaternions = pdqDeltaQuaternionsStruct.deltaQuaternions;
