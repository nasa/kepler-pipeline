...
%
    ...
    import gov.nasa.kepler.systest.sbt.SbtRetrieveSkyGroup;
    sbt = SbtRetrieveSkyGroup();
    
    pathJava = sbt.retrieveSkyGroup(varargin{:});
    path = pathJava.toCharArray()';
    
    skyGroupStruct = sbt_sdf_to_struct(path);
