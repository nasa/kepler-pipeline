...
%
    ...
    import gov.nasa.kepler.systest.sbt.SbtRetrieveRequantTable;
    sbt = SbtRetrieveRequantTable();

    pathJava = sbt.retrieveRequantTable(tableId);
    path = pathJava.toCharArray()';

    requantTableStruct = sbt_sdf_to_struct(path);

    requantEntries = requantTableStruct.requantEntries;
    meanBlackEntries = requantTableStruct.meanBlackEntries;
