function targetDefinitionsStruct = retrieve_tad_target_definitions(module, output, targetListSetName)
%function targetDefinitionsStruct = retrieve_tad(module, output, targetListSetName)
% 
% Returns a targetDefinitionsStruct similar to the following:
%
...
if(isempty(targetDefinitions))
    ...
    targetDefinitionsStruct = [];
    SandboxTools.close;
    return;
end

targetDefinitionsStruct.targetDefinitions = copyTargetDefs(targetDefinitions);
...
targetDefinitionsStruct.maskDefinitions = copyMaskDefs(maskDefinitions);
