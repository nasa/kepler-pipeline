function scaledMatrix = scalerow(scalingVector,matrixM)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% function scaledMatrix = scalerow(scalingVector,matrixM)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%
% multiplies each row of the matrix matrixM by the scalingVector
% elementwise.
%
...
% vector is not equal to the number of columns in the matrixM
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% 
...
if length(scalingVector) ~= iNumCols

    error('Utilities:scaleCol:incompatibleVectorLength', ...
        ['scaling vector length ' num2str(length(scalingVector))  ' is not equal to the number of columns '...
        num2str(size(matrixM,2)) ' in the matrix to be scaled. can''t scale the matrix!']);
end
...
% multiplication
scalingVectorMatrix = repmat(scalingVector, iNumRows, 1);
