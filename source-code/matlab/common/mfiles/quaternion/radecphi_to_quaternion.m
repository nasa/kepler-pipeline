function qzyx = radecphi_to_quaternion(raDecPhiPointing, mjd, raDec2PixObject )
%--------------------------------------------------------------------------
% function qzyx = radecphi_to_quaternion(raDecPhiPointing, mjd, raDec2PixObject)
%--------------------------------------------------------------------------
...
% convert (ra, dec, phi) usually input to ra_dec_2_pix_absolute to
% (rot3, rot2, rot1) Euler angles
rot321 = radecphi_2_euler321(raDec2PixObject, raDecPhiPointing, mjd);

% convert Euler angles to quaternion representation

qzyx = euler321_to_quaternion(rot321);
