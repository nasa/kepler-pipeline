function self = test_retrieve_ancillary_data_q2(self)
%Kamal Uddin
% 
...
display('test_retrieve_ancillary_data_q2(self)');
display(datestr(now()));
...
% [ mjdStart mjdEnd];
    ...
    retrieveAncillaryData =  retrieve_ancillary_data(mjdStartq2, mjdEndq2);
