function self = test_retrieve_invalid_pixels_model_q1(self)
% Kamal Uddin
% 
...
display('test_retrieve_invalid_pixels_model_q1');
...
invalidPixelsData = retrieve_invalid_pixels_model(module, output, mjdStartq1, mjdEndq1);
