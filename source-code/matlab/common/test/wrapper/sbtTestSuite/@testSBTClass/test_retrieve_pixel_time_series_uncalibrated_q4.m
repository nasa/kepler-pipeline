function self = test_retrieve_pixel_time_series_uncalibrated_q4(self)
% Kamal Uddin
...
display('test_retrieve_pixel_time_series_uncalibrated_q4(self)');
...
timeSeriesStruct = retrieve_pixel_time_series(modules, outputs,mjdStartq4, mjdEndq4, isLongCadence, isCalibrated);
