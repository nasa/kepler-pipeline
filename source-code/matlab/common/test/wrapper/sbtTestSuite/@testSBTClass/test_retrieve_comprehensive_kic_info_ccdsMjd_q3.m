function self = test_retrieve_comprehensive_kic_info_ccdsMjd_q3(self)
%kamal
% 
...
display('test_retrieve_comprehensive_kic_info_ccdsMjd_q3(self)');
...
outputStruct = retrieve_comprehensive_kic_info(ccdModules, ccdOutputs,mjdStartq3);
