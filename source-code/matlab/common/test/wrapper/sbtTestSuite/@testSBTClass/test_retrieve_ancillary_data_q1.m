function self = test_retrieve_ancillary_data_q1(self)
%Kamal Uddin
% 
...
display('test_retrieve_ancillary_data_q1(self)');
display(datestr(now()));
...
% [ mjdStart mjdEnd];
    ...
    retrieveAncillaryData =  retrieve_ancillary_data(mjdStartq1, mjdEndq1);
