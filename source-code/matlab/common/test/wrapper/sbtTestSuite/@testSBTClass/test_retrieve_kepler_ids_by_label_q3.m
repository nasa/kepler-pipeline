function self = test_retrieve_kepler_ids_by_label_q3(self)
%Kamal Uddin, 
% 
...
display('test_retrieve_kepler_ids_by_label_q3');
display(datestr(now()));

%targetListSetName='quarter5_spring2010_lc_v2_supp';
test_inputs
...
matchingTargets = retrieve_kepler_ids_by_label(q3targetListSetName);
