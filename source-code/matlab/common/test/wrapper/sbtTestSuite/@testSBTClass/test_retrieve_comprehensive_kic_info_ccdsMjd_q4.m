function self = test_retrieve_comprehensive_kic_info_ccdsMjd_q4(self)
%kamal
% 
...
display('test_retrieve_comprehensive_kic_info_ccdsMjd_q4(self)');
...
outputStruct = retrieve_comprehensive_kic_info(ccdModules, ccdOutputs,mjdStartq4);
