function self = test_retrieve_read_noise_model_q3(self)
% Kamal Uddin
% 
...
%
display('test_retrieve_read_noise_model_q3');
display(datestr(now()));
tic;
...
readNoiseData = retrieve_read_noise_model(mjdStartq3, mjdEndq3);
