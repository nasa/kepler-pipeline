function self = test_retrieve_kics_by_kepler_id_modOut(self)
% Kamal Uddin
% 
...
display('test_retrieve_kics_by_kepler_id_modOut');
%keplerId= 2302624;
display(datestr(now()));
...
kics = retrieve_kics_by_kepler_id(q4targetListSetName, module, output, get_chars);
