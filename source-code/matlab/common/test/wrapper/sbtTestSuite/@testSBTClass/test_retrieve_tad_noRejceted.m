function self = test_retrieve_tad_noRejceted(self)
% Kamal Uddin
% 
...
display('test_retrieve_tad_noRejceted');

display(datestr(now()));
module =7;
output =2;

%targetListSetName='quarter5_spring2010_lc_v2';
...
tadInputStruct = retrieve_tad(module, output, q5targetListSetName, includeRejected);
%    ~isempty(self);
