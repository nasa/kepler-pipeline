function self = test_retrieve_kepler_ids_by_label_Lables(self)
% Kamal Uddin
% 
...
display('test_retrieve_kepler_ids_by_label_Lables');

display(datestr(now()));

% targetListSetName= 'quarter4_winter2009_lc_supp_v4';
...
matchingTargets = retrieve_kepler_ids_by_label(q4targetListSetName, 'labels', labels);
