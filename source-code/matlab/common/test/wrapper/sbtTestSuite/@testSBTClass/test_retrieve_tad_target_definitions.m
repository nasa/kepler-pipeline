function self = test_retrieve_tad_target_definitions(self)
% Kamal Uddin
% 
...
display('test_retrieve_tad_target_definitions');
...
tadTargets = retrieve_tad(module, output, q4targetListSetName);
