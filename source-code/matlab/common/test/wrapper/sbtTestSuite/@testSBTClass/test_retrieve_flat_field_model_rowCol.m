function self = test_retrieve_flat_field_model_rowCol(self)
...
%
tic;
display('test_retrieve_flat_field_model_rowCol(self)');
...
flatFieldData = retrieve_flat_field_model(module, output,mjdStartq2, mjdEndq2,   rows, cols);
