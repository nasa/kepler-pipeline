function self = test_retrieve_pixel_log_lcCadence0_q4(self)
%this test for sc
% Kamal Uddin
% 
...
%
tic;
display('test_retrieve_pixel_log_lc_Cadence0_q4');
display(datestr(now()));

isLongCadence=0;
%for sc, 

% startInterval=  55371.93711104;
% endInterval = 55399.03206960;
