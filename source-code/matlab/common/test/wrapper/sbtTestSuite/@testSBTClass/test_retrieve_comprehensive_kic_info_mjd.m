function self = test_retrieve_comprehensive_kic_info_mjd(self)
%kamalUddin
% 
...
%
tic;
display('test_retrieve_comprehensive_kic_info_mjd(self)');
display(datestr(now()));
...
outputStruct = retrieve_comprehensive_kic_info(keplerIds,  mjdStartq0);
