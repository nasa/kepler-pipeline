function self = test_retrieve_kepler_ids_by_label_CategoriesSub(self)
% Kamal Uddin
% 
...
%
tic;
display('test_retrieve_kepler_ids_by_label_CategoriesSub');
display(datestr(now()));
...
labelsAndCategoriesAreSubstrings =1 ;
 ...
 matchingTargets = retrieve_kepler_ids_by_label(q4targetListSetName,'categories', categories, labelsAndCategoriesAreSubstrings);
