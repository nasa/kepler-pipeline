function self = test_retrieve_target_data_q4(self)
% Kamal Uddin
% 
...
%
display('test_retrieve_target_data_q4');
tic;
...
%targets = retrieve_target_data(keplerIds, startCadenceq4, endCadenceq4, cadenceType, baseDescription);
targets = retrieve_target_data(keplerIds, startCadenceq4, endCadenceq4, cadenceType, baseDescription);
