function self = test_retrieve_pixel_time_series_q6(self)
% Kamal Uddin
...
display('test_retrieve_pixel_time_series_q6(self)');
...
isLongCadence=1;
isCalibrated=1;
 timeSeriesStruct = retrieve_pixel_time_series(ccdModules, ccdOutputs, mjdStartq6, mjdEndq6, isLongCadence, isCalibrated);
