function self = test_retrieve_ra_dec_2_pix_model_mjd_q3(self)
% Kamal Uddin
% 
...
tic;
display(datestr(now()));
display('test_retrieve_ra_dec_2_pix_model_mjd_q3');
...
raDec2PixData = retrieve_ra_dec_2_pix_model(mjdStartq3, mjdEndq3);
