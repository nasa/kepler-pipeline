function self = test_retrieve_geometry_model_q3(self)
% Kamal Uddin
% 
...
%
tic;
display(' test_retrieve_geometry_model_q3(self)');
display(datestr(now()));
...
geometryData = retrieve_geometry_model(mjdStartq3, mjdEndq3);
