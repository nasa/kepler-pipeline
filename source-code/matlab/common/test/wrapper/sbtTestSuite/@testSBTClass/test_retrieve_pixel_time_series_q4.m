function self = test_retrieve_pixel_time_series_ModMjdScCal1(self)
%kamalUddin
% 
...
% Kamal Uddin
display('test_retrieve_pixel_time_series_sdf_ModMjdScCal1');
display(datestr(now()));
...
isCalibrated=1;
  ...
  pixelTimeSeries = retrieve_pixel_time_series(ccdModules, ccdOutputs,mjdStartq4, mjdEndq4, isLongCadence,isCalibrated );
