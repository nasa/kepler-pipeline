function self = test_retrieve_flat_field_model_q4(self)
% Kamal Uddin
% 
...
%
tic;
display('test_retrieve_flat_field_model_mjd_q0(self)');
display(datestr(now()));
...
flatFieldData = retrieve_flat_field_model(module, output, mjdStartq4, mjdEndq4);
