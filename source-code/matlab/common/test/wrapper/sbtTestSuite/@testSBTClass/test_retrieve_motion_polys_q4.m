function self = test_retrieve_motion_polys_q4(self)
% Kamal Uddin
...
display(' test_retrieve_motion_polys_q4(self)');
% start_mjd = 55245.80; 
% end_mjd= 55260.71;
% 	
  test_inputs
  ...
  motion_poly_struct = retrieve_motion_polys(mjdStartq4, mjdEndq4);
