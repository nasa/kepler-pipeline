function self = test_retrieve_comprehensive_kic_info_ccdsMjd_q0(self)
%kamal
% 
...
display('test_retrieve_comprehensive_kic_info_ccdsMjd_q0(self)');
...
outputStruct = retrieve_comprehensive_kic_info(ccdModules, ccdOutputs,mjdStartq0);
