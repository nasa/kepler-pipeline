function self = test_retrieve_tad_targets_q1(self)
% Kamal Uddin
% 
...
display('test_retrieve_tad_targets_q1');
...
tadTargets = retrieve_tad_targets(module, output, q1targetListSetName, includeRejected);
