function self = test_retrieve_flat_field_model_q6(self)
% Kamal Uddin
% 
...
%
tic;
display('test_retrieve_flat_field_model_mjd_q6(self)');
display(datestr(now()));

% startMjd = 55371.93711104;
% endMjd   = 55399.03206960;
...
module =7;
output =2;
flatFieldData = retrieve_flat_field_model(module, output, mjdStartq6, mjdEndq6);

 
if (isempty(flatFieldData))
