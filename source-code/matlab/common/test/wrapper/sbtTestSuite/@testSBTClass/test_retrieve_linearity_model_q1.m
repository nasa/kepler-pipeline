function self = test_retrieve_linearity_model_q1(self)
...
tic;
display('test_retrieve_linearity_model_q1');
% isLongCadence=1;
display(datestr(now()));
...
linearityData = retrieve_linearity_model(mjdStartq1, mjdEndq1, module, output);

 
if (isempty(linearityData))
