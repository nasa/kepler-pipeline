function self = test_retrieve_pixel_time_series_uncalibrated_q1(self)
% Kamal Uddin
...
display('test_retrieve_pixel_time_series_uncalibrated_q1(self)');
...
timeSeriesStruct = retrieve_pixel_time_series(modules, outputs,mjdStartq1, mjdEndq1, isLongCadence, isCalibrated);
