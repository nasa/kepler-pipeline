function self = test_retrieve_ts_FluxWeightedCentroidRows(self)
...
display('test_retrieve_ts_FluxWeightedCentroidRows');
display(datestr(now()));
...
%           endCadence = 12310;
         % tsFlux  = retrieve_ts('SapRawFluxLong',       keplerIds, startCadence, endCadence);
          ...
          tsFlux = retrieve_ts('FluxWeightedCentroidRows', keplerIds, startCadenceq0, endCadenceq0);
