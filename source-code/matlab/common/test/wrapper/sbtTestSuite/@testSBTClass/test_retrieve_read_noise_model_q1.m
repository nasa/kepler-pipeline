function self = test_retrieve_read_noise_model_q1(self)
% Kamal Uddin
% 
...
%
display('test_retrieve_read_noise_model_q1');
display(datestr(now()));
tic;
...
readNoiseData = retrieve_read_noise_model(mjdStartq1, mjdEndq1);
