function self = test_retrieve_ts_PrfCentroidRowsUncert(self)
...
display('test_retrieve_ts_PrfCentroidRowsUncert');
display(datestr(now()));
...
tsFlux = retrieve_ts('PrfCentroidRowsUncert', keplerIds, startCadenceq1, endCadenceq1);
