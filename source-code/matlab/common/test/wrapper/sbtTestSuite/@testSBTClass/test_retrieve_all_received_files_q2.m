function self = test_retrieve_all_received_files_q2(self)
%kamal Uddin
% 
...
%
display('test_retrieve_all_received_files_q2(self)');
tic;
...
%   [mjdStart mjdEnd]
    ...
    retAllRecFiles = retrieve_all_received_files(mjdStartq2, mjdEndq2);
% 
