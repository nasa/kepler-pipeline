function self = test_retrieve_flat_field_model_q1(self)
% Kamal Uddin
% 
...
%
tic;
display('test_retrieve_flat_field_model_mjd_q1(self)');
display(datestr(now()));
...
flatFieldData = retrieve_flat_field_model(module, output, mjdStartq1, mjdEndq1);
