function self = test_retrieve_ancillary_data_q3(self)
%Kamal Uddin
% 
...
display('test_retrieve_ancillary_data_q3(self)');
display(datestr(now()));
...
% [ mjdStart mjdEnd];
    ...
    retrieveAncillaryData =  retrieve_ancillary_data(mjdStartq3, mjdEndq3);
