function self = test_retrieve_pixel_time_series_uncalibrated_q5(self)
% Kamal Uddin
...
display('test_retrieve_pixel_time_series_uncalibrated_q5(self)');
...
timeSeriesStruct = retrieve_pixel_time_series(modules, outputs,mjdStartq5, mjdEndq5, isLongCadence, isCalibrated);
