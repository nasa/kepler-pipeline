function self = test_retrieve_ts_FluxWeightedCentroidRowsUncert(self)
...
display('test_retrieve_ts_FluxWeightedCentroidRowsUncert');
display(datestr(now()));
...
%           endCadence  =  12310;
         ...
         test_inputs
          ...
          tsFlux = retrieve_ts('FluxWeightedCentroidRowsUncert', keplerIds, startCadenceq1, endCadenceq1);
