function self = test_retrieve_tad_targets_q4(self)
% Kamal Uddin
% 
...
display('test_retrieve_tad_targets');
...
%targetListSetName= 'quarter4_winter2009_lc_supp';
 test_inputs
...
tadTargets = retrieve_tad_targets(module, output, q4targetListSetName, includeRejected);
