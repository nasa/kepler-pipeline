function self = test_retrieve_kepler_ids_by_label_q6(self)
%Kamal Uddin, 
% 
...
display('test_retrieve_kepler_ids_by_label_q6');
display(datestr(now()));

%targetListSetName='go_lc_custom_quarter6_summer2010_trimmed.txt';
test_inputs
...
matchingTargets = retrieve_kepler_ids_by_label(q6targetListSetName);
