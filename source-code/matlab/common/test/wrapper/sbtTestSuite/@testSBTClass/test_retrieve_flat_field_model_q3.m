function self = test_retrieve_flat_field_model_q3(self)
% Kamal Uddin
% 
...
%
tic;
display('test_retrieve_flat_field_model_mjd_q3(self)');
display(datestr(now()));
...
flatFieldData = retrieve_flat_field_model(module, output, mjdStartq3, mjdEndq3);
