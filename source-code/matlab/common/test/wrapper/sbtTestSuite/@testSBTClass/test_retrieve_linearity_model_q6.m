function self = test_retrieve_linearity_model_q6(self)
...
display(datestr(now()));
% isLongCadence=1;
display('test_retrieve_linearity_model_q5');
...
linearityData = retrieve_linearity_model(mjdStartq6, mjdEndq6, module, output);
