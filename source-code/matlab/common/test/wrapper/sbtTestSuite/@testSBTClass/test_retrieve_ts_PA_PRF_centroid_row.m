function self = test_retrieve_ts_PA_PRF_centroid_row(self)
...
display('test_retrieve_ts_PA_PRF_centroid_row');
display(datestr(now()));

% Get the PA_PRF_centroid row values/uncertainties for three keplerIds for the first
...
%           endCadence = 12310;
          ...
          tsPrfCentRow       = retrieve_ts('PrfCentroidRows',       keplerIds, startCadenceq2,endCadenceq2 );
           if (isempty(tsPrfCentRow))
            assert(1, 0, 'The retrieved structure is empty.');
           end
          
          tsPrfCentRowUncert = retrieve_ts('PrfCentroidRowsUncert', keplerIds, startCadenceq2 , endCadenceq2);
          ...
          tsPrfCentCol       = retrieve_ts('PrfCentroidCols',       keplerIds, startCadenceq2 , endCadenceq2 );
          ...
          tsPrfCentColUncert = retrieve_ts('PrfCentroidColsUncert', keplerIds,startCadenceq2 , endCadenceq2  );
...
toc;
clear tsPrfCentRow tsPrfCentRowUncert tsPrfCentCol tsPrfCentColUncert ;
  display('*********Done*******');
