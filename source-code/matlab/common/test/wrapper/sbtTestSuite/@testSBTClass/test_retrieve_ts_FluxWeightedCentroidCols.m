function self = test_retrieve_ts_FluxWeightedCentroidCols(self)
...
display('test_retrieve_ts_FluxWeightedCentroidCols');
display(datestr(now()));
...
%           endCadence = 12310;
         % tsFlux  = retrieve_ts('SapRawFluxLong',       keplerIds, startCadence, endCadence);
          ...
          tsFlux = retrieve_ts('FluxWeightedCentroidCols', keplerIds, startCadenceq5, endCadenceq5);
