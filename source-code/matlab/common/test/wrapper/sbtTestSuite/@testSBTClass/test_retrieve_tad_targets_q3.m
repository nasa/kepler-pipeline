function self = test_retrieve_tad_targets_q3(self)
% Kamal Uddin
% 
...
display('test_retrieve_tad_targets_q3');
...
%targetListSetName= 'quarter3_fall2009_lc_v3';
...
tadTargets = retrieve_tad_targets(module, output, q3targetListSetName, includeRejected);
