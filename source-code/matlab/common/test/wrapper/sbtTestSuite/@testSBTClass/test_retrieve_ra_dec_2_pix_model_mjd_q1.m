function self = test_retrieve_ra_dec_2_pix_model_mjd_q1(self)
% Kamal Uddin
% 
...
display('test_retrieve_ra_dec_2_pix_model_mjd_q1');
...
raDec2PixData = retrieve_ra_dec_2_pix_model(mjdStartq1, mjdEndq1);
