 function self = test_retrieve_target_list_q3(self)
% Kamal Uddin
% 
...
tic;
 ...
 display('test_retrieve_target_list_q3');
 
 display(datestr(now()));

%mdj is for q3 and month 1

%targetListName= 'pdq_stellar_quarter3_fall2009.txt';
...
Output = retrieve_target_list(q3targetListSetName);
