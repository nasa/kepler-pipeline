function self = test_retrieve_invalid_pixels_model_q4(self)
% Kamal Uddin
% 
...
display('test_retrieve_invalid_pixels_model');
...
invalidPixelsData = retrieve_invalid_pixels_model(module, output, mjdStartq4, mjdEndq4);
