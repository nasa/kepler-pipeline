function self = test_retrieve_motion_polys_mjdLc(self)
...
display(' test_retrieve_motion_polys_ccdLc(self)');
...
motion_poly_struct = retrieve_motion_polys(mjdStartq1, mjdEndq1, isLongCadence);
