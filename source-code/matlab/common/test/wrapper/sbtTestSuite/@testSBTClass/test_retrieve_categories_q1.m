function self = test_retrieve_categories_q1(self)
%kamal
% 
...
display('test_retrieve_categories_q1(self)');
% 4. retrieve available data range, input 1 for short cadence, 0 or empty is
%for long cadence
display(datestr(now()));


% q1targetListSetName='astero_lc_quarter1_spring2009_v2_trimmed.txt';
                    test_inputs
 ...
 categories = retrieve_categories(q1targetListSetName);
