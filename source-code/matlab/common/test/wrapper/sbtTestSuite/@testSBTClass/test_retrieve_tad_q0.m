function self = test_retrieve_tad_q0(self)
...
tadInputStruct = retrieve_tad(module, output, q0targetListSetName, includeRejected);
%    ~isempty(self);
...
toc;
clear tadInputStruct;display('*********Done*******');
end
