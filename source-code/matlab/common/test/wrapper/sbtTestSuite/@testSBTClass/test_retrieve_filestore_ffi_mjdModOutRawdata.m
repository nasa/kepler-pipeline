function self = test_retrieve_filestore_ffi_mjdModOutRawdata(self)
% Kamal Uddin
% 
...
%
tic;
display('test_retrieve_filestore_ffi_mjdModOutRawdata');
display(datestr(now()));
...
outputs=2;
 ...
 ffi_data_struct = retrieve_filestore_ffi(mjdStartq4, mjdEndq4, modules, outputs, get_raw_data);
