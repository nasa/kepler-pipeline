function self = test_retrieve_motion_polys_q3(self)
% Kamal Uddin
...
display('test_retrieve_motion_polys_q3(self)');
...
% 
 ...
 motion_poly_struct =  retrieve_motion_polys(mjdStartq3, mjdEndq3);
