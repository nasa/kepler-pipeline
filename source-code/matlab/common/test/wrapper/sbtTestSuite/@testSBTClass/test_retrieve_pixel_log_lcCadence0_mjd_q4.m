function self = test_retrieve_pixel_log_lcCadence0_mjd_q4(self)
%this test for sc
% Kamal Uddin
% 
...
%
tic;
display('test_retrieve_pixel_log_lcCadence0_mjd_q0');
display(datestr(now()));

isLongCadence=0;
%for sc, month 4

% startInterval= 54953.03;
% 
% endInterval =	54962.75;
...
pixelLogs = retrieve_pixel_log(isLongCadence,mjdStartq4, mjdEndq4, isInputCadenceNumber);
