function self = test_retrieve_target_time_series_q1(self)
...
display('test_retrieve_target_time_series_q1');
display(datestr(now()));
...
%    Get the DR_collateral_data for mod 7/out 3, coordinate 37 for cadences 0-400:
  ...
  targetTimeSeries = retrieve_target_time_series(ccdModules, ccdOutputs, startCadenceq1, endCadenceq1);
