function self = test_retrieve_two_d_black_model_mjd(self)
...
display('test_retrieve_two_d_black_model_mjd');
...
retTwoDBlack=retrieve_two_d_black_model(module, output, mjdStartq1, mjdEndq1);
