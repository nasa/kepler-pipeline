function self = test_retrieve_invalid_pixels_model_q0(self)
% Kamal Uddin
% 
...
display('test_retrieve_invalid_pixels_model_q0');
...
invalidPixelsData = retrieve_invalid_pixels_model(module, output, mjdStartq0, mjdEndq0);
