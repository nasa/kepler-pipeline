function self = test_retrieve_geometry_model_q1(self)
% Kamal Uddin
% 
...
%
tic;
display(' test_retrieve_geometry_model_q1(self)');
display(datestr(now()));
...
geometryData = retrieve_geometry_model(mjdStartq1, mjdEndq1);
