function self = test_retrieve_invalid_pixels_model_q6(self)
% Kamal Uddin
% 
...
display('test_retrieve_invalid_pixels_model_q6');
...
invalidPixelsData = retrieve_invalid_pixels_model(module, output, mjdStartq6, mjdEndq6);

 
if (isempty(invalidPixelsData))
    assert(1, 0, 'The retrieved structure is empty.');
end


toc;
clear invalidPixelsData;
display('*********Done*******');
end