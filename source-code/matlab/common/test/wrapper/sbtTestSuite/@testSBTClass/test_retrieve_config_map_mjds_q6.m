function self = test_retrieve_config_map_mjds_q6(self)
%kamalUddin
% 
...
%
tic;
display('test_retrieve_config_map_mjds_q6(self)');
display(datestr(now()));
...
%1st test with input paramenter mjdStart

display ('test_retrieve_config_map_mjds ');
 test_inputs
...
configMaps = retrieve_config_map(mjdStartq6, mjdEndq6);
