function self = test_retrieve_all_received_files_q1(self)
%kamal Uddin
% 
...
%
display('test_retrieve_all_received_files_q1(self)');
tic;
display(datestr(now()));
    ...
    retAllRecFiles = retrieve_all_received_files(mjdStartq1, mjdEndq1);
% 
