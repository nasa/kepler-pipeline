function self = test_retrieve_pixel_time_series_uncalibrated_q3(self)
% Kamal Uddin
...
display('test_retrieve_pixel_time_series_uncalibrated_q3(self)');
...
isCalibrated=1;
  ...
  timeSeriesStruct = retrieve_pixel_time_series(modules, outputs,mjdStartq3, mjdEndq3, isLongCadence, isCalibrated);
