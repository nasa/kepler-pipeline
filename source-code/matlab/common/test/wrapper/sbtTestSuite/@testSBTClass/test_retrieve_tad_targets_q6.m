function self = test_retrieve_tad_targets_q6(self)
% Kamal Uddin
% 
...
display('test_retrieve_tad_targets_q6');
...
%  test_inputs
           ...
           %targetListSetName='go_sc1_custom_quarter6_summer2010_trimmed.txt';

tadTargets = retrieve_tad_targets(module, output, q6targetListSetName, includeRejected);
