function self = test_retrieve_geometry_model_q6(self)
% Kamal Uddin
% 
...
%
tic;
display(' test_retrieve_geometry_model_q6(self)');
display(datestr(now()));
...
geometryData = retrieve_geometry_model(mjdStartq6, mjdEndq6);
 
if (isempty(geometryData))
