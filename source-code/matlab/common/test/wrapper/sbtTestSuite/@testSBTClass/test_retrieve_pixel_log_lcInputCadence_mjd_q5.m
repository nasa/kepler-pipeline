function self = test_retrieve_pixel_log_lcInputCadence_mjd_q5(self)
...
%
tic;
display('test_retrieve_pixel_log_lcInputCadence_mjd_q5');

display(datestr(now()));

isLongCadence=1;

% startInterval=  55275.98;
% endInterval = 55300.51;
...
pixelLogs = retrieve_pixel_log(isLongCadence,mjdStartq5, mjdEndq5, isInputCadenceNumber);
