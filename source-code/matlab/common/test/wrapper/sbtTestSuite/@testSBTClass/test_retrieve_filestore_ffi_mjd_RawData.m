function self = test_retrieve_filestore_ffi_mjd_RawData(self)
% Kamal Uddin
% 
...
%
tic;
display('test_retrieve_filestore_ffi_mjd_RawData');
display(datestr(now()));
get_raw_data =1;
%  start_mjd =55184.87;
%  end_mjd =55200.93;
 ...
 ffi_data_struct = retrieve_filestore_ffi(mjdStartq4, mjdEndq4, get_raw_data);
