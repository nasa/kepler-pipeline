function self = test_retrieve_two_d_black_model_q6(self)
...
display('test_retrieve_two_d_black_model_q6');
...
retTwoDBlack=retrieve_two_d_black_model(module, output, mjdStartq6, mjdEndq6);


%    ~isempty(self);
if (isempty(retTwoDBlack))
    assert(1, 0, 'The retrieved KIC is empty.');
end

toc;
clear retTwoDBlack;display('*********Done*******');
