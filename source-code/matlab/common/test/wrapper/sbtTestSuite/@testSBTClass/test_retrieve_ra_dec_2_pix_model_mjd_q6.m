function self = test_retrieve_ra_dec_2_pix_model_mjd_q6(self)
% Kamal Uddin
% 
...
display('test_retrieve_ra_dec_2_pix_model_mjd_q6');
...
raDec2PixData = retrieve_ra_dec_2_pix_model(mjdStartq6, mjdEndq6);


if (isempty(raDec2PixData))
...
toc;
clear raDec2PixData;display('*********Done*******');
end