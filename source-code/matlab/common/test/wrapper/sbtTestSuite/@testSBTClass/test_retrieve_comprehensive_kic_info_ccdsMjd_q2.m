function self = test_retrieve_comprehensive_kic_info_ccdsMjd_q2(self)
%kamal
% 
...
display('test_retrieve_comprehensive_kic_info_ccdsMjd_q2(self)');
...
outputStruct = retrieve_comprehensive_kic_info(ccdModules, ccdOutputs,mjdStartq2);
