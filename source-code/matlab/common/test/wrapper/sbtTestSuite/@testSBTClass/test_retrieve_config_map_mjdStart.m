function self = test_retrieve_config_map_mjdStart(self)
%kamalUddin
% 
...
%
tic;
display('test_retrieve_config_map_mjdStart(self)');
...
retConfigMap = retrieve_config_map(mjdStartq4);



if (isempty(retConfigMap))
