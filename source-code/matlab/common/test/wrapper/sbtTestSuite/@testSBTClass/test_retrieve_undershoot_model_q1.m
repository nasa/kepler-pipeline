function self = test_retrieve_undershoot_model_q1(self)
% Kamal Uddin
...
display('test_retrieve_undershoot_model_q1');
...
Output = retrieve_undershoot_model(mjdStartq1, mjdEndq1);
