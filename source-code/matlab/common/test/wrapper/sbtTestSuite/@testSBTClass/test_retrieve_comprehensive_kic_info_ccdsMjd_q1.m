function self = test_retrieve_comprehensive_kic_info_ccdsMjd_q1(self)
%kamal
% 
...
display('test_retrieve_comprehensive_kic_info_ccdsMjd_q1(self)');

%1st test with out  input paramenter mjdStart
display(datestr(now()));
...
outputStruct = retrieve_comprehensive_kic_info(ccdModules, ccdOutputs,mjdStartq1);
