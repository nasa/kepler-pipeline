function self = test_retrieve_motion_polys_q1(self)
% Kamal Uddin
...
display('test_retrieve_motion_polys_q1 (self)');
...
% end_mjd   = 54997.49;
 ...
 motion_poly_struct =  retrieve_motion_polys(mjdStartq1, mjdEndq1);
