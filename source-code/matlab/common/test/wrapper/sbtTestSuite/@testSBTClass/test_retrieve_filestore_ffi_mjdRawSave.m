function self = test_retrieve_filestore_ffi_mjdRawSave(self)
% Kamal Uddin
% 
...
%
tic;
display('test_retrieve_filestore_ffi_mjdRawSave');
display(datestr(now()));
...
saveLocalCopies=1;
 ...
 ffi_data_struct = retrieve_filestore_ffi(mjdStartq4, mjdEndq4,get_raw_data,saveLocalCopies);
