function self = test_retrieve_pixel_log_lcCadence0_mjd_q5(self)
%this test for sc
% Kamal Uddin
% 
...
%
tic;
display('test_retrieve_pixel_log_lcCadence0_mjd_q5');
display(datestr(now()));
...
% 
% startInterval=55200.98;
% endInterval = 55220.51;
