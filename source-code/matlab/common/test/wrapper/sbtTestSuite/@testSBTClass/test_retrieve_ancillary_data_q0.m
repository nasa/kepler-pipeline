function self = test_retrieve_ancillary_data_q0(self)
%Kamal Uddin
% 
...
display('test_retrieve_ancillary_data_q0(self)');
display(datestr(now()));
...
% [ mjdStart mjdEnd];
    ...
    retrieveAncillaryData =  retrieve_ancillary_data(mjdStartq0, mjdEndq0);
