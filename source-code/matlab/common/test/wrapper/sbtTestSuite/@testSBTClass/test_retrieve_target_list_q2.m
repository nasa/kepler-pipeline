 function self = test_retrieve_target_list_q2(self)
% Kamal Uddin
% 
...
tic;
 ...
 display('test_retrieve_target_list_q2');
 
 display(datestr(now()));

%mdj is for q3 and month 1

%targetListName= 'pdq_stellar_quarter2_summer2009_trimmed.txt';
  test_inputs
...
Output = retrieve_target_list(q2targetListSetName);
