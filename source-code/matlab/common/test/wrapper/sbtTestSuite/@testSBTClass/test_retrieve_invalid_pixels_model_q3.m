function self = test_retrieve_invalid_pixels_model_q3(self)
% Kamal Uddin
% 
...
display('test_retrieve_invalid_pixels_model_q3');
...
invalidPixelsData = retrieve_invalid_pixels_model(module, output, mjdStartq3, mjdEndq3);
