function self = test_retrieve_kicModOutMjdMagChar(self)
% Kamal Uddin
% 
...
display('test_retrieve_kicModOutMjdMag');
...
kics =retrieve_kics(module, output, mjdStartq1, minKeplerMag, maxKeplerMag, 'get_chars');
