function self = test_retrieve_ts_CentroidCols(self)
...
display('test_retrieve_ts_CentroidCols');
display(datestr(now()));
...
%           endCadence = 12310;
         % tsFlux  = retrieve_ts('SapRawFluxLong',       keplerIds, startCadence, endCadence);
          ...
          tsFlux = retrieve_ts('CentroidCols', keplerIds, startCadenceq6, endCadenceq6);
