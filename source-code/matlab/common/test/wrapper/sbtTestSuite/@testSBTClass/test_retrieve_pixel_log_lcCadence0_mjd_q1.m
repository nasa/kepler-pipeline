function self = test_retrieve_pixel_log_lcCadence0_mjd_q1(self)
%this test for sc
% Kamal Uddin
% 
...
%
display('test_retrieve_pixel_log_lcCadence0_mjd_q1');
display(datestr(now()));

isLongCadence=0;
%for sc, month 4
% 
% startInterval= 54964.00;
% endInterval =  54997.49;
...
pixelLogs = retrieve_pixel_log(isLongCadence,mjdStartq1, mjdEndq1, isInputCadenceNumber);
