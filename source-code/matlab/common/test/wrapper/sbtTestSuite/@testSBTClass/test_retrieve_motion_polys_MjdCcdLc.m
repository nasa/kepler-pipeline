function self = test_retrieve_motion_polys_MjdCcdLc(self)
...
display('test_retrieve_motion_polys_MjdCcd(self)');
...
ccdOutputs=2;
 ...
 motion_poly_struct = retrieve_motion_polys(mjdStartq1, mjdEndq1, ccdModules, ccdOutputs, isLongCadence);
