function self = test_retrieve_pixel_log_lcCadence0_q6(self)
...
%
tic;
display('test_retrieve_pixel_log_lc_Cadence0_q6');
display(datestr(now()));
...
pixelLogs = retrieve_pixel_log(isLongCadence,mjdStartq6, mjdEndq6, isInputCadenceNumber);
