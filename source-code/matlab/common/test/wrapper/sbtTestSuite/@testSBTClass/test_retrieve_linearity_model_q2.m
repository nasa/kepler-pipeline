function self = test_retrieve_linearity_model_q2(self)
...
tic;
display('test_retrieve_linearity_model_q2');
% isLongCadence=1;
display(datestr(now()));
...
linearityData = retrieve_linearity_model(mjdStartq2, mjdEndq2, module, output);
