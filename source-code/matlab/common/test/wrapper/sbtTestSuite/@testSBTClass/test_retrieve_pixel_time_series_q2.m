function self = test_retrieve_pixel_time_series_q2(self)
% Kamal Uddin
...
display('test_retrieve_pixel_time_series_q2(self)');
...
%endMjd   = 55012.80;
 ...
 pixelTimeSeries = retrieve_pixel_time_series(ccdModules, ccdOutputs,mjdStartq2, mjdEndq2,   isLongCadence, isCalibrated);
