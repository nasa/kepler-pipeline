function self = test_retrieve_received_file_q3(self)
%
...
display('test_retrieve_received_file_sdf_q3');
...
receivedFiles = retrieve_received_file(dispatcherType, mjdStartq4, mjdEndq5);
