function self = test_retrieve_geometry_model_q2(self)
% Kamal Uddin
% 
...
%
tic;
display(' test_retrieve_geometry_model_q2(self)');
display(datestr(now()));
...
geometryData = retrieve_geometry_model(mjdStartq2, mjdEndq2);
