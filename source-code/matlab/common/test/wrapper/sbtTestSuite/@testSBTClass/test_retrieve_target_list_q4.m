 function self = test_retrieve_target_list_q4(self)
% Kamal Uddin
% 
...
tic;
 ...
 display('test_retrieve_target_list_q4');
 
 display(datestr(now()));

%mdj is for q3 and month 1

%targetListName= 'pdq_stellar_quarter4_winter2009.txt';
 
%retrieve_target_list('kplr2009006012151_trivial_rp_dynamic_target_list.txt');
  test_inputs
...
Output = retrieve_target_list(q4targetListSetName);
