function self = test_retrieve_pixel_log_lcInputCadence_mjd_q3(self)
% Kamal Uddin
% 
...
display('test_retrieve_pixel_log_lcInputCadence_mjd_q3');
...
% 
% startInterval=  55092.71;
% endInterval =   55100.06;
...
pixelLogs = retrieve_pixel_log(isLongCadence,mjdStartq3, mjdEndq3, isInputCadenceNumber);
