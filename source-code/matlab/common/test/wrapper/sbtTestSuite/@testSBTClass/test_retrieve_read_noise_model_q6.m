function self = test_retrieve_read_noise_model_q6(self)
...
%
display('test_retrieve_read_noise_model_q6');
display(datestr(now()));
tic;
...
readNoiseData = retrieve_read_noise_model(mjdStartq6, mjdEndq6);


if (isempty(readNoiseData))
