function self = test_retrieve_kepler_ids_by_label_LabCategoriesSub1(self)
% Kamal Uddin
% 
...
%
tic;
display('test_retrieve_kepler_ids_by_label_LabCategoriesSub1');
display(datestr(now()));
% 
...
labelsAndCategoriesAreSubstrings =1 ;
test_inputs
