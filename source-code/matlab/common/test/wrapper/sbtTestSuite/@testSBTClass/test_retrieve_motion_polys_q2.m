function self = test_retrieve_motion_polys_q2(self)
% Kamal Uddin
...
display(' test_retrieve_motion_polys_q2(self)');
...
% end_mjd   = 55012.80;
 ...
 motion_poly_struct =  retrieve_motion_polys(mjdStartq2, mjdEndq2);
