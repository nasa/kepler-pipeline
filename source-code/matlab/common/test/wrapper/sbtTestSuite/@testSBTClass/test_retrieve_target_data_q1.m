function self = test_retrieve_target_data_q1(self)
...
%
display('test_retrieve_target_data_q1');
tic;
...
targets = retrieve_target_data(keplerIds, startCadenceq1, endCadenceq1, cadenceType, baseDescription);
