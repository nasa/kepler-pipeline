function self = test_retrieve_all_received_files_q0(self)
%kamal Uddin
% 
...
%
display('test_retrieve_all_received_files_q0(self)');
tic;
display(datestr(now()));
  ...
  %[mjdStart mjdEnd]
    ...
    retAllRecFiles = retrieve_all_received_files(mjdStartq0, mjdEndq0);
% 
