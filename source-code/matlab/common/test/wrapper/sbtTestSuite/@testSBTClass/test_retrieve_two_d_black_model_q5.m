function self = test_retrieve_two_d_black_model_q5(self)
...
display('test_retrieve_two_d_black_model_q5');
...
retTwoDBlack=retrieve_two_d_black_model(module, output, mjdStartq5, mjdEndq5);
