function self = test_retrieve_target_data_q0(self)
...
%
display('test_retrieve_target_data_q0');
tic;
...
targets = retrieve_target_data(keplerIds, startCadenceq0, endCadenceq0, cadenceType, baseDescription);
