function self = test_retrieve_linearity_model_q4(self)
...
tic;
% isLongCadence=1;
display('test_retrieve_linearity_model');
display(datestr(now()));
...
linearityData = retrieve_linearity_model(mjdStartq4, mjdEndq4, module, output);
