...
function self = test_retrieve_kics_matlabstyle_Mag(self)
...
tic;
% isLongCadence=1;
display('test_retrieve_kics_matlabstyle_Mag');
display(datestr(now()));
...
maxKeplerMag=10;
  test_inputs
	...
	kics = retrieve_kics_matlabstyle(module, output, mjdStartq3, minKeplerMag, maxKeplerMag);
