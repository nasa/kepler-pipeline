function self = test_retrieve_geometry_model_q4(self)
% Kamal Uddin
% 
...
%
tic;
display(' test_retrieve_geometry_model_q4(self)');
display(datestr(now()));
...
geometryData = retrieve_geometry_model(mjdStartq4, mjdEndq4);
