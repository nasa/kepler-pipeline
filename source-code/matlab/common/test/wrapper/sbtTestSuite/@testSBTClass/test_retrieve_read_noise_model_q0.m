function self = test_retrieve_read_noise_model_q0(self)
% Kamal Uddin
% 
...
%
display('test_retrieve_read_noise_model_q0');
display(datestr(now()));
tic;
...
readNoiseData = retrieve_read_noise_model(mjdStartq0, mjdEndq0);
