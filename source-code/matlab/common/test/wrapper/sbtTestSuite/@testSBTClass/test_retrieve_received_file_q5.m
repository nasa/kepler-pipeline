 function self = test_retrieve_received_file_q5(self)
%
...
display('test_retrieve_received_file_q5');
...
receivedFiles = retrieve_received_file(dispatcherType,mjdStartq5, mjdEndq6 );
