function self = test_retrieve_pixel_log_lcCadence0_mjd_q2(self)
%this test for sc
% Kamal Uddin
% 
...
%
tic;
display('test_retrieve_pixel_log_lcCadence0_mjd_q2');
display(datestr(now()));
...
% 
% startInterval= 55002.01;
% endInterval = 55012.80;
...
pixelLogs = retrieve_pixel_log(isLongCadence,mjdStartq2, mjdEndq2, isInputCadenceNumber);
