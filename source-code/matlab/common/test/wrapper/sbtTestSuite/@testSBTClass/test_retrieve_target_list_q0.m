 function self = test_retrieve_target_list_q0(self)
% Kamal Uddin
% 
...
tic;
 ...
 display('test_retrieve_target_list_q0');
 
 display(datestr(now()));

%mdj is for q3 and month 1

%targetListName= 'sc3_prf_cdpp_v2_3halos_verification.txt';
...
Output = retrieve_target_list(q0targetListSetName );
