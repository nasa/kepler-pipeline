function self = test_retrieve_invalid_pixels_model_q5(self)
% Kamal Uddin
% 
...
display('test_retrieve_invalid_pixels_model_q5');
...
invalidPixelsData = retrieve_invalid_pixels_model(module, output, mjdStartq5, mjdEndq5);
