 function self = test_retrieve_target_list_q5(self)
% Kamal Uddin
% 
...
tic;
 ...
 display('test_retrieve_target_list_q5');
 
 display(datestr(now()));

%mdj is for q3 and month 1

%targetListName= 'pdq_stellar_quarter5_spring2010.txt';
...
Output = retrieve_target_list(q5targetListSetName);
