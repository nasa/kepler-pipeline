function self = test_retrieve_read_noise_model_q2(self)
% Kamal Uddin
% 
...
%
display('test_retrieve_read_noise_model_q2');
display(datestr(now()));
tic;
...
readNoiseData = retrieve_read_noise_model(mjdStartq2, mjdEndq2);
