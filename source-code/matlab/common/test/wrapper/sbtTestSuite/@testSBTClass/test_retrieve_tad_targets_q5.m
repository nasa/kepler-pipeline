function self = test_retrieve_tad_targets_q5(self)
% Kamal Uddin
% 
...
display('test_retrieve_tad_targets_q5');
...
tadTargets = retrieve_tad_targets(module, output,q5targetListSetName, includeRejected);
