function self = test_retrieve_categories_q0(self)
%kamal
% 
...
% targetListSetName='quarter5_spring2010_untrimmed_lc';
 ...
 categories = retrieve_categories(q0targetListSetName);
