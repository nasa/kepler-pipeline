function self = test_retrieve_linearity_model_q3(self)
...
tic;
display('test_retrieve_linearity_model_q3');
% isLongCadence=1;
display(datestr(now()));
...
linearityData = retrieve_linearity_model(mjdStartq3, mjdEndq3, module, output);
