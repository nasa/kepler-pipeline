function self = test_retrieve_ra_dec_2_pix_model_mjd_q4(self)
% Kamal Uddin
% 
...
display('test_retrieve_ra_dec_2_pix_model_mjd_q4');
...
raDec2PixData = retrieve_ra_dec_2_pix_model(mjdStartq4, mjdEndq4);
