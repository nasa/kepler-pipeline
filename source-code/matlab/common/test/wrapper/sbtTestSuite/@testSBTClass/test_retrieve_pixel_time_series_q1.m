function self = test_retrieve_pixel_time_series_q1(self)
% Kamal Uddin
...
display('test_retrieve_pixel_time_series_q1(self)');
...
% endMjd   = 54997.49;
 ...
 pixelTimeSeries = retrieve_pixel_time_series(ccdModules, ccdOutputs,mjdStartq1, mjdEndq1,   isLongCadence, isCalibrated);
