...
function self = test_retrieve_pixel_model_DEAD(self)
% Kamal Uddin
% 
...
display('test_retrieve_pixel_model_DEAD');
...
type='DEAD';
 ...
 test_inputs
   ...
   pixelData = retrieve_pixel_model(module, output, mjdStartq4, mjdEndq4, type);
