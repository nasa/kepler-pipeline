function self = test_retrieve_received_file_q6(self)
%
...
display('test_retrieve_received_file_q6');

% Kamal Uddin
display(datestr(now()));

dispatcherType ='TARGET_LIST';
...
receivedFiles = retrieve_received_file(dispatcherType,mjdStartq6, mjdEndq7);
...
toc;
clear receivedFiles;display('*********Done*******');
end