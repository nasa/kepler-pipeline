function self = test_retrieve_target_data_q5(self)
...
%
display('test_retrieve_target_data_q5');
tic;
...
targets = retrieve_target_data(keplerIds, startCadenceq5, endCadenceq5, cadenceType, baseDescription);
