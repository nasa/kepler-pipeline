function self = test_retrieve_sky_group_q0(self)
...
%
tic;
display('test_retrieve_sky_group_sdf_q0');
display(datestr(now()));
...
ccdOutput =2;
 ...
 skyGroupStruct = retrieve_sky_group(ccdModule, ccdOutput, mjdStartq0);


%    ~isempty(self);
if (isempty(skyGroupStruct))
