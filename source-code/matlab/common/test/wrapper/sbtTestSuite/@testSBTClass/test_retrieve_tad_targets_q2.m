function self = test_retrieve_tad_targets_q2(self)
% Kamal Uddin
% 
...
display('test_retrieve_tad_targets_q2');
...
tadTargets = retrieve_tad_targets(module, output, q2targetListSetName, includeRejected);
