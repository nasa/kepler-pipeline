function self = test_retrieve_received_file_q1(self)
%
...
display('test_retrieve_received_file_q1');
...
receivedFiles = retrieve_received_file (dispatcherType,mjdStartq1, mjdEndq2 );
