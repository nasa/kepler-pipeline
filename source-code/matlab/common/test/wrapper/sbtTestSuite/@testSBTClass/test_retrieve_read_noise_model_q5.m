function self = test_retrieve_read_noise_model_q5(self)
% Kamal Uddin
% 
...
%
display('test_retrieve_read_noise_model_q5');
display(datestr(now()));
tic;
...
readNoiseData = retrieve_read_noise_model(mjdStartq5, mjdEndq5);
