 function self = test_retrieve_target_list_q1(self)
% Kamal Uddin
% 
...
tic;
 ...
 display('test_retrieve_target_list_q1');
 
 display(datestr(now()));

%mdj is for q3 and month 1

%targetListName= 'pdq_stellar_quarter1_spring2009_v2_trimmed_v2.txt';
...
Output = retrieve_target_list(q1targetListSetName);
