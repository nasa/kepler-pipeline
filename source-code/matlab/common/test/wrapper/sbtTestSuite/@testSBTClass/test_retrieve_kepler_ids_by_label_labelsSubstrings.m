function self = test_retrieve_kepler_ids_by_label_labelsSubstrings(self)
% Kamal Uddin
% 
...
%
tic;
display('test_retrieve_kepler_ids_by_label_labelsSubstrings');
display(datestr(now()));
...
test_inputs
 ...
 matchingTargets = retrieve_kepler_ids_by_label(q4targetListSetName, 'labels', labels, labelsAndCategoriesAreSubstrings);
