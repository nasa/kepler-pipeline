function self = test_retrieve_two_d_black_model_q2(self)
...
display('test_retrieve_two_d_black_model_q2');
...
retTwoDBlack=retrieve_two_d_black_model(module, output, mjdStartq2, mjdEndq2);
