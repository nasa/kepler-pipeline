function self = test_retrieve_target_data_q6(self)
...
%
display('test_retrieve_target_data_q6');
tic;
...
targets = retrieve_target_data(keplerIds, startCadenceq6, endCadenceq6, cadenceType, baseDescription);
