function self = test_retrieve_prf_model_mjd_q1(self)
% Kamal Uddin
% 
...
display('test_retrieve_prf_model_mjd_q1');
...
prfModel = retrieve_prf_model(ccdModule, ccdOutput, mjdStartq1);
