function self = test_retrieve_kepler_ids_by_label_Categories(self)
%Kamal Uddin
% 
...
%
tic;
display('test_retrieve_kepler_ids_by_label_Categories');
display(datestr(now()));

% targetListSetName= 'quarter4_winter2009_lc';

categories = {'PDQ_STELLAR'};
...
test_inputs
  ...
  matchingTargets = retrieve_kepler_ids_by_label(q4targetListSetName, 'categories', categories);
