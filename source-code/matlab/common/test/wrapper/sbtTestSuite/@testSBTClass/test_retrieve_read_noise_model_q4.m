function self = test_retrieve_read_noise_model_q4(self)
% Kamal Uddin
% 
...
%
display('test_retrieve_read_noise_model_q4');
display(datestr(now()));
tic;
...
readNoiseData = retrieve_read_noise_model(mjdStartq4, mjdEndq4);
