function self = test_retrieve_ts_FluxWeightedCentroidColsUncert(self)
...
display('test_retrieve_ts_FluxWeightedCentroidColsUncert');
display(datestr(now()));
...
%           endCadence = 12310;
         % tsFlux  = retrieve_ts('SapRawFluxLong',       keplerIds, startCadence, endCadence);
          ...
          tsFlux = retrieve_ts('FluxWeightedCentroidColsUncert', keplerIds, startCadenceq6, endCadenceq6);
