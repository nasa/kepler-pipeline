function self = test_retrieve_geometry_model_q5(self)
% Kamal Uddin
% 
...
%
tic;
display(' test_retrieve_geometry_model_q5(self)');
display(datestr(now()));
...
geometryData = retrieve_geometry_model(mjdStartq5, mjdEndq5);
