function self = test_retrieve_two_d_black_model_MjdRows(self)
...
display('test_retrieve_two_d_black_model_MjdRows');
display(datestr(now()));
module = 7;
output = 2;
...
retTwoDBlack=retrieve_two_d_black_model(module, output, mjdStartq2, mjdEndq2,  rows, cols);
