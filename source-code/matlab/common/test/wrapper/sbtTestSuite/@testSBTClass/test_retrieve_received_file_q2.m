function self = test_retrieve_received_file_q2(self)
%
...
display('test_retrieve_received_file_q2');
...
receivedFiles = retrieve_received_file(dispatcherType,mjdStartq2, mjdEndq3);
