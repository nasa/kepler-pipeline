function self = test_retrieve_received_file_q0(self)
%
...
display('test_retrieve_received_file_q0');
...
receivedFiles = retrieve_received_file(dispatcherType,mjdStartq0, mjdEndq2 );
