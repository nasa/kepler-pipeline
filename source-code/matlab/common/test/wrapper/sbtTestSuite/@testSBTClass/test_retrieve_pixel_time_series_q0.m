function self = test_retrieve_pixel_time_series_q0(self)
% Kamal Uddin
...
display('test_retrieve_pixel_time_series_q0(self)');
...
% endMjd   = 54962.75;
 ...
 timeSeriesStruct = retrieve_pixel_time_series(ccdModules, ccdOutputs, mjdStartq0, mjdEndq0, isLongCadence, isCalibrated);
