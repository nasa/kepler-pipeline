function self = test_retrieve_kepler_ids_by_label_q1(self)
%Kamal Uddin, 
% 
...
display('test_retrieve_kepler_ids_by_label_q1');
display(datestr(now()));
...
matchingTargets = retrieve_kepler_ids_by_label(q1targetListSetName);
