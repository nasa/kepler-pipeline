function self = test_retrieve_ts_CentroidRows(self)
...
%
tic;
display('test_retrieve_ts_CentroidRows');
display(datestr(now()));
...
tsFlux = retrieve_ts('CentroidRows', keplerIds, startCadenceq4, endCadenceq4);
