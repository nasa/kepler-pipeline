function self = test_retrieve_invalid_pixels_model_q2(self)
% Kamal Uddin
% 
...
display('test_retrieve_invalid_pixels_model_q2');
...
invalidPixelsData = retrieve_invalid_pixels_model(module, output, mjdStartq2, mjdEndq2);
