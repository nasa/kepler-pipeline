function self = test_retrieve_flat_field_model_q5(self)
% Kamal Uddin
% 
...
%
tic;
display('test_retrieve_flat_field_model_mjd_q5(self)');
display(datestr(now()));
...
flatFieldData = retrieve_flat_field_model(module, output, mjdStartq5, mjdEndq5);
