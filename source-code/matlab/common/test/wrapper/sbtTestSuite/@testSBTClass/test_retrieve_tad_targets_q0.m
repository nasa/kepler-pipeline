function self = test_retrieve_tad_targets_q0(self)
% Kamal Uddin
% 
...
display('test_retrieve_tad_targets_q0');
...
%targetListSetName= 'cdpp_v1_verification_lc_supp_v2';
 test_inputs
...
tadTargets = retrieve_tad_targets(module, output, q0targetListSetName, includeRejected);

%    ~isempty(self);
if (isempty(tadTargets))
