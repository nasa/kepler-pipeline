function self = test_retrieve_pixel_time_series_uncalibrated_q6(self)
% Kamal Uddin
...
display('test_retrieve_pixel_time_series_uncalibrated_q6(self)');
...
outputs=2;
% 
% startMjd = 55371.93711104;
% endMjd  = 55380.03206960;
...
timeSeriesStruct = retrieve_pixel_time_series(modules, outputs,mjdStartq6, mjdEndq6, isLongCadence, isCalibrated);


if (isempty(timeSeriesStruct))
    assert(1, 0, 'The retrieved structure is empty.');
end


toc;
clear timeSeriesStruct;
display('*********Done*******');
end