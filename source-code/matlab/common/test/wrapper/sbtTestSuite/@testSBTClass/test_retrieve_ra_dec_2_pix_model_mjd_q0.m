function self = test_retrieve_ra_dec_2_pix_model_mjd_q0(self)
% Kamal Uddin
% 
...
display('test_retrieve_ra_dec_2_pix_model_mjd_q0');
...
raDec2PixData = retrieve_ra_dec_2_pix_model(mjdStartq0, mjdEndq0);
