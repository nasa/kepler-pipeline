function self = test_retrieve_two_d_black_model_q0(self)
...
display('test_retrieve_two_d_black_model_q0');
...
retTwoDBlack=retrieve_two_d_black_model(module, output, mjdStartq0, mjdEndq0);
