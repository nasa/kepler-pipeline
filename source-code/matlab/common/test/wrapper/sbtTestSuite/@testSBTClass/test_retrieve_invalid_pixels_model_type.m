function self = test_retrieve_invalid_pixels_model_type(self)
% Kamal Uddin
% 
...
display('test_retrieve_invalid_pixels_model_type');
display(datestr(now()));
...
invalidPixelsData = retrieve_invalid_pixels_model(module, output, mjdStartq1, mjdEndq1, type);
