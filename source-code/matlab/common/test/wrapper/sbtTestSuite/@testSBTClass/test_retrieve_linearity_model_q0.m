function self = test_retrieve_linearity_model_q0(self)
...
tic;
display('test_retrieve_linearity_model_q0');
% isLongCadence=1;
display(datestr(now()));
% 
% mjdStart = 54953.03;
...
linearityData = retrieve_linearity_model(mjdStartq0, mjdEndq0, module, output);
