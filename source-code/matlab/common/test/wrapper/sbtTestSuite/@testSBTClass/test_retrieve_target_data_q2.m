function self = test_retrieve_target_data_q2(self)
...
%
display('test_retrieve_target_data_q2');
tic;
...
targets = retrieve_target_data(keplerIds, startCadenceq2, endCadenceq2, cadenceType, baseDescription);
