 function self = test_retrieve_target_list_q6(self)
% Kamal Uddin
% 
...
tic;
 ...
 display('test_retrieve_target_list_q6');
 
 display(datestr(now()));

%mdj is for q3 and month 1

%targetListName= 'eb_quarter6_summer2010_trimmed.txt';
 test_inputs
...
Output = retrieve_target_list(q6targetListSetName);
