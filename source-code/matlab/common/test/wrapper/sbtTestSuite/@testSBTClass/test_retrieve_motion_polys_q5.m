function self = test_retrieve_motion_polys_q5(self)
% Kamal Uddin
...
%
display('test_retrieve_motion_polys_q5');
display(datestr(now()));
% isLongCadence=1;

tic;

display(' test_retrieve_motion_polys_sdf_q5(self)');
...
% end_mjd   = 55300.51;
 ...
 motion_poly_struct =  retrieve_motion_polys(mjdStartq5, mjdEndq5);
