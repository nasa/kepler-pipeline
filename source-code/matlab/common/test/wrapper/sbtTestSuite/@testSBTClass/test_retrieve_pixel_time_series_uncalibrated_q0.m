function self = test_retrieve_pixel_time_series_uncalibrated_q0(self)
% Kamal Uddin
...
display('test_retrieve_pixel_time_series_uncalibrated_q0(self)');
...
isCalibrated=1;
  ...
  timeSeriesStruct = retrieve_pixel_time_series(modules, outputs,mjdStartq0, mjdEndq0, isLongCadence, isCalibrated);
