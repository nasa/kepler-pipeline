function self = test_retrieve_target_data_q3(self)
...
%
display('test_retrieve_target_data_q3');
tic;
...
targets = retrieve_target_data(keplerIds, startCadenceq3, endCadenceq3, cadenceType, baseDescription);
