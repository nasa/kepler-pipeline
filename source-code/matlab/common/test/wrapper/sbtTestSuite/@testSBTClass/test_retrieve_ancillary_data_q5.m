function self = test_retrieve_ancillary_data_q5(self)
%Kamal Uddin
% 
...
display('test_retrieve_ancillary_data_q5(self)');
display(datestr(now()));
% 
% mjdStart = 55275.98;
% mjdEnd   = 55295.40;
...
% [ mjdStart mjdEnd];
    ...
    retrieveAncillaryData =  retrieve_ancillary_data(mjdStartq5, mjdEndq5);
