function self = test_retrieve_pixel_time_series_q5(self)
% Kamal Uddin
...
display('test_retrieve_pixel_time_series_q5(self)');
...
pixelTimeSeries = retrieve_pixel_time_series(ccdModules, ccdOutputs, mjdStartq5, mjdEndq5, isLongCadence, isCalibrated);
