function self = test_retrieve_pixel_time_series_uncalibrated_q2(self)
% Kamal Uddin
...
display('test_retrieve_pixel_time_series_uncalibrated_q2(self)');
...
isLongCadence=1;
isCalibrated=1;
timeSeriesStruct = retrieve_pixel_time_series(modules, outputs,mjdStartq2, mjdEndq2, isLongCadence, isCalibrated);
