function self = test_retrieve_filestore_ffi_q6(self)
...
%
tic;
display('test_retrieve_filestore_ffi_q6');
display(datestr(now()));
...
retAllRecFiles= retrieve_filestore_ffi(mjdStart, mjdEnd, get_raw_data);
