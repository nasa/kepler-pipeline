function self = test_retrieve_geometry_model_q0(self)
% Kamal Uddin
% 
...
%
tic;
display(' test_retrieve_geometry_model_q0(self)');
display(datestr(now()));
...
geometryData = retrieve_geometry_model(mjdStartq0, mjdEndq0);
