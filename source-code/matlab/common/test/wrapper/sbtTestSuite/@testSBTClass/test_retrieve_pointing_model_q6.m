function self = test_retrieve_pointing_model_q6(self)
% Kamal Uddin
% 
...
display('test_retrieve_pointing_model_q6');
display(datestr(now()));
...
pointingData = retrieve_pointing_model(mjdStartq6, mjdEndq6);


if (isempty(pointingData))
...
toc;
clear pointingData;display('*********Done*******');
end