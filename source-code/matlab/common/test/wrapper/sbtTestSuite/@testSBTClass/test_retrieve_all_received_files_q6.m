function self = test_retrieve_all_received_files_q6(self)
%kamal Uddin
% 
...
%
display('test_retrieve_all_received_files_q6(self)');
tic;
display(datestr(now()));

% mjdStart = 55371.93711104;
% mjdEnd   = 55399.03206960;
% 
%     
%   [mjdStart mjdEnd]
    ...
    retAllRecFiles = retrieve_all_received_files(mjdStartq6, mjdEndq6);
% 
