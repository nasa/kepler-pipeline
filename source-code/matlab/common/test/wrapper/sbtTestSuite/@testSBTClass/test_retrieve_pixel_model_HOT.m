...
function self = test_retrieve_pixel_model_HOT(self)
%kamalUddin
% 
...
display('test_retrieve_pixel_model_HOT');
% Kamal Uddin
display(datestr(now()));
module =7;
output=2;
...
type='HOT';
 test_inputs
   ...
   pixelData = retrieve_pixel_model(module, output, mjdStartq3, mjdEndq3, type);
