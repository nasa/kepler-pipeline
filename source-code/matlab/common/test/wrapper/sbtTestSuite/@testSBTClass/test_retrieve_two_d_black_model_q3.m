function self = test_retrieve_two_d_black_model_q3(self)
...
display('test_retrieve_two_d_black_model_q3');
...
retTwoDBlack=retrieve_two_d_black_model(module, output, mjdStartq3, mjdEndq3);
