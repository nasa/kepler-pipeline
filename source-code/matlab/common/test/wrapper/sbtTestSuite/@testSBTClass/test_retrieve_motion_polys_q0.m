function self = test_retrieve_motion_polys_q0(self)
% Kamal Uddin
...
display(' test_retrieve_motion_polys_q0(self)');
display(datestr(now()));
...
motion_poly_struct =  retrieve_motion_polys(mjdStartq0, mjdEndq0);
