function self = test_retrieve_pixel_time_series_ModMjdLcCalibrated(self)
%kamalUddin
% 
...
% Kamal Uddin
display('test_retrieve_pixel_time_series_ModMjdLcCalibrated');
display(datestr(now()));
...
isCalibrated=1;
 test_inputs
  ...
  pixelTimeSeries = retrieve_pixel_time_series(ccdModules, ccdOutputs,mjdStartq3, mjdEndq3,   isLongCadence, isCalibrated);
