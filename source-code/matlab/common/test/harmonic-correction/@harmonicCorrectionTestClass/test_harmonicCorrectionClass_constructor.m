function self = test_harmonicCorrectionClass_constructor( self )
%
% test_harmonicCorrectionClass_constructor -- unit test for the constructor of the
...
%
%      run(text_test_runner, harmonicCorrectionTestClass('test_harmonicCorrectionClass_constructor'));
%
% 
