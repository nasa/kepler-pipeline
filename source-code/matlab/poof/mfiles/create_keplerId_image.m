function imageKeplerId = create_keplerId_image(tadStruct)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% function imageKeplerId = create_keplerId_image(tadStruct)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% creates a 2D array of kepler ID for the input tadStruct
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% INPUT:
%           
...
% OUTPUT:
%          
%           imageKeplerId: [nRows x nCols uint32] 2D array of kepler Id's
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% 
...
imageKeplerId = uint32(zeros(FcConstants.CCD_ROWS, FcConstants.CCD_COLUMNS));

for t =1:nTargets
    keplerId = targets(t).keplerId;
    numOffsets = length(targets(t).offsets);
    referenceRow = targets(t).referenceRow + 1;
    referenceColumn = targets(t).referenceColumn + 1;

    for p=1:numOffsets
        r = referenceRow + targets(t).offsets(p).row;
        c = referenceColumn + targets(t).offsets(p).column;
        imageKeplerId(r, c) = keplerId;
    end
