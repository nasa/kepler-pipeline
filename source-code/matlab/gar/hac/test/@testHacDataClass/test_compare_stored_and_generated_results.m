...
%      run(text_test_runner, testHacDataClass('test_compare_stored_and_generated_results'));
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% 
...
resultsFileName = 'HacResults.mat';
...
% Load saved results structure hacResultsStruct.
load(fullResultsFileName, 'hacResultsStruct'); 

% Instantiate a hac data object.
hacDataObject = hacDataClass(hacDataStruct);

% Generate a test results structure.
[testHacResultsStruct] = histogram_accumulator(hacDataObject);
