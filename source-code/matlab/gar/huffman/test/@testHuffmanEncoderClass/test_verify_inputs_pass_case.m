function self = test_verify_inputs_pass_case(self)
...
%  Example: run(text_test_runner, testHuffmanEncoderClass('test_verify_inputs_pass_case'));
% 
...
huffmanEncoderClass(huffmanInputStruct); % ignore return value
