function [huffmanOutputStruct] = generate_length_limited_huffman_code_fast(huffmanEncoderObject)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% function [huffmanOutputStruct] =
% generate_length_limited_huffman_code_fast(huffmanEncoderObject)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
% weight (probability or frequency) and each item is considered to be a
...
%
% this step converted to c mex file because of heavy computational burden
%
...
tic
[symbolDepths] =   get_symbol_depths(levelStruct, symbolFrequencies,  huffmanCodeWordLengthLimit  );
t2 = toc;
...
tic
binaryNodesStruct = build_huffman_code_tree(symbolProbabilities, nodeDepths, symbolTypes, nodeNumbers, symbolNumbers);
t3 = toc;
