...
%  Example: run(text_test_runner, testRequantizationTableClass('test_compare_stored_and_generated_results'));
% 
...
requantizationTableObject = requantizationTableClass(requantizationInputStruct);

requantizationOutputStructNew = generate_requantization_table(requantizationTableObject);

messageOut = 'Regression test failed - stored results and generated results are not identical!';
assert_equals(requantizationOutputStructNew, requantizationOutputStruct, messageOut);
