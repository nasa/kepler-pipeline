...
%         Example: run(text_test_runner, testRequantizationTableClass('test_validate_inputs_pass_case'));
...
requantizationInputStruct = validate_requantization_inputs(requantizationInputStruct); %#ok<NODEF>

%ignore returned value
requantizationTableClass(requantizationInputStruct);
