...
\subsection{Motion Polynomials Availability}

\tablefirsthead{%
  \toprule
  \textbf{CCD Module}
  & \multicolumn{1}{r}{\textbf{CCD Output}}
  & \textbf{Channel}
  & \textbf{At Least One Gap}
  & \textbf{Motion Polynomial}\\
  &
  &
  & \textbf{in Motion Polynomial}
  & \textbf{Available}\\
  \midrule
}%
...
\begin{supertabular*}{\tablewidth}{@{\extracolsep{\fill}} c c c c c}
  \input{motion-availability}
\end{supertabular*}
