...
\tablefirsthead{%
  \toprule
  \textbf{Metric}
  & \multicolumn{1}{r}{\textbf{\# Anomalies}}
  & \textbf{MJD First}
  & \textbf{MJD Last}\\
  \midrule
}%
...
\begin{supertabular*}{\tablewidth}{@{\extracolsep{\fill}} l r l l}
...
\tablefirsthead{%
  ...
  & \textbf{MJD}
  & \textbf{Bound Type}
  & \multicolumn{1}{r}{\textbf{Bound Value}}
  & \multicolumn{1}{r}{\textbf{Metric Value}}\\
  \midrule
}%
