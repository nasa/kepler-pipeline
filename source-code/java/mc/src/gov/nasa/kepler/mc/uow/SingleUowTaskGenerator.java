...
public class SingleUowTaskGenerator implements UnitOfWorkTaskGenerator {
    ...
    public List<? extends UnitOfWorkTask> generateTasks(
        ...
        List<SingleUowTask> tasks = new LinkedList<SingleUowTask>();
        SingleUowTask prototypeTask = new SingleUowTask();
