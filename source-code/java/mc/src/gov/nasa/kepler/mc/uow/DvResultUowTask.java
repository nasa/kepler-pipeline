 ...
 *
 */
public class DvResultUowTask extends UnitOfWorkTask {
    ...
    public DvResultUowTask() {
    }
    
    public DvResultUowTask(int startKeplerId, int endKeplerId,
    ...
    public String briefState() {
        ...
        bldr.append("keplerIds[").append(startKeplerId)
        .append(',').append(endKeplerId).append(']');
        bldr.append(" pipeline inst ");
        bldr.append(" = ");

        bldr.append(pipelineInstanceId);
