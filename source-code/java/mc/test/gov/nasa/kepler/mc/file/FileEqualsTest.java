...
public class FileEqualsTest {
    ...
    private static final String OUTPUT_DIRECTORY = "build/test/FileEquals";
    ...
    public void expectedFileNull() throws IOException {

        assertNull(FileEquals.equals(null, outputDirectory));
    }

    @Test(expected = NullPointerException.class)
    public void actualFileNull() throws IOException {

        assertNull(FileEquals.equals(outputDirectory, null));
    }
    ...
    public void mixedFileTypes() throws IOException {
        ...
        file.createNewFile();
        assertNull(FileEquals.equals(outputDirectory, file));
    }
    ...
    public void mixedFileTypes2() throws IOException {
        ...
        File file = new File(outputDirectory, "test.txt");
        file.createNewFile();
        assertNull(FileEquals.equals(file, outputDirectory));
    }
    ...
    public void expectedNotDirectory() throws IOException {
        ...
        File file = new File(outputDirectory, "test.txt");
        file.createNewFile();
        assertNull(FileEquals.directoryEquals(file, outputDirectory));
    }
    ...
    public void actualNotDirectory() throws IOException {
        ...
        File file = new File(outputDirectory, "test.txt");
        file.createNewFile();
        assertNull(FileEquals.directoryEquals(outputDirectory, file));
    }
    ...
    public void filesEquals() throws IOException {
        ...
        assertNull(FileEquals.equals(file1, file2));
    }
    ...
    @Test
    public void binaryFilesEqualsMissingFiles() throws IOException {

        File file1 = new File(outputDirectory, "test1.txt");
        File file2 = new File(outputDirectory, "test2.txt");
        FileUtils.writeStringToFile(file1, TEST_STRING);
        assertEquals("build/test/FileEquals/test2.txt: does not exist.",
            FileEquals.binaryEquals(file1, file2));
    }

    @Test
    public void binaryFilesEqualsFalse() throws IOException {
        ...
        FileUtils.writeStringToFile(file2, TEST_STRING + "\n" + TEST_STRING);
        assertEquals(
            "test1.txt test2.txt differ: byte 28",
            FileEquals.binaryEquals(file1, file2));
    }

    @Test
    public void binaryFilesEquals() throws IOException {

        File file1 = new File(outputDirectory, "test1.txt");
        File file2 = new File(outputDirectory, "test2.txt");
        FileUtils.writeStringToFile(file1, TEST_STRING);
        FileUtils.writeStringToFile(file2, TEST_STRING);
        assertNull(FileEquals.binaryEquals(file1, file2));
    }
    ...
    public void directoryEquals() throws IOException {
        ...
        FileUtils.writeStringToFile(file1, TEST_STRING);
        FileUtils.writeStringToFile(file2, TEST_STRING);
        assertNull(FileEquals.directoryEquals(dir1, dir2));
    }
    ...
    @Test(expected = NullPointerException.class)
    public void nullRegexs() throws IOException {

        assertNull(FileEquals.equals(new File(outputDirectory, "test1"),
            new File(outputDirectory, "test2"), (String[]) null));
    }

    @Test(expected = IllegalArgumentException.class)
    public void emptyRegexs() throws IOException {

        assertNull(FileEquals.equals(new File(outputDirectory, "test1"),
            new File(outputDirectory, "test2"), new String[0]));
    }
    ...
    public void regexEquals() throws IOException {
        ...
        assertNull(FileEquals.equals(dir1, dir2,
            new String[] { "^(.*)(?:\\.\\.\\. [onet]{3},)(.*)$" }));
    }
    ...
    @Test
    public void allResults() throws IOException {
        ...
        new File(subdir2, "test1").mkdir();
        new File(subdir1, "missing").mkdir();
        String result = FileEquals.directoryEquals(dir1, dir2);
