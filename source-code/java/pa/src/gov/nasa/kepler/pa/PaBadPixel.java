...
/**
 * A single identified bad pixel.
 * 
 * @author Forrest Girouard
 * 
 */
public class PaBadPixel implements Persistable {
    ...
    public PaBadPixel(final int ccdRow, final int ccdColumn, final String type,
        final double startMjd, final double endMjd, final float value) {
    ...
    public boolean equals(final Object obj) {
        ...
        PaBadPixel other = (PaBadPixel) obj;
