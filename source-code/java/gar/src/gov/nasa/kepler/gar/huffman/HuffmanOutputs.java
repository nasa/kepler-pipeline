...
/**
 * Outputs for the Huffman pipeline module.
 * 
 * @author Bill Wohler
 */
public class HuffmanOutputs implements Persistable {

    private int[] huffmanCodeLengths;
    private String[] huffmanCodeStrings;
    private float theoreticalCompressionRate;
    private float effectiveCompressionRate;

    public int[] getHuffmanCodeLengths() {
        return huffmanCodeLengths;
    }

    public void setHuffmanCodeLengths(int[] huffmanCodeLengths) {
        this.huffmanCodeLengths = huffmanCodeLengths;
    }

    public String[] getHuffmanCodeStrings() {
        return huffmanCodeStrings;
    }

    public void setHuffmanCodeStrings(String[] huffmanCodeStrings) {
        this.huffmanCodeStrings = huffmanCodeStrings;
    }
