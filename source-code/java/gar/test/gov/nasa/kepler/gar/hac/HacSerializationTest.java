...
/**
 * Tests the {@link HacInputs} and {@link HacOutputs} classes.
 * 
 * @author Bill Wohler
 */
public class HacSerializationTest extends SerializationTest {
    ...
    protected Persistable populateOutputs(Persistable outputs) {
        HacOutputs hacOutputs = (HacOutputs) outputs;

        List<Histogram> histograms = new ArrayList<Histogram>();
        histograms.add(createHistogram());
        hacOutputs.setHistograms(histograms);
