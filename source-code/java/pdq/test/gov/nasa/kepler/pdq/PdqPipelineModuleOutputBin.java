...
public class PdqPipelineModuleOutputBin extends
    PdqPipelineModule {
    ...
    public PdqPipelineModuleOutputBin(String dataDir, int seqNum) {
    ...
    protected void executeAlgorithm(PipelineTask pipelineTask,
        ...
        MatlabBinFileUtils.serializeInputsFile(inputs, new File(dataDir), "pdq", seqNum);
        MatlabBinFileUtils.deserializeOutputsFile(outputs, new File(dataDir), "pdq", seqNum);
    }
}
