...
/**
 * Outputs for the {@link DynablackPipelineModule}.
 * 
 * @author Miles Cote
 * @author Forrest Girouard
 */
public class DynablackOutputs implements Persistable {

    private String dynablackBlobFilename = "";

    private List<RollingBandArtifactFlags> rollingBandArtifactFlagsStruct = newArrayList();

    public DynablackOutputs() {
    }
    ...
    public List<RollingBandArtifactFlags> getRollingBandArtifactFlags() {
        return rollingBandArtifactFlagsStruct;
    }

    public void setRollingBandArtifactFlags(
        List<RollingBandArtifactFlags> rollingBandArtifactFlags) {
        this.rollingBandArtifactFlagsStruct = rollingBandArtifactFlags;
    }
