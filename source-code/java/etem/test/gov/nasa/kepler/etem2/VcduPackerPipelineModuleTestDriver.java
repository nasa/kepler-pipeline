 ...
 * 
 */
public class VcduPackerPipelineModuleTestDriver extends TestCase {
    private static final Log log = LogFactory.getLog(VcduPackerPipelineModuleTestDriver.class);

    public VcduPackerPipelineModuleTestDriver(String name) {
        super(name);
    }
    ...
    public void testProcessTask() {
        ...
        VcduPackerPipelineModule vcduPackerModule = new VcduPackerPipelineModule();
        ...
        PackerParameters packerPipelineParameters = new PackerParameters();
        // packerPipelineParameters.setPacketizedOutputDir("/path/to/packetized");
        ParameterSet paramSet = new ParameterSet("packer");
        paramSet.setParameters(new BeanWrapper<Parameters>(
            packerPipelineParameters));
        pipelineInstance.putParameterSet(new ClassWrapper<Parameters>(
            packerPipelineParameters), paramSet);
        ...
        vcduPackerModule.processTask(pipelineInstance, pipelineTask);
    }
    ...
    public static void main(String[] args) {
        ...
        junit.textui.TestRunner.run(VcduPackerPipelineModuleTestDriver.class);
