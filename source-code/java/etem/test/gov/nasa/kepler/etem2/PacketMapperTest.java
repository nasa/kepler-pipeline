...
public class PacketMapperTest {
    ...
    public void testMerge() throws Exception{
        ...
        File inDirFile = new File(FilenameConstants.SOC_ROOT + "/etem2/auto/packetized/ccsds/");
        File mapDirFile = new File(Filenames.BUILD_TMP, "packetized/map/");
        ...
        packetMapper.run(inDirFile.getAbsolutePath(), mapFile.getAbsolutePath(), 96);
