...
//
//public class TadToFitsShort extends AbstractTadToFits {
//
//    private String scTargetListSetName;
//
//    public TadToFitsShort(String scTargetListSetName, String fitsDir,
//        int startCadence, int endCadence) {
//
//        super(fitsDir, startCadence, endCadence);
//        this.scTargetListSetName = scTargetListSetName;
//    }
//
//    public void export(int module, int output) throws Exception {
//        exportShortCadence(module, output);
//    }
//
//    private void exportShortCadence(int module, int output) throws Exception {
//        // Retrieve tad data.
//        TargetListSet set = targetSelectionCrud.retrieveTargetListSet(scTargetListSetName);
...
//            for (int cadenceNumber = startCadence * 30; cadenceNumber < (endCadence + 1) * 30; cadenceNumber++) {
//                // Generate target data.
//                TargetCadenceDataSet targetDataSet = new TargetCadenceDataSet(
//                    fitsDir, CadenceType.SHORT, cadenceNumber, module, output, 0, 0);
...
//                        rows.add(new Integer(absRow));
//                        cols.add(new Integer(absCol));
//                    }
//                }
//                targetDataSet.save();
//
