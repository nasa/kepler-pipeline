 ...
 */
public class Etem2FitsSetupPipelineModule extends PipelineModule {

    public static final String MODULE_NAME = "Etem2FitsSetup";

    private static final Log log = LogFactory.getLog(Etem2FitsSetupPipelineModule.class);
    ...
    public void processTask(PipelineInstance pipelineInstance,
        ...
        try {
            ...
            String pixelFitsDir = dataGenDirManager.getCadenceFitsDir();

            // Clean the pixelFitsDir before running etem2Fits.
            log.info("Cleaning the pixelFitsDir...");
            FileUtil.cleanDir(pixelFitsDir);
