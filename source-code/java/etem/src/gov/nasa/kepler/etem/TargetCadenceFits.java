 ...
 * 
 */
public class TargetCadenceFits extends CadenceFits {

    private static final String LCS_BKG = "_lcs-bkg";
    private static final String SCS_TARG = "_scs-targ";
    private static final String LCS_TARG = "_lcs-targ";

    public TargetCadenceFits(String fitsDir, TargetType targetType,
        int cadenceNumber,
    ...
    public static List<Header> getMasterHeaders(String masterFitsPath,
        ...
        switch (targetType) {
            case LONG_CADENCE:
                masterSuffix = LCS_TARG;
                break;
            case SHORT_CADENCE:
                masterSuffix = SCS_TARG;
                break;
            case BACKGROUND:
                masterSuffix = LCS_BKG;
                break;
        }
