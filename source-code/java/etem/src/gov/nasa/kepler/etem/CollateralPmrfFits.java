 ...
 * 
 */
public class CollateralPmrfFits extends PmrfFits {

    private static final String SCC = "_scc";
    private static final String LCC = "_lcc";

    public CollateralPmrfFits(String fitsDir, TargetType targetType,
    ...
    protected String getSuffix(TargetType targetType) {
        ...
        switch (targetType) {
            case LONG_CADENCE:
                return "-" + lctIdString + "-" + tadIdString + LCC;
            case SHORT_CADENCE:
                return "-" + sctIdString + "-" + tadIdString + SCC;
            default:
    ...
    public void addColumns(byte[] pixelTypeColumn,
        short[] rowOrColOffsetColumn, int[] targetIdColumn)
        ...
        switch (cadenceType) {
            case LONG:
                // Don't add targetId for long cadence.
                binaryTable = new BinaryTable(new Object[] { pixelTypeColumn,
                    rowOrColOffsetColumn });
                addBinaryTableHdu(binaryTable);
                break;
            case SHORT:
                // Do add targetId for short cadence.
                binaryTable = new BinaryTable(new Object[] { pixelTypeColumn,
                    rowOrColOffsetColumn, targetIdColumn });
                addBinaryTableHdu(binaryTable);
                break;
            default:
                break;
