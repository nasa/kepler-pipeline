...
public abstract class PmrfFits extends KeplerFits {

    public static double PMRF_MJD = 54000.0;
    
    protected PmrfFits(String fitsDir, TargetType targetType,
        ...
        int sctId, int rptId) throws Exception {
        ...
        super(fitsDir, targetType, cadenceZeroMjd, masterHeaders, scConfigId,
            ...
            bgpId, tadId, lctId, sctId, rptId, false);
    ...
    protected Date getTimestamp() {
        Date cadenceDate = ModifiedJulianDate.mjdToDate(PMRF_MJD);
        return cadenceDate;
    }
