...
/**
 * A {@link PmdReport} plus its identifying module and output.
 * 
 * @author Bill Wohler
 */
public class PagInputReport extends PmdReport {
    ...
    /**
     * Creates a {@link PagInputReport}.
     */
    public PagInputReport() {
    }
    ...
    public PagInputReport(
        ...
        super(reportMap, ccdModule, ccdOutput);
