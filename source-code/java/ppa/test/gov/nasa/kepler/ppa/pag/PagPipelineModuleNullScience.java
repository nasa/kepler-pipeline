...
public class PagPipelineModuleNullScience extends PagPipelineModule {

    private AbstractPagPipelineModuleTest moduleTest;
    private boolean forceFatalException;

    public PagPipelineModuleNullScience(
        AbstractPagPipelineModuleTest moduleTest, boolean forceFatalException) {
    ...
    protected void executeAlgorithm(PipelineTask pipelineTask,
        ...
        moduleTest.createOutputs(pagOutputs);
    }
}
