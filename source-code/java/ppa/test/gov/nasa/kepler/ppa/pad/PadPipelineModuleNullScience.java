...
public class PadPipelineModuleNullScience extends PadPipelineModule {

    private AbstractPadPipelineModuleTest moduleTest;
    private boolean forceFatalException;

    public PadPipelineModuleNullScience(
        AbstractPadPipelineModuleTest moduleTest, boolean forceFatalException) {
    ...
    protected void executeAlgorithm(PipelineTask pipelineTask,
        ...
        if (forceFatalException) {
            throw new ModuleFatalProcessingException(
                "executeAlgorithm was set up to fail");
        }

        PadOutputs padOutputs = (PadOutputs) outputs;
        PadInputs padInputs = (PadInputs) inputs;
        moduleTest.createOutputs(padInputs, padOutputs);
    }
}
