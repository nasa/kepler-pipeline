...
public class PmdPipelineModuleNullScience extends PmdPipelineModule {

    private AbstractPmdPipelineModuleTest moduleTest;
    private boolean forceFatalException;

    public PmdPipelineModuleNullScience(
        AbstractPmdPipelineModuleTest moduleTest, boolean forceFatalException) {
    ...
    protected void executeAlgorithm(PipelineTask pipelineTask,
        ...
        moduleTest.createOutputs(pmdOutputs);
    }
}
