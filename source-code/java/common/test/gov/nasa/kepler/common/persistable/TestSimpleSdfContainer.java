...
public class TestSimpleSdfContainer implements Persistable {
    ...
    private Date[] da = {new Date(), new Date()};
    private TestEnum e = TestEnum.ONE;
    private TestEnum[] ea = {TestEnum.ONE, TestEnum.THREE};
     ...
     * @return the ea
     */
    public TestEnum[] getEa() {
        return ea;
    }
    /**
     * @param ea the ea to set
     */
    public void setEa(TestEnum[] ea) {
        this.ea = ea;
    }
