...
package gov.nasa.kepler.common.math;

/**
 * Compute the bounding box and center for a set of 2D points
 * 
 * @author tklaus
 *
 */
public class BoundingBox {
    ...
    public int getMidRow(){
        return(((maxRow - minRow)/2) + minRow);
    }

    public int getMidColumn(){
        return(((maxColumn - minColumn)/2) + minColumn);
    }
