...
public class SystestConfigMapExporterPipelineModule extends PipelineModule {

    public static final String MODULE_NAME = "config-map-exporter";
    ...
    public void processTask(PipelineInstance pipelineInstance,
        ...
        try {
            ...
            String xmlDir = dataGenDirManager.getConfigMapExportDir();

            // Clean output dir.
            FileUtil.cleanDir(xmlDir);

            ConfigMapExporter systestConfigMapExporter = new ConfigMapExporter();
            systestConfigMapExporter.export(scConfigParams, xmlDir);
