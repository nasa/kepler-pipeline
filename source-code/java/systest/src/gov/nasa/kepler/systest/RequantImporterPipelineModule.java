...
public class RequantImporterPipelineModule extends PipelineModule {

    public static final String MODULE_NAME = "requant-importer";
    ...
    public void processTask(PipelineInstance pipelineInstance,
        ...
        try {
            ...
            File requantPath = new File(dataRepoParams.getRequantPath());

            if (!requantPath.exists()) {
                throw new PipelineException(
                    String.format(
                        "%s: no such directory (DataRepoParameters.dataRepoPath=%s)",
                        requantPath, dataRepoParams.getDataRepoPath()));
            }

            File xmlFile = null;
            for (File file : requantPath.listFiles()) {
                if (file.getName()
                    .contains("xml")) {
                    xmlFile = file;
                }
            ...
            RequantTable requantTable = requantImporter.importFile(xmlFile);
