...
/**
 * This class contains a blob with its cadence range.
 * 
 * @author Miles Cote
 * 
 */
public class SbtBlob implements SbtDataContainer {
    ...
    public SbtBlob(int startCadence, int endCadence, byte[] blob) {
