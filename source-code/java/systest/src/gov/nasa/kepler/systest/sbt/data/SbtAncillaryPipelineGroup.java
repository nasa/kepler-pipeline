...
/**
 * This class contains a {@link List} of {@link AncillaryPipelineData}.
 * 
 * @author Miles Cote
 * 
 */
public class SbtAncillaryPipelineGroup implements SbtDataContainer {
    ...
    public String toMissingDataString(ToMissingDataStringParameters parameters) {
        ...
        stringBuilder.append(SbtDataUtils.toString(
            ...
            new SbtAncillaryPipelineParameters(
                ancillaryPipelineConfigurationStruct).toMissingDataString(parameters)));
        stringBuilder.append(SbtDataUtils.toString(
            "ancillaryPipelineDataStruct",
            new SbtList(
                SbtDataContainerListFactory.getInstanceAncillaryPipelineData(ancillaryPipelineDataStruct),
                true).toMissingDataString(parameters)));

        return stringBuilder.toString();
    }

    public SbtAncillaryPipelineGroup() {
    }

    public SbtAncillaryPipelineGroup(int startCadence, int endCadence,
        AncillaryPipelineParameters ancillaryPipelineConfigurationStruct,
        List<AncillaryPipelineData> ancillaryPipelineDataStruct) {
        this.startCadence = startCadence;
        this.endCadence = endCadence;
        this.ancillaryPipelineConfigurationStruct = ancillaryPipelineConfigurationStruct;
        this.ancillaryPipelineDataStruct = ancillaryPipelineDataStruct;
    }
    ...
    public AncillaryPipelineParameters getAncillaryPipelineConfigurationStruct() {
        return ancillaryPipelineConfigurationStruct;
    }

    public void setAncillaryPipelineConfigurationStruct(
        AncillaryPipelineParameters ancillaryPipelineConfigurationStruct) {
        this.ancillaryPipelineConfigurationStruct = ancillaryPipelineConfigurationStruct;
    }

    public List<AncillaryPipelineData> getAncillaryPipelineDataStruct() {
        return ancillaryPipelineDataStruct;
    }

    public void setAncillaryPipelineDataStruct(
        List<AncillaryPipelineData> ancillaryPipelineDataStruct) {
        this.ancillaryPipelineDataStruct = ancillaryPipelineDataStruct;
    }
