...
public class TargetListSetRenamer {
    public void rename(String targetListSetName, String newTargetListSetName) {
        ...
        tls.setName(newTargetListSetName);
    }

    public static void main(String[] args) {
        if (args.length != 2) {
            System.err.println("USAGE: rename-tls TLS_NAME NEW_TLS_NAME");
            System.err.println("EXAMPLE: rename-tls q1_lc_untrimmed q1_lc_untrimmed_new");
            System.exit(-1);
        }
        ...
        TransactionWrapper.run(new Runnable() {
            @Override
            public void run() {
                TargetListSetRenamer versioner = new TargetListSetRenamer();
                versioner.rename(tlsName, newTlsName);
            }
        });
    }
}
