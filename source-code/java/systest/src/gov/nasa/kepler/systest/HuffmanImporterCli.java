...
/**
 * Just so I can get something working.
 * 0) ant start-hsqldb
 * 1) run with -Dconfig.propfile=aft-kepler.properties 
 *             -Dlog4j.xml=file:etc/log4j.xml
 *             <huffman table>.xml
 * usually in <data-repo>/huffman/latest/kplr<something something>.xml
 * 2) Stop database
 * 
 * @author Sean McCauliff
 *
 */
public class HuffmanImporterCli {
