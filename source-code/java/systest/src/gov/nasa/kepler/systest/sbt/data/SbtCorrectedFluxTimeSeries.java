...
/**
 * This class wraps a {@link CorrectedFluxTimeSeries} with a type.
 * 
 * @author Miles Cote
 * 
 */
public class SbtCorrectedFluxTimeSeries implements SbtDataContainer {
    ...
    public String toMissingDataString(ToMissingDataStringParameters parameters) {
        ...
        SbtList uncertainties = new SbtList(
            ...
            gapIndicators);
        SbtList filledIndices = new SbtList(
            SbtDataContainerListFactory.getInstance(timeSeries.getFilledIndices()),
            gapIndicators);
        ...
        stringBuilder.append(SbtDataUtils.toString("filledIndices",
            filledIndices.toMissingDataString(parameters)));

        return stringBuilder.toString();
    }

    public SbtCorrectedFluxTimeSeries() {
    }

    public SbtCorrectedFluxTimeSeries(CorrectedFluxTimeSeries timeSeries) {
        this.type = SbtDataUtils.EMPTY;
        this.timeSeries = timeSeries;
    }

    public SbtCorrectedFluxTimeSeries(String type,
        CorrectedFluxTimeSeries timeSeries) {
        this.type = type;
        this.timeSeries = timeSeries;
    }
