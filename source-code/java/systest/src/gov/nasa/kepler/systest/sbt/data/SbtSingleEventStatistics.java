...
/**
 * This class contains single event statistics.
 * 
 * @author Miles Cote
 * 
 */
public class SbtSingleEventStatistics implements SbtDataContainer {
    ...
    public SbtSingleEventStatistics() {
    }

    public SbtSingleEventStatistics(float trialTransitPulseDuration,
