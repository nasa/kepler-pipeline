...
/**
 * This class contains a quantity.
 * 
 * @author Miles Cote
 * 
 */
public class SbtQuantity implements SbtDataContainer {
    ...
    public SbtQuantity(DvQuantity dvQuantity) {
        if (dvQuantity != null) {
            value = dvQuantity.getValue();
            uncertainty = dvQuantity.getUncertainty();
        }
    }

    public SbtQuantity(float value, float uncertainty) {
        this.value = value;
