...
/**
 * This class wraps {@link SimpleFloatTimeSeries} with a type.
 * 
 * @author Miles Cote
 * 
 */
public class SbtSimpleTimeSeries implements SbtDataContainer {

    private String type = "";

    private SimpleFloatTimeSeries timeSeries = new SimpleFloatTimeSeries();
    ...
    public SbtSimpleTimeSeries() {
    }

    public SbtSimpleTimeSeries(SimpleFloatTimeSeries timeSeries) {
        type = SbtDataUtils.EMPTY;
        this.timeSeries = timeSeries;
    }

    public SbtSimpleTimeSeries(String type, SimpleFloatTimeSeries timeSeries) {
        this.type = type;
        this.timeSeries = timeSeries;
    }
    ...
    public SimpleFloatTimeSeries getTimeSeries() {
        return timeSeries;
    }

    public void setTimeSeries(SimpleFloatTimeSeries timeSeries) {
        this.timeSeries = timeSeries;
    }
