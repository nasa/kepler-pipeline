...
/**
 * This class contains a double quantity.
 * 
 * @author Miles Cote
 * 
 */
public class SbtDoubleQuantity implements SbtDataContainer {
    ...
    public SbtDoubleQuantity() {
    }

    public SbtDoubleQuantity(DvDoubleQuantity dvDoubleQuantity) {
        this.value = dvDoubleQuantity.getValue();
        this.uncertainty = dvDoubleQuantity.getUncertainty();
    }

    public SbtDoubleQuantity(double value, float uncertainty) {
        this.value = value;
