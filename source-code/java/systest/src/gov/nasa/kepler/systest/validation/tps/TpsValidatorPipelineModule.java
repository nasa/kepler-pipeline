...
/**
 * Pipeline module for validation of TPS exports.
 * 
 * @author Forrest Girouard
 * @author Bill Wohler
 */
public class TpsValidatorPipelineModule extends PipelineModule {

    public static final String MODULE_NAME = "tps-validator";
    ...
    public void processTask(PipelineInstance pipelineInstance,
        ...
        options.setCommand(Command.VALIDATE_TPS);
    ...
    private FitsValidationOptions retrieveOptions(PipelineTask pipelineTask) {
        ...
        options.setTpsCdppDirectory(dataGenDirManager.getCdppExportDir());
        options.setTpsId(getMostRecentInstanceId(CadenceType.LONG,
            parameters.getTpsId(), TpsPipelineModule.MODULE_NAME,
            TpsType.TPS_LITE));
