...
public class SystestTadUplinkerPipelineModule extends PipelineModule {

    public static final String MODULE_NAME = "tad-uplinker";
    ...
    public void processTask(PipelineInstance pipelineInstance,
        ...
        TargetListSetUplinker uplinker = new TargetListSetUplinker(tadParameters.getTargetListSetName(), photometerConfigParams);
        try {
            uplinker.uplink();
        } catch (Exception e) {
            throw new ModuleFatalProcessingException("TargetListSetUplinker failed, " + e.getMessage(), e);
        }
    }
}
