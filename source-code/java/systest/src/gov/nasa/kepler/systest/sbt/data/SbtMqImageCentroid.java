...
/**
 * Contains an mq image centroid.
 * 
 * @author Miles Cote
 * 
 */
public class SbtMqImageCentroid implements SbtDataContainer {
    ...
    public SbtMqImageCentroid() {
    }

    public SbtMqImageCentroid(DvMqImageCentroid dvMqImageCentroid) {
        decDegrees = new SbtDoubleQuantity(dvMqImageCentroid.getDecDegrees());
        raHours = new SbtDoubleQuantity(dvMqImageCentroid.getRaHours());
    }

    public SbtMqImageCentroid(SbtDoubleQuantity decDegrees,
        SbtDoubleQuantity raHours) {
