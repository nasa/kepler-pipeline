...
/**
 * This class wraps {@link SimpleDoubleTimeSeries} with a type.
 * 
 * @author Miles Cote
 * 
 */
public class SbtSimpleDoubleTimeSeries implements SbtDataContainer {

    private String type = "";

    private SimpleDoubleTimeSeries timeSeries = new SimpleDoubleTimeSeries();
    ...
    public SbtSimpleDoubleTimeSeries() {
    }

    public SbtSimpleDoubleTimeSeries(String type,
        SimpleDoubleTimeSeries timeSeries) {
        this.type = type;
    ...
    public SimpleDoubleTimeSeries getTimeSeries() {
        return timeSeries;
    }

    public void setTimeSeries(SimpleDoubleTimeSeries timeSeries) {
        this.timeSeries = timeSeries;
    }
