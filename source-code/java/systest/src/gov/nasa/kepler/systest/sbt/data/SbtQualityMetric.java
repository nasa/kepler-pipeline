...
public class SbtQualityMetric implements SbtDataContainer {
    ...
    public SbtQualityMetric() {
    }

    public SbtQualityMetric(DvQualityMetric qualityMetric) {
        attempted = qualityMetric.isAttempted();
        valid = qualityMetric.isValid();
        value = qualityMetric.getValue();
    }
    
    public SbtQualityMetric(boolean attempted, boolean valid, float value) {
