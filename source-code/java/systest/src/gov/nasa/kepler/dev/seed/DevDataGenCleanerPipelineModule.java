...
public class DevDataGenCleanerPipelineModule extends PipelineModule {

    private static final Log log = LogFactory.getLog(DevDataGenCleanerPipelineModule.class);

    public static final String MODULE_NAME = "dev-data-gen-cleaner";
    ...
    public void processTask(PipelineInstance pipelineInstance,
        ...
        try {
            ...
            // An example "etemDir" is: /path/to/dev/etem/dataset-1/long/
            String etemDir = dataGenDirManager.getEtemDir();

            log.info("Cleaning dir: " + etemDir);
            FileUtil.cleanDir(etemDir);
        } catch (Exception e) {
            throw new PipelineException("Unable to processTask.", e);
        }
    }
