...
public class TargetExporter {
    ...
    private final TargetRetriever targetRetriever;
    private final TargetWriter targetWriter;

    public TargetExporter(TargetRetriever targetRetriever,
    ...
    public void exportData() {
        ImportedTargetTable importedTargetTable = targetRetriever.retrieve();

        targetWriter.write(importedTargetTable);
    }
