...
/**
 * Creates {@link PixelTimeSeriesReader}s.
 * 
 * @author Miles Cote
 * 
 */
public class PixelTimeSeriesReaderFactory {

    public static final PixelTimeSeriesReader create(
        DispatcherType dispatcherType, DataSetType dataSetType, int ccdModule,
        int ccdOutput) {
        switch (dispatcherType) {
            case RCLC_PIXEL:
                return new RclcPixelTimeSeriesOperations(dataSetType,
                    ccdModule, ccdOutput);
            default:
