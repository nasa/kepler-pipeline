...
public class TargetRetriever {
    ...
    public TargetRetriever(TargetCrud targetCrud, int externalId,
    ...
    public ImportedTargetTable retrieve() {
        ...
        return new ImportedTargetTable(targetTable, targetDefinitions);
    }
