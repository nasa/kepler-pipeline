 ...
 * 
 */
public class MaskRetriever {

    private final TargetCrud targetCrud;
    private final int externalId;
    private final MaskType maskType;

    public MaskRetriever(TargetCrud targetCrud, int externalId,
        MaskType maskType) {
    ...
    public ImportedMaskTable retrieve() {
        MaskTable maskTable = targetCrud.retrieveUplinkedMaskTable(externalId,
            maskType);

        List<Mask> masks = targetCrud.retrieveMasks(maskTable);

        return new ImportedMaskTable(maskTable, masks);
    }
