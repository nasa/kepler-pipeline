...
public class MaskExporter {
    ...
    private final MaskRetriever maskRetriever;
    private final MaskWriter maskWriter;

    public MaskExporter(MaskRetriever maskRetriever, MaskWriter maskWriter) {
        this.maskRetriever = maskRetriever;
        this.maskWriter = maskWriter;
    }

    public void exportData() {
        ImportedMaskTable importedMaskTable = maskRetriever.retrieve();

        maskWriter.write(importedMaskTable);
    }
