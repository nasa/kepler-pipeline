...
public abstract class PipelineSeedData {
    ...
    protected ParameterSet retrieveParameterSet(String name){
        return parameterSetCrud.retrieveLatestVersionForName(name);
    }
    
    protected PipelineModuleDefinition retrieveModule(String name){
        return pipelineModuleDefinitionCrud.retrieveLatestVersionForName(name);
    }
