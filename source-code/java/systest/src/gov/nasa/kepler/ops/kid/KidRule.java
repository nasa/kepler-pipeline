...
/**
 * Defines a rule regarding the KID which can be applied.
 * 
 * @author Miles Cote
 * 
 */
public interface KidRule {

    static final String INVESTIGATION_ID_SEPARATOR = "_";

    /**
     * @param kidInvestigations The KID to which the rule should be applied.
     * @param investigationIdToKtcEntries
     * @param baseInvestigationIdToBaseInvestigation
     */
