...
public class AftRefPixelDispatcher extends RefPixelDispatcher {

    private static final Log log = LogFactory.getLog(AftRefPixelDispatcher.class);

    public AftRefPixelDispatcher() {
    }
