...
public abstract class TestData {
    ...
    protected Properties createDatabaseProperties() {
        ...
        log.info("Oracle: "
            + databaseProperties.getProperty("hibernate.connection.url"));
