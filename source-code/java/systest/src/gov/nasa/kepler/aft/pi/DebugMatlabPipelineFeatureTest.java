...
import gov.nasa.kepler.debug.DebugMatlabPipelineModule;
...
public class DebugMatlabPipelineFeatureTest extends AutomatedFeatureTest {

    private static final Logger log = Logger.getLogger(DebugMatlabPipelineFeatureTest.class);

    private static final String TRIGGER_NAME = "DEBUG_MATLAB";

    public DebugMatlabPipelineFeatureTest() {
        super("pi", "DebugMatlab");
    }
    ...
    protected void createDatabaseContents() throws Exception {
        ...
        new PipelineConfigurationOperations().importPipelineConfiguration(new File(
            SocEnvVars.getLocalDataDir(), AFT_PIPELINE_CONFIGURATION_ROOT
                + DebugMatlabPipelineModule.MODULE_NAME + ".xml"));
