...
public class AftRefPixelSeeder extends RefPixelSeeder {

    public AftRefPixelSeeder(TestDataSetDescriptor testDescriptor,
    ...
    protected DispatcherWrapper createDispatcher(
        ...
        return new DispatcherWrapper(new AftRefPixelDispatcher(),
