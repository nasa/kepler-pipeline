...
package gov.nasa.kepler.aft.tps;
 ...
 */
public class TpsLiteOverwriteTest extends AbstractTpsLiteTest {

    private static final Log log = LogFactory.getLog(TpsLiteOverwriteTest.class);

    public TpsLiteOverwriteTest() {
        super("Overwrite");
        setAllowFilestoreOverwrite(true);
    }
    ...
    protected void process() throws Exception {
        ...
        captureDatabaseSnapshot(getTestActualRoot());
        ...
        ParameterSet tpsParameterSet = retrieveParameterSet(TpsPipelineModule.MODULE_NAME);
        TpsModuleParameters tpsModuleParameters = tpsParameterSet.parametersInstance();

        tpsModuleParameters.setWaveletFilterLength(20);
        new PipelineOperations().updateParameterSet(tpsParameterSet,
            tpsModuleParameters, false);
        ...
        runPipeline(TPS_LITE_TRIGGER_NAME);
    }
}
