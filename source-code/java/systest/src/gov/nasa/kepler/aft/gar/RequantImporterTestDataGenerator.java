...
/**
 * Creates an HSQLDB database with one {@code GAR_REQUANT_TABLE} with 84 {@code
 * GAR_RT_MEAN_BLACK_ENTRIES} and 65536 {@code GAR_RT_REQUANT_ENTRIES} seeded by
 * using an instance of
 * {@link gov.nasa.kepler.aft.gar.RequantImporterPipelineSeedData}.
 * 
 * @author Forrest Girouard
 */
public class RequantImporterTestDataGenerator extends RequantTestDataGenerator {

    private static final Log log = LogFactory.getLog(RequantImporterTestDataGenerator.class);

    private static final String REQUANT_IMPORTER_TRIGGER_NAME = "REQUANT_IMPORTER";

    public RequantImporterTestDataGenerator() {
    ...
    protected void process() throws Exception {
        runPipeline(REQUANT_IMPORTER_TRIGGER_NAME);
    ...
    public static void main(String[] args) {
        try {
            new RequantImporterTestDataGenerator().generate();
        } catch (Exception e) {
