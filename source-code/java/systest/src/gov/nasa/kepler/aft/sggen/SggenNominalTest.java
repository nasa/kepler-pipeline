...
package gov.nasa.kepler.aft.sggen;
 ...
 */
public class SggenNominalTest extends AutomatedFeatureTest {

    private static final Logger log = Logger.getLogger(SggenNominalTest.class);

    private static final String SGGEN_TRIGGER_NAME = "SGGEN";

    public SggenNominalTest() {
        super(SkyGroupGenPipelineModule.MODULE_NAME, "Nominal");
    }
    ...
    protected void createDatabaseContents() throws Exception {
        ...
        new PipelineConfigurationOperations().importPipelineConfiguration(new File(
            SocEnvVars.getLocalDataDir(), AFT_PIPELINE_CONFIGURATION_ROOT
                + SkyGroupGenPipelineModule.MODULE_NAME + ".xml"));
    ...
    protected void process() throws Exception {
        runPipeline(SGGEN_TRIGGER_NAME);
    }
}
