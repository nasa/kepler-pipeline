...
/**
 * Nominal (uses all the defaults) PA AFT.
 * 
 * @author Forrest Girouard
 * 
 */
public class PaNominalTest extends AbstractPaFeatureTest {

    private static final Log log = LogFactory.getLog(PaNominalTest.class);

    public PaNominalTest() {
        super("Nominal");
    }
