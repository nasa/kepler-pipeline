...
/**
 * Automated feature test for PPA:PMD (PPA Metric Determination).
 * 
 * @author Bill Wohler
 * @author Forrest Girouard
 */
public class PmdNominalTest extends AutomatedFeatureTest {

    private static final Logger log = Logger.getLogger(PmdNominalTest.class);

    private static final String PMD_TRIGGER_NAME = "PMD";

    public PmdNominalTest() {
        super(PmdPipelineModule.MODULE_NAME, "Nominal");
    }
    ...
    protected void createDatabaseContents() throws Exception {
        ...
        new PipelineConfigurationOperations().importPipelineConfiguration(new File(
            SocEnvVars.getLocalDataDir(), AFT_PIPELINE_CONFIGURATION_ROOT
                + PmdPipelineModule.MODULE_NAME + ".xml"));
    }

    @Override
    protected void process() throws Exception {
        runPipeline(PMD_TRIGGER_NAME);
    }
}
