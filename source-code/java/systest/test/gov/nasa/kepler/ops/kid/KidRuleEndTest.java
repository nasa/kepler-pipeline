 ...
 * 
 */
public class KidRuleEndTest extends JMockTest {

    @Test
    public void testApplyWithPlannedEndLater() {
        testApply(2.2, 1.1, 2.2, ObservationEventTypeType.PLANNED,
            "investigationId", "investigationId");
    }

    @Test
    public void testApplyWithActualEndLater() {
        testApply(1.1, 2.2, 2.2, ObservationEventTypeType.ACTUAL,
            "investigationId", "investigationId");
    }

    @Test
    public void testApplyWithNullActualEnd() {
    ...
    private void testApply(double planned, Double actual, double expectedMjd,
        ObservationEventTypeType.Enum expectedType, String ktcInvestigationId,
        ...
        allowing(ktcEntry).getPlanStop();
        will(returnValue(planned));

        allowing(ktcEntry).getActualStop();
        will(returnValue(actual));

        KidRuleEnd kidRuleEnd = new KidRuleEnd();
        kidRuleEnd.apply(kidInvestigations, investigationIdToKtcEntries,
        ...
        expectedKidInvestigation.setEnd(expectedObservationEventType);
