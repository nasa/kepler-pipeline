...
public class ProcessUtilsTest {
    ...
    public void testRunJava() throws Exception {
        Process subJavaProcess = ProcessUtils.runJava(ProcessUtilsTestProgram.class,
        ...
        subJavaProcess.getErrorStream()
            .close();
        subJavaProcess.getOutputStream()
            .close();
    ...
    @Test
    public void testGrabOutput() throws Exception {
        ProcessUtils.ProcessOutput output = ProcessUtils.grabOutput("ls -1 /dev/null");
        List<String> outputList = output.allAsList();
        assertEquals(1, outputList.size());
        assertEquals("/dev/null", outputList.get(0));
    }
}
