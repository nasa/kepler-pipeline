...
import gov.nasa.spiffy.common.os.CpuInfo;
...
public class CpuInfoTest {
    ...
    private static final Log log = LogFactory.getLog(CpuInfoTest.class);

    @Test
    public void test() throws Exception {

        CpuInfo cpuInfo = OperatingSystemType.getInstance()
            .getCpuInfo();
