...
public class Filenames {
     ...
     * build/tmp} instead of {@code tmp} so there is plenty of room for large
     * fits and bin files.
     */
    public static final String BUILD_TMP = "build/tmp";

    /** The name of the configuration directory (etc). */
    ...
    public static final String DIST_ROOT = "../../dist";
    public static final String SKEL_ROOT = "../../skel";
    public static final String MATLAB_ROOT = "../../matlab";
