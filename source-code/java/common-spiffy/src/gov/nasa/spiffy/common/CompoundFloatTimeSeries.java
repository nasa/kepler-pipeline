...
/**
 * A simple persistable time series with both values and uncertainties.
 * 
 * @author Forrest Girouard
 * 
 */
public class CompoundFloatTimeSeries extends SimpleFloatTimeSeries {
    ...
    public CompoundFloatTimeSeries() {
    }

    public CompoundFloatTimeSeries(int length) {
    ...
    public CompoundFloatTimeSeries(float[] values, float[] uncertainties,
    ...
    public boolean equals(Object obj) {
        ...
        final CompoundFloatTimeSeries other = (CompoundFloatTimeSeries) obj;
