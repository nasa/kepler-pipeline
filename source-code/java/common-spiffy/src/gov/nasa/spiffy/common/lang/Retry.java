...
/**
 * This class provides retry logic for a specified
 * {@link Retryable} object.
 * 
 * Assumes that the call method of the provided {@link Retryable}
 * throws an {@link Exception} in the case of a failure.
 * 
