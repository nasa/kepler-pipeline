...
/**
 * Finds all the files which match the given filter. This is not thread safe.
 * 
 * @author Forrest Girouard
 * 
 */
public class FileFilterFind implements FileVisitor {

    private FileFilter fileFilter;

    private List<File> found = new ArrayList<File>();

    public FileFilterFind(FileFilter fileFilter) {
    ...
    /**
     * @see gov.nasa.spiffy.common.io.FileVisitor#visitFile(java.io.File,
     * java.io.File)
     */
    @Override
