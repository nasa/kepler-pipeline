...
public class LinuxCpuInfo extends AbstractSysInfo implements CpuInfo {
    ...
    private static final String PROCINFO_FILE = "/proc/cpuinfo";

    private static final String NUM_CORES_KEY = "cpu cores";

    public LinuxCpuInfo() throws IOException {

        super(new FileReader(PROCINFO_FILE));
    }

    @Override
    public int getNumCores() {

        return Integer.parseInt(get(NUM_CORES_KEY));
    }
