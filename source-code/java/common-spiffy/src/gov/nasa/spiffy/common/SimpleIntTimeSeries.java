...
/**
 * A simple persistable int time series (no uncertainties).
 * 
 * @author Miles Cote
 * 
 */
public class SimpleIntTimeSeries implements Persistable {

    /**
     * Time series values.
     */
    private int[] values = ArrayUtils.EMPTY_INT_ARRAY;
    ...
    public SimpleIntTimeSeries() {
    }

    public SimpleIntTimeSeries(int[] values, boolean[] gapIndicators) {
    ...
    public boolean equals(Object obj) {
        ...
        final SimpleIntTimeSeries other = (SimpleIntTimeSeries) obj;
