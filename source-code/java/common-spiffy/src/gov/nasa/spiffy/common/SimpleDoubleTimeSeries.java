...
/**
 * A simple persistable double precision time series (no uncertainties).
 * 
 * @author Forrest Girouard
 * 
 */
public class SimpleDoubleTimeSeries implements Persistable {
    /**
     * Time series values.
     */
    ...
    public SimpleDoubleTimeSeries() {
    }

    public SimpleDoubleTimeSeries(int length) {
    ...
    public SimpleDoubleTimeSeries(double[] values, boolean[] gapIndicators) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SimpleDoubleTimeSeries)) {
            return false;
        }
        final SimpleDoubleTimeSeries other = (SimpleDoubleTimeSeries) obj;
