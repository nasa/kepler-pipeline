...
/**
 * A simple persistable boolean time series (no uncertainties).
 * 
 * @author Forrest Girouard
 * 
 */
public class SimpleBooleanTimeSeries implements Persistable {

    /**
     * Time series values.
     */
    private boolean[] values = ArrayUtils.EMPTY_BOOLEAN_ARRAY;
    ...
    public SimpleBooleanTimeSeries() {
    }

    public SimpleBooleanTimeSeries(boolean[] values, boolean[] gapIndicators) {
    ...
    public boolean equals(Object obj) {
        ...
        final SimpleBooleanTimeSeries other = (SimpleBooleanTimeSeries) obj;
