 ...
 *
 */
public class TpsResultUowParameters implements Parameters {

    private int chunkSize = 512;
    private long pipelineInstanceId = -1L;
    
    public TpsResultUowParameters() {
    ...
    public TpsResultUowParameters(int chunkSize) {
    ...
    public boolean equals(Object obj) {
        ...
        TpsResultUowParameters other = (TpsResultUowParameters) obj;
