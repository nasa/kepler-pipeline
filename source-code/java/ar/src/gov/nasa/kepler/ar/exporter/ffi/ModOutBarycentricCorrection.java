...
/**
 * The barycentric correction for a particular mod/out.
 * 
 * @author Sean McCauliff
 *
 */
class ModOutBarycentricCorrection {
    private final float barycentricCorrection;
    private final double referenceCcdRow;
    private final double referenceCcdColumn;
    
    public ModOutBarycentricCorrection(float barycentricCorrection, double referenceCcdRow, double referenceCcdColumn) {
