...
/**
 * Writes out the a date/time in the ISO 8601 Standard.  This is used in the
 * XML Schema standard.  This class is not MT-safe.
 * 
...
public class Iso8601Formatter   {
   ...
   private SimpleDateFormat simple = 
    ...
    public Iso8601Formatter() {
        simple.setTimeZone(TimeZone.getTimeZone("UT"));
    }
    ...
    public String format(Date dateTime) {
        ...
        simple.format(dateTime, buf, new FieldPosition(0));
        
        //Fixup the time zone string.
    ...
    Date parse(String dateStr) throws ParseException {
        ...
        return simple.parse(buf.toString());
    }
