...
/**
 * This exports all the combined flat fields available.
 * 
 * @author Sean McCauliff
 *
 */
public class CombinedFlatFieldExportCli {

    private final FlatFieldOperations ffOps;
    private final SystemProvider system;
    
    public CombinedFlatFieldExportCli(FlatFieldOperations ffOps, SystemProvider system) {
        this.ffOps = ffOps;
        this.system = system;
    }
    ...
    public void export(String[] argv) throws FitsException, IOException {
        if (argv.length != 2) {
            printUsage();
            system.exit(-1);
            return;
    ...
    private void printUsage() {
        system.out().println("CombinedFlatFieldExportCli -o <output dir>");
        system.out().println("This exports all available combined flat fields.");
    }
