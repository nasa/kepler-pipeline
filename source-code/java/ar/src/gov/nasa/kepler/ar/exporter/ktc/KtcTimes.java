...
/**
 * A factory for actual times.
 * 
 * @author Sean McCauliff
 *
 */
public interface KtcTimes {
    ...
    /**
     * The ordering of target tables.
     * 
     * @param type LONG_CADENCE or SHORT_CADENCE target table.
     * @param externalId  The target tables external id.
     * @return  The order so that if order(targetTable0) < order(targetTable1)
     * then targetTable0 comes before targetTable1.
     */
