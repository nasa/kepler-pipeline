 ...
 * 
 */
public final class FloatArrayDataCopier implements ArrayDataCopier<TimeSeries> {

    private final ExposureCalculator exposureCalc;

    public FloatArrayDataCopier(ExposureCalculator exposureCalc) {
    ...
    throws IOException {
        dout.writeFloat((float) exposureCalc.fluxPerCadenceToFluxPerSecond(((FloatTimeSeries) t).fseries()[tsi]));
    }
