...
/**Parameters for the FFI assembler.
 * @author Sean McCauliff
 *
 */
public class FfiAssemblerModuleParameters implements Parameters {

    private String nfsExportDirectory; // = "/tmp";
    private boolean allowMissingChannels; // = false;
    ...
    /**
     * This is useful when testing in the dev pipeline.
     * @return
     */
    public boolean isAllowMissingChannels() {
        return allowMissingChannels;
    }

    public void setAllowMissingChannels(boolean allowMissingChannels) {
        this.allowMissingChannels = allowMissingChannels;
    }
