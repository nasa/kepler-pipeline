...
{
	this.homeForm.action = this.location +'uploadfile.html';
	this.homeForm.target = "_parent";
	this.homeForm.submit();
}

function Controller_refreshTree()
{
	this.homeForm.action = this.location +'index.html?oe-action=ReportTree.reloadTree&tree-name=reportPicker';
	this.homeForm.target = "_parent";
	this.homeForm.submit();
}
...
function Controller_uploadFile( inForm )
{
	...
	inForm.action = this.location +'index.html?oe-action=Page.uploadFile';
	inForm.target = "_parent";
	inForm.submit();
}
