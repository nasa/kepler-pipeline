...
/**
 * A filter for TaggedIntervals.
 * @author Sean McCauliff
 *
 */
public class TaggedIntervalFilter extends IntervalFilter {

	@Override
	protected Interval createNewInterval(Interval old, long newStart, long newEnd) {
		TaggedInterval taggedOld = (TaggedInterval) old;
		return new TaggedInterval(newStart, newEnd, taggedOld.tag());
	}
}