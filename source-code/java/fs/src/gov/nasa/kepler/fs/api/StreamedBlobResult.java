 ...
 *
 */
public class StreamedBlobResult  {
     ...
     * @param data
     */
    public StreamedBlobResult(long originator, long size, InputStream in) {
    	this.size = size;
    ...
    /**
     * Always returns the same stream no matter how many times this is called.
     * @return
     */
