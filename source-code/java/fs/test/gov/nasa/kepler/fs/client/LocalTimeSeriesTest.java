 ...
 *
 */
public class LocalTimeSeriesTest extends TimeSeriesCorrectnessTest {
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        config.setProperty(FS_DRIVER_NAME_PROPERTY, "local");
    }
