...
public class TransactionSpeed {
    ...
    @Test
    public void transactionSpeed() {
        final int warmup = 100;
        IntTimeSeries its = 
            new IntTimeSeries(new FsId("/test/1"), new int[] { 1}, 0, 0, new boolean[1], 11L);
        ...
        double elaspedSeconds = (end - start) /1000.0;
        double transactionsPerSecond = nTest / elaspedSeconds;
        System.out.println("Transactions per second: " + transactionsPerSecond);
     }
    
    public static void main(String[] argv) throws Exception {
        TransactionSpeed speed = new TransactionSpeed();
        speed.setup();
