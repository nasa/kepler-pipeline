 ...
 * @author Miles Cote
 */
public class MaskDefinition implements Persistable {
    ...
    MaskDefinition(Mask mask) {
        offsets = OffsetList.toList(mask.getOffsets());
    }

    public Mask toMask(MaskTable maskTable) {
        return new Mask(maskTable, OffsetList.toDatabaseList(offsets));
    }
