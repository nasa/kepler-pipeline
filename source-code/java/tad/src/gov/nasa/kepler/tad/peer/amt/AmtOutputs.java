...
/**
 * Contains the data that is returned by AMT MATLAB.
 * 
 * @author Miles Cote
 */
public class AmtOutputs implements Persistable {
    ...
    public AmtOutputs(TargetCrud targetCrud) {
        this.targetCrud = targetCrud;
    }

    public void storeFor(PipelineTask pipelineTask) {
        ...
        for (int i = 0; i < maskDefinitions.size(); i++) {
            MaskDefinition maskDefinition = maskDefinitions.get(i);
