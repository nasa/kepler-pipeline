...
/**
 * Contains the data that is returned by AMA MATLAB.
 * 
 * @author Miles Cote
 */
public class AmaOutputs implements Persistable {

    private List<TargetDefinitionStruct> targetDefinitions = newArrayList();

    private boolean[] usedMasks;
    ...
    public List<TargetDefinitionStruct> getTargetDefinitions() {
        return targetDefinitions;
    }

    public void setTargetDefinitions(
        List<TargetDefinitionStruct> targetDefinitions) {
    ...
    public boolean[] getUsedMasks() {
        return usedMasks;
    }

    public void setUsedMasks(boolean[] usedMasks) {
        this.usedMasks = usedMasks;
    }
