 ...
 * 
 */
public class TargetListSetEditorTest extends JMockTest {
    ...
    public void testGetValueSetValue() {
        ...
        TargetListSetEditor targetListSetEditor = new TargetListSetEditor(
            targetSelectionCrud);

        targetListSetEditor.setValue(TARGET_LIST_SET_NAME);

        assertEquals(TARGET_LIST_SET_NAME, targetListSetEditor.getValue());
    }
