 ...
 * 
 */
public class TadProductsToCharTablePipelineModuleTest extends JMockTest {
    ...
    private TadProductCharManager tadProductCharManager = mock(TadProductCharManager.class);

    private TadProductsToCharTablePipelineModule tadProductsToCharTablePipelineModule = new TadProductsToCharTablePipelineModule(
        tadProductCharManager);
    ...
    public void testFrameworkMethods() {
        PipelineModuleTest.testFrameworkMethods(tadProductsToCharTablePipelineModule);
    }
    ...
    public void testProcessTask() {
        ...
        oneOf(tadProductCharManager).manage(TARGET_LIST_SET_NAME, MOD_OUT);

        tadProductsToCharTablePipelineModule.processTask(pipelineInstance,
            pipelineTask);
    }
