 ...
 * 
 */
public class AmtOutputsTest extends JMockTest {
    ...
    private int indexInTable = maskDefinitions.size() - 1;
    ...
    private AmtOutputs amtOutputs = new AmtOutputs(targetCrud) {
        {
            setMaskDefinitions(maskDefinitions);
        }
    };

    @Test
    public void testGettersSetters() {
        PojoTest.testGettersSetters(new AmtOutputs());
    }

    @Test
    public void testStoreFor() {
        setAllowances();
