...
public class TaskMetricsTableModel extends AbstractTableModel {
    ...
    private static final Log log = LogFactory.getLog(TaskMetricsTableModel.class);

    private TaskMetricsDisplayModel taskMetricsDisplayModel = null;
    private boolean completedTasksOnly = false;
    
    public TaskMetricsTableModel(List<PipelineTask> tasks, List<String> orderedModuleNames, boolean completedTasksOnly) {
    ...
    public void update(List<PipelineTask> tasks, List<String> orderedModuleNames) {
        try{
            ...
            taskMetricsDisplayModel = new TaskMetricsDisplayModel(tasks, orderedModuleNames, completedTasksOnly);
