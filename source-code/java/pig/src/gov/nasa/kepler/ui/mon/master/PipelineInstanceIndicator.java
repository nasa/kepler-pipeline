...
public class PipelineInstanceIndicator extends Indicator {
    ...
    private LabelValue idLV = new LabelValue( "id", "0" );
    private LabelValue pipelineLV = new LabelValue( "pipeline", "PA" );
    private LabelValue stateLV = new LabelValue( "state", "PROCESSING" );
    private LabelValue tasksLV = new LabelValue( "tasks", "140/5/20/3" );
    private LabelValue workersLV = new LabelValue( "workers", "5" );

	public PipelineInstanceIndicator(IndicatorPanel parentIndicatorPanel, String name) {
        super(parentIndicatorPanel, name);
		this.setPreferredSize(new java.awt.Dimension(220, 65));
