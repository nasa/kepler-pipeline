...
public class ParameterSetViewDialog extends javax.swing.JDialog {
    //private static final Log log = LogFactory.getLog(ParameterSetViewDialog.class);
    ...
    public ParameterSetViewDialog(JDialog parentDialog, Map<ClassWrapper<Parameters>, ParameterSet> parameterSetsMap) {
        super(parentDialog);
    ...
    public static void showParameterSet(JDialog parentDialog, Map<ClassWrapper<Parameters>, ParameterSet> parameterSetsMap){
    ...
    private void initGUI() {
        try {
            {
                this.setTitle("View Parameter Sets");
