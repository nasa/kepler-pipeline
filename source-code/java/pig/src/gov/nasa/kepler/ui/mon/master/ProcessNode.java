...
public class ProcessNode extends StatusNode{
    ...
    public ProcessNode(ProcessStatusMessage processStatusMessage){
        update(processStatusMessage);
    }
    ...
    public void update(StatusMessage statusMessage){
        ...
        // clone it so we're not holding a reference to an object created by messaging layer
        processInfo = new ProcessInfo(processStatusMessage.getSourceProcess());
        
        this.state = processStatusMessage.getState();
        this.uptime = processStatusMessage.getUptime();
    }
