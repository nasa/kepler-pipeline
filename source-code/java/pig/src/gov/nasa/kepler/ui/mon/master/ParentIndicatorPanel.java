...
/**
 * A special {@link IndicatorPanel} that has an {@link Indicator} for each indicator
 * type (processes, workers, pipeline instances, metrics).  These parent indicators 
 * indicate the health of the worst child indicator of that type (rollup status) and
 * act as a navigation tool (clicking on the parent indicator will display the IndicatorPanel
 * for that type).
 * 
 * @author tklaus
 *
