...
import gov.nasa.kepler.hibernate.pi.GroupCrud;
...
public class GroupCrudProxy extends CrudProxy{
    ...
    public void save(final Group group) {
        ...
        PipelineConsole.crudProxyExecutor.executeSynchronous(new Runnable(){
            public void run() {
                ...
                GroupCrud crud = new GroupCrud(databaseService);
    ...
    public List<Group> retrieveAll() {
        ...
        List<Group> result = (List<Group>) PipelineConsole.crudProxyExecutor.executeSynchronous(new Callable<List<Group>>(){
            public List<Group> call() {
                GroupCrud crud = new GroupCrud();

                List<Group> result = crud.retrieveAll();
