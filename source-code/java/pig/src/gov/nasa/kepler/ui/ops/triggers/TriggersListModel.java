...
public class TriggersListModel extends AbstractListModel implements ComboBoxModel{
	@SuppressWarnings("unused")
    private static final Log log = LogFactory.getLog(TriggersListModel.class);
