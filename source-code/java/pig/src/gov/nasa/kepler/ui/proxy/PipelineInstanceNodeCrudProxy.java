...
public class PipelineInstanceNodeCrudProxy extends CrudProxy{
    ...
    public PipelineInstanceNode retrieve(final long id) {
        ...
        PipelineInstanceNode result = (PipelineInstanceNode) PipelineConsole.crudProxyExecutor.executeSynchronous(new Callable<PipelineInstanceNode>(){
            public PipelineInstanceNode call() {
                DatabaseService databaseService = DatabaseServiceFactory.getInstance();
                PipelineInstanceNodeCrud crud = new PipelineInstanceNodeCrud(databaseService);
    ...
    public List<PipelineInstanceNode> retrieveAll(final PipelineInstance pipelineInstance) {
        verifyPrivileges(Privilege.PIPELINE_MONITOR);
        List<PipelineInstanceNode> result = (List<PipelineInstanceNode>) PipelineConsole.crudProxyExecutor.executeSynchronous(new Callable<List<PipelineInstanceNode>>(){
            public List<PipelineInstanceNode> call() {
                DatabaseService databaseService = DatabaseServiceFactory.getInstance();
                PipelineInstanceNodeCrud crud = new PipelineInstanceNodeCrud(databaseService);
