...
import gov.nasa.kepler.ui.proxy.AlertLogCrudProxy;
...
public class AlertLogTableModel extends AbstractTableModel {
    ...
    private AlertLogCrudProxy alertLogCrud;
    private List<AlertLog> alerts = new ArrayList<AlertLog>();
    private long pipelineInstanceId;
    private AlertLogDisplayModel alertLogDisplayModel = new AlertLogDisplayModel();
