...
public class InstancesTableModel extends AbstractDatabaseModel{
    ...
    private static final Log log = LogFactory.getLog(InstancesTableModel.class);

    private InstancesDisplayModel instancesDisplayModel = new InstancesDisplayModel();
    private List<PipelineInstance> instances = new LinkedList<PipelineInstance>();
    private PipelineInstanceCrudProxy pipelineInstanceCrud;
    ...
    public void loadFromDatabase(){
        ...
        try{
            instances = pipelineInstanceCrud.retrieve(filter);
