...
/**
 * This exception is thrown by {@link CrudProxy} methods in response to 
 * a Hibernate/database error.  It's an indication to calling code that 
 * modal dialogs that contain database objects should be closed because
 * the database objects have become transient (because the underlying
 * Hibernate {@link Session} has been closed.
 *  
 * @author tklaus
 *
 */
