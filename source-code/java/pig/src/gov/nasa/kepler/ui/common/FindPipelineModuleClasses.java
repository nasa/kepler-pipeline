...
public class FindPipelineModuleClasses {
    ...
    public void report() throws Exception{
        ...
        Set<Class<? extends PipelineModule>> detectedClasses = 
            classpathUtils.scanFully(PipelineModule.class);
        ...
        LinkedList<String> packageNames = new LinkedList<String>(packageMap.keySet());
