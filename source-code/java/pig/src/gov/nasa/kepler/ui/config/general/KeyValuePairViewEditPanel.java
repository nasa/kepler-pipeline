...
public class KeyValuePairViewEditPanel extends AbstractViewEditPanel {
	private static final Log log = LogFactory.getLog(KeyValuePairViewEditPanel.class);

	private KeyValuePairTableModel keyValuePairTableModel; // do NOT init to null! (see getTableModel)
	...
	protected void doDelete(int row) {
		...
		if( choice == JOptionPane.YES_OPTION ){
			try {
                ...
                KeyValuePairCrud keyValuePairCrud = new KeyValuePairCrud(DatabaseServiceFactory.getInstance());
...
//                ConfigurationOperations.deleteKeyValuePairTransacted( keyValuePair );
	...
	private void showEditDialog( KeyValuePair keyValuePair ){
		...
		KeyValuePairEditDialog inst = new KeyValuePairEditDialog( PipelineConsole.instance, keyValuePair );
