 ...
 *
 */
public class PipelineConfigurationOperationsTest {

    private File libraryFile = new File(Filenames.BUILD_TEST,"config/pipeline-config.xml");
    ...
    public void testExportAll() throws IOException{
        ...
        PipelineConfigurationOperations p = new PipelineConfigurationOperations();
        
        FileUtil.cleanDir(libraryFile.getParentFile());
        p.exportPipelineConfiguration(triggers, libraryFile.getAbsolutePath());
    }
}
