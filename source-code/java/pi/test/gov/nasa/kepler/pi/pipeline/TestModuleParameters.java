...
public class TestModuleParameters implements Parameters {
    ...
    public static final int NON_FATAL_EXCEPTION = 2;
    ...
    public TestModuleParameters(int desiredResult) {
        this.desiredResult = desiredResult;
    }

    public int getDesiredResult() {
        return desiredResult;
    }

    public void setDesiredResult(int desiredResult) {
        this.desiredResult = desiredResult;
    }
