...
public class MockSupPortal extends SupPortal {

    private List<String> commandLine = new LinkedList<String>();
    
    public MockSupPortal() {
        super("host", "username");
    }

    @Override
    public SupCommandResults execCommand(List<String> commandLine) {
        this.commandLine = commandLine;
        return new SupCommandResults("so", "se", 0);
    }
