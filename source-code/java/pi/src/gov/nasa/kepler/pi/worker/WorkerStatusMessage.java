...
public class WorkerStatusMessage extends StatusMessage {
    private static final long serialVersionUID = -6549412605414612040L;
     ...
     */
    public WorkerStatusMessage(int threadNumber, String state, String instanceId, String taskId, String module, String moduleUow, long processingStartTime) {
    ...
    public String briefStatus() {
        return "WS:" + super.briefStatus() + "(" + threadNumber + "):" + "[" + state + ":" + instanceId + "-" + taskId + ":" + module + "{" + moduleUow + "}:since " + new Date(processingStartTime) + "]";
      }
