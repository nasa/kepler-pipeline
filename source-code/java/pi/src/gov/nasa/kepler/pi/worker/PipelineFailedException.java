...
/**
 * Exception thrown by the {@link EmbeddedWorkerCluster} when
 * a pipeline fails.
 * 
 * @author tklaus
 *
...
public class PipelineFailedException extends PipelineException {
    ...
    public PipelineFailedException(Throwable cause) {
        super(cause);
    }
}
