...
/**
 * Interface between {@link MatlabPipelineModule} and the serialization implementation
 * for MATLAB input files.
 * 
 * @author tklaus
 *
 */
public interface MatlabSerializer {
    
    public void serializeInputs(PipelineTask pipelineTask, List<? extends Persistable> inputsList, 
        File taskWorkingDir) throws Exception;
