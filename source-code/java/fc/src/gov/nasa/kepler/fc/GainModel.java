...
/**
 * Since the amount of gain data is relatively small, the gain values for every
 * module and output are included in the output Models.
 * 
 * @author kester
 * 
 */
public class GainModel implements Persistable {
    ...
    public GainModel(double[] mjds, double[][] constants) {
        this.mjds = mjds;
    ...
    public String toString() {
        ...
        try {
            ...
            out.setLength(0);
            out.append("ERROR IN GainModel.toString()");
        }
        return out.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final GainModel other = (GainModel) obj;
