...
import gov.nasa.kepler.dv.io.DvCentroidOffsets;
import gov.nasa.kepler.dv.io.DvDoubleQuantity;
import gov.nasa.kepler.dv.io.DvImageCentroid;
import gov.nasa.kepler.dv.io.DvQualityMetric;
import gov.nasa.kepler.dv.io.DvQuantity;

public class DvTestUtils {

    static DvCentroidOffsets createCentroidOffsets(int offset) {
    ...
    static DvImageCentroid createImageCentroid(int offset) {
    ...
    static DvQualityMetric createQualityMetric() {
