 ...
 */
public class DvDifferenceImageMotionResults implements Persistable {

    private DvMqCentroidOffsets mqControlCentroidOffsets = new DvMqCentroidOffsets();
    private DvMqCentroidOffsets mqKicCentroidOffsets = new DvMqCentroidOffsets();
    private DvMqImageCentroid mqControlImageCentroid = new DvMqImageCentroid();
    private DvMqImageCentroid mqDifferenceImageCentroid = new DvMqImageCentroid();
    private DvSummaryQualityMetric summaryQualityMetric = new DvSummaryQualityMetric();
    private DvSummaryOverlapMetric summaryOverlapMetric = new DvSummaryOverlapMetric();

    /**
     * Creates a {@link DvDifferenceImageMotionResults}. For use only by
    ...
    /**
     * Creates a new immutable {@link DvDifferenceImageMotionResults} object.
     */
    public DvDifferenceImageMotionResults(
