...
public class DvPlanetParameters implements Persistable {
    
    private DvQuantity geometricAlbedo = new DvQuantity();
    
    private DvQuantity planetEffectiveTemp = new DvQuantity();
    
    public DvPlanetParameters() {
    }
    
    public DvPlanetParameters(DvQuantity geometricAlbedo, DvQuantity planetEffectiveTemp) {
    ...
    public void setGeometricAlbedo(DvQuantity geometricAlbedo) {
        this.geometricAlbedo = geometricAlbedo;
    }
    ...
    public void setPlanetEffectiveTemp(DvQuantity planetEffectiveTemp) {
        this.planetEffectiveTemp = planetEffectiveTemp;
    }
