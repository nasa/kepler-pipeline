...
/**
 * Persistable class that simple contains the ancillary engineering data. This
 * enables writing it to a SDF file.
 * 
 * @author Forrest Girouard
 */
public class AncillaryEngineeringDataContainer implements Persistable {

    private List<AncillaryEngineeringData> ancillaryEngineeringDataStruct = new ArrayList<AncillaryEngineeringData>();

    public AncillaryEngineeringDataContainer(
