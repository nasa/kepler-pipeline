...
public class DvComparisonTests implements Persistable {
    
    private DvStatistic albedoComparisonStatistic = new DvStatistic();
    
    private DvStatistic tempComparisonStatistic = new DvStatistic();
    
    public DvComparisonTests() {
    }
    
    public DvComparisonTests(DvStatistic albedoComparisonStatistic, DvStatistic tempComparisonStatistic) {
    ...
    public void setAlbedoComparisonStatistic(DvStatistic albedoComparisonStatistic) {
        this.albedoComparisonStatistic = albedoComparisonStatistic;
    }
    ...
    public void setTempComparisonStatistic(DvStatistic tempComparisonStatistic) {
        this.tempComparisonStatistic = tempComparisonStatistic;
    }
}
