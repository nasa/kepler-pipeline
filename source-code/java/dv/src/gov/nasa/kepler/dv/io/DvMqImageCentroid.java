 ...
 */
public class DvMqImageCentroid implements Persistable {

    private DvDoubleQuantity decDegrees = new DvDoubleQuantity();
    private DvDoubleQuantity raHours = new DvDoubleQuantity();
