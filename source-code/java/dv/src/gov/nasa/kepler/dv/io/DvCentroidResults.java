...
/**
 * Results for both flux-weighted and PRF centroids.
 * 
 * @author Forrest Girouard
 */
public class DvCentroidResults implements Persistable {

    private DvCentroidMotionResults fluxWeightedMotionResults = new DvCentroidMotionResults();
    private DvCentroidMotionResults prfMotionResults = new DvCentroidMotionResults();
    private DvDifferenceImageMotionResults differenceImageMotionResults = new DvDifferenceImageMotionResults();
    private DvPixelCorrelationMotionResults pixelCorrelationMotionResults = new DvPixelCorrelationMotionResults();

    /**
     * Creates a {@link DvCentroidResults}. For use only by serialization, mock
     * objects, and Hibernate.
     */
    public DvCentroidResults() {
    }

    /**
     * Creates a new immutable {@link DvCentroidResults} object.
     */
