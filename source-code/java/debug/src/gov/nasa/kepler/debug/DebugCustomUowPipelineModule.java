...
public class DebugCustomUowPipelineModule extends DebugPipelineModule {
    static final Log log = LogFactory.getLog(DebugCustomUowPipelineModule.class);

    public static final String MODULE_NAME = "debug-custom-uow";

    public DebugCustomUowPipelineModule() {
    }
    ...
    public void processTask(PipelineInstance pipelineInstance, PipelineTask pipelineTask) {
        ...
        alertsService.generateAlert("debug-custom", pipelineTask.getId(), Severity.WARNING, "debug-custom was here");
