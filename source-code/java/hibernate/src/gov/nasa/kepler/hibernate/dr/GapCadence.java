...
/**
 * Models a gap of a complete cadence
 * 
 * @author Todd Klaus tklaus@arc.nasa.gov
 * 
 */
@Entity
@Table(name = "DR_GAP_CADENCE")
public class GapCadence {

    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "sg")
    @SequenceGenerator(name = "sg", sequenceName = "DR_GAP_CADENCE_SEQ")
    private long id;
    ...
    public GapCadence(int cadenceNumber, CadenceType cadenceType) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final GapCadence other = (GapCadence) obj;
