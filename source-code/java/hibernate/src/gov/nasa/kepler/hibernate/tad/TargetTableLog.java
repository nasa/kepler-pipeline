...
/**
 * Used for mapping target tables to actual cadence ranges. This is not an
 * Entity. It is used by pipeline modules (CAL, PA, etc.).
 * 
 * @author Miles Cote
 */
public class TargetTableLog {

    private TargetTable targetTable;
    private int cadenceStart;
    private int cadenceEnd;

    public TargetTableLog(TargetTable targetTable, int cadenceStart,
        int cadenceEnd) {
    ...
    public boolean equals(Object obj) {
        ...
        final TargetTableLog other = (TargetTableLog) obj;
        if (targetTable == null) {
