...
/**
 * This class provides CRUD methods for the security entities ({@link User} and
 * {@link Role}).
 * 
...
public class UserCrud extends AbstractCrud {
    ...
    public List<User> retrieveAllUsers() {
        List<User> results = list(getSession().createQuery("from User"));
        return results;
    }
    ...
    public List<Role> retrieveAllRoles() {
        List<Role> results = list(getSession().createQuery("from Role"));
        return results;
    }
