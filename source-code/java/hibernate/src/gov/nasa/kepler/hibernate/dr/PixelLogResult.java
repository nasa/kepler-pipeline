...
/**
 * Used for returning cadence log result sets to TAD. This is not a persistent
 * class.
 * 
 * @author Miles Cote
 * 
 */
public class PixelLogResult {

    private short tableId;
    private int cadenceStart;
    private int cadenceEnd;

    public PixelLogResult() {
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final PixelLogResult other = (PixelLogResult) obj;
    ...
    public PixelLogResult(short tableId, int cadenceStart, int cadenceEnd) {
    ...
    public String toString() {
        return "tableId=" + tableId + ",cadenceStart=" + cadenceStart
