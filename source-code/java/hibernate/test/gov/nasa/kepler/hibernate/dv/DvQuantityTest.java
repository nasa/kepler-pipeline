...
/**
 * Tests the {@link DvQuantity} class.
 * 
 * @author Bill Wohler
 */
public class DvQuantityTest {

    private static final Log log = LogFactory.getLog(DvQuantityTest.class);
    ...
    static DvQuantity createQuantity(float value, float uncertainty) {
        return new DvQuantity(value, uncertainty);
    }
    ...
    static void testQuantity(DvQuantity quantity) {
    ...
    public void testEquals() {
        ...
        DvQuantity mp = createQuantity(VALUE, UNCERTAINTY);
