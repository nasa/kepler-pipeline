 ...
 * 
 */
public class ModelMetadataRetrieverLatestTest extends JMockTest {
    ...
    public void testRetrieve() {
        ...
        ModelMetadataRetrieverLatest modelMetadataRetrieverLatest = new ModelMetadataRetrieverLatest(
            modelMetadataCrud);
        ModelMetadata actualModelMetadata = modelMetadataRetrieverLatest.retrieve(MODEL_TYPE);
