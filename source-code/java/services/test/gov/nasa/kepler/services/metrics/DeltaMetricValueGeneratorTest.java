...
import static gov.nasa.kepler.services.metrics.MetricsFileParserTest.assertMetricValue;
...
public class DeltaMetricValueGeneratorTest {
    ...
    public void generateDeltaMetricValues() throws Exception {
        ...
        List<MetricValue> absoluteMetricValues = 
            ImmutableList.of(new MetricValue("", mt0, timestampAsDate, 1.0f),
                             new MetricValue("", mt1, timestampAsDate, 2.0f),
                             new MetricValue("", mt0, timestampAsDate, 5.5f),
                             new MetricValue("", mt1, timestampAsDate, 2.1f));
        DeltaMetricValueGenerator generator = 
                new DeltaMetricValueGenerator(absoluteMetricValues.iterator());
