...
/**
 * Superclass for all status-related messages
 * (messages sent by the {@link StatusMessageBroadcaster}
 * 
 * @author Todd Klaus tklaus@arc.nasa.gov
 *
 */
public class StatusMessage extends PipelineMessage {
    private static final long serialVersionUID = 4832190073837838890L;
