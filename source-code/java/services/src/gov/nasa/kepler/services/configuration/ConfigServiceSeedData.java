...
/**
 * Loads config service properties from a file and uses them to seed
 * the KeyValuePair table.
 * 
 * @author Todd Klaus tklaus@arc.nasa.gov
 *
 */
public class ConfigServiceSeedData{
    private static final Log log = LogFactory.getLog(ConfigServiceSeedData.class);
