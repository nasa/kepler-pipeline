...
public class ConfigurationPanel extends ToolPanel {
    // Actions.
    public static final String NAME = "configurationPanel";

    /**
     * Creates an ConfigurationPanel.
     * 
     * @throws UiException if the panel could not be created.
     */
    public ConfigurationPanel() throws UiException {
        setName(NAME);
        createUi();
    }
