...
/**
 * Provides a transactional version of {@link PdqCrud}.
 * 
 * @author Bill Wohler
 */
public class PdqCrudProxy extends AbstractCrud {

    private PdqCrud pdqCrud;

    /**
     * Creates a new {@link PdqCrudProxy} object.
     */
    public PdqCrudProxy() {
        this(null);
    }
    ...
    /**
     * Creates a new {@link PdqCrudProxy} object with the specified database
     * service.
     * 
     * @param databaseService the {@link DatabaseService} to use for the
     * operations
     */
    public PdqCrudProxy(DatabaseService databaseService) {
    ...
    public List<AttitudeAdjustment> retrieveLatestAttitudeAdjustments(int n) {
        ...
        List<AttitudeAdjustment> attitudeAdjustments = pdqCrud.retrieveLatestAttitudeAdjustments(n);
        for (AttitudeAdjustment attitudeAdjustment : attitudeAdjustments) {
            Hibernate.initialize(attitudeAdjustment.getRefPixelLog());
            Hibernate.initialize(attitudeAdjustment.getPipelineTask());
        }
     ...
     */
    void setPdqCrud(PdqCrud pdqCrud) {
