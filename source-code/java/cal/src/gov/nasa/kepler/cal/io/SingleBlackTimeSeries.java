 ...
 *
 */
public final class SingleBlackTimeSeries implements Persistable {
    /**  The uncalibrated value of a black pixel that has been coadded in two dimensions. 
     * Where values[i] is the value at the time of cadenceTimes.cadenceNumber[i]
     */
    ...
    public SingleBlackTimeSeries() {
        
    }
    
    public SingleBlackTimeSeries(int[] values, boolean[] gapIndicators) {
        this.values = values;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        SingleBlackTimeSeries other = (SingleBlackTimeSeries) obj;
