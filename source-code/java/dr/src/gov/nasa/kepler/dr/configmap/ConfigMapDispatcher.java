...
/**
 * Dispatches config maps.
 * 
 * @author Miles Cote
 */
public class ConfigMapDispatcher implements Dispatcher {
    ...
    public void dispatch(Set<String> filenames, String sourceDirectory,
        ...
        for (String filename : filenames) {
            try {
                Importer<ConfigMap> configMapImporter = new Importer<ConfigMap>(
                    new ConfigMapReader(new FileReader(new File(
                        sourceDirectory, filename))), new ConfigMapStorer(
                        new ConfigMapCrud()));
                configMapImporter.importData();
            } catch (Exception e) {
