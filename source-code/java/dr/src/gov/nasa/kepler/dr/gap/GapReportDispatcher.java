...
/**
 * Dispatches gap reports.
 * 
 * @author Todd Klaus tklaus@arc.nasa.gov
 * @author Miles Cote
 * 
 */
public class GapReportDispatcher implements Dispatcher {
    ...
    public void dispatch(Set<String> filenames, String sourceDirectory,
        ...
        try {
            for (String filename : filenames) {
                Importer<GapReport> gapReportImporter = new Importer<GapReport>(
                    new GapReportReader(new FileReader(new File(
                        sourceDirectory, filename))), new GapReportStorer(
                        new GapCrud()));
                gapReportImporter.importData();
            }
        } catch (Exception e) {
