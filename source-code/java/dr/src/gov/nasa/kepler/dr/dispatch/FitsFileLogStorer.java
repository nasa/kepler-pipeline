...
/**
 * Stores fits file logs.
 * 
 * @author Miles Cote
 * 
 */
public class FitsFileLogStorer implements Storer<FitsFileLog> {

    @Override
    public void store(FitsFileLog fitsFileLog) {
        FileLog fileLog = fitsFileLog.getFileLog();
        FitsFile fitsFile = fitsFileLog.getFitsFile();
        ...
        FitsFileWriter fitsFileWriter = new FitsFileWriter(outputStream);
