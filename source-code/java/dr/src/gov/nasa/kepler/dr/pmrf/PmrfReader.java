 ...
 * 
 */
public class PmrfReader implements Reader<Pmrf> {

    private final FitsFileReader fitsFileReader;
    private final FileLog fileLog;
    private final PmrfType pmrfType;

    public PmrfReader(FitsFileReader fitsFileReader, FileLog fileLog,
        PmrfType pmrfType) {
        this.fitsFileReader = fitsFileReader;
    ...
    public Pmrf read() {
        ...
        PmrfLog pmrfLog = new PmrfLog(fileLog, pmrfType, targetTableId);
