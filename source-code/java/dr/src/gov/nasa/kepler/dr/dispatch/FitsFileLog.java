...
/**
 * Contains a fits file log.
 * 
 * @author Miles Cote
 * 
 */
public class FitsFileLog {

    private final FileLog fileLog;
    private final FitsFile fitsFile;

    public FitsFileLog(FileLog fileLog, FitsFile fitsFile) {
    ...
    public String toString() {
        return "FitsFileLog [fileLog=" + fileLog + ", fitsFile=" + fitsFile
            + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        FitsFileLog other = (FitsFileLog) obj;
        if (fileLog == null) {
