...
/**
 * Contains one entry of a time series.
 * 
 * @author Miles Cote
 * 
 */
final class TimeSeriesEntry {

    private final FsId fsId;
    private final int cadenceNumber;
    private final int value;

    TimeSeriesEntry(FsId fsId, int cadenceNumber, int value) {
        this.fsId = fsId;
    ...
    public String toString() {
        return "TimeSeriesEntry [fsId=" + fsId + ", cadenceNumber="
