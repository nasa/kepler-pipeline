 ...
 * 
 */
public class KicExtensionImporterTest extends JMockTest {
    ...
    private Importer<KicExtension> importer = mock(Importer.class);
    private ModelMetadataCrud modelMetadataCrud = mock(ModelMetadataCrud.class);

    private KicExtensionImporter kicExtensionImporter = new KicExtensionImporter(
        importer, modelMetadataCrud, description);

    @Test
    public void testImportData() {
        allowing(modelMetadataCrud).retrieveLatestModelRevision(
            KicExtensionImporter.MODEL_TYPE);
