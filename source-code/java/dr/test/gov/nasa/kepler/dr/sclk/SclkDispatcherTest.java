 ...
 * 
 */
public class SclkDispatcherTest extends DispatcherAbstractTest {

    public SclkDispatcherTest() {
        this.sourceDir = UNIT_TEST_PATH + "/sclk/";
        this.filename = "kplr2007284180000.tsc";
        this.dispatcherType = DispatcherType.SCLK;
        this.dispatcher = new DispatcherWrapper(new SclkDispatcher(),
