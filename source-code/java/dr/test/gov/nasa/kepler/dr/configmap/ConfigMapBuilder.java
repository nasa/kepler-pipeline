...
public class ConfigMapBuilder {
    ...
    private int scConfigId = 1;
    private double mjd = 56000;
    private Map<String, String> map = ImmutableMap.of(
        ConfigMapMnemonic.scConfigId.mnemonic(),
        String.valueOf(scConfigId),
        ConfigMapMnemonic.mjd.mnemonic(),
        String.valueOf(DateUtils.formatLikeDmc(ModifiedJulianDate.mjdToDate(Double.valueOf(mjd)))),
        ConfigMapMnemonic.fgsFramesPerIntegration.mnemonic(), "3");

    public ConfigMap build() {
        return new ConfigMap(scConfigId, mjd, map);
    }

    public ConfigMapBuilder withScConfigId(int scConfigId) {
        this.scConfigId = scConfigId;
        return this;
    }

    public ConfigMapBuilder withMjd(double mjd) {
        this.mjd = mjd;
        return this;
    }

    public ConfigMapBuilder withMap(Map<String, String> map) {
        this.map = map;
        return this;
    }
