 ...
 * 
 */
public class FfiDispatcherTest extends DispatcherAbstractTest {

    public FfiDispatcherTest() {
        this.sourceDir = UNIT_TEST_PATH + "/ffi/";
        this.filename = "kplr2008347160000_ffi-orig.fits";
        this.dispatcherType = DispatcherType.FFI;
        this.dispatcher = new DispatcherWrapper(new FfiDispatcher(),
