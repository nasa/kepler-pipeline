 ...
 * 
 */
public class PmrfBuilder {

    private PmrfLog pmrfLog = new PmrfLogBuilder().build();
    private FitsFile fitsFile = new FitsFileBuilder().build();

    public Pmrf build() {
        return new Pmrf(pmrfLog, fitsFile);
    }

    public PmrfBuilder withPmrfLog(PmrfLog pmrfLog) {
        this.pmrfLog = pmrfLog;
        return this;
    }

    public PmrfBuilder withFitsFile(FitsFile fitsFile) {
